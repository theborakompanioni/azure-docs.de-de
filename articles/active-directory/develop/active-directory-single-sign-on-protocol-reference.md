...
* `urn:oasis:names:tc:SAML:2.0:nameid-format:transient`: Azure Active Directory gibt den Anspruch „NameID“ in Form eines zufällig generierten Werts aus, der für den aktuellen SSO-Vorgang eindeutig ist. Dieser Wert ist temporär und kann nicht zur Identifizierung des sich authentifizierenden Benutzers verwendet werden.
