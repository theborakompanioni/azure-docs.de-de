...
## <a name="download-the-third-party-nxoauth2-library-and-create-a-workspace"></a>Herunterladen der Drittanbieterbibliothek „NXOAuth2“ und Erstellen eines Arbeitsbereichs
...
### <a name="add-the-library-to-your-project-by-using-cocoapods"></a>Hinzufügen der Bibliothek zu Ihrem Projekt mit CocoaPods
...
## <a name="explore-the-structure-of-the-project"></a>Erkunden der Struktur des Projekts
...
## <a name="set-up-the-settingsplst-file-in-the-library"></a>Einrichten der Datei „settings.plst“ in der Bibliothek
...
## <a name="set-up-the-nxoauth2client-library-in-your-loginviewcontroller"></a>Einrichten der NXOAuth2Client-Bibliothek im LoginViewController
...
### <a name="create-a-url-cache"></a>Erstellen eines URL-Cache
...
### <a name="create-a-webview-for-sign-in"></a>Erstellen einer Webansicht zum Anmelden
...
### <a name="override-the-webview-methods-to-handle-authentication"></a>Überschreiben der Webansichtmethoden zum Durchführen der Authentifizierung
...
### <a name="write-code-to-handle-the-result-of-the-oauth2-request"></a>Schreiben von Code zum Behandeln des Ergebnisses der OAuth2-Anforderung
...
### <a name="set-up-the-oauth-context-called-account-store"></a>Einrichten des OAuth-Kontexts (Kontospeicher)
...
## <a name="set-up-the-master-view-to-search-and-display-the-users-from-the-graph-api"></a>Einrichten der Masteransicht zum Durchsuchen und Anzeigen der Benutzer aus der Graph-API
...
### <a name="add-a-check-to-see-if-youre-logged-in"></a>Hinzufügen einer Prüfung, ob Sie angemeldet sind
...
### <a name="update-the-table-view-when-data-is-received"></a>Aktualisieren der Tabellenansicht nach dem Erhalt von Daten
...
### <a name="provide-a-way-to-call-the-graph-api-when-someone-types-in-the-search-field"></a>Schaffen einer Möglichkeit zum Aufrufen der Graph-API bei einer Eingabe im Suchfeld
...
## <a name="write-a-helper-class-to-access-the-graph-api"></a>Schreiben einer Hilfsklasse zum Zugreifen auf die Graph-API
...
### <a name="create-a-new-objective-c-header-file"></a>Erstellen einer neuen Objective-C-Headerdatei
...
### <a name="create-a-new-objective-c-file"></a>Erstellen einer neuen Objective-C-Datei
