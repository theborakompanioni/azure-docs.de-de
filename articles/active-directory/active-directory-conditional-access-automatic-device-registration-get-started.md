...
1.  Geräte können beim Beitritt zur Azure AD-Domäne registriert werden. Erfahren Sie mehr über das Einbinden in Azure AD und über die Einstellungen, die Benutzer für den Beitritt zu einer Azure AD-Domäne benötigen.

2.  Geräte können registriert werden, wenn Benutzer auf einem persönlichen Gerät Geschäfts-, Schul- oder Unikonten in Windows hinzufügen oder wenn mobile Geräte eine Verbindung mit Arbeitsressourcen herstellen, für die eine Registrierung erforderlich ist. Um dies sicherzustellen, müssen Sie die Azure AD-Geräteregistrierung im Azure-Portal aktivieren. 

3.  Geräte können für herkömmliche in die Domäne eingebundene Computer mithilfe der automatischen Geräteregistrierung registriert werden. Hierzu müssen Sie zuerst Azure AD Connect einrichten, bevor Sie mit der automatischen Geräteregistrierung fortfahren.
