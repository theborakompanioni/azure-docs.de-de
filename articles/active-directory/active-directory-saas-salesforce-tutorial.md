...
3. Wählen Sie Ihren Testbenutzer aus, und klicken Sie am unteren Bildschirmrand auf die Schaltfläche **Zuweisen** :
 ...
 - Wenn Sie die automatisierte Benutzerbereitstellung aktiviert haben, werden Sie aufgefordert, zu definieren, welche Art von Salesforce-Profil der Benutzer erhalten soll. Neu bereitgestellte Benutzer sollten in Ihrer Salesforce-Umgebung nach einigen Minuten angezeigt werden.
        ...
        > [AZURE.IMPORTANT] Bei der Bereitstellung in einer Salesforce-**Entwickler**umgebung steht Ihnen für jedes Profil eine sehr begrenzte Anzahl von Lizenzen zur Verfügung. Daher sollten Benutzer möglichst im **Chatter Free User**-Profil bereitgestellt werden, für das 4.999 Lizenzen verfügbar sind.
