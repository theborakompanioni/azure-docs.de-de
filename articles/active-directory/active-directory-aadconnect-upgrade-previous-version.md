...
6. Machen Sie den Stagingserver zum aktiven Server. Dies ist der letzte Schritt in [Überprüfen der Konfiguration eines Servers](active-directory-aadconnectsync-operations.md#verify-the-configuration-of-a-server): **Wechseln des aktiven Servers**.
