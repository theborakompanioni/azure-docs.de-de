...
Damit einmaliges Anmelden funktioniert, muss Azure AD wissen, welcher Benutzer in Skilljar als Gegenbenutzer zu einem Benutzer in Azure AD fungiert. Anders ausgedrückt: Zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Skilljar muss eine Linkbeziehung eingerichtet werden.  
...
3. Führen Sie auf der Dialogseite **App-Einstellungen konfigurieren** die folgenden Schritte aus:
    ...
    a. Geben Sie im Textfeld **Anmelde-URL** die URL, die die Benutzer zur Anmeldung bei der Skilljar-Anwendung verwenden, nach folgendem Muster ein: *https://\<Unternehmensname\>.skilljar.com*.

    b. Klicken Sie auf **Weiter**.


1. Führen Sie auf der Seite **Einmaliges Anmelden konfigurieren für Skilljar** die folgenden Schritte aus:
...
2. Für die Konfiguration von SSO für Ihre Anwendung wenden Sie sich per E-Mail an das Supportteam von Skilljar. Fügen Sie den Wert von **Namensbezeichnerformat** in Ihre E-Mail ein, und hängen Sie die heruntergeladene Metadatendatei an.
...
### <a name="creating-a-skilljar-test-user"></a>Erstellen eines Skilljar-Testbenutzers
...
Das Ziel dieses Abschnitts besteht darin, Britta Simon die Verwendung des einmaligen Anmeldens von Azure zu ermöglichen, indem sie Zugriff auf Skilljar erhält.
