...
Dieses Tutorial soll Ihnen zeigen, wie Sie HR2day by Merces in Azure Active Directory (Azure AD) integrieren können. Die Integration von HR2day by Merces in Azure AD bietet die folgenden Vorteile:
...
2. Klicken Sie im Menü oben auf **Schnellstart**, um das Dialogfeld **Schnellstart** zu öffnen.
...
4. Wählen Sie auf der Seite **Wie sollen sich Benutzer bei HR2day by Merces anmelden** die Option **Azure AD – einmaliges Anmelden** aus, und klicken Sie dann auf **Weiter**.
...
> [!NOTE]
> Informieren Sie das Merces-Team darüber, dass für diese Integration das Festlegen der Entitäts-ID mit diesem Muster erforderlich ist: **https://hr2day.force.com/INSTANCENAME**
> 
> 
...
8. Führen Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** die folgenden Schritte aus:
    ...
    ![Erstellen einesAzure AD-Testbenutzers](./media/active-directory-saas-hr2day-tutorial/create_aaduser_08.png)
