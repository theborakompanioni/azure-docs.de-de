<properties
   pageTitle="Schrittweise Anleitung für den generischen SQL-Connector | Microsoft Azure"
...
Führen Sie auf einem Server mit SQL Server das SQL-Skript aus [Anhang A](#appendix-a) aus. Mit diesem Skript wird eine Beispieldatenbank mit dem Namen GSQLDEMO erstellt. Das Objektmodell für die erstellte Datenbank sieht wie in folgender Abbildung aus:   
...
1. Wählen Sie auf der Synchronization Service Manager-Benutzeroberfläche **Connectors** und **Erstellen**. Wählen Sie **Generisch, SQL (Microsoft)** aus, und geben Sie dem Connector einen aussagekräftigen Namen.  
![Connector 1](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\connector1.png)
...
![Connector 2](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\connector2.png)
...
![Connector 3](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\connector3.png)
...
![Connector 4](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\connector4.png)
...
![Connector 5](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\connector5.png)
...
![Connector 6](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\connector6.png)
...
![Connector 8](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\connector8.png)
9. Wählen Sie auf der Seite **Partitionen und Hierarchien konfigurieren** beide Objekttypen aus.
![Connector 9](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\connector9.png)
...
![Ausführungsprofil 1](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\runprofile1.png)
...
![Ausführungsprofil 5a](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\runprofile5a.png)  
![Ausführungsprofil 5b](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\runprofile5b.png)  
...
![CS 1](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\cs1.png)  
![CS 2](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\cs2.png)  
