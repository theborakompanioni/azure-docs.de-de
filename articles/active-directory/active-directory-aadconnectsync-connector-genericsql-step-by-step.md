...
Führen Sie auf einem Server mit SQL Server das SQL-Skript aus [Anhang A](#appendix-a) aus. Mit diesem Skript wird eine Beispieldatenbank mit dem Namen GSQLDEMO erstellt. Das Objektmodell für die erstellte Datenbank sieht wie in folgender Abbildung aus: ![Objektmodell](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\objectmodel.png)
...
2. Wählen Sie die Registerkarte **Datei-DSN**. Klicken Sie auf **Hinzufügen...**. ![ODBC 1](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\odbc1.png)
3. Der Standardtreiber funktioniert gut. Wählen Sie ihn also aus, und klicken Sie auf **Weiter>**. ![ODBC 2](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\odbc2.png)
...
6. Konfigurieren Sie jetzt die Verbindung. Geben Sie eine aussagekräftige Beschreibung der Datenquelle ein, und geben Sie den Namen des Servers mit SQL Server an. ![ODBC 5](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\odbc5.png)
...
1. Wählen Sie auf der Synchronization Service Manager-Benutzeroberfläche **Connectors** und **Erstellen**. Wählen Sie **Generisch, SQL (Microsoft)** aus, und geben Sie dem Connector einen aussagekräftigen Namen. ![Connector 1](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\connector1.png)
