...
2. Führen Sie auf der Dialogseite **App-Einstellungen konfigurieren** die folgenden Schritte aus:
    ...
    a. Geben Sie im Textfeld „Anmelde-URL“ die URL, die von Ihren Benutzern zur Anmeldung bei der Asset Bank-Anwendung verwendet wird, nach folgendem Muster ein: **https://\<Unternehmensname\>.assetbank-server.com**.
...
### <a name="creating-a-asset-bank-test-user"></a>Erstellen eines Asset Bank-Testbenutzers
