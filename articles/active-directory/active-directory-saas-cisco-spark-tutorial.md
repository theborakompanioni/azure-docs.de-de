...
In diesem Abschnitt konfigurieren und testen Sie das einmalige Anmelden von Azure AD bei Cisco Spark mithilfe eines Testbenutzers namens Britta Simon.
...
Das Ziel dieses Abschnitts besteht darin, das einmalige Anmelden von Azure AD im klassischen Azure-Portal zu aktivieren und das einmalige Anmelden in Ihrer Cisco Spark-Anwendung zu konfigurieren.
...
2. Führen Sie im Dialogfeld **SAML-Tokenattribute** die folgenden Schritte aus:
    ...
    c. Wählen Sie in der Liste **Attributwert** den Wert **user:userprincipal** aus.
...
6. Führen Sie auf der Dialogseite **App-Einstellungen konfigurieren** die folgenden Schritte aus:
    ...
    a. Geben Sie im Textfeld „Anmelde-URL“ eine URL im folgenden Format ein: `https://web.ciscospark.com/#/signin`.

    b. Klicken Sie auf **Weiter**.


1. Klicken Sie auf der Seite **Einmaliges Anmelden konfigurieren für Cisco Spark** auf **Metadaten herunterladen**, und speichern Sie die Datei auf Ihrem Computer.
   
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-cisco-spark-tutorial/tutorial_cisco_spark_09.png)
2. Melden Sie sich beim [Cisco Cloud Collaboration Management](https://admin.ciscospark.com/) mit vollständigen Administratorberechtigungen an.
3. Wählen **Settings** (Einstellungen) aus, und klicken Sie im Bereich **Authentication** (Authentifizierung) auf **Modify** (Ändern).
   
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-cisco-spark-tutorial/tutorial_cisco_spark_10.png)
4. Wählen Sie **Integrate a 3rd-party identity provider. (Advanced)** (Identitätsanbieter von Drittanbieter integrieren (Erweitert)) aus, und wechseln Sie zum nächsten Bildschirm.
5. Klicken Sie auf **Download Metadata File** (Metadatendatei herunterladen), und speichern Sie die Datei auf Ihrem Computer.
...
In diesem Abschnitt ermöglichen Sie Britta Simon das einmalige Anmelden bei Azure, indem Sie ihr Zugriff auf Cisco Spark gewähren.
