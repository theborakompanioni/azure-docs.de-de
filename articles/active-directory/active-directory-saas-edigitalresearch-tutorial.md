...
4. Geben Sie im Suchfeld **eDigitalResearch** ein, wählen Sie im Ergebnisbereich **eDigitalResearch** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![eDigitalResearch in der Ergebnisliste](./media/active-directory-saas-edigitalresearch-tutorial/tutorial_edigitalresearch_addfromgallery.png)
...
3. **[Erstellen eines eDigitalResearch-Testbenutzers](#create-a-edigitalresearch-test-user)**, um ein Pendant von Britta Simon in eDigitalResearch zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/active-directory-saas-edigitalresearch-tutorial/tutorial_edigitalresearch_samlbase.png)

3. Führen Sie im Abschnitt **Domäne und URLs für eDigitalResearch** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für eDigitalResearch](./media/active-directory-saas-edigitalresearch-tutorial/tutorial_edigitalresearch_url.png)
...
4. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.
    ...
    !![Downloadlink für das Zertifikat](./media/active-directory-saas-edigitalresearch-tutorial/tutorial_edigitalresearch_certificate.png) 

5. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Einmaliges Anmelden konfigurieren“](./media/active-directory-saas-edigitalresearch-tutorial/tutorial_general_400.png)

6. Klicken Sie im Abschnitt **eDigitalResearch-Konfiguration** auf **eDigitalResearch konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL und SAML-Entitäts-ID** aus dem Abschnitt **Kurzübersicht**.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/active-directory-saas-edigitalresearch-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/active-directory-saas-edigitalresearch-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/active-directory-saas-edigitalresearch-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/active-directory-saas-edigitalresearch-tutorial/create_aaduser_04.png)
...
2. Wählen Sie in der Anwendungsliste den Eintrag **eDigitalResearch** aus.
    ...
    ![eDigitalResearch-Link in der Anwendungsliste](./media/active-directory-saas-edigitalresearch-tutorial/tutorial_edigitalresearch_app.png)  
