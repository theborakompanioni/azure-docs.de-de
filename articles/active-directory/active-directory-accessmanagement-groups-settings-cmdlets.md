...
--------------------------------------|-----------------------------------------------
 ...
 <ul><li>EnableGroupCreation<li>Typ: Boolesch<li>Standardwert: True | Das Flag, das angibt, ob die Erstellung von einheitlichen Gruppen im Verzeichnis zulässig ist.                               
...
## SettingsTemplate-Objektreferenz (SettingsTemplate-Objekt „Group.Unified“)
...
Name | Typ | defaultValue | description
----------  | ----------  | ---------  | ----------
