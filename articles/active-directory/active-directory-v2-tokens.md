---
title: Azure AD v2.0-Tokenreferenz| Microsoft Docs
...
---
# <a name="v2.0-token-reference"></a>v2.0-Tokenreferenz
...
#### <a name="sample-id_token"></a>ID-Beispieltoken
```
...
> [!TIP]
> Überprüfen Sie zu Übungszwecken die Ansprüche im ID-Beispieltoken, indem Sie sie in [calebb.net](https://calebb.net) einfügen.
> 
> 

#### <a name="claims-in-id_tokens"></a>Ansprüche in ID-Token
