...
Diese Linkbeziehung wird hergestellt, indem Sie den Wert des **Benutzernamens** in Azure AD als Wert des **Benutzernamens** in Atomic Learning zuweisen.
...
3. Wählen Sie auf der Seite **Wie sollen sich Benutzer bei Atomic Learning anmelden?** die Option **Microsoft Azure AD – einmaliges Anmelden** aus, und klicken Sie dann auf **Weiter**.
...
1. Klicken Sie auf der Seite **Einmaliges Anmelden konfigurieren für Atomic Learning** auf **Metadaten herunterladen**, und speichern Sie die Datei auf Ihrem Computer.
   
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-atomiclearning-tutorial/tutorial_atomiclearning_08.png)

2. Wenden Sie sich an den Support von Atomic Learning, um SSO für Ihre Anwendung konfigurieren zu lassen. Dort erhalten Sie Informationen zum richtigen Kanal für die SSO-Konfiguration. Beachten Sie, dass Sie eine E-Mail mit der angefügten heruntergeladenen Metadatendatei an <mailto:cs@atomiclearning.com> senden müssen.
...
8. Führen Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** die folgenden Schritte aus:
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-atomiclearning-tutorial/create_aaduser_08.png) 
   
    a. Notieren Sie den Wert von **Neues Kennwort**.
   
    b. Klicken Sie auf **Fertig stellen**.   

### <a name="creating-a-atomic-learning-test-user"></a>Erstellen eines Atomic Learning-Testbenutzers
