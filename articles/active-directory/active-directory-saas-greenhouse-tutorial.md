...
3.  Geben Sie auf der Seite **App-URL konfigurieren** im Textfeld **Anmelde-URL** Ihre URL im Format „*https://company.greenhouse.io*" ein, und klicken Sie dann auf **Weiter**.
