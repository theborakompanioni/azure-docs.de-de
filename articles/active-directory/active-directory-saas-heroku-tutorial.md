...
7. Wählen Sie im Ergebnisbereich **Heroku** aus, und klicken Sie dann auf **Abschließen**, um die Anwendung hinzuzufügen. <br><br> ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-heroku-tutorial/tutorial_heroku_02.png)<br>
...
Damit einmaliges Anmelden funktioniert, muss Azure AD wissen, welcher Benutzer in Heroku als Gegenbenutzer zu einem Benutzer in Azure AD fungiert. Anders ausgedrückt: Zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Heroku muss eine Linkbeziehung eingerichtet werden.<br> Diese wird hergestellt, indem Sie den **Benutzernamen** in Azure AD als Wert dem **Benutzernamen** in Heroku zuweisen.
...
4. **[Creating an Heroku test user](#creating-an-heroku-test-user)** (Erstellen eines Heroku-Testbenutzers), um eine Entsprechung von Britta Simon in Heroku zu erstellen, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
3. Führen Sie auf der Dialogseite **App-Einstellungen konfigurieren** die folgenden Schritte aus: <br><br>![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-heroku-tutorial/tutorial_heroku_04.png) <br>
    ...
    > [AZURE.NOTE] Wenn Sie die korrekten Werte für die Anmelde-URL und den Bezeichner-URL nicht wissen, finden Sie die Lösung im Abschnitt „[Führen Sie die folgenden Schritte aus, um einmaliges Anmelden in Heroku zu aktivieren](#x123)“.


    a. Geben Sie im Textfeld **Anmelde-URL** nach folgendem Muster die URL ein, die Benutzer zum Anmelden bei Ihrer Heroku-Anwendung verwenden: „**https://sso.heroku.com/saml/<Firmenname>/init**“.

    b. Geben Sie im Textfeld **Bezeichner** nach folgendem Muster eine URL ein: „**https://sso.heroku.com/saml/\<Firmenname>**“.

    c. Klicken Sie auf **Weiter**.


4. Führen Sie auf der Seite **Einmaliges Anmelden bei Heroku konfigurieren** die folgenden Schritte aus: <br><br>![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-heroku-tutorial/tutorial_heroku_05.png) <br>
...
5. Führen Sie die folgenden Schritte aus, um einmaliges Anmelden in Heroku zu aktivieren:
    ...
    f. <a name="x123"></a>Kopieren Sie Ihre **Heroku-Anmelde-URL** und Ihre **Heroku-Entitäts-ID**. Gehen Sie dann im klassischen Azure AD-Portal zurück auf die Seite **App-Einstellungen konfigurieren**, und fügen Sie die Werte in die entsprechenden Textfelder ein.
...
6. Wählen Sie die Bestätigung zur Konfiguration des einmaligen Anmeldens aus, und klicken Sie dann auf **Weiter**. <br><br>![Azure AD – einmaliges Anmelden][10]<br>
...
In diesem Abschnitt erstellen Sie im klassischen Portal einen Testbenutzer namens Britta Simon.<br> Wählen Sie in der Benutzerliste **Britta Simon** aus.<br><br>![Azure AD-Benutzer erstellen][20]<br>
...
In diesem Abschnitt ermöglichen Sie Britta Simon das einmalige Anmelden bei Azure, indem Sie ihr Zugriff auf Heroku gewähren. <br><br>![Benutzer zuweisen][200] <br>

**Um Britta Simon Heroku zuzuweisen, führen Sie die folgenden Schritte aus:**

1. Klicken Sie in der oberen Menüleiste der Verzeichnisansicht auf **Anwendungen**, um die Anwendungsansicht im klassischen Portal öffnen. <br><br>![Benutzer zuweisen][201] <br>
...
In diesem Abschnitt testen Sie die Azure AD-Konfiguration für das einmalige Anmelden mithilfe des Zugriffsbereichs.<br> Wenn Sie im Zugriffsbereich auf die Kachel „Heroku“ klicken, sollten Sie automatisch bei Ihrer Heroku-Anwendung angemeldet werden.
