...
# Hinzufügen einer mehrinstanzenfähigen Anwendung zum Azure AD-Anwendungskatalog

<a id="what-is-the-azure-ad-application-gallery" class="xliff"></a>

## Was ist der Azure AD-Anwendungskatalog?
...
## Wenn Ihre Anwendung SAML oder OpenIDConnect unterstützt
...
## Wenn Ihre Anwendung keine SAML- oder OpenIDConnect-Unterstützung bietet
