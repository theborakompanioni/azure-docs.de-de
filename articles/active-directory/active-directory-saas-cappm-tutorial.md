...
3. Führen Sie auf der Dialogseite **App-Einstellungen konfigurieren** die folgenden Schritte aus:
    ...
    a. Geben Sie im Textfeld **Bezeichner** die URL, die von Ihren Benutzern zur Anmeldung bei der CA PPM-Anwendung verwendet wird, nach folgendem Muster ein: **https://ca.ondemand.saml.20.post.\<Unternehmensname\>**.
...
### <a name="creating-an-ca-ppm-test-user"></a>Erstellen eines CA PPM-Testbenutzers
