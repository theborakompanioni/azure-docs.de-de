...
- Sie können Benutzern ermöglichen, sich mit ihrem Azure AD-Konto automatisch bei Zscaler One (Single Sign-On, SSO; einmaliges Anmelden) anzumelden.
...
4. Geben Sie im Suchfeld den Namen **Zscaler One** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-zscaler-one-tutorial/tutorial_zscalerone_search.png)

5. Wählen Sie im Ergebnisbereich die Option **Zscaler One** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-zscaler-one-tutorial/tutorial_zscalerone_addfromgallery.png)
...
Weisen Sie in Zscaler One den Wert für **Benutzername** in Azure AD als Wert für **Benutzername** zu, um eine Linkbeziehung herzustellen.
...
4. **[Erstellen eines Zscaler One-Testbenutzers](#creating-a-zscaler-one-test-user)**, um ein Pendant von Britta Simon in Zscaler One zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-zscaler-one-tutorial/tutorial_zscalerone_samlbase.png)

3. Führen Sie im Abschnitt **Domäne und URLs für Zscaler One** die folgenden Schritte aus:

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-zscaler-one-tutorial/tutorial_zscalerone_url.png)
...
4. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-zscaler-one-tutorial/tutorial_zscalerone_certificate.png) 

5. Klicken Sie auf die Schaltfläche **Save** .

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-zscaler-one-tutorial/tutorial_general_400.png)

6. Klicken Sie im Abschnitt **Zscaler One-Konfiguration** auf **Zscaler One konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-zscaler-one-tutorial/tutorial_zscalerone_configure.png) 

7. Melden Sie sich in einem anderen Webbrowserfenster bei der Zscaler One-Unternehmenswebsite als Administrator an.
...
11. Führen Sie auf der Dialogfeldseite **Parameter der einmaligen Anmeldung für SAML konfigurieren** die folgenden Schritte aus, und klicken Sie dann auf **Fertig**.
    ...
    ![Einmaliges Anmelden](./media/active-directory-saas-zscaler-one-tutorial/ic800209.png "des einmaligen Anmeldens")
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-zscaler-one-tutorial/create_aaduser_01.png) 

2. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-zscaler-one-tutorial/create_aaduser_02.png) 

3. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-zscaler-one-tutorial/create_aaduser_03.png) 

4. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-zscaler-one-tutorial/create_aaduser_04.png) 
...
3. Klicken Sie auf **Benutzerverwaltung**.   
     ...
     ![Hinzufügen](./media/active-directory-saas-zscaler-one-tutorial/ic781036.png "Hinzufügen")
...
> [!NOTE]
> Sie können Azure AD-Benutzerkonten auch mithilfe anderer Tools zum Erstellen von Zscaler One-Benutzerkonten oder mithilfe der von Zscaler One bereitgestellten APIs erstellen.
...
**Um Britta Simon Zscaler One zuzuweisen, führen Sie die folgenden Schritte aus:**
...
2. Wählen Sie in der Liste der Anwendungen **Zscaler One** aus.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-zscaler-one-tutorial/tutorial_zscalerone_app.png) 
