...
## <a name="enabling-the-application-integration-for-freshservice"></a>Aktivieren der Anwendungsintegration für FreshService
...
6. Klicken Sie oben im Menü auf **Administrator**.
   ...
   ![Administrator](./media/active-directory-saas-freshservice-tutorial/IC790814.png "Admin")
...
### <a name="to-assign-users-to-freshservice-perform-the-following-steps"></a>So weisen Sie FreshService Benutzer zu
