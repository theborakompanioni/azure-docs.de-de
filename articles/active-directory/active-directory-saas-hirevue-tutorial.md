<properties
	pageTitle="Tutorial: Azure Active Directory-Integration mit HireVue | Microsoft Azure"
...
# Tutorial: Azure Active Directory-Integration mit HireVue
...
## Hinzufügen von HireVue über den Katalog
...
Diese Linkbeziehung wird hergestellt, indem Sie den Benutzernamen in Azure AD dem Benutzernamen in HireVue zuweisen.
...
3. **[Erstellen eines HireVue-Testbenutzers](#creating-a-predictix-price-reporting-test-user)**, um in HireVue einen Gegenpart von Britta Simon zu erhalten, der mit ihrer Darstellung in Azure AD verknüpft ist.
...
8. Führen Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** die folgenden Schritte aus:
	...
	![Erstellen einesAzure AD-Testbenutzers](./media/active-directory-saas-hirevue-tutorial/create_aaduser_08.png)
...
### Erstellen eines HireVue-Testbenutzers
