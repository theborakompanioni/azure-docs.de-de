...
3. Geben Sie auf der Seite **App-URL konfigurieren** im Textfeld **Anmelde-URL** Ihre URL im Format „*http://company.mindflash.com*" ein, und klicken Sie dann auf **Weiter**.
