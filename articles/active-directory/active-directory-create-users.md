...
## <a name="guest-user-management-and-limitations"></a>Verwaltung von Gastbenutzern und Einschränkungen
...
## <a name="set-guest-user-access-policies"></a>Festlegen von Richtlinien für den Gastbenutzerzugriff
