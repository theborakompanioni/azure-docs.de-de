...
description: "Hier erfahren Sie, wie Sie Nexonia mit Azure Active Directory verwenden können, um einmaliges Anmelden, automatisierte Bereitstellung und vieles mehr zu ermöglichen."
...
6. Geben Sie im Suchfeld als Suchbegriff **Nexonia** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-nexonia-tutorial/tutorial_nexonia_01.png)

7. Wählen Sie im Ergebnisbereich **Nexonia** aus, und klicken Sie dann auf **Abschließen**, um die Anwendung hinzuzufügen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-nexonia-tutorial/tutorial_nexonia_02.png)


##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>Konfigurieren und Testen der einmaligen Anmeldung von Azure AD
In diesem Abschnitt konfigurieren und testen Sie anhand eines Testbenutzers namens Britta Simon das einmalige Anmelden von Azure AD mit Nexonia.
...
Diese Linkbeziehung wird hergestellt, indem Sie den Benutzernamen**** in Azure AD als Benutzernamen ****in Nexonia zuweisen.
...
In diesem Abschnitt ermöglichen Sie das einmalige Anmelden von Azure AD im klassischen Portal und konfigurieren das einmalige Anmelden in Ihrer Nexonia-Anwendung.


**Führen Sie zum Konfigurieren des einmaligen Anmeldens von Azure AD in Nexonia die folgenden Schritte aus:**

1. Klicken Sie im klassischen Azure-Portal auf der Anwendungsintegrationsseite für **Nexonia** auf **Einmaliges Anmelden konfigurieren**, um das Dialogfeld **Einmaliges Anmelden konfigurieren** zu öffnen.
     
    ![Einmaliges Anmelden konfigurieren][6] 

2. Wählen Sie auf der Seite **Wie sollen sich Benutzer bei Nexonia anmelden?** die Option **Azure AD – einmaliges Anmelden** aus, und klicken Sie dann auf **Weiter**.

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-nexonia-tutorial/tutorial_nexonia_03.png) 

3. Führen Sie auf der Dialogseite **App-Einstellungen konfigurieren** die folgenden Schritte aus:

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-nexonia-tutorial/tutorial_nexonia_04.png) 

    a. Geben Sie im Textfeld **Antwort-URL** eine URL nach folgendem Muster ein: `https://system.nexonia.com/assistant/saml.do?orgCode=<organizationcode>`.
    
    b. click **Weiter**
 
4. Führen Sie auf der Seite **Einmaliges Anmelden konfigurieren für Nexonia** die folgenden Schritte aus:

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-nexonia-tutorial/tutorial_nexonia_05.png)
...
5. Wenden Sie sich an das Supportteam von Nexonia, um SSO (Single Sign-On, einmaliges Anmelden) für Ihre Anwendung konfigurieren zu lassen, und stellen Sie Folgendes bereit:
...
1. Klicken Sie im linken Navigationsbereich des **klassischen Azure-Portals** auf **Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-nexonia-tutorial/create_aaduser_09.png) 
...
5. Führen Sie auf der Dialogfeldseite **Informationen über diesen Benutzer** die folgenden Schritte aus:  ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-nexonia-tutorial/create_aaduser_05.png) 
...
6.  Führen Sie auf der Dialogfeldseite **Benutzerprofil** die folgenden Schritte aus: ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-nexonia-tutorial/create_aaduser_06.png) 
...
7. Klicken Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** auf **Erstellen**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-nexonia-tutorial/create_aaduser_07.png) 

8. Führen Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** die folgenden Schritte aus:

    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-nexonia-tutorial/create_aaduser_08.png) 
...
### <a name="creating-an-nexonia-test-user"></a>Erstellen eines Nexonia-Testbenutzers

In diesem Abschnitt erstellen Sie in Nexonia einen Benutzer namens Britta Simon. Lassen Sie sich beim Hinzufügen der Benutzer ggf. vom Nexonia-Supportteam unterstützen. Benutzer müssen erstellt und aktiviert werden, damit Sie einmaliges Anmelden verwenden können.
...
2. Wählen Sie in der Anwendungsliste **Nexonia** aus.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-nexonia-tutorial/tutorial_nexonia_50.png) 
