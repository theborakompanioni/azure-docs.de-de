<properties
	pageTitle="Tutorial: Azure Active Directory-Integration mit BenSelect | Microsoft Azure"
...
# Tutorial: Azure Active Directory-Integration mit BenSelect
...
## Hinzufügen von BenSelect über den Katalog
...
7. Wählen Sie im Ergebnisbereich **BenSelect** aus, und klicken Sie dann auf **Abschließen**, um die Anwendung hinzuzufügen.
...
1. Klicken Sie im klassischen Azure-Portal auf der Anwendungsintegrationsseite von **BenSelect** im Menü oben auf **Attribute**.
...
5. Führen Sie auf der Dialogseite **App-Einstellungen konfigurieren** die folgenden Schritte aus:
    ...
    a. Geben Sie im Textfeld **Antwort-URL** eine URL im folgenden Format ein: `https://www.benselect.com/enroll/login.aspx?Path={<tenant name>}`
...
7. Wenden Sie sich unter [support@selerix.com](mailto:support@selerix.com) an das Supportteam von BenSelect, um SSO für Ihre Anwendung konfigurieren zu lassen, und stellen Sie Folgendes bereit:
	...
	> [AZURE.NOTE] Weisen Sie darauf hin, dass für diese Integration der SHA256-Algorithmus erforderlich ist, um SSO für den entsprechenden Server (etwa „app2101“) festzulegen. (SHA1 wird nicht unterstützt.)
...
8. Führen Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** die folgenden Schritte aus:
	...
	![Erstellen einesAzure AD-Testbenutzers](./media/active-directory-saas-benselect-tutorial/create_aaduser_08.png)
...
### Erstellen eines BenSelect-Testbenutzers
...
> [AZURE.NOTE] Setzen Sie sich über <mailto:support@selerix.com> mit dem Supportteam von BenSelect in Verbindung, wenn Sie einen Benutzer manuell erstellen müssen.
