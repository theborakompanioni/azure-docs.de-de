...
8.  Führen Sie auf der Dialogfeldseite für SAML die folgenden Schritte aus:
    ...
    2.  Kopieren Sie im klassischen Azure-Portal auf der Seite **Einmaliges Anmelden konfigurieren für New Relic** den Wert für **Remoteanmelde-URL**, und fügen Sie ihn in das Textfeld **Remote login URL** ein.
    3.  Kopieren Sie im klassischen Azure-Portal auf der Seite **Einmaliges Anmelden konfigurieren für New Relic** den Wert für **Remoteabmelde-URL**, und fügen Sie ihn in das Textfeld **Logout landing URL** ein.
