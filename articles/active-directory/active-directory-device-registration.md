...
* [Es wird beschrieben, wie Sie die automatische Registrierung von in die Domäne eingebundenen Windows-Geräten mit Azure Active Directory konfigurieren.](active-directory-conditional-access-automatic-device-registration-setup.md)
...
* [Azure Active Directory-Geräteregistrierung – Übersicht](active-directory-device-registration-get-started.md)
