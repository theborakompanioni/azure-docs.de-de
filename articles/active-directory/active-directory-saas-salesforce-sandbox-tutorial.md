...
5. Klicken Sie auf der Seite **Einmaliges Anmelden konfigurieren um Salesforce Sandbox** auf **Zertifikat herunterladen**, und speichern Sie das Zertifikat auf Ihrem Computer.
...
8. Klicken Sie auf der Salesforce Sandbox-Unternehmenswebsite auf **Security Controls** und anschließend auf **Einzelanmeldungseinstellungen**.
