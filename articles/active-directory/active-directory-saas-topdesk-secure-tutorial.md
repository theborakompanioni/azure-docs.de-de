...
9. Führen Sie auf der Seite **App-URL konfigurieren** die folgenden Schritte aus:
   ...
   2. Fügen Sie in das Textfeld **TOPdesk - Public-Antwort-URL** die **TOPdesk - Secure-AssertionConsumerService-URL** ein (z.B.: *https://qssolutions.topdesk.net/tas/public/login/saml*).
...
16. Führen Sie auf der Seite **SAML Configuration Assistant** die folgenden Schritte aus:
    ...
    2. Klicken Sie zum Hochladen Ihrer Zertifikatsdatei unter **Zertifikat (RSA)** auf **Durchsuchen**.
    ...
    4. Geben Sie in das Textfeld **Benutzernamenattribut** Folgendes ein: **http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress**.
...
3. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:
   ...
   2. Geben Sie in das Textfeld **Nachname** des Abschnitts **Allgemein** den Nachnamen eines gültigen Azure Active Directory-Kontos ein, das Sie bereitstellen möchten.
   3. Wählen Sie im Abschnitt **Speicherort** eine **Website** für das Konto aus.
