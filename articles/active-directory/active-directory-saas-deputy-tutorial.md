<properties
	pageTitle="Tutorial: Azure Active Directory-Integration mit Deputy | Microsoft Azure"
...
# Tutorial: Azure Active Directory-Integration mit Deputy
...
## Hinzufügen von Deputy aus dem Katalog
...
Diese Verknüpfungsbeziehung wird hergestellt, indem Sie den **Benutzernamen** in Azure AD als Wert dem **Benutzernamen** in Deputy zuweisen.
...
4. Wenn die Anwendung im **SP-initiierten Modus** konfiguriert werden soll, klicken Sie auf der Dialogfeldseite **App-Einstellungen konfigurieren** auf **Zeigen Sie die erweiterten Einstellungen an (optional)**, geben Sie die **Anmelde-URL** ein, und klicken Sie dann auf **Weiter**.
	...
	> [AZURE.NOTE] Das Regionssuffix für Deputy ist optional und muss bei Verwendung auf eines der folgenden Suffixe festgelegt werden: au | na | eu |as |la |af |an |ent-au |ent-na |ent-eu |ent-as | ent-la | ent-af | ent-an

5. Führen Sie auf der Seite **Einmaliges Anmelden bei Deputy konfigurieren** die folgenden Schritte aus, und klicken Sie dann auf **Weiter**:
...
6. Öffnen Sie einen Browser, und navigieren Sie zur folgenden URL: https://(your-subdomain).deputy.com/exec/config/system_config. Wechseln Sie zu **Sicherheitseinstellungen**, und klicken Sie auf **Bearbeiten**.
...
### Erstellen eines Deputy-Testbenutzers
...
4.  Führen Sie die folgenden Schritte aus, und klicken Sie auf **Speichern und einladen**.
	...
	>[AZURE.NOTE]Der Besitzer des AAD-Kontos erhält eine E-Mail mit einem Link zur Bestätigung des Kontos, bevor es aktiv wird. Sie können AAD-Benutzerkonten auch mithilfe anderer Tools zum Erstellen von Deputy-Benutzerkonten oder mithilfe der von Deputy bereitgestellten APIs erstellen.
