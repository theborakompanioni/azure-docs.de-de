...
In diesem Abschnitt ermöglichen Sie das einmalige Anmelden für Azure AD im klassischen Portal und konfigurieren das einmalige Anmelden in Ihrer Reward Gateway-Anwendung.
...
3. Führen Sie auf der Dialogseite **App-Einstellungen konfigurieren** die folgenden Schritte aus:
    ...
    a. Geben Sie im Textfeld **Bezeichner-URL** die URL, die von Ihren Benutzern zur Anmeldung bei der Reward Gateway-Anwendung genutzt wird, nach folgendem Muster ein: 
...
1. Führen Sie auf der Seite **Einmaliges Anmelden konfigurieren für Reward Gateway** die folgenden Schritte aus:
...
2. Wenden Sie sich an das [Supportteam](mailTo:clientsupport@rewardgateway.com) von Reward Gateway, um SSO (Single Sign-On, einmaliges Anmelden) für Ihre Anwendung konfigurieren zu lassen, und stellen Sie dazu Folgendes bereit:
...
5. Führen Sie auf der Dialogfeldseite **Informationen über diesen Benutzer** die folgenden Schritte aus:  ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-reward-gateway-tutorial/create_aaduser_05.png) 
...
6. Führen Sie auf der Dialogfeldseite **Benutzerprofil** die folgenden Schritte aus: ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-reward-gateway-tutorial/create_aaduser_06.png) 
...
### <a name="creating-an-reward-gateway-test-user"></a>Erstellen eines Reward Gateway-Testbenutzers
