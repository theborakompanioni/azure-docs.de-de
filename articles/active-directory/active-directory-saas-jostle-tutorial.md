...
4. Geben Sie im Suchfeld als Suchbegriff **Jostle**ein.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-jostle-tutorial/tutorial_jostle_search.png)
...
5. Wählen Sie im Ergebnisbereich **Jostle** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-jostle-tutorial/tutorial_jostle_addfromgallery.png)
...
3. **[Erstellen eines Jostle-Testbenutzers](#creating-a-jostle-test-user)** , um eine Entsprechung von Britta Simon in Jostle zu erhalten, die mit der Darstellung dieses Benutzers in Azure AD verknüpft ist.
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-jostle-tutorial/tutorial_jostle_samlbase.png)

3. Führen Sie die folgenden Schritte auf der Seite **Domäne und URLs für Jostle** aus:

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-jostle-tutorial/tutorial_jostle_url.png)
...
4. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-jostle-tutorial/tutorial_jostle_certificate.png) 

5. Klicken Sie auf die Schaltfläche **Save** .

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-jostle-tutorial/tutorial_general_400.png)
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-jostle-tutorial/create_aaduser_01.png) 

2. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-jostle-tutorial/create_aaduser_02.png) 
...
2. Wählen Sie in der Anwendungsliste **Jostle**aus.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-jostle-tutorial/tutorial_jostle_app.png) 
