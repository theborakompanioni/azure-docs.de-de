...
1. Führen Sie auf der Seite **Einmaliges Anmelden konfigurieren für Bynder** die folgenden Schritte aus, und klicken Sie dann auf **Weiter**:
...
2. Wenden Sie sich an das Supportteam von Bynder, um SSO (Single Sign-On, einmaliges Anmelden) für Ihre Anwendung konfigurieren zu lassen. Fügen Sie die heruntergeladene Metadatendatei an die E-Mail an, damit das Bynder-Team SSO auf seiner Seite einrichten kann.
...
### <a name="creating-a-bynder-test-user"></a>Erstellen einen Bynder-Testbenutzers
