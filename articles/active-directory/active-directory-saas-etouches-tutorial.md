...
3. Führen Sie auf der Dialogseite **App-Einstellungen konfigurieren** die folgenden Schritte aus:
    ...
    a. Geben Sie im Textfeld **Anmelde-URL** die URL, die von Ihren Benutzern zur Anmeldung bei der eTouches-Anwendung verwendet wird, nach folgenden Muster ein: **https://www.eiseverywhere.com/saml/accounts/?sso&accountid=\<accountid\>**.
...
5. Führen Sie zum Konfigurieren von SSO für Ihre Anwendung in der eTouches-Anwendung die folgenden Schritte aus:
    ...
    g. Wählen Sie im Feld **Benutzername** wie unten dargestellt **emailaddress** (E-Mail-Adresse) aus. 
...
### <a name="creating-an-etouches-test-user"></a>Erstellen eines eTouches-Testbenutzers
