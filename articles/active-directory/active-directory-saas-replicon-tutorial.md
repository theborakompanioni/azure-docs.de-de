...
## <a name="enabling-the-application-integration-for-replicon"></a>Aktivieren der Anwendungsintegration für Replicon
...
3. Führen Sie auf der Seite **App-URL konfigurieren** die folgenden Schritte aus:
    ...
    a. Geben Sie im Textfeld **Replicon-Anmelde-URL** die URL Ihres Replicon-Mandanten ein (z.B. *https://na2.replicon.com/company/saml2/sp-sso/post*).

    b. Geben Sie im Textfeld **Replicon-Antwort-URL** Ihre **AssertionConsumerService**-URL für Replicon ein (z.B. *https://global.replicon.com/!/saml2/company/sso/post*).  
...
6. Um SAML 2.0 zu konfigurieren, führen Sie die folgenden Schritte aus:
   ...
   1. Zum Anzeigen des Dialogfelds **EnableSAML Authentication2** fügen Sie nach dem Unternehmensschlüssel Folgendes an Ihre URL an:  
...
### <a name="to-assign-users-to-replicon-perform-the-following-steps"></a>So weisen Sie Replicon Benutzer zu:
