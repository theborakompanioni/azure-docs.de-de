...
4. Geben Sie im Suchfeld die Zeichenfolge **JobScore** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-jobscore-tutorial/tutorial_jobscore_search.png)

5. Wählen Sie im Ergebnisbereich **JobScore** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-jobscore-tutorial/tutorial_jobscore_addfromgallery.png)
...
3. **[Erstellen eines JobScore-Testbenutzers](#creating-a-jobscore-test-user)**, um ein Pendant von Britta Simon in JobScore zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-jobscore-tutorial/tutorial_jobscore_samlbase.png)

3. Führen Sie im Abschnitt **Domäne und URLs für JobScore** die folgenden Schritte aus:

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-jobscore-tutorial/tutorial_jobscore_url.png)
...
4. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-jobscore-tutorial/tutorial_jobscore_certificate.png) 

5. Klicken Sie auf die Schaltfläche **Save** .

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-jobscore-tutorial/tutorial_general_400.png)

6. Zum Konfigurieren des einmaligen Anmeldens bei **JobScore** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [JobScore-Supportteam](mailto:support@jobscore.com) senden. 
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-jobscore-tutorial/create_aaduser_01.png) 

2. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-jobscore-tutorial/create_aaduser_02.png) 
...
2. Wählen Sie in der Anwendungsliste die Option **JobScore** aus.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-jobscore-tutorial/tutorial_jobscore_app.png) 
