...
In diesem Thema erfahren Sie, wie Sie die zertifikatbasierte Authentifizierung auf einem Android-Gerät für Benutzer von Mandanten in folgenden Tarifen konfigurieren und nutzen: Office 365 Enterprise, Business und Education. 
...
## <a name="supported-scenarios-and-requirements"></a>Unterstützte Szenarien und Voraussetzungen
...
Zum Hochladen der Informationen können Sie das Azure AD-Modul über Windows PowerShell verwenden.  
Nachfolgend finden Sie Beispiele für das Hinzufügen, Entfernen oder Ändern einer Zertifizierungsstelle. 
...
### <a name="retrieving-the-list-certificate-authorities"></a>Abrufen der Liste mit Zertifizierungsstellen
...
1. Installieren Sie auf Ihrem Testgerät eine mobile Office-Anwendung (z.B. OneDrive) aus dem Google Play Store.
...
Führen Sie die unten aufgeführten Schritte aus, um die Zertifikatauthentifizierung mit einer Anwendung auf Android 5.0 (Lollipop) oder einer höheren Version zu testen:  

1. Konfigurieren Sie ein EAS-Profil in der Anwendung, das die oben beschriebenen Anforderungen erfüllt.  
2. Öffnen Sie nach der ordnungsgemäßen Konfiguration des Profils die Anwendung, und überprüfen Sie, ob E-Mails synchronisiert werden. 
