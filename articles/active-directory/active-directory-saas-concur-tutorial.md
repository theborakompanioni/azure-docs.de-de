...
## <a name="enabling-the-application-integration-for-concur"></a>Aktivieren der Anwendungsintegration für Concur
...
### <a name="to-assign-users-to-concur-perform-the-following-steps"></a>So weisen Sie Concur Benutzer zu
