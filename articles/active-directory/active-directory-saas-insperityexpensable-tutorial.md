...
Dieses Tutorial soll Ihnen zeigen, wie Sie Insperity ExpensAble in Azure Active Directory (Azure AD) integrieren können.  
...
Diese Linkbeziehung wird hergestellt, indem Sie den Wert des **Benutzernamens** in Azure AD als Wert des**Benutzernamens** in Insperity ExpensAble zuweisen.
...
3. **[Erstellen eines Insperity ExpensAble-Testbenutzers](#creating-a-insperityexpensable-test-user)** , um eine Entsprechung von Britta Simon in Insperity ExpensAble zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie auf der Seite **Einmaliges Anmelden konfigurieren für Insperity ExpensAble** die folgenden Schritte aus:
...
2. Wenden Sie sich an das technische Supportteam von Insperity ExpensAble, um SSO für Ihre Anwendung konfigurieren zu lassen. Sobald der Fall zugewiesen ist, senden Sie die heruntergeladene Zertifikatsdatei per E-Mail. Geben Sie außerdem die Aussteller-URL und die URL des Diensts für einmaliges Anmelden an, damit diese für die SSO-Integration konfiguriert werden können. 

3. Bestätigen Sie im klassischen Azure-Portal die Konfiguration des einmaligen Anmeldens, und klicken Sie dann auf **Weiter**.
...
8. Führen Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** die folgenden Schritte aus:
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-insperityexpensable-tutorial/create_aaduser_08.png) 
...
> [!NOTE]
> Wenn Sie einen Benutzer manuell erstellen müssen, setzen Sie sich mit dem Supportteam von Insperity ExpensAble in Verbindung.
> 
> 
