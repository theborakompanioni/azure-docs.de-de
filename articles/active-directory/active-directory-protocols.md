...
- [OAuth 2.0 in Azure AD](active-directory-protocols-oauth-code.md): Enthält Informationen zum Ablauf der Erteilung einer OAuth 2.0-Autorisierung und zur Implementierung in Azure AD.
