...
##<a name="enabling-the-application-integration-for-timeoffmanager"></a>Aktivieren der Anwendungsintegration für TimeOffManager
...
7.  Führen Sie im Abschnitt **Einstellungen für einmaliges Anmelden** die folgenden Schritte aus:
    ...
    f.  Wählen Sie für **Auto-Create Users** (Benutzer automatisch erstellen), die Option **Ja** aus.
    
    g.  Kopieren Sie im klassischen Azure-Portal auf der Dialogfeldseite **Einmaliges Anmelden konfigurieren für TimeOffManager** den Wert für **Remoteabmelde-URL**, und fügen Sie ihn in das Textfeld **Abmelde-URL** ein.
...
10. So fügen Sie die erforderlichen Attributzuordnungen hinzu:
    ...
    ![SAML-Tokenattribute](./media/active-directory-saas-timeoffmanager-tutorial/123.png "saml token attributes")
...
###<a name="to-assign-users-to-timeoffmanager,-perform-the-following-steps:"></a>So weisen Sie TimeOffManager Benutzer zu:
