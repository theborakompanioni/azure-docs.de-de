...
4. Geben Sie im Suchfeld den Begriff **Jobbadmin** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-jobbadmin-tutorial/tutorial_jobbadmin_search.png)

5. Wählen Sie im Ergebnisbereich die Option **Jobbadmin** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-jobbadmin-tutorial/tutorial_jobbadmin_addfromgallery.png)
...
3. **[Erstellen eines Jobbadmin-Testbenutzers](#creating-a-jobbadmin-test-user)**, um ein Pendant von Britta Simon in Jobbadmin zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-jobbadmin-tutorial/tutorial_jobbadmin_samlbase.png)

3. Führen Sie im Abschnitt **Domäne und URLs für Jobbadmin** die folgenden Schritte aus:

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-jobbadmin-tutorial/tutorial_jobbadmin_url.png)
...
4. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-jobbadmin-tutorial/tutorial_jobbadmin_certificate.png) 

5. Klicken Sie auf die Schaltfläche **Save** .

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-jobbadmin-tutorial/tutorial_general_400.png)

6. Zum Konfigurieren des einmaligen Anmeldens bei **Jobbadmin** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [Jobbadmin-Supportteam](https://www.jobbnorge.no/om-oss/kontakt-oss) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-jobbadmin-tutorial/create_aaduser_01.png) 

2. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-jobbadmin-tutorial/create_aaduser_02.png) 

3. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-jobbadmin-tutorial/create_aaduser_03.png) 

4. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-jobbadmin-tutorial/create_aaduser_04.png) 
...
2. Wählen Sie in der Anwendungsliste die Option **Jobbadmin** aus.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-jobbadmin-tutorial/tutorial_jobbadmin_app.png) 
