...
4. Geben Sie im Suchfeld den Suchbegriff **Huddle** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-huddle-tutorial/tutorial_huddle_search.png)

5. Wählen Sie im Ergebnisbereich **Huddle** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-huddle-tutorial/tutorial_huddle_addfromgallery.png)
...
Weisen Sie in Huddle den Wert für **Benutzername** in Azure AD als Wert für **Benutzername** zu, um eine Linkbeziehung herzustellen.
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-huddle-tutorial/tutorial_huddle_samlbase.png)

3. Führen Sie die folgenden Schritte auf der Seite **Domäne und URLs für Huddle** aus:

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-huddle-tutorial/tutorial_huddle_url.png)

    Geben Sie im Textfeld **Anmelde-URL** eine URL im folgenden Format ein: `http://<company name>.huddle.com`.

    > [!NOTE] 
    > Dieser Wert entspricht nicht dem tatsächlichen Wert. Ersetzen Sie diesen Wert durch die tatsächliche Anmelde-URL. Wenden Sie sich an das [Kundensupportteam von Huddle](https://huddle.zendesk.com), um diesen Wert zu erhalten. 

4. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-huddle-tutorial/tutorial_huddle_certificate.png) 

5. Klicken Sie auf die Schaltfläche **Save** .

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-huddle-tutorial/tutorial_general_400.png)

6. Klicken Sie im Abschnitt **Huddle-Konfiguration** auf **Huddle konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**. 

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-huddle-tutorial/tutorial_huddle_configure.png) 
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-huddle-tutorial/create_aaduser_01.png) 

2. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-huddle-tutorial/create_aaduser_02.png) 

3. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-huddle-tutorial/create_aaduser_03.png) 

4. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-huddle-tutorial/create_aaduser_04.png) 
...
**Um Britta Simon Huddle zuzuweisen, führen Sie die folgenden Schritte aus:**
...
2. Wählen Sie in der Anwendungsliste **Huddle** aus.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-huddle-tutorial/tutorial_huddle_app.png) 
