...
Damit einmaliges Anmelden funktioniert, muss Azure AD wissen, welcher Benutzer in ICIMS als Gegenbenutzer zu einem Benutzer in Azure AD fungiert. Anders ausgedrückt: Zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in ICIMS muss eine Linkbeziehung eingerichtet werden.  
...
1. Führen Sie auf der Seite **Einmaliges Anmelden konfigurieren um ICIMS** die folgenden Schritte aus:
...
### <a name="creating-a-icims-test-user"></a>Erstellen eines ICIMS-Testbenutzers
