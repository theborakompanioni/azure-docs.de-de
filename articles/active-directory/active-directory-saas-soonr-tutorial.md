...
Dieses Tutorial soll Ihnen zeigen, wie Sie Soonr Workplace in Azure Active Directory (Azure AD) integrieren können.  
...
Diese Linkbeziehung wird hergestellt, indem Sie den Benutzernamen**** in Azure AD als Benutzernamen**** in Soonr Workplace zuweisen.
...
In diesem Abschnitt ermöglichen Sie das einmalige Anmelden von Azure AD im klassischen Portal und konfigurieren es in Ihrer Soonr Workplace-Anwendung.
...
3. Führen Sie auf der Dialogseite **App-Einstellungen konfigurieren** die folgenden Schritte aus:
    ...
    a. Geben Sie im Textfeld **Anmelde-URL** eine URL im folgenden Format ein: `https://<server-name>.soonr.com/singlesignon/saml/SSO`.

    b. Klicken Sie auf **Weiter**.

    > [!NOTE] 
    > Hinweis: Hierbei handelt es sich um einen Beispielwert. Sie müssen den Wert mit der richtigen Anmelde-URL aktualisieren. Wenden Sie sich an das Supportteam von Soonr Workplace, um diesen Wert zu erhalten.

4. Klicken Sie auf der Seite **Einmaliges Anmelden konfigurieren für Soonr Workplace** auf **Metadaten herunterladen**, und speichern Sie die Datei auf Ihrem Computer.

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-soonr-tutorial/tutorial_soonr_05.png) 

5. Wenden Sie sich an das Supportteam von Soonr Workplace, um SSO (Single Sign-On, einmaliges Anmelden) für Ihre Anwendung konfigurieren zu lassen, und stellen Sie Folgendes bereit: 
    ...
    >[!NOTE]
    >Diese Anwendung wird durch <a href="https://azure.microsoft.com/en-us/marketplace/partners/autotask-corporataion/autotask/">Autotask Workplace</a> abgelöst. In <a href="https://docs.microsoft.com/en-us/azure/active-directory/active-directory-saas-autotaskworkplace-tutorial">diesem</a> Tutorial finden Sie Informationen zum Konfigurieren der Anwendung mit Azure AD.
...
8. Führen Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** die folgenden Schritte aus:
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-soonr-tutorial/create_aaduser_08.png) 
...
In diesem Abschnitt wird in Soonr Workplace eine Benutzerin namens Britta Simon erstellt. Wenden Sie sich an das Supportteam von Soonr Workplace, um einen Benutzer in der Plattform zu erstellen. Das Supportticket für Soonr kann <a href="https://na01.safelinks.protection.outlook.com/?url=http%3A%2F%2Fsoonr.com%2FAWPHelp%2FContent%2F0_HOME%2FSupport_for_End_Clients.htm&data=01%7C01%7Cv-saikra%40microsoft.com%7Ccbb4367ab09b4dacaac408d3eebe3f42%7C72f988bf86f141af91ab2d7cd011db47%7C1&sdata=FB92qtE6m%2Fd8yox7AnL2f1h%2FGXwSkma9x9H8Pz0955M%3D&reserved=0/">hier</a> erstellt werden.
