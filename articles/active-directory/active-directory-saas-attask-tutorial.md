...
4. **[Erstellen eines @Tasktest-Benutzers](#creating-a-halogen-software-test-user)**, um in @Taskthat eine Entsprechung von Britta Simon zu erhalten, der mit ihrer Darstellung in Azure AD verknüpft ist.
