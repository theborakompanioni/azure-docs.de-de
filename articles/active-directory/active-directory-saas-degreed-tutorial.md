...
Dieses Tutorial soll Ihnen zeigen, wie Sie Degreed in Azure Active Directory (Azure AD) integrieren können.  
...
3. **[Erstellen eines Degreed-Testbenutzers](#creating-a-degreed-test-user)** , um eine Entsprechung von Britta Simon in Degreed zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
2. Wählen Sie auf der Seite **Wie sollen sich Benutzer bei Degreed anmelden?** die Option **Microsoft Azure AD – einmaliges Anmelden** aus, und klicken Sie dann auf **Weiter**.
...
1. Führen Sie auf der Seite **Einmaliges Anmelden konfigurieren für Degreed** die folgenden Schritte aus:
    ...
    b. Klicken Sie auf **Weiter**.
2. Wenden Sie sich über [admin@degreed.com](mailto:admin@degreed.com) an das Supportteam von Degreed, um SSO (Single Sign-On, einmaliges Anmelden) für Ihre Anwendung konfigurieren zu lassen, und fügen Sie die heruntergeladene Metadatendatei an Ihre E-Mail an.
...
8. Führen Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** die folgenden Schritte aus:
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-degreed-tutorial/create_aaduser_08.png) 
...
> [!NOTE]
> Setzen Sie sich mit dem Supportteam von Degreed in Verbindung, wenn Sie einen Benutzer manuell erstellen müssen.
> 
> 
