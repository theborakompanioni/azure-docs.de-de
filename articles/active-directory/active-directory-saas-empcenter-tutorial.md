...
5. Senden Sie die heruntergeladene Metadatendatei an das Supportteam von EmpCenter.
   ...
   > [!NOTE]
   > Die eigentliche SSO-Konfiguration muss vom Supportteam von EmpCenter durchgeführt werden. Sie erhalten eine Benachrichtigung, wenn SSO für Ihr Abonnement aktiviert wurde.
   > 
   > 
