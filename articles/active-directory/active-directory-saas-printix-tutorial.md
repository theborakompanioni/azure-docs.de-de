...
Diese Linkbeziehung wird hergestellt, indem Sie den Wert des **Benutzernamens** in Azure AD als Wert des **Benutzernamens** in Printix zuweisen.
...
2. Wählen Sie auf der Seite **Wie sollen sich Benutzer bei Printix anmelden?** die Option **Microsoft Azure AD – einmaliges Anmelden** aus, und klicken Sie dann auf **Weiter**.
...
3. Führen Sie auf der Dialogseite **App-Einstellungen konfigurieren** die folgenden Schritte aus:
    ...
    a. Geben Sie im Textfeld **Antwort-URL** Folgendes ein: `https://auth.printix.net/saml/SSO`.
...
7. Wählen Sie auf der Registerkarte **Setup** die Option **Azure-/Office 365-Authentifizierung aktivieren** aus.
   
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-printix-tutorial/tutorial_printix_07.png)

8. Geben Sie auf der Registerkarte **Azure** im Textfeld **Verbundmetadaten-Dokument** die Verbundmetadaten-URL ein. 
...
9. Klicken Sie auf die Schaltfläche **Testen** und dann auf die Schaltfläche **OK**, wenn der Test erfolgreich war.
    ...
    a. Nachdem Sie auf die Schaltfläche **Testen** geklickt haben, wird die Azure Active Directory-Seite angezeigt. Eine Meldung der Art „Der Test war erfolgreich“ bedeutet in diesem Fall, dass nach dem Eingeben der Anmeldeinformationen für Ihr Azure-Testkonto die Meldung „Einstellungen getestet – OK“ angezeigt wird. Klicken Sie anschließend auf die Schaltfläche **OK**.
...
8. Führen Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** die folgenden Schritte aus:
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-printix-tutorial/create_aaduser_08.png) 
   
    a. Notieren Sie den Wert von **Neues Kennwort**.
   
    b. Klicken Sie auf **Fertig stellen**.   

### <a name="creating-an-printix-test-user"></a>Erstellen eines Printix-Testbenutzers
...
> [!NOTE]
> Setzen Sie sich mit dem Supportteam von Printix in Verbindung, wenn Sie einen Benutzer manuell erstellen müssen.
> 
> 
