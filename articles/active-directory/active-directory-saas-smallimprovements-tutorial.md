...
3. Führen Sie auf der Dialogseite **App-Einstellungen konfigurieren** die folgenden Schritte aus:
   ...
   > 
    ...
    a. Geben Sie im Textfeld **Anmelde-URL** die von Ihren Benutzern für die Anmeldung bei Ihrer Small Improvements-Anwendung verwendete URL ein.  
...
5. Führen Sie auf der Seite für die SSO-Einrichtung die folgenden Schritte aus:
    ...
    a. Kopieren Sie im klassischen Azure-Portal auf der Dialogfeldseite **Einmaliges Anmelden konfigurieren für Small Improvements** den Wert aus dem Feld **SAML-SSO-URL**, und fügen Sie ihn in das Textfeld **HTTP-Endpunkt** ein.
