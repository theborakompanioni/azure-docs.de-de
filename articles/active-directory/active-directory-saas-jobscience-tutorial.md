...
## <a name="enabling-the-application-integration-for-jobscience"></a>Aktivieren der Anwendungsintegration für Jobscience
...
10. Klicken Sie auf der Jobscience-Unternehmenswebsite auf **Sicherheitskontrollen** und anschließend auf **Einstellungen für einmaliges Anmelden**.
    ...
    ![Einstellungen für einmaliges Anmelden](./media/active-directory-saas-jobscience-tutorial/IC784364.png "Security Controls")
...
12. Führen Sie im Dialogfeld **Einstellungen für einmaliges Anmelden mit SAML – Bearbeiten** die folgenden Schritte aus:
    ...
    6. Wählen Sie als **Speicherort der SAML-Identität** die Option **Identität ist im NameIdentifier-Element der Subject-Anweisung enthalten** aus.
...
![Einstellungen für einmaliges Anmelden](./media/active-directory-saas-jobscience-tutorial/IC784368.png "Security Controls")

Klicken Sie auf das SSO-Profil, das Sie im obigen Schritt erstellt haben.  
Auf dieser Seite wird die URL für einmaliges Anmelden für Ihr Unternehmen angezeigt (z.B. *https://unternehmensname.my.salesforce.com?so=unternehmens-id*).
...
### <a name="to-assign-users-to-jobscience-perform-the-following-steps"></a>So weisen Sie Jobscience Benutzer zu
