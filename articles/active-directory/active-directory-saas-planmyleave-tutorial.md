...
6. Geben Sie im Suchfeld den Suchbegriff **PlanMyLeave** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-planmyleave-tutorial/tutorial_planmyleave_01.png)
    
7. Wählen Sie im Ergebnisbereich **PlanMyLeave** aus, und klicken Sie dann auf **Abschließen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-planmyleave-tutorial/tutorial_planmyleave_011.png)
...
In diesem Abschnitt ermöglichen Sie das einmalige Anmelden von Azure AD im klassischen Portal und konfigurieren es in Ihrer PlanMyLeave-Anwendung.


**Führen Sie zum Konfigurieren des einmaligen Anmeldens von Azure AD bei PlanMyLeave die folgenden Schritte aus:**

1. Klicken Sie im klassischen Portal auf der Anwendungsintegrationsseite für **PlanMyLeave** auf **Einmaliges Anmelden konfigurieren**, um das Dialogfeld **Einmaliges Anmelden konfigurieren** zu öffnen.
     
    ![Einmaliges Anmelden konfigurieren][6] 

2. Wählen Sie auf der Seite **Wie sollen sich Benutzer bei PlanMyLeave anmelden?** die Option **Azure AD – einmaliges Anmelden** aus, und klicken Sie dann auf **Weiter**.
...
3. Führen Sie auf der Dialogseite **App-Einstellungen konfigurieren** die folgenden Schritte aus:
    ...
    - Geben Sie im Textfeld **Anmelde-URL** die URL ein, die von Ihren Benutzern zur Anmeldung bei der PlanMyLeave-Anwendung genutzt wird, und verwenden Sie dabei folgendes Muster: `https://<company-name>.planmyleave.com/Login.aspx`.
    
    > [!NOTE]
    > Hinweis: Die Werte müssen durch die tatsächliche Anmelde-URL ersetzt werden. Wenden Sie sich an das [Supportteam von PlanMyLeave](emaiLto:support@planmyleave.com), um diese Werte zu erhalten.
         
4. Klicken Sie auf der Seite **Einmaliges Anmelden konfigurieren für PlanMyLeave** auf **Metadaten herunterladen**, und speichern Sie die Datei auf Ihrem Computer:

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-planmyleave-tutorial/tutorial_planmyleave_05.png)
   
5. Wenden Sie sich <a href=“mailto:support@planmyleave.com”>hier</a> an das Supportteam von PlanMyLeave, um SSO für Ihre Anwendung konfigurieren zu lassen, und stellen Sie Folgendes bereit:
...
1. Klicken Sie im linken Navigationsbereich des **klassischen Azure-Portals** auf **Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-planmyleave-tutorial/create_aaduser_09.png) 
...
5. Führen Sie auf der Dialogfeldseite **Informationen über diesen Benutzer** die folgenden Schritte aus:  ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-planmyleave-tutorial/create_aaduser_05.png) 
...
6.  Führen Sie auf der Dialogfeldseite **Benutzerprofil** die folgenden Schritte aus: ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-planmyleave-tutorial/create_aaduser_06.png) 
...
7. Klicken Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** auf **Erstellen**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-planmyleave-tutorial/create_aaduser_07.png) 

8. Führen Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** die folgenden Schritte aus:

    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-planmyleave-tutorial/create_aaduser_08.png) 
...
In diesem Abschnitt erstellen Sie in PlanMyLeave einen Benutzer namens Britta Simon. Wenden Sie sich <a href=“mailto:support@planmyleave.com”>hier</a> an das Supportteam von PlanMyLeave, um die Benutzer der PlanMyLeave-Plattform hinzufügen zu lassen.
