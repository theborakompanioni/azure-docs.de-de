...
* Sie können es Benutzern ermöglichen, sich mit ihrem Azure AD-Konto automatisch bei Litmos anzumelden (einmaliges Anmelden, SSO).
...
8. Führen Sie im klassischen Azure-Portal auf der Dialogseite **App-Einstellungen konfigurieren** die folgenden Schritte aus:
    ...
    1. Geben Sie im Textfeld **Bezeichner** die von Ihren Benutzern für die Anmeldung bei Ihrer Litmos-Anwendung verwendete URL ein (z.B. *https://azureapptest.litmos.com/account/Login*).
...
9. Führen Sie auf der Seite **Einmaliges Anmelden konfigurieren für Litmos** die folgenden Schritte aus:
    ...
    * Klicken Sie auf "Zertifikat herunterladen", und speichern Sie das Zertifikat auf Ihrem Computer.
10. Führen Sie in der **Litmos** -Anwendung die folgenden Schritte aus:
    ...
    >Weitere Informationen finden Sie unter [How to convert a binary certificate into a text file](http://youtu.be/PlgrzUZ-Y1o)(in englischer Sprache).
     ...
     3. Öffnen Sie das Base64-codierte Zertifikat im Editor, kopieren Sie den Inhalt des Zertifikats in die Zwischenablage, und fügen Sie ihn anschließend in das Textfeld **SAML-X.509-Zertifikat** ein.
...
14. Führen Sie im Dialogfeld **Benutzerattribut hinzufügen** die folgenden Schritte aus: 
 ...
 3. Wählen Sie den für die Zeile angezeigten **Attributwert** aus.
 4. Klicken Sie auf **Abschließen**, um das Dialogfeld **Benutzerattribut hinzufügen** zu schließen.
