...
##<a name="how-to-customize-the-expiration-date-for-your-federation-certificate"></a>Anpassen des Ablaufdatums für das Verbundzertifikat
...
3. Geben Sie die **Anmelde-URL** für Ihre Anwendung ein, und aktivieren Sie das Kontrollkästchen **Konfigurieren Sie das für die einmalige Verbundanmeldung verwendete Zertifikat**. Klicken Sie auf **Weiter**.
...
4. Wählen Sie auf der nächsten Seite **Neues Zertifikat generieren**aus, und geben Sie an, wie lange das Zertifikat gültig sein soll. Klicken Sie auf **Weiter**.
    ...
    ![Neues Zertifikat generieren](./media/active-directory-sso-certs/new-app-config-cert.PNG)
...
##<a name="how-to-renew-a-certificate-that-will-soon-expire"></a>Vorgehensweise zum Erneuern eines in Kürze ablaufenden Zertifikats
