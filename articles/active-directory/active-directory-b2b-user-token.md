---
title: "Grundlegendes zu Benutzertoken für die Azure Active Directory B2B-Zusammenarbeit | Microsoft-Dokumentation"
...
# <a name="understand-user-tokens-in-azure-active-directory-b2b-collaboration"></a>Grundlegendes zu Benutzertoken für die Azure Active Directory B2B-Zusammenarbeit

Wenn Sie wissen möchten, wie die Token für B2B-Zusammenarbeitsbenutzer aussehen: Hier finden Sie die Bearertokendetails und Tokeninhalte für AAD-Gastbenutzer und MSA-Gastbenutzer im Ressourcenmandanten (für diese Mandanten-ID:&04;dcc6ab-388a-4559-b527-fbec656300ea). Sie können [https://jwt.io/](https://jwt.io/) oder [http://calebb.net](http://calebb.net/)/ verwenden, um die JWT-Tokeninhalte anzuzeigen.

## <a name="azure-ad-guest-user-token"></a>Azure AD-Gastbenutzertoken
```
...
## <a name="microsoft-account-guest"></a>Microsoft-Kontogast
```
