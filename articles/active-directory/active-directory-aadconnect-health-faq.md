...
Wenn Sie einen Proxy während der Agent-Registrierung konfigurieren müssen, müssen Sie die Proxyeinstellungen Ihres Internet Explorers ändern. <br>
Öffnen Sie "Internet Explorer -> Einstellungen -> Internetoptionen -> Verbindungen -> LAN-Einstellungen".<br>
...
Wenn Sie einen Agent von einem Server entfernen, wird der Server nicht automatisch aus dem Azure AD Connect-Portal entfernt.  Wenn Sie also manuell einen Agent von einem Server oder den Server selbst entfernt haben, müssen Sie den Servereintrag manuell aus dem Azure AD Connect Health-Portal löschen.  Weitere Informationen finden Sie unter [Löschen eines Servers oder einer Dienstinstanz](active-directory-aadconnect-health-operations.md#delete-a-server-or-service-instance).
