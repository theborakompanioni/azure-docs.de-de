<properties
	pageTitle="Tutorial: Azure Active Directory-Integration mit Icertis Contract Management Platform | Microsoft Azure"
...
# Tutorial: Azure Active Directory-Integration mit Icertis Contract Management Platform
...
## Hinzufügen von Icertis Contract Management Platform über den Katalog
...
Diese Linkbeziehung wird eingerichtet, indem Sie den Benutzernamen in Azure AD dem Benutzernamen in Icertis Contract Management Platform zuweisen.
...
4. Führen Sie auf der Seite **Einmaliges Anmelden konfigurieren für Icertis Contract Management Platform** die folgenden Schritte aus, und klicken Sie anschließend auf **Weiter**:
...
5. Wenden Sie sich an das Supportteam von Icertis Contract Management Platform, um SSO für Ihre Anwendung konfigurieren zu lassen, und stellen Sie Folgendes bereit:
...
8. Führen Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** die folgenden Schritte aus:
	...
	![Erstellen einesAzure AD-Testbenutzers](./media/active-directory-saas-icertisicm-tutorial/create_aaduser_08.png)
...
### Erstellen eines Icertis Contract Management Platform-Testbenutzers
