...
3. Führen Sie auf der Dialogseite **App-Einstellungen konfigurieren** die folgenden Schritte aus:
    ...
    b. Geben Sie im Textfeld **Bezeichner** die URL nach folgendem Muster ein: **https://surveys.kenexa.com/\<Unternehmenscode>/tools**.
...
1. Führen Sie auf der Seite **Einmaliges Anmelden bei IBM Kenexa Survey Enterprise konfigurieren** die folgenden Schritte aus:
...
2. Wenden Sie sich an das Supportteam von IBM Kenexa, um SSO (Single Sign-On, einmaliges Anmelden) für Ihre Anwendung konfigurieren zu lassen, und stellen Sie Folgendes bereit:
