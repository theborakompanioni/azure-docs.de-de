...
1. Klicken Sie auf der Seite **Einmaliges Anmelden konfigurieren für PostBeyond** auf **Zertifikat herunterladen**, und speichern Sie die Datei auf Ihrem Computer. Kopieren Sie auch die Aussteller-URL, die Dienst-URL für einmaliges Anmelden und die Dienst-URL für einmaliges Abmelden. Der PostBeyond-Support benötigt diese Angaben, um das einmalige Anmelden konfigurieren zu können.
   
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-postbeyond-tutorial/tutorial_postbeyond_08.png)
2. Wenden Sie sich unter <mailto:sso@postbeyond.com> an das Supportteam von PostBeyond, um SSO für Ihre Anwendung konfigurieren zu lassen. Dort erhalten Sie Informationen zum richtigen Kanal für die SSO-Konfiguration. Dazu muss Folgendes bereitgestellt werden: 
