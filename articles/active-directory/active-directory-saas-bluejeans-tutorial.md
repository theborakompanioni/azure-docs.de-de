...
## <a name="enabling-the-application-integration-for-bluejeans"></a>Aktivieren der Anwendungsintegration für BlueJeans
...
6. Wechseln Sie zu **ADMIN (Administrator) \> Group Settings (Gruppeneinstellungen) \> Security (Sicherheit)**.
   ...
   ![Administrator](./media/active-directory-saas-bluejeans-tutorial/IC785868.png "Admin")
...
2. Wechseln Sie zu **ADMIN (Administrator) \> Manage Users (Benutzer verwalten) \> Add User (Benutzer hinzufügen)**.
   ...
   ![Administrator](./media/active-directory-saas-bluejeans-tutorial/IC785877.png "Admin")
...
### <a name="to-assign-users-to-bluejeans-perform-the-following-steps"></a>So weisen Sie BlueJeans Benutzer zu
1. Erstellen Sie im klassischen Azure-Portal ein Testkonto.
2. Klicken Sie auf der Anwendungsintegrationsseite für **BlueJeans** auf **Assign users** (Benutzer zuweisen).
