...
1. Führen Sie auf der Seite **Einmaliges Anmelden konfigurieren für Novatus** die folgenden Schritte aus:
...
2. Wenden Sie sich unter jvinci@novatusinc.com. Hängen Sie die heruntergeladene Zertifikatdatei an Ihre E-Mail-Nachricht an, und teilen Sie dem Novatus-Team die Metadaten-URLs (Entitäts-ID, Anmelde-URL und Abmelde-URL für SSO) zum Einrichten von SSO auf ihrer Seite mit.
