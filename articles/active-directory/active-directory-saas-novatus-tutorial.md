...
4. Geben Sie im Suchfeld als Suchbegriff **Novatus**ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-novatus-tutorial/tutorial_novatus_search.png)

5. Wählen Sie im Ergebnisbereich die Option **Novatus** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-novatus-tutorial/tutorial_novatus_addfromgallery.png)
...
3. **[Erstellen einen Novatus-Testbenutzers](#creating-a-novatus-test-user)** , um eine Entsprechung von Britta Simon in Novatus zu erhalten, die mit der Darstellung dieses Benutzers in Azure AD verknüpft ist.
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-novatus-tutorial/tutorial_novatus_samlbase.png)

3. Führen Sie die folgenden Schritte auf der Seite **Domäne und URLs für Novatus** aus:

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-novatus-tutorial/tutorial_novatus_url.png)
...
4. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-novatus-tutorial/tutorial_novatus_certificate.png) 

5. Klicken Sie auf die Schaltfläche **Save** .

    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-novatus-tutorial/tutorial_general_400.png)
...
6. Klicken Sie im Abschnitt **Novatus-Konfiguration** auf **Novatus konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL, die SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-novatus-tutorial/tutorial_novatus_configure.png) 
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-novatus-tutorial/create_aaduser_01.png) 

2. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-novatus-tutorial/create_aaduser_02.png) 
...
2. Wählen Sie in der Anwendungsliste den Eintrag **Novatus**aus.
    ...
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-novatus-tutorial/tutorial_novatus_app.png) 
