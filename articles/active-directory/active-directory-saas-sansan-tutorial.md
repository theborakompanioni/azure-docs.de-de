<properties
	pageTitle="Tutorial: Azure Active Directory-Integration mit SanSan | Microsoft Azure"
...
# Tutorial: Azure Active Directory-Integration mit SanSan
...
5.  Wenden Sie sich an das SanSan-Supportteam, um Unterstützung bei der SSO-Konfiguration für Ihre Anwendung zu erhalten. Geben Sie dabei die folgenden Informationen an:
...
> [AZURE.NOTE] Die PC-Browsereinstellungen funktionieren auch für die Mobile App und den mobilen Browser mit PC-Web.
...
8. Führen Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** die folgenden Schritte aus:
	...
	![Erstellen einesAzure AD-Testbenutzers](./media/active-directory-saas-sansan-tutorial/create_aaduser_08.png)
...
### Erstellen einen SanSan-Testbenutzers
...
> [AZURE.NOTE] Wenn Sie einen Benutzer manuell oder eine Gruppe von Benutzern erstellen müssen, wenden Sie sich an das SanSan-Supportteam.
