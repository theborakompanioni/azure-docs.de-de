...
Dieses Tutorial soll Ihnen zeigen, wie Sie Trakstar in Azure Active Directory (Azure AD) integrieren können. Die Integration von Trakstar in Azure AD bietet die folgenden Vorteile:
...
4. Führen Sie auf der Seite **Einmaliges Anmelden konfigurieren für Trakstar** die folgenden Schritte aus:
...
1. Wenden Sie sich unter [integrations@trakstar.com](mailto:integrations@trakstar.com) an das Supportteam von Trakstar, um SSO für Ihre Anwendung konfigurieren zu lassen, und stellen Sie Folgendes bereit:
...
8. Führen Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** die folgenden Schritte aus:
	...
	![Erstellen einesAzure AD-Testbenutzers](./media/active-directory-saas-trakstar-tutorial/create_aaduser_08.png)
...
In diesem Abschnitt soll Ihre Azure AD-Konfiguration für das einmalige Anmelden mithilfe des Zugriffsbereichs getestet werden. Wenn Sie im Zugriffsbereich auf die Kachel „Trakstar“ klicken, sollten Sie automatisch bei Ihrer Trakstar-Anwendung angemeldet werden.
