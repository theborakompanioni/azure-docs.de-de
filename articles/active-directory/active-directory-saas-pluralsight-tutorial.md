...
Sie können auch das Attribut **Unique ID** mit einem Wert wie z.B. EmployeeID oder einem anderen für Ihre Organisation geeigneten Wert verwenden. Beachten Sie, dass dieses Attribut nicht erforderlich ist. Sie können es jedoch zum eindeutigen Identifizieren des Benutzers hinzufügen.
...
1. Um die redundanten **SAML-Tokenattribute** zu entfernen, führen Sie die folgenden Schritte aus:
...
1. Klicken Sie im klassischen Azure-Portal auf der Anwendungsintegrationsseite für **Pluralsight** auf **Einmaliges Anmelden konfigurieren**, um das Dialogfeld **Einmaliges Anmelden konfigurieren** zu öffnen.

    ![Einmaliges Anmelden konfigurieren][6]

2. Wählen Sie auf der Seite **Wie sollen sich Benutzer bei Pluralsight anmelden** die Option **Azure AD – einmaliges Anmelden** aus, und klicken Sie dann auf **Weiter**.
...
4. Führen Sie auf der Seite **Einmaliges Anmelden bei Pluralsight konfigurieren** die folgenden Schritte aus: ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-pluralsight-tutorial/tutorial_pluralsight_05.png)
...
5. Wenden Sie sich an das [Professional Services](mailTo:professionalservices@pluralsight.com)-Team von Pluralsight, um SSO für Ihre Anwendung konfigurieren zu lassen, und stellen Sie die heruntergeladene Metadatendatei bereit.
...
8. Führen Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** die folgenden Schritte aus:
    ...
    ![Erstellen einen Azure AD-Testbenutzers](./media/active-directory-saas-pluralsight-tutorial/create_aaduser_08.png)
