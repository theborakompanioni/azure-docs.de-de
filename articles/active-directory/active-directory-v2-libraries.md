---
title: Azure Active Directory v2.0-Bibliotheken | Microsoft Docs
...
---
# <a name="azure-active-directory-(ad)-v2.0-and-authentication-libraries"></a>Azure Active Directory (AD) v2.0 und Authentifizierungsbibliotheken
