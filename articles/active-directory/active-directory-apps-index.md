---
title: Artikelindex für die Anwendungsverwaltung in Azure Active Directory | Microsoft Docs
...
| Vorgehensweise für Anwendungshersteller zum Hinzufügen von Apps zum Azure AD-App-Katalog |[Auflisten Ihrer Anwendung im Azure Active Directory-Anwendungskatalog](active-directory-app-gallery-listing.md) |
...
| Verwenden dynamischer Gruppen zum automatischen Auffüllen der Gruppenmitgliedschaft mithilfe von attributbasierten Mitgliedschaftsregeln |[Dynamische Gruppenmitgliedschaft: erweiterte Regeln](active-directory-accessmanagement-groups-with-advanced-rules.md)<br /><br />[Problembehandlung bei dynamischen Mitgliedschaften](active-directory-accessmanagement-troubleshooting.md) |
