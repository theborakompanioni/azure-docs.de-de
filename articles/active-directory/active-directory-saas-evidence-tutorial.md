...
3. Geben Sie auf dem Bildschirm „App-URL konfigurieren“ die URL ein, mit der sich Benutzer bei Ihrem Evidence.com-Mandanten anmelden können (Beispiel: https://yourtenant.evidence.com), und klicken Sie dann auf **Weiter**. 
