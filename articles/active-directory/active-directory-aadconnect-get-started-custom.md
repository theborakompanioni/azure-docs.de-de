...
Stellen Sie sicher, dass WinRM auf den Remoteservern aktiviert ist, damit Sie Ihre AD FS-Farm mithilfe von Azure AD Connect konfigurieren können. Lesen Sie darüber hinaus die Portanforderungen in [Tabelle 3: Azure AD Connect und Verbund-/WAP-Server](active-directory-aadconnect-ports.md#table-3---azure-ad-connect-and-federation-serverswap).
...
- Überprüfen Sie die Browseranmeldung von einem beliebigen Gerät aus dem Extranet: Stellen Sie mit Ihrem Computer zu Hause oder mit einem Mobilgerät eine Verbindung mit https://myapps.microsoft.com her, und geben Sie Ihre Anmelde-ID und Ihr Kennwort ein.
