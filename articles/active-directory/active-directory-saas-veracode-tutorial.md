...
9. Führen Sie im Abschnitt **Selbstregistrierungseinstellungen** die folgenden Schritte aus. Klicken Sie dann auf **Speichern**:
   ...
   1. Wählen Sie für **Aktivierung neuer Benutzer** die Option **Keine Aktivierung erforderlich** aus.
   2. Wählen Sie für **Benutzerdaten-Aktualisierungen** die Option **Veracode-Benutzerdaten bevorzugen** aus.
