...
Damit einmaliges Anmelden funktioniert, muss Azure AD wissen, welcher Benutzer in Cimpl als Gegenbenutzer zu einem Benutzer in Azure AD fungiert. Anders ausgedrückt: Zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Cimpl muss eine Linkbeziehung eingerichtet werden.  
...
3. Führen Sie auf der Dialogseite **App-Einstellungen konfigurieren** die folgenden Schritte aus:
    ...
    a. Geben Sie im Textfeld „Anmelde-URL“ die URL, die Benutzer zum Anmelden bei der Cimpl-Anwendung verwenden, in folgendem Format ein: **https://login.bws.cimpl.com/SAMLSSO/Service.aspx?cimpl.idpid=\<MANDANTEN-ID-PID\>**.


1. Führen Sie auf der Seite **Einmaliges Anmelden konfigurieren für Cimpl** die folgenden Schritte aus:
