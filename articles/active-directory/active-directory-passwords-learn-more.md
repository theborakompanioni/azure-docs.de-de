...
#### <a name="data-accessible-with-azure-ad-powershell"></a>Mit Azure AD PowerShell zugängliche Daten
...
##### <a name="authentication-phone"></a>Telefonnummer für Authentifizierung
```
Connect-MsolService
Get-MsolUser -UserPrincipalName user@domain.com | select -Expand StrongAuthenticationUserDetails | select PhoneNumber
```

##### <a name="authentication-email"></a>E-Mail-Adresse für Authentifizierung
```
Connect-MsolService
