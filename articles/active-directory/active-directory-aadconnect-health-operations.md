...
### <a name="delete-a-server-from-azure-ad-connect-health-service"></a>Löschen eines Servers aus einem Azure AD Connect Health-Dienst
...
### <a name="remove-users-and/or-groups"></a>Entfernen von Benutzern und/oder Gruppen
