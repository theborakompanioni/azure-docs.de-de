...
# <a name="tutorial:-azure-active-directory-integration-with-lesson.ly"></a>Tutorial: Azure Active Directory-Integration mit Lesson.ly
...
## <a name="adding-lesson.ly-from-the-gallery"></a>Hinzufügen von Lesson.ly aus dem Katalog
...
8. Führen Sie auf der Seite **Einmaliges Anmelden konfigurieren für Lesson.ly** die folgenden Schritte aus:
...
9. Wenden Sie sich über dev@lesson.ly. Hängen Sie die heruntergeladene Zertifikatsdatei an Ihre E-Mail-Nachricht an und teilen Sie dem Lesson.ly-Team die Metadaten-URLs (Entitäts-ID, Anmelde-URL und Abmelde-URL für SSO) zum Einrichten von SSO auf ihrer Seite mit.
...
### <a name="creating-a-lesson.ly-test-user"></a>Erstellen eines Lesson.ly-Testbenutzers
