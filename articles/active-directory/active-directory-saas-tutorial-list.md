...
Sind Informationen zur Benutzerbereitstellung verfügbar, ist ein Anwendungstutorial für die Benutzerbereitstellung in der rechten Spalte neben dem Anwendungstutorial eingefügt.
...
| ![Logo](./media/active-directory-saas-tutorial-list/SaaSApp_QuickHelp.png)| [Schnellhilfe](active-directory-saas-quickhelp-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/SaaSApp_Slack.png)| [Puffer](active-directory-saas-slack-tutorial.md)| [Slack – Benutzerbereitstellung](active-directory-saas-slack-provisioning-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/SaaSApp_FBAtWork.png)| [Workplace by Facebook](active-directory-saas-facebook-at-work-tutorial.md)| [Workplace by Facebook – Benutzerbereitstellung](active-directory-saas-workplacebyfacebook-provisioning-tutorial.md)|
