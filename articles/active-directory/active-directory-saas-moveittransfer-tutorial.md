<properties
	pageTitle="Tutorial: Azure Active Directory-Integration mit MOVEit Transfer | Microsoft Azure"
...
# Tutorial: Azure Active Directory-Integration mit MOVEit Transfer
...
## Hinzufügen von MOVEit Transfer über den Katalog
...
Diese Linkbeziehung wird hergestellt, indem Sie den Benutzernamen in Azure AD dem Benutzernamen in MOVEit Transfer zuweisen.
...
3. Führen Sie auf der Seite **App-Einstellungen konfigurieren** die folgenden Schritte aus, und klicken Sie anschließend auf **Weiter**:
	...
	> [AZURE.NOTE] Hinweis: Die Werte müssen durch die tatsächliche Anmelde-URL und den tatsächlichen Bezeichner ersetzt werden. Informationen zum Abrufen dieser Werte finden Sie in Schritt 8. Alternativ können Sie sich auch mit [MOVEit Transfer](https://www.ipswitch.com/support/technical-support) in Verbindung setzen.
...
### Erstellen eines MOVEit Transfer-Testbenutzers
...
> [AZURE.NOTE] Setzen Sie sich mit dem Supportteam von MOVEit Transfer in Verbindung, wenn Sie einen Benutzer manuell erstellen müssen.
