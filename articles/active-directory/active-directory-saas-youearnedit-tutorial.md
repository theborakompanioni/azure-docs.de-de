...
# Tutorial: Azure Active Directory-Integration mit YouEarnedIt
...
## Hinzufügen von YouEarnedIt über den Katalog
...
Diese Linkbeziehung wird hergestellt, indem Sie den Benutzernamen in Azure AD dem Benutzernamen in YouEarnedIt zuweisen.
...
3. **[Erstellen eines YouEarnedIt-Testbenutzers](#creating-a-predictix-price-reporting-test-user)**, um einen Gegenpart von Britta Simon in YouEarnedIt zu erhalten, der mit ihrer Darstellung in Azure AD verknüpft ist.
...
8. Führen Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** die folgenden Schritte aus:
	...
	![Erstellen einesAzure AD-Testbenutzers](./media/active-directory-saas-youearnedit-tutorial/create_aaduser_08.png)
...
### Erstellen eines YouEarnedIt-Testbenutzers
