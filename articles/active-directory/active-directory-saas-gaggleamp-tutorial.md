...
Damit einmaliges Anmelden funktioniert, muss Azure AD wissen, welcher Benutzer in GaggleAMP als Gegenbenutzer zu einem Benutzer in Azure AD fungiert. Anders ausgedrückt: Zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in GaggleAMP muss eine Linkbeziehung eingerichtet werden.
...
3. Führen Sie auf der Dialogseite **App-Einstellungen konfigurieren** die folgenden Schritte aus:
    ...
    > [AZURE.NOTE]Wenn Sie die [Anmelde-URL](mailto:sales@gaggleamp.com) für Ihre Anwendung benötigen, wenden Sie sich an das **Vertriebsteam von GaggleAMP** ."

    b. Klicken Sie auf **Weiter**.


1. Führen Sie auf der Seite **Einmaliges Anmelden konfigurieren für GaggleAMP** die folgenden Schritte aus:
    ...
    b. Klicken Sie auf **Weiter**.
2. Navigieren Sie in einer weiteren Browserinstanz zu der SAML-SSO-Seite, die das Gaggle-Supportteam für Sie erstellt hat (Beispiel: *https://accounts.gaggleamp.com/saml_configurations/oXH8sQcP79dOzgFPqrMTyw/edit*).
3. Führen Sie auf der Seite **SAML-SSO** die folgenden Schritte aus:  
   
    ![Einmaliges Anmelden in GaggleAMP](./media/active-directory-saas-gaggleamp-tutorial/tutorial_gaggleamp_06.png) 
   
    a. Kopieren Sie im klassischen Azure-Portal die **Aussteller-URL**, und fügen Sie sie in das Textfeld **Aussteller des Identitätsanbieters** ein. 
   
    b. Kopieren Sie im klassischen Azure-Portal die **Dienst-URL für einmalige Anmeldung**, und fügen Sie sie in das Textfeld **URL für einmaliges Anmelden des Identitätsanbieters** ein. 
...
Das Ziel dieses Abschnitts besteht darin, für Britta Simon das einmalige Anmelden bei Azure zu aktivieren, indem sie Zugriff auf GaggleAMP erhält.
