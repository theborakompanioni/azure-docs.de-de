...
## <a name="enabling-the-application-integration-for-intacct"></a>Aktivieren der Anwendungsintegration für Intacct
...
### <a name="to-assign-users-to-intacct-perform-the-following-steps"></a>So weisen Sie Intacct Benutzer zu
