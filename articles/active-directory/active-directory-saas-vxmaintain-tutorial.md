<properties
	pageTitle="Tutorial: Azure Active Directory-Integration mit vxMaintain | Microsoft Azure"
...
# Tutorial: Azure Active Directory-Integration mit vxMaintain
...
Diese Linkbeziehung wird hergestellt, indem Sie den **Benutzernamen** in Azure AD als Wert für den **Benutzernamen** in vxMaintain zuweisen.
...
8. Führen Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** die folgenden Schritte aus:
	...
	![Erstellen einesAzure AD-Testbenutzers](./media/active-directory-saas-vxmaintain-tutorial/create_aaduser_08.png)
...
### Erstellen eines vxMaintain-Testbenutzers
