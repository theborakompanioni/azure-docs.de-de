...
Wenn Ihnen eine Administratorrolle zugewiesen wurde, können Sie diese Rolle aktivieren, um Aufgaben durchzuführen, für die diese Rolle erforderlich ist. Wenn Sie beispielsweise Office 365 nur gelegentlich verwalten müssen, werden die Sicherheitsadministratoren Ihrer Organisation Ihnen keine permanente Administratorrolle zuweisen. Stattdessen werden Sie als Kandidat für die Rollen eines globalen Administrator oder eines Exchange Online-Administrators in Azure AD eingerichtet. Dies bedeutet, dass Sie eine temporäre Rollenzuweisung anfordern können, wenn Sie diese Berechtigungen benötigen, und damit über einen bestimmten Zeitraum administrative Kontrolle für Office 365 besitzen.
...
6. Geben Sie im Textfeld den Grund für die Aktivierungsanforderung ein. Der Sicherheitsadministrator kann Sie möglicherweise auffordern, eine Ticketnummer zur Problembehebung bereitzustellen.
