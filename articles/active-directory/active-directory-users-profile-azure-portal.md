<properties
	pageTitle="Hinzufügen oder Ändern von Profilinformationen für einen Benutzer in der Azure Active Directory-Vorschau | Microsoft Azure"
...
# Hinzufügen oder Ändern von Profilinformationen für einen Benutzer in der Azure Active Directory-Vorschau

In diesem Artikel wird erläutert, wie Sie in der Azure Active Directory-Vorschau Benutzerprofilinformationen hinzufügen, beispielsweise ein Profilbild oder Informationen für die Authentifizierung per Telefon und E-Mail. [Was bietet die Vorschauversion?](active-directory-preview-explainer.md) Informationen dazu, wie Sie neue Benutzer in Ihrer Organisation hinzufügen, finden Sie unter [Hinzufügen neuer Benutzer zu Azure Active Directory](active-directory-users-create-azure-portal.md).

## Ändern von Profilinformationen
...
6. Fügen Sie Profilinformationen hinzu, oder ändern Sie Informationen, und klicken Sie anschließend auf der Befehlsleiste auf **Speichern**.
