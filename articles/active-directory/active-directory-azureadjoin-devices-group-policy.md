...
* Wenn Sie eine [benutzerdefinierte Installation für Azure AD Connect](connect/active-directory-aadconnect-get-started-custom.md) ausgeführt haben (nicht die Express-Installation), führen Sie das später in diesem Schritt beschriebene Verfahren **Erstellen eines Dienstverbindungspunkts im lokalen Active Directory** aus.
