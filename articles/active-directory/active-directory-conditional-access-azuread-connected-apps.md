...
Sicherheitsgruppen können auch explizit von der Richtlinie ausgeschlossen werden, indem Sie die **Ausnahmeo** ption aktivieren und mindestens eine Gruppe angeben. Benutzer, die Mitglied einer Gruppe in der **Ausnahmenliste** sind, unterliegen nicht der Pflicht zur mehrstufigen Authentifizierung, selbst wenn sie einer Gruppe angehören, für die diese Regel gilt.
