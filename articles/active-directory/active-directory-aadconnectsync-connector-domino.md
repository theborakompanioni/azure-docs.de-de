...
**Hinweis:** Lotus Notes muss einmalig mit einem Benutzer gestartet werden, der sich auf dem gleichen Server befindet wie das Konto, das sie als Dienstkonto für den Connector verwenden möchten. Stellen Sie auch sicher, dass der Lotus Notes-Client auf dem Server geschlossen ist. Der Client darf nicht ausgeführt werden, wenn der Connector versucht, eine Verbindung mit dem Domino-Server herzustellen.
