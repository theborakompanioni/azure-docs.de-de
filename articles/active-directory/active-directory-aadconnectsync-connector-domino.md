...
10. Schließen Sie Domino Administrator, und öffnen Sie die Domino-Konsole, um den LDAP-Dienst neu zu starten und das LDAP-Schema neu zu laden:
    * Fügen Sie in der Domino-Konsole den Befehl **Restart Task LDAP** als Domino-Befehl [](http://publib.boulder.ibm.com/infocenter/domhelp/v8r0/index.jsp?topic=%2Fcom.ibm.help.domino.admin85.doc%2FH_STARTING_AND_STOPPING_THE_LDAP_SERVER_OVER.html)ein, um den LDAP-Dienst neu zu starten.
    * Verwenden Sie zum Neuladen des LDAP-Schemas den Befehl **Tell LDAP ReloadSchema**.
