...
Zunächst versucht ein Benutzer, auf eine Ressource zuzugreifen, die von Azure AD ausgestellten Token vertraut, wie z.B. SharePoint Online.  SharePoint Online leitet den Benutzer dann zur Authentifizierung an Azure AD weiter. Der Benutzer gibt dann seinen Benutzernamen ein, sodass Azure AD ermitteln kann, ob das einmalige Anmelden für die Organisation des Benutzers aktiviert ist. Wenn das einmalige Anmelden für die Organisation aktiviert ist, geschieht Folgendes.
...
Wählen Sie beim Installieren von Azure AD Connect eine benutzerdefinierte Installation aus, damit Sie das einmalige Anmelden auf der Benutzeranmeldeseite auswählen können. Weitere Informationen finden Sie unter [Benutzerdefinierte Installation von Azure AD Connect](active-directory-aadconnect-get-started-custom.md).
...
>[!NOTE]
>Azure AD Connect muss über Port 9090 (TCP) mit *.msappproxy.net kommunizieren können, damit das einmalige Anmelden konfiguriert werden kann. Dies ist nur während der Konfiguration erforderlich, nicht während der Authentifizierung durch Endbenutzer.
