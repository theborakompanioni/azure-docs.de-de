...
5. Geben Sie auf dem Bildschirm „Mit Azure AD verbinden“ den Benutzernamen und das Kennwort eines globalen Azure-Administrators für Azure AD ein. Klicken Sie auf **Next**.  
...
Weitere Informationen zu den Features, die mit der Installation aktiviert wurden: [Automatisches Upgrade](../active-directory-aadconnect-feature-automatic-upgrade.md), [Verhindern von versehentlichen Löschungen](../active-directory-aadconnectsync-feature-prevent-accidental-deletes.md) und [Azure AD Connect Health](../active-directory-aadconnect-health-sync.md).
