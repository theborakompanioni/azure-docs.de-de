...
3. **[Erstellen eines Ceridian Dayforce HCM-Testbenutzers](#creating-a-ceridian-dayforce-hcm-test-user)**, um eine Entsprechung von Britta Simon in Ceridian Dayforce HCM zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
2. Wählen Sie aus der Attributliste **SAML-Tokenattribute** das Attribut „name“ aus, und klicken Sie auf **Bearbeiten**.
...
6. Wählen Sie auf der Seite **Wie sollen sich Benutzer bei Ceridian Dayforce HCM anmelden** die Option **Azure AD – einmaliges Anmelden** aus, und klicken Sie dann auf **Weiter**.
