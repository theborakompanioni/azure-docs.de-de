...
Dieses Tutorial soll Ihnen zeigen, wie Sie Ceridian Dayforce HCM in Azure Active Directory (Azure AD) integrieren können.  
...
3. **[Erstellen einen Ceridian Dayforce HCM-Testbenutzers](#creating-a-ceridian-dayforce-hcm-test-user)** , um eine Entsprechung von Britta Simon in Ceridian Dayforce HCM zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
2. Wählen Sie in der Attributliste **SAML-Tokenattribute** das Attribut „name“ aus, und klicken Sie auf **Bearbeiten**.
...
3. Führen Sie im Dialogfeld **Benutzerattribut hinzufügen** die folgenden Schritte aus:
    ...
    a. Wählen Sie in der Liste **Attributwert** das Benutzerattribut aus, das Sie für Ihre Implementierung verwenden möchten.  
...
4. Klicken Sie im oberen Menü auf **Schnellstart**.
   
    ![Einmaliges Anmelden konfigurieren](./media/active-directory-saas-hightail-tutorial/tutorial_general_83.png)  
5. Klicken Sie im klassischen Azure-Portal auf der Anwendungsintegrationsseite für **Ceridian Dayforce HCM** auf **Einmaliges Anmelden konfigurieren**.
   
    ![Einmaliges Anmelden konfigurieren][6] 
6. Wählen Sie auf der Seite **Wie sollen sich Benutzer bei Ceridian Dayforce HCM anmelden?** die Option **Microsoft Azure AD – einmaliges Anmelden** aus, und klicken Sie dann auf **Weiter**.
...
7. Führen Sie auf der Dialogseite **App-Einstellungen konfigurieren** die folgenden Schritte aus:
    ...
    b. Geben Sie im Textfeld **Antwort-URL** die URL ein, die von Azure AD zum Senden der Antwort verwendet wird.  
...
2. Um das einmalige Anmelden (SSO, Single Sign-On) für Ihre Anwendung konfigurieren zu lassen, wenden Sie sich per E-Mail an das Supportteam von Ceridian Dayforce HCM, und stellen Sie folgende Informationen bereit:
...
8. Führen Sie auf der Dialogfeldseite **Vorübergehendes Kennwort abrufen** die folgenden Schritte aus:
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/active-directory-saas-ceridiandayforcehcm-tutorial/create_aaduser_08.png) 
   
    a. Notieren Sie den Wert von **Neues Kennwort**.
   
    b. Klicken Sie auf **Fertig stellen**.   

### <a name="creating-a-ceridian-dayforce-hcm-test-user"></a>Erstellen einen Ceridian Dayforce HCM-Testbenutzers
