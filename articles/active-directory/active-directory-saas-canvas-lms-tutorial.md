---
title: 'Lernprogramm: Azure Active Directory-Integration mit Canvas LMS | Microsoft Docs'
...
8. Führen Sie auf der Seite "Current Integration" die folgenden Schritte aus.
   ...
   5. Kopieren Sie den **Fingerabdruckwert** aus dem exportierten Zertifikat, und fügen Sie ihn in das Textfeld **Fingerabdruck des Zertifikats** ein.
      ...
      > [!TIP]
      > Weitere Informationen finden Sie unter [How to retrieve a certificate's thumbprint value](http://youtu.be/YKQF266SAxI) (in englischer Sprache).
      > 
      > 
