---
title: SAS (Shared Access Signatures, freigegebene Zugriffssignaturen) – Übersicht | Microsoft Docs
...
Nach Erstellung der Richtlinie werden ihr ein *Primärschlüssel* und ein *Sekundärschlüssel* zugewiesen. Hierbei handelt es sich um kryptografisch starke Schlüssel. Achten Sie darauf, dass sie Ihnen nicht abhanden kommen: Sie sind immer im [klassischen Azure-Portal][klassischen Azure-Portal] verfügbar. Sie können einen beliebigen der generierten Schlüssel verwenden und die Schlüssel jederzeit erneut generieren. Wenn Sie allerdings den Primärschlüssel neu generieren oder in der Richtlinie ändern, werden alle auf deren Grundlage erstellten SAS ungültig.
...
> [!NOTE]
> Beim Erstellen der Verbindung muss der **SASL-Authentifizierungsmechanismus auf EXTERNAL** festgelegt werden. (Es darf nicht der Standardmechanismus PLAIN mit Benutzername und Kennwort genutzt werden. Dieser wird verwendet, wenn Sie das SAS-Token nicht senden müssen).
> 
> 
