        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Videobibliothek zu Logik-Apps</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Schemas</h3>
                        <p><a href="/azure/logic-apps/logic-apps-workflow-definition-language">Definitionssprache für Workflows</a></p>
                        <p><a href="/azure/logic-apps/logic-apps-workflow-actions-triggers">Workflow-Aktionen und -Trigger</a></p>
                   </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Schemaverlauf</h3>
                        <p><a href="/azure/logic-apps/logic-apps-schema-2016-04-01">ALLGEMEINE VERFÜGBARKEIT</a></p>
                        <p><a href="/azure/logic-apps/logic-apps-schema-2015-08-01">Vorschau</a></p>
                   </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/logic/">REST-API-Referenz</a></p>
                    </div>
                </div>
            </div>
        </div>
