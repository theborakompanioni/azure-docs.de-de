...
### [Verarbeiten von EDIFACT-Dokumenten mit einem UNH2.5-Segment](logic-apps-enterprise-integration-edifact_inputfile_unh2.5.md)
...
### [Fehler und Lösungen](logic-apps-enterprise-integration-b2b-list-errors-solutions.md)
...
# Serverlos
## Übersicht
### [Serverlos in Azure](logic-apps-serverless-overview.md)
## Erste Schritte
### [Erstellen einer serverlosen App in Visual Studio](logic-apps-serverless-get-started-vs.md)
## Szenarien und exemplarische Vorgehensweisen
### [Einholen von Kundenfeedback](logic-apps-scenario-social-serverless.md)
### [Versenden automatisierter E-Mails](https://channel9.msdn.com/Blogs/Microsoft-Integration/Build-and-Deploy-Serverless-Part-1)
### [B2B/EDI-Auftragsverarbeitung](logic-apps-enterprise-integration-overview.md)
...
### [Azure-Funktionen](logic-apps-azure-functions.md)
### [Azure Logic Apps](logic-apps-http-endpoint.md)
### [Azure SQL-Datenbank](../connectors/connectors-create-api-sqlazure.md)
### [Benutzerdefinierte APIs/Web-Apps](logic-apps-create-api-app.md)
...
### [Dateisystem](logic-apps-using-file-connector.md)
### [Flatfile](logic-apps-enterprise-integration-flatfile.md)
...
### [Oracle-Datenbank](../connectors/connectors-create-api-oracledatabase.md)
### [Anforderung/Antwort](../connectors/connectors-native-reqres.md)
...
### [XML-Überprüfung](logic-apps-enterprise-integration-xml-validation.md)

## [Connectors: Details](https://docs.microsoft.com/connectors/)
## Schemaverlauf
