...
|dayOfWeek|Gibt die Wochentagkomponente eines Zeichenfolgenzeitstempels zurück. Beispiel: `Wednesday`:<br /><br /> `dayOfWeek('2017-03-15T13:27:36Z')`<br /><br /> **Parameternummer:** 1<br /><br /> **Name:** Zeitstempel<br /><br /> **Beschreibung:** Erforderlich. Eine Zeichenfolge mit der Uhrzeit.| 
