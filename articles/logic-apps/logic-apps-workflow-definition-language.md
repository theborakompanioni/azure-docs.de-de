...
|actions|Nein|Gibt Aktionen an, die im Rahmen des Workflows ausgeführt werden. Es können bis zu 250 Aktionen definiert werden.|  
...
|Typ|Ja|Gibt die Art des angegebenen Werts an. Mögliche Werttypen: <ul><li>`string`</li><li>`securestring`</li><li>`int`</li><li>`bool`</li><li>`array`</li><li>`object`</li></ul>|
