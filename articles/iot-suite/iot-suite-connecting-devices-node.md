...
Stellen Sie sicher, dass auf dem Entwicklungscomputer mindestens die Node.js-Version 0.10.x installiert ist. Sie können `node --version` in der Befehlszeile ausführen, um die Version zu überprüfen.
