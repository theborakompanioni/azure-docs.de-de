...
Die Clientbibliotheken des IoT Hub-Serialisierungsprogramms verwenden ein Modell, das sowohl das Format der Nachrichten angibt, die das Gerät an IoT Hub sendet, als auch die Befehle, die es von IoT empfängt.
...
### <a name="add-code-to-implement-the-behavior-of-the-device"></a>Hinzufügen von Code, um das Verhalten des Geräts zu implementieren
...
### <a name="add-code-to-invoke-the-remotemonitoringrun-function"></a>Hinzufügen von Code zum Aufrufen der Funktion „remote_monitoring_run“
...
## <a name="use-cmake-to-build-the-client-application"></a>Erstellen der Clientanwendung mit CMake
