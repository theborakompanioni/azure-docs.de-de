...
description: Erfahren Sie, wie Sie Azure SQL-Datenbanken verwenden.
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/powershell/elasticdatabasejobs/v0.8.33/elasticdatabasejobs">Azure PowerShell (elastische Datenbank)</a></p>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>SQL Server-Treiber</h3>
                        <p><a href="https://msdn.microsoft.com/library/mt654049.aspx">SQL Server-Treiber</a></p>
