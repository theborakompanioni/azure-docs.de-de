...
4. Sie können Schieberegler und Zoomschaltflächen verwenden, um das Beobachtungsintervall zu ändern und Spitzenwerte zu untersuchen: ![settings](./media/sql-database-query-performance/zoom.png)
...
3. Klicken Sie an verschiedene Stellen des Diagramms, um Details anzuzeigen.
