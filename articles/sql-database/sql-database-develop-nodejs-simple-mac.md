...
[Prerequisites for using the Tedious Node.js Driver for SQL Server](https://msdn.microsoft.com/library/mt652094.aspx#Mac) (Voraussetzungen für die Verwendung des Tedious Node.js-Treibers für SQL Server)
