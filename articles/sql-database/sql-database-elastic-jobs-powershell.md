...
Verwenden Sie bei einer Kennwortänderung das Cmdlet [**Set-AzureSqlJobCredential**](/powershell/module/elasticdatabasejobs/set-azuresqljobcredential), und legen Sie den Parameter **CredentialName** fest.
...
Verwenden Sie das Cmdlet [**New-AzureSqlJobContent**](/powershell/module/elasticdatabasejobs/new-azuresqljobcontent), um ein Skript für die Ausführung zu erstellen und zu speichern, und legen Sie die Parameter **-ContentName** und **-CommandText** fest.
...
Verwenden Sie das Cmdlet [**Get-AzureSqlJobExecution**](/powershell/module/elasticdatabasejobs/get-azuresqljobexecution), und legen Sie den Parameter **JobExecutionId** fest, um den Status der Auftragsausführung anzuzeigen.
...
Das Cmdlet [**Get-AzureSqlJobExecution**](/powershell/module/elasticdatabasejobs/new-azuresqljob) weist mehrere optionale Parameter auf, die zum Anzeigen der Ausführung mehrerer Aufträge verwendet werden können, gefiltert anhand der angegebenen Parameter. Die folgenden Beispiele zeigen einige der möglichen Verwendungsweisen von „Get-AzureSqlJobExecution“:
...
Verwenden Sie zum Senden von Abbruchanforderungen das Cmdlet [**Stop-AzureSqlJobExecution**](/powershell/module/elasticdatabasejobs/stop-azuresqljobexecution), und legen Sie den Parameter **JobExecutionId** fest.
...
Rufen Sie [**Stop-AzureSqlJobExecution**](/powershell/module/elasticdatabasejobs/stop-azuresqljobexecution) auf, um die Ausführung aktiver Aufträge abzubrechen.

Verwenden Sie zum Auslösen der Löschung von Aufträgen das Cmdlet [**Remove-AzureSqlJob**](/powershell/module/elasticdatabasejobs/remove-azuresqljob), und legen Sie den Parameter **JobName** fest.
...
Verwenden Sie das Cmdlet [**Add-AzureSqlJobChildTarget**](/powershell/module/elasticdatabasejobs/add-azuresqljobchildtarget), um eine Datenbank zu einer bestimmten benutzerdefinierten Sammlung hinzuzufügen.
...
Verwenden Sie das Cmdlet [**Get-AzureSqlJobTarget**](/powershell/module/elasticdatabasejobs/new-azuresqljobtarget), um die untergeordneten Datenbanken in einem benutzerdefinierten Datenbankziel abzurufen. 
...
Dieses Skript verwendet das Cmdlet [**Get-AzureSqlJobTarget**](/powershell/module/elasticdatabasejobs/new-azuresqljobtarget). Legen Sie die Parameter für Skript, Anmeldeinformationen und Ausführungsziel fest:
...
Dieses Skript verwendet das Cmdlet [**Start-AzureSqlJobExecution**](/powershell/module/elasticdatabasejobs/start-azuresqljobexecution).
...
Das folgende PowerShell-Skript kann zum Erstellen eines wiederkehrenden Zeitplans verwendet werden. In diesem Skript wird zwar ein Minutenintervall verwendet, [**New-AzureSqlJobSchedule**](/powershell/module/elasticdatabasejobs/new-azuresqljobschedule) unterstützt jedoch auch die Parameter „-DayInterval“, „-HourInterval“, „-MonthInterval“ und „-WeekInterval“. Zeitpläne, die nur einmalig ausgeführt werden sollen, können durch Angeben von „-OneTime“ erstellt werden.
...
Verwenden Sie [New-AzureSqlJobTrigger](/powershell/module/elasticdatabasejobs/new-azuresqljobtrigger) , und legen Sie die folgenden Variablen für den gewünschten Auftrag und Zeitplan fest:
...
Um die Fortsetzung der Auftragsausführung durch einen Auftragsauslöser aufzuheben, kann der Auftragsauslöser entfernt werden. Entfernen Sie einen Auftragsauslöser mithilfe des [**Cmdlets Remove-AzureSqlJobTrigger**](/powershell/module/elasticdatabasejobs/remove-azuresqljobtrigger), um die fortlaufende Ausführung eines Auftrags gemäß einem Zeitplan zu beenden.
...
Verwenden Sie [Get-AzureSqlJobTrigger](/powershell/module/elasticdatabasejobs/get-azuresqljobtrigger) , um die Zeitpläne für einen registrierten Auftrag abzurufen und anzuzeigen.
