---
title: 'Azure-Portal: Erstellen und Abfragen einer einzelnen SQL-Datenbank | Microsoft-Dokumentation'
...
Eine Azure SQL-Datenbank wird in einer Azure-Ressourcengruppe, auf einem logischen Server und mit einem definierten Satz von Compute- und Speicherressourcen erstellt. Führen Sie diese Schritte aus, um eine SQL-Datenbank mit den Adventure Works LT-Beispieldaten zu erstellen. 

1. Klicken Sie in der linken oberen Ecke des Azure-Portals auf die Schaltfläche **Neu**.

2. Wählen Sie auf dem Blatt **Neu** die Option **Datenbanken** und dann auf dem Blatt **Datenbanken** die Option **SQL-Datenbank**.
...
Wenn Sie möchten, können Sie die in diesem Schnellstart erstellten Ressourcen für spätere Tutorials speichern. Sie können auch die folgenden Schritte ausführen, um alle erstellten Ressourcen dieses Schnellstarts im Azure-Portal zu löschen.
