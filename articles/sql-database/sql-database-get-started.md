...
>[AZURE.IMPORTANT]Wenn die Bereitstellung abgeschlossen ist, werden der neue Azure SQL-Server und die neue Datenbank in Azure erstellt. Sie können erst dann mit SQL Server-Tools eine Verbindung mit dem neuen Server oder der neuen Datenbank herstellen, nachdem Sie eine Serverfirewallregel zum Öffnen der SQL-Datenbankfirewall für Verbindungen von außerhalb von Azure erstellt haben.

[AZURE.INCLUDE [Erstellen einer Serverfirewallregel](../../includes/sql-database-create-new-server-firewall-portal.md)]
