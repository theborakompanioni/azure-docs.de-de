...
- Durch das Ändern des Tarifs für Ihre Datenbank ändert sich nicht die maximale Datenbankgröße. Verwenden Sie [Transact-SQL (T-SQL)](https://msdn.microsoft.com/library/mt574871.aspx) oder [PowerShell](https://msdn.microsoft.com/library/mt619433.aspx), um die maximale Datenbankgröße zu ändern.
...
3.	Klicken Sie im Blatt „SQL-Datenbank“ auf **Alle Einstellungen**, und wählen Sie dann **Tarif (DTUs skalieren)**:
...
1.  Wählen Sie eine neue Stufe aus, und klicken Sie auf **Auswählen**.
    ...
    > [AZURE.NOTE] Durch das Ändern des Tarifs für Ihre Datenbank ändert sich nicht die maximale Datenbankgröße. Verwenden Sie [Transact-SQL (T-SQL)](https://msdn.microsoft.com/library/mt574871.aspx) oder [PowerShell](https://msdn.microsoft.com/library/mt619433.aspx), um die maximale Datenbankgröße zu ändern.
