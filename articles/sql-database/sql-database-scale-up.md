---
title: Ändern der Dienstebene und Leistungsstufe einer Azure SQL-Datenbank
...
4. Klicken Sie auf die Datenbank, die Sie ändern möchten.
5. Klicken Sie auf dem Blatt der SQL-Datenbank auf **Alle Einstellungen** und dann auf **Tarif (DTUs skalieren)**:
   
   ![Tarif][1]
6. Wählen Sie eine neue Stufe aus, und klicken Sie auf **Auswählen**.
   ...
   ![Tarif auswählen][2]
7. Klicken Sie im linken Menüband auf **Benachrichtigungen**:
...
1. Klicken Sie auf **ALLE DURCHSUCHEN**.
2. Klicken Sie auf **SQL-Datenbanken**.
3. Klicken Sie auf die Datenbank, die Sie aktualisiert haben.
4. Überprüfen Sie den **Tarif**, und vergewissern Sie sich, dass er richtig festgelegt ist.
