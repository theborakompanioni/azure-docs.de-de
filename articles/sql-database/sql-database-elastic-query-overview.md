---
title: "Übersicht über elastische Datenbankabfragen in Azure SQL-Datenbank | Microsoft Docs"
...
---
# <a name="azure-sql-database-elastic-database-query-overview-preview"></a>Übersicht über elastische Datenbankenabfragen in Azure SQL-Datenbank (Vorschau)
...
* [Erstellen von Berichten für horizontal hochskalierte Clouddatenbanken](sql-database-elastic-query-getting-started.md)
...
## <a name="elastic-database-query-scenarios"></a>Szenarios mit elastischen Datenbankabfragen
...
## <a name="implementing-elastic-database-queries"></a>Implementieren elastischer Datenbankabfragen
...
Weitere Informationen zu den Schritten, die für das vertikale Partitionierungsszenario erforderlich sind, finden Sie unter [Elastische Abfrage für die vertikale Partitionierung](sql-database-elastic-query-vertical-partitioning.md).  
