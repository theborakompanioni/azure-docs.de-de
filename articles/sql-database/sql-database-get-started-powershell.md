...
# <a name="get-started-with-azure-sql-database-servers-databases-and-firewall-rules-by-using-azure-powershell"></a>Erste Schritte mit Azure SQL-Datenbankservern, -Datenbanken und -Firewallregeln mit Azure PowerShell
