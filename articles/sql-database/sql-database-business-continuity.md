...
Im Anschluss werden die zentralen Szenarien für die Planung von Geschäftskontinuität und Datenbankwiederherstellung beschrieben.
...
- [Anwendungsupgrades ohne Ausfallzeiten](sql-database-business-continuity-application-upgrade.md)
