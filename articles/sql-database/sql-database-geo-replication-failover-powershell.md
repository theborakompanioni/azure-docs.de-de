---
title: "Initiieren eines geplanten oder ungeplanten Failovers für die Azure SQL-Datenbank mit PowerShell | Microsoft Docs"
...
---
# <a name="initiate-a-planned-or-unplanned-failover-for-azure-sql-database-with-powershell"></a>Initiieren eines geplanten oder ungeplanten Failovers für die Azure SQL-Datenbank mit PowerShell
...
## <a name="initiate-a-planned-failover"></a>Initiieren eines geplanten Failovers
...
> [!NOTE]
> In seltenen Fällen ist es möglich, dass der Vorgang nicht abgeschlossen werden kann und nicht mehr zu reagieren scheint. In diesem Fall kann der Benutzer den Befehl zum Erzwingen des Failovers (ungeplantes Failover) aufrufen und den Datenverlust akzeptieren.
> 
> 
