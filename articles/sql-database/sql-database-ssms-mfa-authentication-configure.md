i--- title: Konfigurieren der Multi-Factor Authentication – Azure SQL | Microsoft Docs description: Verwenden der Multi-Factor Authentication mit SSMS für SQL-Datenbank und SQL Data Warehouse.
