...
## <a name="standalone-database-service-tiers-and-performance-levels"></a>Tarife und Leistungsstufen für eigenständige Datenbanken
...
### <a name="choosing-a-service-tier-for-a-standalone-database"></a>Auswählen einer Dienstebene für eine eigenständige Datenbank
