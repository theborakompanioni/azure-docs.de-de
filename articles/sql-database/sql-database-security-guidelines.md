...
---
# <a name="azure-sql-database-security-guidelines-and-limitations"></a>Sicherheitsrichtlinien und Einschränkungen von Azure SQL-Datenbank
...
## <a name="access-to-the-virtual-master-database"></a>Zugriff auf die virtuelle Masterdatenbank
