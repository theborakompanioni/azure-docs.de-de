---
title: 'Azure-Portal: Erstellen und Verwalten von Azure SQL-Datenbankservern | Microsoft-Dokumentation'
description: "Kurzübersicht über das Erstellen und Verwalten von Azure SQL-Datenbankservern mit dem Azure-Portal."
...
# <a name="create-and-manage-azure-sql-database-servers-with-the-azure-portal"></a>Erstellen und Verwalten von Azure SQL-Datenbankservern mit dem Azure-Portal
...
## <a name="view-and-update-azure-sql-server-settings-using-the-azure-portal"></a>Anzeigen und Aktualisieren der Einstellungen eines Azure SQL-Servers über das Azure-Portal
1. Öffnen Sie im [Azure-Portal](https://portal.azure.com/) das Blatt **SQL-Server**. 
