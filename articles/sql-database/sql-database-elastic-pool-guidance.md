...
4.	Die kleinste eDTU-Poolgröße, die größer ist als die Schätzung aus Schritt 3, finden Sie auf der [SQL-Datenbank Preisseite](https://azure.microsoft.com/pricing/details/sql-database/).
