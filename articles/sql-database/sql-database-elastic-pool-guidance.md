...
---
# <a name="when-should-an-elastic-database-pool-be-used"></a>Wo sollte ein Pool für elastische Datenbanken verwendet werden?
...
## <a name="elastic-database-pools"></a>Elastische Datenbankpools
