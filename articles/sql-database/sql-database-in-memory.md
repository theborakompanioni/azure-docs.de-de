---
title: Erste Schritte mit SQL In-Memory | Microsoft Docs
...
> [!NOTE]
> Die in der Vorschau befindlichen Features stehen nur für Azure SQL-Datenbanken im Tarif [*Premium*](sql-database-service-tiers.md) zur Verfügung, nicht für Datenbanken im Tarif „Standard“ oder „Basic“.
> 
> 
...
* Die Verwendung von In-Memory OLTP-Features mit Datenbanken in elastischen Pools wird in der Vorschauversion nicht unterstützt.
  ...
  * 1. Ändern Sie die Dienstebene der Datenbank in „Standard“.
  * 1. Verschieben Sie die Datenbank in den elastischen Pool.
