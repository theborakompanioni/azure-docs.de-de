...
Firewallregeln auf Serverebene über Transact-SQL können nur über die Azure SQL Server-Administratoranmeldung oder vom Azure Active Directory-Administrator erstellt werden.
...
1. Öffnen Sie nach dem Erstellen einer Firewall auf Serverebene für Ihre IP-Adresse ein Abfragefenster über das Azure-Portal oder über SQL Server Management Studio.
