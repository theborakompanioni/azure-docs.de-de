...
> [!NOTE]
> Sie können auch einen neuen Pool erstellen, indem Sie im **Marketplace** nach **SQL elastischer Pool** oder klicken Sie im Blatt zum Durchsuchen von **elastischen SQL-Pools** auf **+Hinzufügen**. Sie können über diesen Poolbereitstellungsworkflow einen neuen oder einen bestehenden Server angeben.
>
>

1. Klicken Sie im [Azure-Portal](http://portal.azure.com/) unterhalb der Liste auf der linken Seite auf **Weitere Dienste** **>** **Computer mit SQL Server** und dann auf den Server mit den Datenbanken, die Sie einem Pool hinzufügen möchten.
...
Klicken Sie auf **Tarif**, wählen sie den gewünschten Tarif aus,und klicken Sie anschließend auf **Auswählen**, um die Preisstufe des Pools zu ändern.
