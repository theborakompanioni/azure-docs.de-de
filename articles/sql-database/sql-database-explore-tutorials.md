---
title: Entdecken Sie die Azure SQL-Datenbank-Tutorials | Microsoft Docs
...
| [Kopieren einer Azure SQL-Datenbank mithilfe von PowerShell](sql-database-copy-powershell.md#copy-your-sql-database) |In diesem Tutorial erfahren Sie, wie Sie eine Azure SQL-Datenbank mithilfe von PowerShell kopieren. |
