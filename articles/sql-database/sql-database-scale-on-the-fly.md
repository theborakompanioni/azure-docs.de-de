---
title: Spontane Skalierung von Azure SQL-Datenbank
...
---
# <a name="azure-sql-database-scales-on-the-fly"></a>Spontane Skalierung von Azure SQL-Datenbank
## <a name="when-your-app-grows-from-a-small-number-of-customers-to-just-about-everyone-azure-sql-database-can-scale-on-the-fly-with-minimal-app-downtime"></a>Wenn Ihre App von einer kleinen Anzahl von Kunden rasant anwächst, können Sie Azure SQL-Datenbank ohne längere Ausfallzeiten der App spontan skalieren.
...
## <a name="within-your-budget"></a>Im Rahmen Ihres Budgets
...
## <a name="get-the-fastest-performance"></a>Optimale Leistung erzielen
