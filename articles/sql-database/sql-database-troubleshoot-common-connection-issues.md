...
5.	Wenn die Verbindungsprobleme weiterhin bestehen, stellen Sie eine Azure-Supportanfrage, indem Sie auf der Website des [Azure-Supports](https://azure.microsoft.com/support/options) die Option **Support erhalten** auswählen.
