---
title: "TSQL: Initiieren des Failovers für Azure SQL-Datenbank | Microsoft-Dokumentation"
...
In diesem Artikel wird beschrieben, wie Sie mit Transact-SQL ein Failover zu einer sekundären SQL-Datenbank konfigurieren. Informationen zum Konfigurieren der Georeplikation finden Sie unter [Konfigurieren der Georeplikation für die Azure SQL-Datenbank mit PowerShell](sql-database-geo-replication-transact-sql.md).
