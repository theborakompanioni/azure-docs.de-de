...
> [!NOTE]
> Ein Wert für **ObjectID** ist in Azure AD erforderlich, wenn **DisplayName** nicht eindeutig ist. Um die Werte für **ObjectID** und **DisplayName** abzurufen, verwenden Sie den Active Directory-Abschnitt im klassischen Azure-Portal, um die Eigenschaften für einen Benutzer oder eine Gruppe anzuzeigen.
> 
> 
...
> [!NOTE]
> Azure AD-Benutzer werden in den Datenbankmetadaten mit dem Typ E (EXTERNAL\_USER) gekennzeichnet, Gruppen mit dem Typ X (EXTERNAL\_GROUPS). Weitere Informationen finden Sie unter [sys.database\_principals](https://msdn.microsoft.com/library/ms187328.aspx).
> 
> 
