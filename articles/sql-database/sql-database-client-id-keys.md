---
title: Registrieren Ihrer App und Abrufen der Client-ID und des Schlüssels für die Verbindung mit der SQL-Datenbank aus dem Code | Microsoft Docs
...
2. Suchen Sie im Menü nach **Active Directory**, und wählen Sie diese Option aus.
   
    ![AAD][1]
3. Wählen Sie das Verzeichnis zum Authentifizieren Ihrer Anwendung aus, und klicken Sie auf seinen **Namen**.
   
    ![Verzeichnisse][4]
4. Klicken Sie auf der Verzeichnisseite auf **ANWENDUNGEN**.
   
    ![Anwendungen][5]
5. Klicken Sie auf **HINZUFÜGEN**, um eine neue Anwendung zu erstellen.
   
    ![Anwendung hinzufügen][6]
6. Geben Sie im Feld **NAME** einen Namen für die App ein, und wählen Sie **SYSTEMEIGENE CLIENTANWENDUNG** aus.
   
    ![Anwendung hinzufügen][7]
7. Geben Sie einen **UMLEITUNGS-URI** an. Es muss kein tatsächlicher Endpunkt sein, lediglich ein gültiger URI.
   
    ![Anwendung hinzufügen][8]
8. Schließen Sie das Erstellen der App ab, klicken Sie auf **KONFIGURIEREN**, und kopieren Sie die **CLIENT-ID** (diesen Wert benötigen Sie in Ihrem Code).
   
    ![Client-ID abrufen][9]
9. Scrollen Sie auf der Seite nach unten, und klicken Sie auf **Anwendung hinzufügen**.
10. Wählen Sie **Microsoft-Apps** aus.
11. Wählen Sie **Microsoft Azure-Service-Verwaltungs-API** aus, und schließen Sie dann den Assistenten ab.
12. Suchen Sie im Abschnitt **Berechtigungen für andere Anwendungen** nach **Microsoft Azure-Service-Verwaltungs-API**, und klicken Sie auf **Delegierte Berechtigungen**.
13. Wählen Sie **Auf Azure-Service-Verwaltung zugreifen** aus.
...
5. Klicken Sie auf **HINZUFÜGEN**, um eine neue Anwendung zu erstellen.
    ...
    ![Anwendung hinzufügen][6]
6. Geben Sie im Feld **NAME** einen Namen für die App ein, und wählen Sie **WEBANWENDUNG UND/ODER WEB-API** aus.
   
    ![Anwendung hinzufügen][10]
7. Geben Sie eine **ANMELDE-URL** und einen **APP-ID-URI** ein. Es muss kein tatsächlicher Endpunkt sein, lediglich ein gültiger URI.
   
    ![Anwendung hinzufügen][11]
8. Schließen Sie das Erstellen der App ab, und klicken Sie dann **KONFIGURIEREN**.
   
    ![Konfigurieren][12]
9. Scrollen Sie zum Abschnitt **Schlüssel**, und wählen Sie **1 Jahr** in der Liste **Dauer auswählen** aus. Der Schlüsselwert wird nach dem Speichern angezeigt. Daher kehren wir später zurück und kopieren den Schlüssel.
   
    ![Dauer für den Schlüssel festlegen][13]
10. Scrollen Sie auf der Seite nach unten, und klicken Sie auf **Anwendung hinzufügen**.
11. Wählen Sie **Microsoft-Apps** aus.
12. Suchen Sie nach **Microsoft Azure-Service-Verwaltungs-API**, und wählen Sie sie aus. Schließen Sie dann den Assistenten ab.
13. Suchen Sie im Abschnitt **Berechtigungen für andere Anwendungen** nach **Microsoft Azure-Service-Verwaltungs-API**, und klicken Sie auf **Delegierte Berechtigungen**.
14. Wählen Sie **Auf Azure-Service-Verwaltung zugreifen** aus.
    
     ![Berechtigungen][2]
15. Klicken Sie unten auf der Seite auf **Speichern**.
16. Wenn der Speichervorgang abgeschlossen ist, suchen und speichern Sie die CLIENT-ID und den Schlüssel:
