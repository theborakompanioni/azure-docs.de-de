...
[!INCLUDE [SSMS-Installation](../../includes/sql-server-management-studio-install.md)]

[!INCLUDE [SSMS-Verbindung](../../includes/sql-database-sql-server-management-studio-connect-server-principal.md)]
