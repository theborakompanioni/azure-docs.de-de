---
title: Herstellen von Verbindungen mit SQL-Datenbank mithilfe von .NET (C#) | Microsoft Docs
...
---
# <a name="connect-to-sql-database-by-using-net-c"></a>Herstellen von Verbindungen mit SQL-Datenbanken mithilfe von .NET (C#)
...
* [Erstellen einer ASP.NET MVC-App mit Authentifizierung und SQL-Datenbank und Bereitstellung der App in Azure App Service](../app-service-web/web-sites-dotnet-deploy-aspnet-mvc-app-membership-oauth-sql-database.md)
* Lesen Sie die [Übersicht über die Entwicklung von SQL-Datenbanken](sql-database-develop-overview.md)
* Weitere Informationen zum [Microsoft ADO.NET-Treiber für SQL Server](https://docs.microsoft.com/sql/connect/ado-net/microsoft-ado-net-for-sql-server/)
