...
> [!NOTE]
> Sie können eine SQL-Datenbank auch über [PowerShell](scripts/sql-database-copy-database-to-new-server-powershell.md) oder [Transact-SQL](sql-database-copy-transact-sql.md) kopieren.
>
