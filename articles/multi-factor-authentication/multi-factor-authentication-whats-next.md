...
description: 'Dies ist die Seite '
;azure: ''
multi-factor: ''
authentication";,: ''
auf: ''
...
|:--- |:--- |:--- |
| Innerhalb des Unternehmensnetzwerks |Für Browserflüsse, für die KEINE mehrstufige Authentifizierung erforderlich ist. |
...
> [!WARNING]
> App-Kennwörter funktioniert nicht in Hybridumgebungen, in denen Clients sowohl mit lokalen AutoErmittlung-Endpunkten als auch mit solchen in der Cloud kommunizieren.
> 
