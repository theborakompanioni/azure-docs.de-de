...
<a id="configure-azure-multi-factor-authentication-server-for-iis-web-apps" class="xliff"></a>
...
<a id="using-form-based-iis-authentication-with-azure-multi-factor-authentication-server" class="xliff"></a>
...
<a id="using-integrated-windows-authentication-with-azure-multi-factor-authentication-server" class="xliff"></a>
...
<a id="enable-iis-plug-ins-for-azure-multi-factor-authentication-server" class="xliff"></a>
...
<a id="trusted-ips" class="xliff"></a>
