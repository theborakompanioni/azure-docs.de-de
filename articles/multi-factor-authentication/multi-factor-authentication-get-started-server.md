...
---
# <a name="getting-started-with-the-azure-multifactor-authentication-server"></a>Erste Schritte mit Azure Multi-Factor Authentication-Server
...
## <a name="download-the-azure-multifactor-authentication-server"></a>Herunterladen des Azure Multi-Factor Authentication-Servers
...
### <a name="to-download-the-azure-multifactor-authentication-server-from-the-azure-portal"></a>So laden Sie den Azure Multi-Factor Authentication-Server im Azure-Portal herunter
- - -
...
### <a name="to-download-the-azure-multifactor-authentication-server-via-the-service-settings"></a>So laden Sie den Azure Multi-Factor Authentication-Server über die Diensteinstellungen herunter
1. Melden Sie sich beim Azure-Portal als Administrator an.
2. Wählen Sie im linken Bereich "Active Directory" aus.
...
## <a name="install-and-configure-the-azure-multifactor-authentication-server"></a>Installieren und Konfigurieren des Azure Multi-Factor Authentication-Servers
...
### <a name="azure-multifactor-authentication-server-firewall-requirements"></a>Anforderungen an die Azure Multi-Factor Authentication-Server-Firewall
- - -
...
### <a name="to-install-and-configure-the-azure-multifactor-authentication-server"></a>So installieren und konfigurieren Sie den Azure Multi-Factor Authentication-Server
- - -
...
## <a name="send-users-an-email"></a>Senden Sie Benutzern eine E-Mail.
...
### <a name="configuring-email-and-email-templates"></a>Konfigurieren von E-Mails und E-Mail-Vorlagen
...
## <a name="how-the-azure-multifactor-authentication-server-handles-user-data"></a>Verarbeitung von Benutzerdaten durch den Azure Multi-Factor Authentication-Server
...
## <a name="advanced-azure-multifactor-authentication-server-configurations"></a>Erweiterte Azure Multi-Factor Authentication Server-Konfigurationen
