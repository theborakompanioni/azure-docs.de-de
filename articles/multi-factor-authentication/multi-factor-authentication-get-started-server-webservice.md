---
title: "Erste Schritte mit dem Webdienst der mobilen App für den MFA-Server"
...
---
# <a name="getting-started-the-mfa-server-mobile-app-web-service"></a>Erste Schritte mit dem Webdienst der mobilen App für den MFA-Server
...
<center>![Einrichtung](./media/multi-factor-authentication-get-started-server-webservice/sdk.png)</center>
...
### <a name="to-install-the-mobile-app-web-service"></a>So installieren Sie den Webdienst der mobilen App
<ol>
