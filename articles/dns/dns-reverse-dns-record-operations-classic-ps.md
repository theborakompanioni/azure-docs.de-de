---
title: Mit PowerShell im klassischen Bereitstellungsmodell Ihre Reverse-DNS-Einträge für Ihre Dienste verwalten | Microsoft Docs
...
Erfahren Sie, wie Sie [diese Schritte mit dem Resource Manager-Modell ausführen](dns-reverse-dns-record-operations-ps.md).
...
[!INCLUDE [HÄUFIG GESTELLTE FRAGEN](../../includes/dns-reverse-dns-record-operations-faq-asm-include.md)]
