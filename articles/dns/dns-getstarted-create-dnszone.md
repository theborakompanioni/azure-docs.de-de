...
- Der *SOA*-Eintrag (Start of Authority, Autoritätsursprung). Dieser ist im Stamm jeder DNS-Zone vorhanden.
...
Ressourceneintragssätze am Stamm (oder der *Spitze*) einer DNS-Zone verwenden **@** als Namen des Ressourceneintragssatzes.
