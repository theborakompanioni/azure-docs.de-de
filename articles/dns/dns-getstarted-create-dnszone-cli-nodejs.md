---
title: Erstellen einer DNS-Zone mit der Azure CLI 1.0 | Microsoft-Dokumentation
description: "Erfahren Sie, wie Sie DNS-Zonen in Azure DNS erstellen. Dies ist eine Schritt-für-Schritt-Anleitung zum Erstellen und Verwalten Ihrer ersten DNS-Zone mithilfe der Azure CLI 1.0."
services: dns
...
# <a name="create-an-azure-dns-zone-using-azure-cli-10"></a>Erstellen einer Azure-DNS-Zone mit der Azure CLI 1.0
