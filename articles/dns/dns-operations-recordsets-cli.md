...
# <a name="manage-dns-records-in-azure-dns-using-the-azure-cli"></a>Verwalten von DNS-Einträgen mit der Azure-Befehlszeilenschnittstelle
...
In diesem Beispiel verwenden wir den Namen der Datensatzgruppe "@" zum Erstellen des MX-Eintrags auf oberster Ebene der Zone (in diesem Fall „contoso.com“).
