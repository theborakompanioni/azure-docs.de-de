...
## <a name="delegating-subdomains-in-azure-dns"></a>Delegieren von Unterdomänen in Azure DNS
...
### <a name="to-delegate-a-subdomain"></a>So delegieren Sie eine Unterdomäne
