...
2. Wählen Sie **Ein**, um diese Richtlinie zu aktivieren, und **Aus**, um sie zu deaktivieren.
3. Wenn Sie diese Richtlinie aktivieren, geben Sie einen numerischen Wert für die maximale Anzahl von virtuellen Computern ein, die von einem Benutzer erstellt werden können. Wenn Sie eine ungültige Zahl eingeben, zeigt die Benutzeroberfläche die maximal zulässige Zahl für dieses Feld an.
4. Wählen Sie **Speichern** aus.
...
2. Wählen Sie **Ein**, um diese Richtlinie zu aktivieren, und **Aus**, um sie zu deaktivieren.
3. Wenn Sie diese Richtlinie aktivieren, geben Sie einen numerischen Wert für die maximale Anzahl von virtuellen Computern ein, die für das aktuelle Lab erstellt werden können. Wenn Sie eine ungültige Zahl eingeben, zeigt die Benutzeroberfläche die maximal zulässige Zahl für dieses Feld an.
4. Wählen Sie **Speichern** aus.
