...
4. Wählen Sie auf dem Blatt des Labs **Configuration** (Konfiguration) aus.
5. Wählen Sie auf dem Blatt **Configuration** (Konfiguration) die Option **Marketplace images** (Marketplace-Images) aus.
