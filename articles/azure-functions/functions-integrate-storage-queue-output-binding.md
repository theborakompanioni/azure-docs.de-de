...
1. Klicken Sie auf die Funktion, um den Funktionscode im Editor anzuzeigen. 
...
1. Nachdem die Änderungen des Codes gespeichert wurden, klicken Sie auf **Ausführen**. 
...
3. Geben Sie den **Kontonamen** und den **Kontoschlüssel** aus Schritt 1 ein, klicken Sie auf **Weiter** und dann auf **Verbinden**. 
    ...
    ![Geben Sie die Speicheranmeldeinformationen ein, und stellen Sie eine Verbindung her.](./media/functions-integrate-storage-queue-output-binding/functions-storage-manager-connect-2.png)
