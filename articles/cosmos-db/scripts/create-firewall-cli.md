...
[!code-azurecli-interactive[main](../../../cli_scripts/cosmosdb/secure-cosmosdb-create-firewall/secure-cosmosdb-create-firewall.sh?highlight=38-42 "Erstellen einer Azure Cosmos DB-Firewall")]
...
| [az cosmosdb create](https://docs.microsoft.com/cli/azure/cosmosdb#create) | Erstellt ein Konto für Azure Cosmos DB. |
| [az cosmosdb update](https://docs.microsoft.com/cli/azure/cosmosdb#update) | Aktualisiert ein Azure Cosmos DB-Konto so, dass es Firewalleinstellungen umfasst. |
