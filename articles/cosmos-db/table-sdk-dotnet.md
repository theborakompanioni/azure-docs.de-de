...
Weitere Informationen zur Azure Cosmos DB-Tabellen-API finden Sie unter [Introduction to Azure Cosmos DB: Table API](table-introduction.md) (Einführung in Azure Cosmos DB: Tabellen-API). 
