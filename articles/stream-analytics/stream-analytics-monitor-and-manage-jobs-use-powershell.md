...
Ausführliche Informationen zu Struktur und Inhalten von JSON-Dateien finden Sie im Abschnitt [Create Input (Azure Stream Analytics) (Eingabe Erstellen (Azure Stream Analytics)][msdn-rest-api-create-stream-analytics-input] der Bibliothek [Stream Analytics-REST-API][stream.analytics.rest.api.reference].
