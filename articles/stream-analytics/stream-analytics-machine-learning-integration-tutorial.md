---
title: Stimmungsanalysen mit Azure Stream Analytics und Azure Machine Learning | Microsoft Docs
...
## <a name="upload-the-csv-input-file-to-blob-storage"></a>Hochladen der CSV-Eingabedatei in den Blobspeicher
...
1. Klicken Sie in Visual Studio auf **Azure**  >  **Speicher**  >  **Attach External Storage** (Externen Speicher anfügen). Geben Sie einen **Kontonamen** und einen **Kontoschlüssel** ein.  
...
3. Um die CSV-Datei hochzuladen, klicken Sie auf **Blob hochladen**, und klicken Sie dann auf **file from the local disk** (Datei vom lokalen Datenträger).  
...
2. Klicken Sie auf **Neu** > **Data Services** > **Stream Analytics** > **Schnellerfassung**. Geben Sie unter **Auftragsname** einen Namen für Ihren Auftrag ein, geben Sie unter **Region** eine geeignete Region für den Auftrag ein, und wählen Sie dann das Konto in **Speicherkonto für regionale Überwachung** aus.    
...
2. Klicken Sie im Dialogfeld **Abfrage starten** auf die Option **Benutzerdefinierte Uhrzeit**, und wählen Sie einen Zeitpunkt aus, der vor dem Zeitpunkt des Hochladens der CSV-Datei in den Blob Storage liegt. Klicken Sie auf **OK**.  
