...
3.  Klicken Sie auf **EVENT HUB** und anschließend auf die rechte Schaltfläche.
4.  Geben Sie die folgenden Werte auf der dritten Seite ein, oder wählen Sie sie aus:
    ...
    * **NAME DER EVENT HUB-RICHTLINIE**: Wählen Sie die Event Hub-Richtlinie aus, die Sie zuvor in diesem Tutorial erstellt haben.
...
6.  Geben Sie die folgenden Werte an:
    ...
    * **CODIERUNG**: UTF8
7.  Klicken Sie auf die Schaltfläche **PRÜFEN**, um diese Quelle hinzuzufügen und um zu überprüfen, ob Stream Analytics erfolgreich mit dem Event Hub verbunden werden kann.
...
2.  Fügen Sie dem Code-Editor Folgendes hinzu:
    ...
    > [AZURE.IMPORTANT] Stellen Sie sicher, dass der Name der Eingabequelle dem Namen der Eingabe entspricht, die Sie zuvor angegeben haben.
...
2.  Klicken Sie auf **BLOB STORAGE**und anschließend auf die rechte Schaltfläche.
...
2.  Wählen Sie im daraufhin angezeigten Dialogfeld **AUFTRAGSSTARTZEIT** aus, und klicken Sie dann auf die Schaltfläche **PRÜFEN** am unteren Rand des Dialogfelds. Der Status ändert sich in **Wird gestartet** und wechselt nach kurzer Zeit zu **Wird ausgeführt**.
