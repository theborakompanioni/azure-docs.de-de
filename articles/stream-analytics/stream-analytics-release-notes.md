...
| Anzeigen einer Vorschau von Ein-/Ausgabedaten für Blob-/Tabellenspeicher | Durch Doppelklicken auf eine Blob- oder Tabellenspeichereingabe/-ausgabe in einer Auftragsansicht können Sie einfach eine Vorschau der Daten in Visual Studio anzeigen. |
| Anzeigen von Fehlermeldungen für Ein-/Ausgaben | Laufzeitfehler im Zusammenhang mit den Ein- oder Ausgaben eines Auftrags werden im Auftragsdiagramm angezeigt. Dort können Sie darauf zeigen, um die ausführliche Fehlermeldung anzuzeigen.|
