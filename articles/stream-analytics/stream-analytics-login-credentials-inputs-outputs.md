...
![Grafik24][graphic24]
13. Geben Sie die folgende Abfrage ein, und ersetzen Sie <user_name> mit einem Namen, mit dem diese Anmeldung im Kontext der Datenbank identifiziert werden soll (Sie können z. B. den gleichen Wert wie für <login_name> eingeben). Ersetzen Sie anschließend <login_name> mit Ihrem neuen Benutzernamen:  
...
###SQL-Datenbank
1.	Wechseln Sie zurück zum Abfragefenster von Teil 1 Schritt 7, geben Sie die folgende Abfrage ein, und ersetzen Sie <previous_login_name> mit dem Benutzernamen, der zuvor für den Auftrag verwendet wurde:  
