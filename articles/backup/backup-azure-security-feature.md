...
1. Wenn der Computer, auf dem die Sicherungen durchgeführt wurden, noch verfügbar ist, verwenden Sie in MARS die [Wiederherstellung von Daten auf demselben Computer](backup-azure-restore-windows-server.md#recover-data-to-the-same-machine), um die Wiederherstellung mithilfe aller alten Wiederherstellungspunkte durchzuführen.
2. Wenn der obengenannte Computer nicht mehr verfügbar ist, verwenden Sie die [Wiederherstellung auf einem anderen Computer](backup-azure-restore-windows-server.md#recover-to-an-alternate-machine), um einen anderen MARS-Computer für die Wiederherstellung dieser Daten zu verwenden.
