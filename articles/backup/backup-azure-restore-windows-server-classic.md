<properties
   pageTitle="Wiederherstellen von Daten auf einem Windows-Server oder -Client von Azure unter Verwendung des klassischen Bereitstellungsmodells | Microsoft Azure"
