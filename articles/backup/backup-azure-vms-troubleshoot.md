...
Wenn die Sicherung oder Wiederherstellung sehr lange dauert (Sicherung > 12 Stunden, Wiederherstellung > 6 Stunden), stellen Sie sicher, dass Sie die [Bewährten Methoden für Sicherungen befolgen](backup-azure-vms-introduction.md#best-practices). Stellen Sie außerdem sicher, dass die Anwendungen [Azure Storage auf optimale Weise](backup-azure-vms-introduction.md#total-vm-backup-time) für Sicherungen verwenden. 
