...
## Sichern und Wiederherstellen virtueller Storage Premium-Computer
Der Azure Backup-Dienst dient jetzt auch zum Schutz virtueller Storage Premium-Computer.

### Sichern virtueller Storage Premium-Computer
...
> [!WARNING]
> Die Deduplizierung ist in Azure für keine der Azure Backup-Komponenten verfügbar! Wenn System Center DPM und Azure Backup Server in Azure bereitgestellt werden, können an die VM angefügte Speicherdatenträger nicht dedupliziert werden.
> 
> 
