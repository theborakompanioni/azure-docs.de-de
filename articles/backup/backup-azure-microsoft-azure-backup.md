...
description: "Bereiten Sie Ihre Umgebung für die Verwendung von Azure Backup Server vor, um Arbeitsauslastungen zu schützen und zu sichern."
services: backup
documentationcenter: 
author: PVRK
manager: shivamg
...
5. Wenn der Assistent für erste Schritte geöffnet wird, ist der Bildschirm „Sicherungsziele“ automatisch ausgewählt.
...
6. Wählen Sie die Workloads, die Sie mithilfe von Azure Backup Server schützen möchten, in *Welche Workloads möchten Sie schützen?* , und klicken Sie auf **OK**.
   ...
   > [!NOTE]
   > Wenn Sie nur Dateien und Ordner schützen möchten, sollten Sie den Azure Backup-Agent verwenden. Wenn Sie mehr Workloads als nur Dateien und Ordner schützen möchten, oder beabsichtigen, in Zukunft die Schutzanforderungen auszudehnen, wählen Sie alle diese Workloads.
   > 
   > 
