...
|SQL Server|SQL Server 2016|Physischer Server <br /><br /> Lokaler virtueller Hyper-V-Computer <br /> <br /> Virtueller Azure-Computer <br /><br /> Windows-VM in VMware (schützt Workloads auf virtuellen Windows-Computern in VMware)|J |N|Alle Bereitstellungsszenarien: Datenbank|
