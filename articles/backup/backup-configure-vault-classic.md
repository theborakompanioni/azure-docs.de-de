---
title: Sichern eines Windows-Servers oder -Clients in Azure mit dem klassischen Bereitstellungsmodell | Microsoft Docs
...
---
# <a name="back-up-a-windows-server-or-client-to-azure-using-the-classic-deployment-model"></a>Sichern eines Windows-Servers oder -Clients in Azure mit dem klassischen Bereitstellungsmodell
...
## <a name="step-1-create-a-backup-vault"></a>Schritt 1: Erstellen eines Sicherungstresors
...
### <a name="to-create-a-backup-vault"></a>Erstellen eines Sicherungstresors
1. Melden Sie sich beim [klassischen Portal](https://manage.windowsazure.com/)an.
2. Klicken Sie auf **Neu** > **Data Services** > **Recovery Services** > **Sicherungstresor**, und wählen Sie dann **Schnellerfassung** aus.
...
6. Wählen Sie die Speicherredundanzoption, indem Sie die hier beschriebenen Schritte ausführen.
   
   > [!IMPORTANT]
   > Der beste Zeitpunkt zum Identifizieren von Speicherredundanzoptionen ist unmittelbar nach der Erstellung des Tresors, bevor Computer beim Tresor registriert werden. Nachdem ein Element beim Tresor registriert wurde, wird die Speicherredundanzoption gesperrt und kann nicht mehr geändert werden.
   > 
   > 
...
## <a name="step-2-download-the-vault-credential-file"></a>Schritt 2: Herunterladen der Datei mit Tresoranmeldeinformationen
