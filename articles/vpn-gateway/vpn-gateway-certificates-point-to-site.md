---
title: "Erstellen selbstsignierter Zertifikate für standortübergreifende Punkt-zu-Standort-Verbindungen mit einem virtuellen Netzwerk mithilfe von „makecert“ | Microsoft Docs"
...
2. Nach der Installation finden Sie das Hilfsprogramm „makecert.exe“ im Pfad „C:\Programme (x86)\Windows Kits\10\bin\<arch>“. 
...
1. Um eine CER-Datei aus dem Zertifikat zu erhalten, öffnen Sie **certmgr.msc**. Klicken Sie mit der rechten Maustaste auf das selbstsignierte Stammzertifikat, klicken Sie auf **Alle Aufgaben** und dann auf **Exportieren**. Dadurch wird der **Zertifikatexport-Assistent**geöffnet.
...
1. Alle Zertifikate werden im Zertifikatspeicher „Zertifikate - Aktueller Benutzer\Eigene Zertifikate\Zertifikate“ auf Ihrem Computer gespeichert. Sie können mit diesem Verfahren bei Bedarf beliebig viele Clientzertifikate generieren.
