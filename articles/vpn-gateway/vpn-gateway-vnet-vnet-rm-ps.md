...
1. Deklarieren Sie Ihre Variablen.
...
3. Erstellen Sie eine neue Ressourcengruppe.
  ...
  ```
4. Erstellen Sie die Subnetzkonfigurationen für „TestVNet1“.
...
7. Erstellen Sie die Gatewaykonfiguration.
  ...
  ```
8. Erstellen Sie das Gateway für „TestVNet1“.
   
    In diesem Schritt erstellen Sie das virtuelle Netzwerkgateway für TestVNet1. VNet-zu-VNet-Konfigurationen erfordern einen routenbasierten VPN-Typ. Häufig kann die Erstellung eines Gateways je nach ausgewählter Gateway-SKU mindestens 45 Minuten dauern.
...
1. Rufen Sie die beiden virtuellen Netzwerkgateways ab.
  ...
  ```
2. Erstellen Sie die Verbindung zwischen „TestVNet1“ und „TestVNet4“.
  ...
  ```
3. Erstellen Sie die Verbindung zwischen „TestVNet4“ und „TestVNet1“.
...
1. Deklarieren Sie Ihre Variablen.
  ...
  ```
2. Stellen Sie eine Verbindung mit Abonnement 5 her.
...
1. **[Abonnement 1]** Rufen Sie das virtuelle Netzwerkgateway für Abonnement 1 ab.
  ...
  ```
2. **[Abonnement 5]** Rufen Sie das virtuelle Netzwerkgateway für Abonnement 5 ab.
  ...
  ```
3. **[Abonnement 1]** Erstellen Sie die Verbindung zwischen „TestVNet1“ und „TestVNet5“.
  ...
  ```
4. **[Abonnement 5]** Erstellen Sie die Verbindung zwischen „TestVNet5“ und „TestVNet1“.
