...
Dieser Artikel beschreibt die verschiedenen Methoden, wie Sie Ihren lokalen Standort mit virtuellen Azure-Netzwerken verbinden können. Dieser Artikel betrifft sowohl das Resource Manager-Bereitstellungsmodell als auch das klassische Bereitstellungsmodell. Diagramme zu VPN-Gatewayverbindungen finden Sie unter [Azure VPN Gateway-Verbindungstopologien](vpn-gateway-topology.md).
...
- Das VPN-Gerät, das Sie verwenden, muss mit dem Gatewaytyp kompatibel sein, der für Ihre Lösung erforderlich ist. Lesen Sie die Informationen unter [Informationen zu VPN-Gateways](vpn-gateway-about-vpngateways.md).
- Die Gateway-SKU wirkt sich auch auf den aggregierten Durchsatz aus. Weitere Informationen finden Sie unter [Gateway-SKUs](vpn-gateway-about-vpngateways.md#gwsku). 

**Verfügbare Bereitstellungsmodelle und -methoden für S2S**
...
**Verfügbare Bereitstellungsmodelle und -methoden für P2S**
...
- Weitere Informationen zu VPN Gateway finden Sie unter [Informationen zu VPN-Gateways](vpn-gateway-about-vpngateways.md), [Häufig gestellte Fragen zum VPN-Gateway](vpn-gateway-vpn-faq.md) und [Planung und Entwurf](vpn-gateway-plan-design.md).

- Weitere Informationen über ExpressRoute finden Sie unter [ExpressRoute – Technische Übersicht](../expressroute/expressroute-introduction.md), in den [häufig gestellten Fragen](../expressroute/expressroute-faqs.md) und unter [Workflows](../expressroute/expressroute-workflows.md).
