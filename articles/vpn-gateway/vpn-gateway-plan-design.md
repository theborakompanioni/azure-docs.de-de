...
### <a name="compare"></a>1. Vergleichen von standortübergreifender Konnektivität und virtuellen Computern
...
### <a name="gwrequire"></a>2. Berücksichtigen der Gatewayanforderungen nach VPN-Typ und SKU
...
### 3\. Gatewaytypen und aggregierte Durchsatzschätzungen
...
### 1\. Auswählen einer Verbindungstopologie

Lesen Sie zunächst den Artikel [Verbindungstopologien](vpn-gateway-topology.md). Der Artikel enthält grundlegende Diagramme, die Bereitstellungsmodelle für jede Topologie (Resource Manager oder klassisch) und Informationen dazu, welche Bereitstellungstools Sie für Ihre Konfiguration verwenden können.

### 2\. Erläuterungen der Entwurfsgrundlagen
...
### <a name="devices"></a>3. Auswählen eines VPN-Geräts für Standort-zu-Standort-Verbindungen
...
Sie müssen im Konfigurieren von VPN-Geräten erfahren sein, um eine Standort-zu-Standort-Konfiguration zu erstellen. Weitere Informationen zu VPN-Geräten finden Sie unter [Informationen zu VPN-Geräten](vpn-gateway-about-vpn-devices.md). Der Artikel zu VPN-Geräten enthält Informationen zu überprüften Geräten, Anforderungen an nicht überprüfte Geräte und Links zu den Dokumenten zur Gerätekonfiguration die einzelnen Geräte, sofern diese verfügbar sind.

### <a name="forcedtunnel"></a>4. Erwägen der Weiterleitung per Tunnelerzwingung
...
Diese Tabelle zeigt das Bereitstellungsmodell, für das die Tunnelerzwingung verfügbar ist, und die Bereitstellungstools, die Sie zum Konfigurieren der Tunnelerzwingung verwenden können. Falls ein Artikel verfügbar ist, ist dieser direkt verlinkt. Die Tabellen werden häufig aktualisiert, wenn neue Artikel verfügbar sind und von Ihnen genutzt werden können.
