...
[AZURE.INCLUDE [vpn-gateway-gwsku-include](../../includes/vpn-gateway-gwsku-include.md)] Richtlinienbasierte VPNs können nur für Gateways erstellt werden, die die Basic-SKU nutzen.
