...
## <a name="<a-name="declare"></a>part-1---log-in-and-set-variables"></a><a name="declare"></a>Teil 1 – Anmelden und Festlegen von Variablen
...
## <a name="part-2---configure-a-vnet"></a>Teil 2 – Konfigurieren eines VNET
...
## <a name="part-3---add-trusted-certificates"></a>Teil 3 – Hinzufügen vertrauenswürdiger Zertifikate
...
## <a name="part-4---create-the-vpn-gateway"></a>Teil 4 – Erstellen des VPN-Gateways
...
## <a name="part-5---download-the-vpn-client-configuration-package"></a>Teil 5 – Herunterladen des Konfigurationspakets für VPN-Clients
...
## <a name="<a-name="cc"></a>part-6---generate-the-client-certificate"></a><a name="cc"></a>Teil 6: Generieren des Clientzertifikats
...
## <a name="part-7---install-the-client-certificate"></a>Teil 7: Installieren des Clientzertifikats
...
## <a name="part-8---connect-to-azure"></a>Teil 8: Verbinden mit Azure
...
## <a name="part-9---verify-your-connection"></a>Teil 9: Überprüfen der Verbindung
...
## <a name="to-add-or-remove-a-trusted-root-certificate"></a>So können Sie ein vertrauenswürdiges Stammzertifikat hinzufügen oder entfernen
...
## <a name="to-manage-the-list-of-revoked-client-certificates"></a>Verwalten der Liste gesperrter Clientzertifikate
