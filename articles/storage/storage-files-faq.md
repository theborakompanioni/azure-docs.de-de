...
* **F: Wann empfiehlt sich die Verwendung von Azure File Storage (anstelle von Azure Blob Storage oder Azure Data Disks)?**  
    ...
    Weitere Informationen finden Sie unter [Entscheidung zwischen Azure-Blobs, Azure Files und Azure-Datenträger](storage-decide-blobs-files-disks.md).
...
* **F: Wie kann ich Azure File Storage verwenden?**  
    ...
    * [Erstellen einer Azure-Dateifreigabe über das Portal](storage-file-how-to-create-file-share.md#create-file-share-through-the-portal)
    * [Erstellen einer Azure-Dateifreigabe mithilfe von PowerShell](storage-file-how-to-create-file-share.md#create-file-share-through-powershell)
    * [Erstellen einer Azure-Dateifreigabe unter Verwendung der Befehlszeilenschnittstelle](storage-file-how-to-create-file-share.md#create-file-share-through-command-line-interface-cli)
...
* **F: Welche Skalierungsgrenzwerte gelten für Azure File Storage?**
    Informationen zu Skalierbarkeits- und Leistungszielen von Azure File Storage finden Sie unter [Skalierbarkeitsziele für Blobs, Warteschlangen, Tabellen und Dateien](storage-scalability-targets.md#scalability-targets-for-blobs-queues-tables-and-files).
...
* **F: Wie behandle ich Fehler von Azure File Storage?**
    ...
    Umfassende Unterstützung bei der Problembehandlung erhalten Sie im [Artikel zur Problembehandlung für Azure File Storage](storage-troubleshoot-file-connection-problems.md). 
...
* [Beheben von Problemen mit Azure File Storage](storage-troubleshoot-file-connection-problems.md)
