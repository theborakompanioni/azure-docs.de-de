...
Warum sollten Sie Ihre eigenen Schlüssel erstellen? Weil es Ihnen mehr Flexibilität bietet. Außerdem haben Sie so die Möglichkeit, Zugriffsteuerungen zu erstellen, zu rotieren, zu deaktivieren und zu definieren sowie die zum Schutz Ihrer Daten verwendeten Verschlüsselungsschlüssel zu überwachen.
...
Weitere Informationen erhalten Sie in den [FAQ](#frequently-asked-questions-about-storage-service-encryption-for-data-at-rest).
...
Sie können die SSE über das [Azure-Portal](https://portal.azure.com) für das Speicherkonto aktivieren. Suchen Sie auf dem Blatt „Einstellungen“ für das Speicherkonto nach dem Abschnitt „Blob-Dienst“, wie in der Abbildung unten gezeigt, und klicken Sie auf „Verschlüsselung“.
...
Wenn Sie auf diesem Bildschirm das Kontrollkästchen „Eigenen Schlüssel verwenden“ nicht angezeigt wird, wurden Sie nicht für die Vorschau zugelassen. Senden Sie eine E-Mail an [ssediscussions@microsoft.com](mailto:ssediscussions@microsoft.com), um eine Genehmigung anzufordern.
...
Wenn Sie Daten in das neue Speicherkonto übertragen möchten, damit sie verschlüsselt werden, lesen Sie [Schritt 3: Kopieren von Daten in das Speicherkonto](https://docs.microsoft.com/en-us/azure/storage/storage-service-encryption#step-3-copy-data-to-storage-account) im Artikel „Azure-Speicherdienstverschlüsselung für ruhende Daten“.

## <a name="step-5-query-the-status-of-the-encrypted-data"></a>Schritt 5: Abfragen des Status der verschlüsselten Daten
Informationen zum Abfragen des Status der verschlüsselten Daten finden Sie im Abschnitt [Schritt 4: Abfragen des Status der verschlüsselten Daten](https://docs.microsoft.com/en-us/azure/storage/storage-service-encryption#step-4-query-the-status-of-the-encrypted-data) im Artikel „Azure-Speicherdienstverschlüsselung für ruhende Daten“.
...
A: SSE ist nur in bestimmten Regionen für Blob Storage für diese Vorschau verfügbar. Senden Sie eine E-Mail an [ssediscussions@microsoft.com](mailto:ssediscussions@microsoft.com), um Informationen über Verfügbarkeit und Details zur Vorschauversion einzuholen. 
...
*   Weitere Informationen zu allen Sicherheitsfunktionen, die Entwicklern beim Erstellen sicherer Anwendungen unterstützen, finden Sie im [Azure Storage-Sicherheitsleitfaden](https://docs.microsoft.com/en-us/azure/storage/storage-security-guide).
