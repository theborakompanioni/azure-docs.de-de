...
3.  [Erstellen Sie dann eine Momentaufnahme eines Blobs](storage-blob-snapshots.md) für alle Datenträger.
...
Informationen zum effizienten Kopieren Ihrer inkrementellen Momentaufnahmen für die Notfallwiederherstellung finden Sie in der Anleitung zum [Sichern nicht verwalteter Azure-VM-Datenträger mithilfe inkrementeller Momentaufnahmen](storage-incremental-snapshots.md).
