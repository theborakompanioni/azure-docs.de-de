...
Weitere Informationen zu Datenträgern finden Sie in den Artikeln [Informationen zu Datenträgern und VHDs für Azure-Linux-VMs](storage-about-disks-and-vhds-linux.md) und [Anfügen eines Datenträgers an einen virtuellen Windows-Computer, der mit dem klassischen Bereitstellungsmodell erstellt wurde](../virtual-machines/windows/classic/attach-disk.md).
