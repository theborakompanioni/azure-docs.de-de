...
title: "Vorbereiten von Festplatten für einen Importauftrag | Microsoft-Dokumentation"
description: "Erfahren Sie, wie Sie eine oder mehrere Festplatten für einen Importauftrag für den Microsoft Azure Import/Export-Dienst vorbereiten"
author: muralikk
manager: syadav
editor: tysonn
services: storage
...
##  <a name="a-nameprepareharddrivesidentifythedatatobeimporteda-identify-the-data-to-be-imported"></a><a name="PrepareHardDrives_IdentifytheDatatoBeImported"></a> Identifizieren der zu importierenden Daten
...
>
>  Gegenwärtig hat das Import/Export-Tool von Microsoft Azure folgende Einschränkung: Wenn ein Verzeichnis mehr Daten enthält, als eine Festplatte aufnehmen kann, muss das Verzeichnis in kleinere Verzeichnisse unterteilt werden. Wenn ein Verzeichnis z.B. 2,5TB Daten enthält, und die Kapazität der Festplatte nur 2TB beträgt, müssen Sie das 2,5TB große Verzeichnis in kleinere Verzeichnisse unterteilen. Diese Einschränkung wird in zukünftigen Versionen des Tools behoben werden.

##  <a name="a-nameprepareharddrivesidentifythedestinationlocationsintheblobservicea-identify-the-destination-locations-in-the-blob-service"></a><a name="PrepareHardDrives_IdentifytheDestinationLocationsintheBlobService"></a> Ermitteln der Zielverzeichnisse im Blob-Dienst
...
##  <a name="a-nameprepareharddrivesdeterminehowmanydrivesareneededa-determine-how-many-drives-are-needed"></a><a name="PrepareHardDrives_DetermineHowManyDrivesAreNeeded"></a> Bestimmen der Anzahl benötigter Laufwerke
...
##  <a name="a-nameprepareharddrivescopydatatoasingleharddrivea-copy-data-to-your-hard-drive"></a><a name="PrepareHardDrives_CopyDatatoaSingleHardDrive"></a> Kopieren von Daten auf Ihre Festplatte
...
> [!NOTE]
>  Wenn Sie über mehrere Computer verfügen, die die in [Setting Up the Azure Import-Export Tool](storage-import-export-tool-setup-v1.md) (Einrichten des Azure Import/Export-Tools) beschriebenen Anforderungen erfüllen, können Sie Daten parallel auf mehrere Festplatten kopieren, indem Sie eine Instanz dieses Tools auf jedem Computer ausführen.
...
### <a name="azure-importexport-tool-syntax-for-an-import-job"></a>Azure Import/Export-Tool-Syntax für einen Importauftrag
 Um Laufwerke für einen Importauftrag vorzubereiten, rufen Sie das Azure Import/Export-Tool mit dem **PrepImport**-Befehl auf. Welche Parameter Sie verwenden, hängt davon ab, ob dies die erste oder eine nachfolgende Kopiersitzung ist.
...
|**/PropertyFile:**<Eigenschaftendatei\>|`Optional.` Pfad zur Eigenschaftendatei für die Zielblobs. Weitere Informationen finden Sie unter [Import-Export Service Metadata and Properties File Format (Import/Export-Dienst: Format der Metadaten- und Eigenschaftendatei)](storage-import-export-file-format-metadata-and-properties.md).|
|**/MetadataFile:**<Metadatendatei\>|`Optional.` Pfad zur Metadatendatei für die Zielblobs. Weitere Informationen finden Sie unter [Import-Export Service Metadata and Properties File Format (Import/Export-Dienst: Format der Metadaten- und Eigenschaftendatei)](storage-import-export-file-format-metadata-and-properties.md).|
...
## <a name="see-also"></a>Weitere Informationen
 [Setting Up the Azure Import-Export Tool](storage-import-export-tool-setup-v1.md) (Einrichten des Azure Import/Export-Tools)
 [Setting Properties and Metadata during the Import Process](storage-import-export-tool-setting-properties-metadata-import-v1.md) (Festlegen von Eigenschaften und Metadaten während des Importvorgangs)
 [Sample Workflow to Prepare Hard Drives for an Import Job](storage-import-export-tool-sample-preparing-hard-drives-import-job-workflow-v1.md) (Beispiel-Workflow, um Festplatten für einen Importauftrag vorzubereiten)
 [Quick Reference for Frequently Used Commands](storage-import-export-tool-quick-reference-v1.md) (Kurzübersicht über häufig verwendete Befehle) 
 [Reviewing Job Status with Copy Log Files](storage-import-export-tool-reviewing-job-status-v1.md) (Überprüfen des Auftragsstatus mit Kopierprotokolldateien)
 [Repairing an Import Job](storage-import-export-tool-repairing-an-import-job-v1.md) (Reparieren eines Importauftrags)
 [Repairing an Export Job](storage-import-export-tool-repairing-an-export-job-v1.md) (Reparieren eines Exportauftrags)
 [Troubleshooting the Azure Import-Export Tool](storage-import-export-tool-troubleshooting-v1.md) (Problembehandlung beim Azure Import/Export-Tool)
