...
2. Klicken Sie auf **Verbinden** , um die Befehlszeile zum Bereitstellen der Dateifreigabe aus Windows abzurufen.
    ...
    >[AZURE.TIP] Klicken Sie zum Abrufen des Speicherkonto-Zugriffsschlüssels für die Bereitstellung auf die **Einstellungen** Ihres Speicherkontos und anschließend auf **Zugriffsschlüssel**.
...
### <a name="save-your-storage-account-credentials-to-the-app.config-file"></a>Speichern der Anmeldeinformationen Ihres Speicherkontos in der Datei „app.config“
