...
* [Erste Schritte mit dem Azure Blob-Dienst in Java](storage-java-how-to-use-blob-storage.md)
* [Erste Schritte mit dem Azure-Warteschlangendienst in Java](storage-java-how-to-use-queue-storage.md)
* [Erste Schritte mit dem Azure-Tabellenspeicherdienst in Java](storage-java-how-to-use-table-storage.md)
