...
1. **Navigieren Sie im Azure-Portal zum Blatt „Speicherkonto“:**    
    ![Blatt „Speicherkonto“](media/storage-file-how-to-create-file-share/create-file-share-portal1.png)

2. **Klicken Sie auf die Schaltfläche „Dateifreigabe hinzufügen“:**    
    ![Klicken Sie auf die Schaltfläche „Dateifreigabe hinzufügen“.](media/storage-file-how-to-create-file-share/create-file-share-portal2.png)

3. **Geben Sie einen Namen und ein Kontingent an. Das Kontingent kann derzeit auf maximal 5 TB festgelegt werden:**    
    ![Geben Sie einen Namen und das gewünschte Kontingent für die neue Dateifreigabe an.](media/storage-file-how-to-create-file-share/create-file-share-portal3.png)

4. **Zeigen Sie Ihre neuen Dateifreigabe an:** ![Zeigen Sie Ihre neuen Dateifreigabe an.](media/storage-file-how-to-create-file-share/create-file-share-portal4.png)

5. **Laden Sie eine Datei hoch:** ![Laden Sie eine Datei hoch.](media/storage-file-how-to-create-file-share/create-file-share-portal5.png)

6. **Navigieren Sie zu Ihrer Dateifreigabe, und verwalten Sie Ihre Verzeichnisse und Dateien:** ![Durchsuchen Sie die Dateifreigabe.](media/storage-file-how-to-create-file-share/create-file-share-portal6.png)
...
* [Einbinden einer Azure-Dateifreigabe und Zugreifen auf die Freigabe unter Windows](storage-file-how-to-use-files-windows.md)
* [Verwenden des Azure-Dateispeichers unter Linux](storage-how-to-use-files-linux.md)
* [Einbinden einer Azure-Dateifreigabe über SMB mit macOS](storage-file-how-to-use-files-mac.md)
