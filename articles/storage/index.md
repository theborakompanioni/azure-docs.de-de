            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p>Referenz zu Storage mit Verwendung der Azure-Befehlszeilenschnittstelle</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Java</h3>
                        <p>Storage in der Java-Referenz</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>.NET</h3>
                        <p>Verwaltete Referenz zur Storage-API</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <p>Speicherressourcenanbieter – REST-API-Referenz</p>
                    </div>
                </div>
            </div>
        </div>
