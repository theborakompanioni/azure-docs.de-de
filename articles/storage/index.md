        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Informationen zu Azure Storage</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Videobibliothek zu Azure Storage</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erste Schritte mit Storage</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erstellen eines Speicherkontos</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/cli/azure/storage">Azure-Befehlszeilenschnittstelle</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="https://msdn.microsoft.com/en-us/library/azure/mt684990.aspx">.NET: Datenverschiebung</a></p>
                        <p><a href="https://msdn.microsoft.com/library/azure/mt347887.aspx">.NET: Blobs, Warteschlangen, Tabellen und Dateien</a></p>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/storageservices/fileservices/azure-storage-services-rest-api-reference">Blobs, Warteschlangen, Tabellen und Dateien</a></p>
                        <p><a href="/rest/api/storagerp">Ressourcenanbieter</a></p>
                        <p><a href="/rest/api/storageimportexport">Import/Export</a></p>
                        <p><a href="/rest/api/storageservices/fileservices/azure-storage-services-rest-api-reference">Speicherdaten-REST-API</a></p>
                   </div>
                </div>
            </div>
        </div>
