...
### <a name="a-namesubheading1ascalability-targets"></a><a name="subheading1"></a>Skalierbarkeitsziele
...
### <a name="a-namesubheading47apartition-naming-convention"></a><a name="subheading47"></a>Partitionsbenennungskonvention
...
##### <a name="a-namesubheading3alink-quality"></a><a name="subheading3"></a>Verbindungsqualität
...
##### <a name="useful-resources"></a>Nützliche Ressourcen
Weitere Informationen zu Größen von virtuellen Computern und zur zugewiesenen Bandbreite finden Sie unter [Größen für virtuelle Computer in Azure (Windows)](../virtual-machines/virtual-machines-windows-sizes.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) oder [Größen für virtuelle Computer in Azure (Linux )](../virtual-machines/virtual-machines-linux-sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).  

#### <a name="a-namesubheading4alocation"></a><a name="subheading4"></a>Standort
...
### <a name="a-namesubheading5acontent-distribution"></a><a name="subheading5"></a>Inhaltsverteilung
...
#### <a name="a-namesubheading8auploading-data-in-batches"></a><a name="subheading8"></a>Hochladen von Daten in Batches
...
#### <a name="a-namesubheading9aincrease-default-connection-limit"></a><a name="subheading9"></a>Erhöhen des Standardverbindungslimits
...
#### <a name="a-namesubheading10aincrease-threadpool-min-threads-if-using-synchronous-code-with-async-tasks"></a><a name="subheading10"></a>Erhöhen der Mindestanzahl von ThreadPool-Threads bei Verwendung von synchronem Code mit asynchronen Aufgaben
...
#### <a name="a-namesubheading11atake-advantage-of-net-45-garbage-collection"></a><a name="subheading11"></a>Nutzung der .NET 4.5 Garbage Collection
...
### <a name="a-namesubheading12aunbounded-parallelism"></a><a name="subheading12"></a>Uneingeschränkte Parallelität
...
### <a name="a-namesubheading13astorage-client-libraries-and-tools"></a><a name="subheading13"></a>Speicherclientbibliotheken und Tools
...
#### <a name="a-namesubheading14athrottlingserverbusy"></a><a name="subheading14"></a>Drosselung/Server ausgelastet
...
#### <a name="a-namesubheading15anon-retryable-errors"></a><a name="subheading15"></a>Nicht wiederholbare Fehler
...
#### <a name="a-namesubheading46amultiple-clients-accessing-a-single-object-concurrently"></a><a name="subheading46"></a>Mehrere Clients greifen gleichzeitig auf ein einzelnes Objekt zu
...
#### <a name="a-namesubheading17acopy-blob"></a><a name="subheading17"></a>Kopieren von Blobs
...
#### <a name="a-namesubheading21auploading-one-large-blob-quickly"></a><a name="subheading21"></a>Schnelles Hochladen eines großen Blobs
...
#### <a name="a-namesubheading22auploading-many-blobs-quickly"></a><a name="subheading22"></a>Schnelles Hochladen von mehreren Blobs
...
### <a name="a-namesubheading23achoosing-the-correct-type-of-blob"></a><a name="subheading23"></a>Auswählen des richtigen Blobtyps
...
### <a name="a-namesubheading24atable-specific-scalability-targets"></a><a name="subheading24"></a>Tabellenspezifische Skalierbarkeitsziele
...
#### <a name="a-namesubheading26anagle-off"></a><a name="subheading26"></a>Deaktivieren von Nagle
...
##### <a name="a-namesubheading28aappend-only-and-prepend-only-patterns"></a><a name="subheading28"></a>Nur-Anhängen/Nur-Voranstellen-Muster
...
##### <a name="a-namesubheading29ahigh-traffic-data"></a><a name="subheading29"></a>Hoher Datenverkehr
...
##### <a name="a-namesubheading31aquery-density"></a><a name="subheading31"></a>Abfragedichte
...
###### <a name="a-namesubheading32afiltering"></a><a name="subheading32"></a>Filterung
...
##### <a name="a-namesubheading34adenormalization"></a><a name="subheading34"></a>Denormalisierung
...
##### <a name="a-namesubheading37astoring-data-series-in-a-single-entity"></a><a name="subheading37"></a>Speichern von Datenreihen in einer einzigen Entität
...
##### <a name="a-namesubheading38astoring-structured-data-in-blobs"></a><a name="subheading38"></a>Speichern strukturierter Daten in Blobs
...
### <a name="a-namesubheading39ascalability-limits"></a><a name="subheading39"></a>Skalierbarkeitsgrenze
...
### <a name="a-namesubheading40anagle-off"></a><a name="subheading40"></a>Deaktivieren von Nagle
...
### <a name="a-namesubheading41amessage-size"></a><a name="subheading41"></a>Nachrichtengröße
...
### <a name="a-namesubheading42abatch-retrieval"></a><a name="subheading42"></a>Batchabruf
...
### <a name="a-namesubheading43aqueue-polling-interval"></a><a name="subheading43"></a>Abrufintervall für die Warteschlange
...
Weitere Informationen finden Sie im Artikel [Ändern des Inhalts von Nachrichten in der Warteschlange](storage-dotnet-how-to-use-queues.md#change-the-contents-of-a-queued-message).  

### <a name="a-namesubheading45aapplication-architecture"></a><a name="subheading45"></a>Anwendungsarchitektur
