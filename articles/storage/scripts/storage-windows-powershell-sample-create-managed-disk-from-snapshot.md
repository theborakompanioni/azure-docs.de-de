...
[!code-powershell[main](../../../powershell_scripts/storage/create-managed-disk-from-snapshot/create-managed-disk-from-snapshot.ps1 "Verwaltete Datenträger aus Momentaufnahmen erstellen")]
...
[Erstellen eines virtuellen Computers aus einem verwalteten Datenträger](./../../virtual-machines/scripts/virtual-machines-windows-powershell-sample-create-vm-from-managed-os-disks.md?toc=%2fpowershell%2fmodule%2ftoc.json)
