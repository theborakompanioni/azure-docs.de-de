...
* Weitere Informationen zum Arbeiten mit Datenträger-Momentaufnahmen für virtuelle Computer (VMs) finden Sie in [Sichern nicht verwalteter Azure-VM-Datenträger mithilfe inkrementeller Momentaufnahmen](storage-incremental-snapshots.md)
