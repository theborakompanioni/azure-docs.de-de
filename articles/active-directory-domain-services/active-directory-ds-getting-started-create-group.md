...
> [!NOTE]
> [**Try the new (preview) Azure portal experience instead (Verwenden Sie stattdessen die neue Azure-Portal-Benutzeroberfläche (Vorschauversion))**](active-directory-ds-getting-started.md). 
>
