<properties
	pageTitle="Azure Active Directory Domain Services: Leitfaden zur Problembehandlung | Microsoft Azure"
...
# Azure AD Domain Services – Leitfaden zur Problembehandlung
...
### Sie können die Azure AD Domain Services für Ihr Azure AD-Verzeichnis nicht aktivieren
...
### Benutzer können sich nicht bei der verwalteten Domäne der Azure AD Domain Services anmelden
...
> [AZURE.NOTE] Es wird empfohlen, das UPN-Format zu verwenden, um sich bei der verwalteten Azure AD Domain Services-Domäne anzumelden.
...
- **Überlanges UPN-Präfix**: Stellen Sie sicher, dass das UPN-Präfix (d.h. der erste Teil des Benutzerprinzipalnamens) des betroffenen Benutzerkontos im Azure AD-Mandanten weniger als 20 Zeichen lang ist. Beispielsweise umfasst das Präfix beim UPN „joereallylongnameuser@contoso.com“ („joereallylongnameuser“) mehr als 20 Zeichen und steht in der verwalteten Domäne nicht zur Verfügung.

- **Doppeltes UPN-Präfix**: Stellen Sie sicher, dass in Ihrem Azure AD-Mandanten keine Benutzerkonten vorhanden sind, die dasselbe UPN-Präfix (d.h. der erste Teil des Benutzerprinzipalnamens) wie das betroffene Benutzerkonto verwenden. Wenn beispielsweise die Benutzerkonten „joeuser@finance.contoso.com“ und „joeuser@engineering.contoso.com“ vorhanden sind, kommt es für beide Benutzern bei der Anmeldung bei der verwalteten Domäne zu Fehlern. Dies kann auch passieren, wenn es sich bei einem der Benutzerkonten um ein externes Konto handelt (z.B. „joeuser@live.com“). Wir arbeiten an der Behebung dieses Problems.
