---
title: 'Azure AD-Domänendienste: Netzwerkrichtlinien | Microsoft Docs'
...
> [!NOTE]
> **Stellen Sie Azure AD-Domänendienste in einem separaten dedizierten Subnetz in Ihrem virtuellen Azure-Netzwerk bereit. Wenden Sie die NSG nicht auf dieses dedizierte Subnetz an. Aktivieren Sie Azure AD-Domänendienste nicht im Gatewaysubnetz Ihres virtuellen Netzwerks.**
> 
> 
