...
Sie haben nun Azure AD-Domänendienste für Ihr Verzeichnis erfolgreich aktiviert und müssen in der nächsten Aufgabe sicherstellen, dass Computer innerhalb des virtuellen Netzwerks eine Verbindung mit diesen Diensten herstellen und die Dienste nutzen können. Zu diesem Zweck müssen Sie die DNS-Servereinstellungen für Ihr virtuelles Netzwerk so aktualisieren, dass sie auf die IP-Adressen verweisen, unter denen Azure Active Directory-Domänendienste auf dem virtuellen Netzwerk verfügbar sind.
