...
### PowerShell
Stellen Sie sicher, dass Azure PowerShell 1.01 oder höher auf einem Windows-Computer installiert ist und dass für Ihr [Azure AD-Konto](active-directory/active-directory-how-subscriptions-associated-directory.md) (auch als Geschäfts-, Schul- oder Unikonto bezeichnet) eine Verbindung mit Ihrem Abonnement besteht. Ausführliche Informationen hierzu finden Sie im Artikel [Gewusst wie: Installieren und Konfigurieren von Azure PowerShell](powershell-install-configure.md). Geben Sie an einer PowerShell-Eingabeaufforderung den folgenden Befehl ein, um die Ressourcengruppe für die Entwicklungsumgebung zu erstellen.
