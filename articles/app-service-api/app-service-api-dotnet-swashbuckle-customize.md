...
---
title: Anpassen von mit Swashbuckle generierten API-Definitionen
...
---
# <a name="customize-swashbuckle-generated-api-definitions"></a>Anpassen von mit Swashbuckle generierten API-Definitionen
...
## <a name="customize-operation-identifier-generation"></a>Anpassen der Generierung von Vorgangs-IDs
...
## <a name="allow-response-codes-other-than-200"></a>Zulassen anderer Antwortcodes als "200"
...
### <a name="customize-expected-response-codes-using-xml-comments"></a>Anpassen der erwarteten Antwortcodes mithilfe von XML-Kommentaren
...
2. Fügen Sie Anweisungen in der Datei *SwaggerConfig.cs* hinzu, um Swashbuckle anzuweisen, die XML-Dokumentationsdatei zu verwenden.
   
   * Öffnen Sie die Datei *SwaggerConfig.cs*, und erstellen Sie eine Methode für die *SwaggerConfig*-Klasse, um den Pfad zur XML-Dokumentationsdatei anzugeben. 
...
3. Um die XML-Dokumentationsdatei zu generieren, wechseln Sie in die Eigenschaften des Projekts, und aktivieren Sie die XML-Dokumentationsdatei entsprechend den Vorgaben im folgenden Screenshot. 
...
### <a name="customize-expected-response-codes-using-the-swaggerresponse-attribute"></a>Anpassen der erwarteten Antwortcodes mit dem SwaggerResponse-Attribut
...
2. Klicken Sie neben dem NuGet-Paket *Swashbuckle* auf die Schaltfläche *Aktualisieren*. 
   
    ![](./media/app-service-api-dotnet-swashbuckle-customize/update-nuget-dialog.png)
3. Fügen Sie den Web-API-Aktionsmethoden, für die Sie gültige HTTP-Antwortcodes angeben möchten, die *SwaggerResponse* -Attribute hinzu. 
...
4. Fügen Sie eine `using` -Anweisung für den Namespace des Attributs hinzu:
   
        using Swashbuckle.Swagger.Annotations;
5. Navigieren Sie zu der URL */swagger/docs/v1* des Projekts. Die verschiedenen HTTP-Antwortcodes werden nun im Swagger-JSON-Format angezeigt. 
