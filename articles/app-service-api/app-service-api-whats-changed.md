---
title: "App Service-API-Apps – Änderungen | Microsoft-Dokumentation"
...
---
# <a name="app-service-api-apps---whats-changed"></a>App Service-API-Apps – Änderungen
...
### <a name="cors"></a>CORS
Anstelle einer kommagetrennten **MS_CrossDomainOrigins**-App-Einstellung enthält das Azure-Verwaltungsportal jetzt ein Blatt zum Konfigurieren von CORS (Cross-Origin Resource Sharing). Alternativ dazu kann die Konfiguration auch mit den Resource Manager-Tools durchgeführt werden, wie z.B. Azure PowerShell, Befehlszeilenschnittstelle (CLI) oder [Ressourcen-Explorer](https://resources.azure.com/). Legen Sie die **cors**-Eigenschaft für Ihre Ressource **&lt;Websitename&gt;/web** auf den Ressourcentyp **Microsoft.Web/sites/config** fest. Beispiel:
...
1. Erstellen Sie eine leere API-App. Hierfür können Sie im Portal die Option „Neu“ > „API-App“, in Visual Studio die Veröffentlichungsfunktion oder die Ressourcen-Manager-Tools verwenden. Legen Sie beim Verwenden der Resource Manager-Tools oder -Vorlagen den Wert **kind** für den Ressourcentyp **Microsoft.Web/sites** auf **api** fest, damit die Schnellstarts und Einstellungen im Verwaltungsportal auf API-Szenarien ausgerichtet sind.
...
Das neue API-App-Modell eignet sich gut für die Verwendung mit der [Logik-Apps-Schemaversion 2015-08-01](../logic-apps/logic-apps-schema-2015-08-01.md).
