...
Dieser Artikel enthält eine Übersicht über die Datenintegration zwischen lokalen Datenspeichern und Clouddatenspeichern sowie der Cloudverarbeitung mit Data Factory. Er baut auf dem Artikel [Datenverschiebungsaktivitäten](data-factory-data-movement-activities.md) und anderen Artikeln über zentrale Konzepte von Data Factory auf. Es wird davon ausgegangen, dass Sie mit Data Factory-Konzepten wie Pipelines, Aktivitäten, Datasets und der Kopieraktivität vertraut sind.

## Funktionsweise von Azure Data Factory mit dem Datenverwaltungsgateway 
Wie wäre es, wenn Sie Daten nahtlos zwischen dem lokalen Speicher und der Cloud verschieben könnten? Mit Azure Data Factory – einem lokal installierten Agent – erhalten Sie die benötigten Datengateway-Verwaltungsfunktionen, z.B. eine Anwendung zum Festlegen von Gatewayanmeldeinformationen.

## Funktionsweise des Datengateways
...
1.	Die unterstützten **Betriebssystemversionen** sind Windows 7, Windows 8/8.1, Windows 10, Windows Server 2008 R2, Windows Server 2012 und Windows Server 2012 R2. Die Installation des Datenverwaltungsgateways auf einem Domänencontroller wird derzeit nicht unterstützt.
...
3. Klicken Sie auf dem Blatt **Konfigurieren** auf **Direkt auf diesem Computer installieren**. Daraufhin wird das Installationspaket für das Gateway heruntergeladen, installiert, konfiguriert und das Gateway auf dem Computer registriert.
	...
	> 
	> Navigieren Sie bei Verwendung von Chrome zum [Chrome Web Store](https://chrome.google.com/webstore/), und führen Sie eine Suche mit dem Schlüsselwort „ClickOnce“ durch. Wählen Sie eine der ClickOnce-Erweiterungen aus, und installieren Sie diese.
	>  
...
5. Klicken Sie in der Befehlsleiste auf **Verschlüsseln**, um die ClickOnce-Anwendung **Anmeldeinformationsverwaltung** zu starten. Das Dialogfeld **Anmeldeinformationen festlegen** wird angezeigt. ![Dialogfeld "Anmeldeinformationen festlegen"](./media/data-factory-move-data-between-onprem-and-cloud/setting-credentials-dialog.png)
