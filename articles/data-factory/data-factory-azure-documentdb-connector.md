...
| connectionString |Geben Sie die zum Verbinden mit der Azure Cosmos DB-Datenbank erforderlichen Informationen ein. |Ja |
...
1. **Frage:**
    ...
    **Antwort:**
    Nein.
2. **Frage:**
    Wie wird bei einer Wiederholung eines Kopiervorgangs nach Azure Cosmos DB mit bereits kopierten Datensätzen umgegangen?
...
3. **Frage:**
    Unterstützt Data Factory die [bereichs- oder hashbasierte Datenpartitionierung](../documentdb/documentdb-partition-data.md)?

    **Antwort:**
    Nein.
4. **Frage:**
    Können mehrere Azure Cosmos DB-Sammlungen für eine Tabelle angegeben werden?
