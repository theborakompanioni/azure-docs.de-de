<properties 
	pageTitle="Verschieben von Daten aus Amazon Redshift mit Data Factory | Microsoft Azure" 
...
# Verschieben von Daten mithilfe von Azure Data Factory
...
## Beispiel: Kopieren von Daten aus Amazon Redshift in ein Azure-Blob
In diesem Beispiel wird gezeigt, wie Sie Daten aus Amazon Redshift in einen Azure-Blobspeicher kopieren. Daten können jedoch mithilfe der Kopieraktivität in Azure Data Factory **direkt** in die [hier](data-factory-data-movement-activities.md#supported-data-stores) aufgeführten Senken kopiert werden.
...
### Typzuordnung für Amazon Redshift
