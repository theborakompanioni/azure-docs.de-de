...
---
# <a name="monitor-and-manage-azure-data-factory-pipelines-using-new-monitoring-and-management-app"></a>Überwachen und Verwalten von Azure Data Factory-Pipelines mit der neuen App „Überwachung und Verwaltung“
...
## <a name="launching-the-monitoring-and-management-app-a"></a>Starten der App „Überwachung und Verwaltung“
...
> [!NOTE]
> Wenn Sie feststellen, dass der Webbrowser bei der Autorisierung hängen bleibt, deaktivieren Sie die Einstellung **Cookies und Websitedaten von Drittanbietern blockieren**. Lassen Sie die Einstellung alternativ aktiviert, und erstellen Sie eine Ausnahme für **login.microsoftonline.com**. Versuchen Sie anschließend erneut, die App zu starten.
> 
> 
...
## <a name="understanding-the-monitoring-and-management-app"></a>Grundlegendes zur App „Überwachung und Verwaltung“
...
* **Aktivitätsfenstern** unten im mittleren Bereich.
* **Eigenschaften**/**Aktivitätsfenster-Explorer** im rechten Bereich. 
...
## <a name="sorting-and-filtering-activity-windows"></a>Sortieren und Filtern von Aktivitätsfenstern
...
## <a name="creating-alerts"></a>Erstellen von Warnungen
...
2. Geben Sie den **Namen** und eine **Beschreibung** für die Warnung an, und klicken Sie auf **Weiter**. Daraufhin sollte die Seite **Filter** angezeigt werden.
...
4. Wählen Sie **E-Mail-Abonnementadministratoren** aus, und/oder füllen Sie **E-Mail an weiteren Administrator** aus, und klicken Sie auf **Fertig stellen**. Sie sollten die Warnung in der Liste sehen. 
...
### <a name="to-editdeletedisable-an-alert"></a>So bearbeiten, löschen oder deaktivieren Sie eine Warnung
