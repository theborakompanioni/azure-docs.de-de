...
- Klicken Sie oben auf den Link [Data Factory-Editor verwenden](data-factory-copy-activity-tutorial-using-azure-portal.md), um das Lernprogramm mithilfe des Data Factory-Editors auszuführen, der Teil des Azure-Portals ist.
- Klicken Sie oben auf den Link [PowerShell verwenden](data-factory-copy-activity-tutorial-using-powershell.md), um das Lernprogramm mit Azure PowerShell auszuführen.
- Klicken Sie oben auf den Link [Mit Visual Studio](data-factory-copy-activity-tutorial-using-visual-studio.md), um das Lernprogramm mit Visual Studio 2013 auszuführen.
