<properties 
    pageTitle="Tutorial: Erstellen einer Pipeline mit dem Kopier-Assistenten | Microsoft Azure" 
...
3. Führen Sie unter „Ressourcengruppe“ einen der folgenden Schritte aus: 1. Wählen Sie **Use existing** (Vorhandene verwenden), um eine vorhandene Ressourcengruppe auszuwählen.
...
12. Klicken Sie auf der Seite **Bereitstellung** auf diesen Link: `Click here to monitor copy pipeline`.
