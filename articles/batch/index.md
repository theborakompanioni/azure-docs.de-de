...
---
#<a name="batch-documentation"></a>Batchdokumentation

Hier erfahren Sie, wie Sie mithilfe von Batch effizient umfangreiche parallele und leistungsfähige Anwendungen in der Cloud ausführen. Anhand von Tutorials, API-Referenzen und anderem Dokumentationsmaterial wird gezeigt, wie Sie ohne manuelle Konfiguration oder Verwaltung der Infrastruktur die Azure-Computeressourcen für die parallele oder skalierte Ausführung Ihrer Anwendung definieren.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erste Schritte mit Batch</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erste Schritte mit Batch bei Verwendung von .NET</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erste Schritte mit Batch bei Verwendung von Python</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erste Schritte mit Batch bei Verwendung von Node.js</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/cli/azure/batch">Azure-Befehlszeilenschnittstelle</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/batchservice">REST-API-Referenz</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Batch</h3>
                        <p><a href="/azure/batch/batch-diagnostics">Diagnoseprotokolle für Batch</a></p>
                        <p><a href="/azure/batch/batch-analytics">Batch-Analyse</a></p>
                        <p><a href="/azure/batch/batch-compute-node-environment-variables">Umgebungsvariablen für Batch-Computeknoten</a></p>
                    </div>
                </div>
            </div>
        </div>
