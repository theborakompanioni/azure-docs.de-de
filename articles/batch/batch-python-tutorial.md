...
Zudem müssen Sie die **Azure Batch**- und **Azure Storage**-Python-Pakete installieren. Hierfür können Sie **pip** und die Datei *requirements.txt* verwenden, die Sie hier finden:
