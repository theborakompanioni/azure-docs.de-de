<properties
   ...
   description="Enthält Informationen zu Batch- und High Performance Computing-Szenarien (HPC und Big Compute) sowie Lösungsoptionen in Azure."
...
>[AZURE.NOTE] Azure führt regelmäßig neue Dienste ein, die für Ihr Szenario hilfreich sein können. Wenden Sie sich bei Fragen an einen [Azure-Partner](https://pinpoint.microsoft.com/en-US/search?keyword=azure), oder senden Sie eine E-Mail an *bigcompute@microsoft.com*.
...
* [Virtual Network](https://azure.microsoft.com/documentation/services/virtual-network/): Erstellt einen logisch isolierten Bereich in Azure, um eine Verbindung zwischen Azure-Ressourcen untereinander oder mit Ihrem lokalen Rechenzentrum herzustellen, und ermöglicht Big Compute-Anwendungen den Zugriff auf lokale Daten, Active Directory-Dienste und Lizenzserver.
