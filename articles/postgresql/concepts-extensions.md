...
Bevor Sie PostgreSQL-Erweiterungen verwenden können, müssen diese für Ihre Datenbank installiert werden. Um eine bestimmte Erweiterung zu installieren, führen Sie über das psql-Tool einen einfachen Befehl [ERWEITERUNG ERSTELLEN](https://www.postgresql.org/docs/9.6/static/sql-createextension.html) aus, um die gepackten Objekte in Ihrer Datenbank zu laden.

Azure-Datenbank für PostgreSQL unterstützt eine Teilmenge der wichtigsten Erweiterungen, die nachstehend aufgeführt werden. Nur diese können Sie für Ihre Datenbank installieren. Mit dem Azure-Datenbank für PostgreSQL-Dienst können keine eigenen Erweiterungen erstellt werden.
...
Im Folgenden wird eine Liste der standardmäßigen PostgreSQL-Erweiterungen aufgeführt, die derzeit von Azure-Datenbank für PostgreSQL unterstützt werden. Sie können diese Informationen auch abrufen, indem Sie pg\_available\_extensions abfragen. 
...
| address\_standardizer, address\_standardizer\_data\_us | Wird verwendet, um eine Adresse in dessen zugehörige Elemente zu analysieren. Wird allgemein als Unterstützung für den Normalisierungsschritt zur Geocodierung von Adressen verwendet. |
