...
> [!NOTE]
> Schneller starten! Verwenden Sie die [Komplettanleitung](http://support.microsoft.com/kb/2990804)für Azure. Mit dieser Anleitung wird das Zuordnen eines benutzerdefinierten Domänennamens zu Azure-Clouddiensten und Azure-Websites sowie das Absichern der Kommunikation mittels SSL zum Kinderspiel.
> 
> 
...
Ein A-Eintrag weist eine Domäne wie **contoso.com** oder **www.contoso.com** *oder eine Domäne mit Platzhalter* wie **\*.contoso.com** einer IP-Adresse zu. Im Falle eines Azure Cloud Service ist dies die virtuelle IP des Service. Der Vorteil eines A-Datensatzes gegenüber einem CNAME-Datensatz ist, dass Sie einen Eintrag mit einem Platzhalter verwenden können, beispielsweise \***.contoso.com**, der Anfragen für mehrere Unterdomänen verarbeiten kann, beispielsweise **mail.contoso.com**, **login.contoso.com** oder **www.contoso.com**.
...
1. Verwenden Sie eine dieser Methoden, um den **.cloudapp.net** -Domänennamen zu ermitteln, der Ihrem Clouddienst zugewiesen ist.
   ...
   * Melden Sie sich beim [klassischen Azure-Portal] an, und wählen Sie Ihren Clouddienst aus. Wählen Sie dann **Dashboard** aus, und navigieren Sie im Abschnitt **Auf einen Blick** zum Eintrag **Website-URL**.
     
       ![Der Abschnitt „Auf einen Blick“ zeigt die Website-URL.][csurl]
...
1. Verwenden Sie eine der folgenden Methoden, um die IP-Adresse Ihres Clouddiensts zu ermitteln.
   ...
   * Melden Sie sich beim [klassischen Azure-Portal] an, und wählen Sie Ihren Clouddienst aus. Wählen Sie dann **Dashboard** aus, und navigieren Sie im Abschnitt **Auf einen Blick** zum Eintrag **Öffentliche virtuelle IP-Adresse (VIP)**.
     
       ![Der Abschnitt „Auf einen Blick“ zeigt die VIP.][vip]
...
4. Wählen Sie die Domäne oder Unterdomäne aus, die diesen A-Datensatz verwenden wird, oder geben Sie diese ein. Wählen Sie beispielsweise **www**, wenn Sie einen Alias für **www.customdomain.com** erstellen möchten. Wenn Sie einen Platzhaltereintrag für alle Unterdomänen erstellen möchten, geben Sie „__*__“ ein. Dieser Eintrag deckt alle Unterdomänen wie **mail.customdomain.com**, **login.customdomain.com** und **www.customdomain.com** ab.
