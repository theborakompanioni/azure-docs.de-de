---
title: Einrichten eines Hybrid-HPC-Clusters mit Microsoft HPC Pack | Microsoft Docs
...
* Erstellen eines Azure-Speicherkontos
  ...
  > [!NOTE]
  > Notieren Sie auch Ihre Azure-Abonnement-ID, die Sie später noch brauchen werden. Sie finden sie im klassischen Portal unter **Einstellungen** > **Abonnements**.
  > 
  > 
