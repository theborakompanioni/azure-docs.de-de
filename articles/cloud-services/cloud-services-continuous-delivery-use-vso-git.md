---
title: Kontinuierliche Bereitstellung mit Git und Visual Studio Team Services in Azure | Microsoft Docs
...
---
# <a name="continuous-delivery-to-azure-using-visual-studio-team-services-and-git"></a>Continuous Delivery für Azure mithilfe von Visual Studio Team Services und Git
...
> [!NOTE]
> Für dieses Tutorial benötigen Sie ein Visual Studio Team Services-Konto. Dieses können Sie [kostenlos erstellen](http://go.microsoft.com/fwlink/p/?LinkId=512979).
> 
> 
...
## <a name="1-create-a-git-repository"></a>1: Erstellen eines Git-Repositorys
...
## <a name="2-create-a-project-and-commit-it-to-the-repository"></a>2: Erstellen eines Projekts und Übertragen an das Repository
...
3. Öffnen Sie das Kontextmenü für die Projektmappe, und klicken Sie auf **Commit**.
    ...
    ![][7]
4. Wenn Sie zum ersten Mal Git in Visual Studio Team Services verwenden, müssen Sie einige Informationen angeben, um sich in Git zu identifizieren. Geben Sie im Bereich **Ausstehende Änderungen** von **Team Explorer** Ihren Benutzernamen und Ihre E-Mail-Adresse an. Geben Sie einen Kommentar für den Commit ein, und klicken Sie dann auf die Schaltfläche **Commit** .
...
## <a name="3-connect-the-project-to-azure"></a>3: Verbinden des Projekts mit Azure
1. Nachdem Sie in Visual Studio Team Services ein Git-Repository mit Quellcode erstellt haben, können Sie Ihr Git-Repository mit Azure verknüpfen.  Wählen Sie im [klassischen Azure-Portal](http://go.microsoft.com/fwlink/?LinkID=213885) Ihren Clouddienst oder Ihre Web-App aus, oder erstellen Sie einen neuen Clouddienst oder eine neue Web-App, indem Sie auf das Plus-Symbol (+) links unten sowie auf **Cloud Service** oder **Web-App** und anschließend auf **Schnellerstellung** klicken.
   
    ![][9]
2. Wählen Sie für Clouddienste den Link **Veröffentlichung einrichten mit Visual Studio Team Services** aus. Für Web-Apps wählen Sie den Link **Bereitstellung über Quellcodeverwaltung einrichten** .
   
    ![][10]
3. Geben Sie in das Textfeld des Assistenten den Namen Ihres Visual Studio Team Services-Kontos ein, und wählen Sie den Link **Jetzt autorisieren** aus. Eventuell werden Sie aufgefordert, sich anzumelden.
   
    ![][11]
4. Klicken Sie im Popupdialogfeld **Verbindungsanforderung** auf **Übernehmen**, um Azure zum Konfigurieren Ihres Teamprojekts in Visual Studio Team Services zu autorisieren.
   
    ![][12]
5. Nach erfolgreicher Autorisierung wird eine Dropdownliste mit Ihren Visual Studio Team Services-Teamprojekten angezeigt.  Wählen Sie den Namen des Teamprojekts aus, das Sie in den vorherigen Schritten erstellt haben, und klicken Sie auf das Häkchen im Assistenten.
...
## <a name="4-trigger-a-rebuild-and-redeploy-your-project"></a>4: Auslösen einer erneuten Erstellung und Bereitstellung Ihres Projekts
...
8. Klicken Sie auf den Link **Builds** , um die derzeit ausgeführten Builds anzuzeigen.
    ...
    **Team Explorer** wird ersichtlich, dass für Ihren Eincheckvorgang ein Build ausgelöst wurde.
   
    ![][23]
9. Doppelklicken Sie auf den Namen des aktiven Builds, um ein detailliertes Protokoll des Buildverlaufs anzuzeigen.
10. Betrachten Sie während des Buildverlaufs die Builddefinition, die erstellt wurde, als Sie mit dem Assistenten eine Verknüpfung mit Azure eingerichtet haben.  Öffnen sie das Kontextmenü für die Builddefinition, und klicken Sie auf **Builddefinition bearbeiten**.
...
11. Auf der Registerkarte **Trigger** sehen Sie, dass die Builddefinition standardmäßig so festgelegt ist, dass bei jedem Einchecken ein Buildvorgang ausgeführt wird. (Für einen Clouddienst erstellt Visual Studio Team Services die Hauptverzweigung und stellt sie automatisch für die Stagingumgebung bereit.) Sie müssen für die Bereitstellung zur Live-Website weiterhin einen Schritt manuell durchführen. Für eine Web-App ohne Stagingumgebung wird die Hauptverzweigung direkt in der Live-Website bereitgestellt.
    ...
    ![][26]
12. Auf der Registerkarte **Prozess** ist zu sehen, dass die Bereitstellungsumgebung auf den Namen Ihres Clouddiensts oder Ihrer Web-App eingestellt ist.
...
14. An diesem Punkt sollte Ihr Build erfolgreich abgeschlossen sein.
    
     ![][28]
15. Wenn Sie auf den Buildnamen doppelklicken, zeigt Visual Studio eine **Buildzusammenfassung**mit allen Testergebnissen aus den zugeordneten Komponententestprojekten an.
    
     ![][29]
16. Im [klassischen Azure-Portal](http://go.microsoft.com/fwlink/?LinkID=213885)können Sie die entsprechende Bereitstellung auf der Registerkarte **Bereitstellungen** anzeigen, wenn die Stagingumgebung ausgewählt ist.
    
     ![][30]
17. Wechseln Sie zur URL Ihrer Site. Wählen Sie für eine Web-App im Portal die Schaltfläche **Durchsuchen**. Wenn es sich um einen Clouddienst handelt, wählen Sie die URL im Abschnitt **Auf einen Blick** der Seite **Dashboard**, auf der die Stagingumgebung angezeigt wird.
    
    Bereitstellungen aus einer fortlaufenden Integration für Clouddienste werden standardmäßig in der Stagingumgebung veröffentlicht. Sie können dies ändern, indem Sie für die Eigenschaft **Alternative Umgebung für den Clouddienst** die Option **Produktion** festlegen. Hier wird gezeigt, wo auf der Dashboard-Seite des Cloud-Diensts sich die Website-URL befindet.
    ...
    ![][32]
18. Wenn Sie weitere Änderungen an Ihrem Projekt vornehmen, lösen Sie weitere Builds aus und sammeln mehrere Bereitstellungen. Die letzte davon wird als „Aktiv“ markiert.
    
    ![][33]

## <a name="5-redeploy-an-earlier-build"></a>5: Erneute Bereitstellung eines früheren Builds
...
## <a name="6-change-the-production-deployment"></a>6: Ändern der Produktionsbereitstellung
...
## <a name="7-deploy-from-a-working-branch"></a>7: Bereitstellen von einer Arbeitsverzweigung aus.
...
7. Geben Sie die erstellte Verzweigung an, zum Beispiel refs/heads/working.
    ...
    ![][48]
8. Nehmen Sie eine Änderung am Code vor, öffnen Sie das Kontextmenü für die geänderte Datei, und wählen Sie **Commit**aus.
   
    ![][43]
9. Wählen Sie den Link **Unsynchronisierte Commits** und anschließend die Schaltfläche **Sync** oder den Link **Push** aus, um die Änderungen in die Arbeitsverzweigung in Visual Studio Team Services zu kopieren.
   
   ![][45]
10. Navigieren Sie zur Ansicht **Builds** und suchen Sie den Build, der für die Arbeitsverzweigung ausgelöst wurde.

## <a name="next-steps"></a>Nächste Schritte
Zusätzliche Tipps zur Verwendung von Git mit Visual Studio Team Services finden Sie unter [Entwickeln und Freigeben von Code in Git mit Visual Studio](https://www.visualstudio.com/en-us/docs/git/share-your-code-in-git-vs-2017). Informationen zur Verwendung eines nicht von Visual Studio Team Services verwalteten Git-Repositorys zur Veröffentlichung in Azure finden Sie unter [Kontinuierliche Bereitstellung in Azure App Service](../app-service-web/app-service-continuous-deployment.md). Weitere Informationen zu Visual Studio Team Services finden Sie unter [Visual Studio Team Services](http://go.microsoft.com/fwlink/?LinkId=253861).
