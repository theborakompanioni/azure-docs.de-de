...
## <a name="a-namebizopsaoperations-tracked-using-azure-management-services"></a><a name="bizops"></a>Vorgänge, die mit Azure-Verwaltungsdiensten nachverfolgt werden
