...
8. Aktualisieren der Datei „EDIBridge.config“ mit Konfigurationsdetails
   ...
   * Geben Sie unter *<behaviors>* den ACS-Namespace und den dem BizTalk Services-Abonnement zugeordneten Schlüssel an.
   * Geben Sie unter *<client>* den Endpunkt an, an dem der EDI-Sendevertrag bereitgestellt ist.
