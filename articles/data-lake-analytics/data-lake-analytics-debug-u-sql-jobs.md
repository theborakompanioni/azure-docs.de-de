...
#Debuggen von U-SQL-Aufträgen 

Erfahren Sie mehr über das Debuggen fehlerhafter U-SQL-Aufträge, die von Fehlern im Benutzercode verursacht werden, mithilfe der Visual Studio-Tools für Azure Data Lake. Die Visual Studio-Tools für Data Lake ermöglichen Benutzern das Herunterladen von kompiliertem Code und benötigter Vertexdaten aus dem Cluster, um fehlerhafte Aufträge nachzuverfolgen und zu debuggen.
...
Wenn in der U-SQL-CodeBehind-Datei (Script.usql.cs) benutzerdefinierte Operatoren verwendet werden, müssen Sie ein C#-Projekt mit einer Klassenbibliothek und dem Code der benutzerdefinierten Operatoren erstellen und das Projekt der Projektmappe „VertexDebug“ hinzufügen. Wenn es DLL-Assemblys gibt, die bei Ihrer Data Lake Analytics-Datenbank registriert sind, müssen Sie den Quellcode der Assemblys der Projektmappe „VertexDebug“ hinzufügen.
 

**So konfigurieren Sie das Projekt**

1.	Klicken Sie im Projektmappen-Explorer mit der rechten Maustaste auf **LocalVertexHost**, und klicken Sie dann auf **Eigenschaften**.
