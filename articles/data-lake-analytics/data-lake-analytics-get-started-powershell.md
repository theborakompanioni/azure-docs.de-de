...
description: 'Erfahren Sie, wie Sie die Azure PowerShell zum Erstellen eines Data Lake Analytics-Kontos, Erstellen eines Data Lake Analytics-Auftrags mit U-SQL und Senden des Auftrags verwenden. '
...
* **Eine Arbeitsstation mit Azure PowerShell**. Weitere Informationen finden Sie unter [Installieren und Konfigurieren von Azure PowerShell](/powershell/azureps-cmdlets-docs).
...
## <a name="upload-data-to-data-lake"></a>Hochladen von Daten in Data Lake
...
> [!NOTE]
> Das Azure-Portal bietet eine Benutzeroberfläche zum Kopieren der Beispieldatendateien in das Data Lake-Standardspeicherkonto. Anweisungen finden Sie unter [Erste Schritte mit Azure Data Lake Analytics mithilfe des Azure-Portals](data-lake-analytics-get-started-portal.md#prepare-source-data).
>
>
