...
> [!TIP]
> In der [exemplarischen Vorgehensweise für Kubernetes](../kubernetes/container-service-kubernetes-walkthrough.md) erfahren Sie, wie Sie `az acs create` mit Standardwerten verwenden, um einen Kubernetes.-Cluster zu erstellen.
>
