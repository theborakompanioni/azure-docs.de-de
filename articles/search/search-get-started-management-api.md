...
[Azure Search – Entwicklungsworkflow]: search-workflow.md
[Erstellen Ihrer ersten Azure Search-Lösung]: search-create-first-solution.md
[Erstellen einer geografischen Suchanwendung mit Azure Search]: search-create-geospatial.md
