---
title: Verwenden von Bewertungsprofilen in Azure Search | Microsoft Docs
...
---
# <a name="how-to-use-scoring-profiles-in-azure-search"></a>Verwenden von Bewertungsprofilen in Azure Search
...
Sie benötigen ein Azure-Abonnement und einen Azure Search-Dienst zum Abschließen dieses Lernprogramms. Hilfe beim Einrichten des Diensts finden Sie unter [Erstellen eines Search-Diensts im Portal](search-create-service-portal.md) .
 ...
 [Sie benötigen ein Microsoft Azure-Konto, um dieses Tutorial durchführen zu können:](../../includes/free-trial-note.md)]
...
2. Doppelklicken Sie im Projektmappen-Explorer auf **app.config**. Diese Datei gibt den Dienstendpunkt und einen `api-key` an, die zur Authentifizierung der Anforderung verwendet werden. Diese Werte erhalten Sie im klassischen Portal.
3. Melden Sie sich beim [Azure-Portal](https://portal.azure.com)an.
4. Rufen Sie das Dienst-Dashboard für Azure Search auf.
5. Klicken Sie auf die Kachel **Eigenschaften** , um die Dienst-URL zu kopieren.
6. Klicken Sie auf die Kachel **Schlüssel**, um den `api-key` zu kopieren.
