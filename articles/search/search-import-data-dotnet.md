...
In diesem Artikel erfahren Sie, wie Sie das [Azure Search .NET SDK](https://aka.ms/search-sdk) zum Importieren von Daten in einen Azure Search-Index verwenden.
