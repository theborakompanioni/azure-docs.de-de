---
title: "Azure Search-Fallstudie für Entwickler: So hat WhatToPedia mit Microsoft Azure ein Infomedia-Portal erstellt | Microsoft Docs"
...
---
# <a name="azure-search-developer-case-study"></a>Azure Search-Fallstudie für Entwickler
## <a name="how-whattopediacomhttpwhattopediacom-built-an-infomedia-portal-on-microsoft-azure"></a>So hat [WhatToPedia.com](http://whattopedia.com/) mit Microsoft Azure ein Infomedia-Portal erstellt
...
## <a name="what-we-built"></a>Das haben wir erstellt
...
## <a name="how-we-did-it"></a>So sind wir vorgegangen
...
### <a name="high-level-components"></a>Spitzenkomponenten
...
### <a name="how-we-use-microsoft-azure"></a>So verwenden wir Microsoft Azure
...
2. Aufrufen der Azure Search-Dienst-API, um Wiederverkäufer nacheinander hochzuladen (siehe: http://msdn.microsoft.com/library/azure/dn798930.aspx).
...
1. Aufrufen des Azure Search-Diensts, um alle Dokumente aus der Suche zu erhalten (siehe: http://msdn.microsoft.com/library/azure/dn798927.aspx)
...
> [!NOTE]
> Es gibt ein Prototypindexerfeature, das kürzlich in Azure Search eingeführt wurde. Dieses Feature kam für uns zu spät, um es in unserer ersten Version zu verwenden. Es scheint aber genau das Problem zu lösen, für das wir unsere Indexeraufgabe verwenden: das Automatisieren von Datenladevorgängen.
> 
> 
...
## <a name="what-we-learned"></a>Was wir gelernt haben
...
### <a name="webjobs-for-scheduling-tasks"></a>WebJobs für die Planung von Aufgaben
...
### <a name="azure-blob-storage-explorer-for-updating-images"></a>Azure Storage Explorer zum Aktualisieren von Bildern
...
## <a name="a-few-final-words"></a>Abschließende Worte
...
## <a name="appendix-search-indexer-webjob"></a>Anhang: Suchindexer-WebJob
