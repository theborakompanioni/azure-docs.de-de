...
## <a name="performance-and-scale-tuning-for-search-services"></a>Optimierung der Leistung und Skalierbarkeit für Search-Dienste
...
## <a name="scaling-geo-distributed-workloads-and-provide-geo-redundancy"></a>Skalieren von geografisch verteilten Workloads und Bereitstellen von Georedundanz
