<properties 
	pageTitle="Dienstverwaltung für Azure Search im Azure-Portal" 
...
*Content Management* (oder Indexverwaltung) bezieht sich auf Vorgänge, z.B. das Analysieren von Suchdatenverkehr, mit dem Ziel, Informationen zum Abfragevolumen und verwendeten Suchbegriffen zu erhalten und zu ermitteln, wie hoch die Erfolgsrate für die Suchergebnisse in Bezug auf das Leiten von Kunden zu bestimmten Dokumenten in Ihrem Index ist. Eine weiter gehende Beschreibung des Content Management würde den Rahmen dieses Artikels sprengen. Informationen dazu, wie Sie Einblicke in die internen Abläufe auf Indexebene erhalten, finden Sie unter [Aktivieren und Verwenden von „Datenverkehrsanalyse durchsuchen“](search-traffic-analytics.md).

Auf die *Abfrageleistung* wird in diesem Artikel ebenfalls nicht eingegangen. Weitere Informationen finden Sie unter [Überlegungen zur Leistung und Optimierung von Azure Search](search-performance-optimization.md).
...
<a id="admin-rights"></a>
## Administratorrechte in Azure Search
...
<a id="sys-info"></a>
## Protokollierung in Azure Search und Systeminformationen
...
<a id="rbac"></a>
## Festlegen von RBAC-Rollen für den administrativen Zugriff für Azure Search
...
Rolle|Task
---|---
Besitzer|Erstellen oder Löschen des Diensts oder eines beliebigen Objekts im Dienst, z.B. API-Schlüssel, Indizes, Indexer, Indexerdatenquellen und Indexerzeitpläne.<p>Anzeigen von Dienststatus, z.B. Anzahl und Speichergröße.<p>Hinzufügen oder Löschen der Rollenmitgliedschaft (nur ein Besitzer kann die Rollenmitgliedschaft verwalten).<p>Abonnementadministratoren und Dienstbesitzer sind automatisch Mitglieder der Rolle „Besitzer“.
...
1. Klicken Sie im Dashboard des Diensts auf das Zugriffssymbol, um das Blatt „Benutzer“ zu öffnen. ![][7]
...
3. Fahren Sie fort, indem Sie auf **Abonnement-Administratoren** klicken. Erweitern Sie dann die Liste mit den Rollenzuweisungen, um zu ermitteln, wer über die Co-Administratorrechte für Ihren Suchdienst verfügt.
...
## Bewährte Methoden zur Skalierung und Bereitstellung (Video)

In diesem 30-minütigen Video werden die bewährten Methoden für erweiterte Bereitstellungsszenarien vorgestellt, z.B. geografisch verteilte Workloads. Unter [Überlegungen zur Leistung und Optimierung von Azure Search](search-performance-optimization.md) finden Sie als Alternative Hilfeseiten zu denselben Punkten.
