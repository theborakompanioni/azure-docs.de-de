---
title: Abfragen von Daten aus einer Azure Time Series Insights-Umgebung mit C# | Microsoft-Dokumentation
...
---
# <a name="query-data-from-azure-time-series-insights-environment-using-c"></a>Abfragen von Daten aus einer Azure Time Series Insights-Umgebung mit C#
...
1. Zur Vorbereitung wird das Zugriffstoken mithilfe der Azure Active Directory-API abgerufen. Dieses Token muss im `Authorization`-Header jeder Abfrage-API-Anforderung übergeben werden.
...
Die vollständige Referenz zur Abfrage-API finden Sie im Dokument zur [Abfrage-API](/rest/api/time-series-insights/time-series-insights-reference-queryapi).
