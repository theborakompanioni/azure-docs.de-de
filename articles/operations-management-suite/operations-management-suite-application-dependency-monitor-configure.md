<properties
   pageTitle="Konfigurieren von Application Dependency Monitor (ADM) in der Operations Management Suite (OMS) | Microsoft Azure"
...
>[AZURE.NOTE]Application Dependency Monitor ist derzeit in der privaten Vorschau verfügbar.  Unter [https://aka.ms/getadm](https://aka.ms/getadm) können Sie den Zugriff auf die private Vorschau von ADM anfordern.
>
