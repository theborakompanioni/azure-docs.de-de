...
* [Dokumentation zu Azure Automation](http://azure.microsoft.com/documentation/services/automation)
* [PowerShell-Cmdlets für Automation](http://msdn.microsoft.com/library/dn690262.aspx)
* [Automation-REST-API](http://msdn.microsoft.com/library/mt662285.aspx)
* [Runbooks aus der Community](https://gallery.technet.microsoft.com/scriptcenter/site/search?f%5B0%5D.Type=RootCategory&f%5B0%5D.Value=WindowsAzure&f%5B0%5D.Text=Windows%20Azure)
...
* [Hinzufügen von Azure Automation-Runbooks zu Wiederherstellungsplänen](../site-recovery/site-recovery-runbook-automation.md)
* [Replizieren zwischen lokalen virtuellen Hyper-V-Computern und Azure mithilfe von PowerShell und Azure Resource Manager](../site-recovery/site-recovery-deploy-with-powershell-resource-manager.md)
