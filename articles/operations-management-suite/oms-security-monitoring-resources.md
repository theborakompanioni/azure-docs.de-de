<properties
   pageTitle="Überwachen von Ressourcen in der Sicherheits- und Überwachungslösung von Operations Management Suite | Microsoft Azure"
...
> [AZURE.NOTE] Eine Übersicht über alle Optionen können Sie sich unter [Erste Schritte mit der Sicherheits- und Überwachungslösung von Operations Management Suite](oms-security-getting-started.md)verschaffen.
...
> [AZURE.NOTE] Für Computer, auf die über das Internet direkt zugegriffen werden kann, kommt es zu vielen fehlgeschlagenen Anmeldeversuchen mit allen Arten von gängigen Benutzernamen (z.B. „Administrator“). Dies stellt in den meisten Fällen keine größere Gefahr dar, solange keine gängigen Benutzernamen verwendet werden und das Kennwort sicher genug ist.
