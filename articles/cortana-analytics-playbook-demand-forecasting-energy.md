<properties
	pageTitle="Cortana Intelligence -Lösungsvorlage – Playbook für die Vorhersage des Energiebedarfs | Microsoft Azure"
...
# Cortana Intelligence-Lösungsvorlage – Playbook für die Vorhersage des Energiebedarfs  
...
>[AZURE.TIP] Unter [Cortana Intelligence-Lösungsvorlage – Architektur für die Energienachfrageprognose](cortana-analytics-architecture-demand-forecasting-energy.md) können Sie ein Diagramm herunterladen, das eine Architekturübersicht zu dieser Vorlage enthält.
...
### Datenformat
Die Cortana Intelligence Suite unterstützt die gängigsten Datenformate wie CSV, TSV, JSON usw. Es ist wichtig, dass das Datenformat über den gesamten Lebenszyklus des Projekts gleich bleibt.
