---
title: Erstellen und Konfigurieren eines Application Gateways mit internem Lastenausgleich (ILB) in einem virtuellen Netzwerk | Microsoft Docs
...
5. [Überprüfen des Gateways](#verify-the-gateway-status)
...
Verwenden Sie das `Get-AzureApplicationGateway` -Cmdlet zum Überprüfen des Status des Gateways. Wenn `Start-AzureApplicationGateway` im vorherigen Schritt erfolgreich ausgeführt wurde, sollte für „State“ nun *Running* angezeigt werden, und „Vip“ und „DnsName“ sollten gültige Einträge besitzen. Dieses Beispiel zeigt das Cmdlet in der ersten Zeile, gefolgt von der Ausgabe. In diesem Beispiel wird das Gateway ausgeführt und kann Datenverkehr verarbeiten. 

> [!NOTE]
> Das Anwendungsgateway ist in diesem Beispiel so konfiguriert, dass Datenverkehr am konfigurierten ILB-Endpunkt 10.0.0.10 akzeptiert wird.
