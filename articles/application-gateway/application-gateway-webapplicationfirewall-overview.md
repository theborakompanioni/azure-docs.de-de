<properties
   pageTitle="Web Application Firewall für Application Gateway | Microsoft Azure"
   description="Diese Seite enthält eine Übersicht über die Funktionalität der Web Application Firewall für Application Gateway."
...
- HTTP-DoS-Schutzmaßnahmen, einschließlich Verhindern von HTTP-Überflutung und langsamen HTTP-DoS-Angriffen
