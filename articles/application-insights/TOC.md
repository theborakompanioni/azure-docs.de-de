...
## [Leistungsüberwachung in einem DevOps-Zyklus](app-insights-detect-triage-diagnose.md)
...
### [Überwachen von Apps mit mehreren Rollen](app-insights-monitor-multi-role-apps.md)
...
#### [Verwenden](app-insights-analytics-using.md)
...
### [Dienstupdates](https://azure.microsoft.com/updates/?product=application-insights) 
