...
* Wenn das Abhängigkeitselement „<version>“ ein Muster mit Platzhalterzeichen verwendet (etwa „(Maven) `<version>[1.0,)</version>`“ oder „(Gradle) `version:'1.0.+'`“), geben Sie stattdessen eine bestimmte Version (beispielsweise `1.0.2`) an. Weitere Informationen finden Sie in den [Versionshinweisen](https://github.com/Microsoft/ApplicationInsights-Java#release-notes) für die aktuelle Version.
...
* In Ihrer Firewall müssen Sie möglicherweise die TCP-Ports 80 und 443 für ausgehenden Datenverkehr zu „dc.services.visualstudio.com“ öffnen. Die Liste mit sämtlichen Firewallausnahmen finden Sie [hier](app-insights-ip-addresses.md).
