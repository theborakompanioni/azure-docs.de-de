<properties 
	pageTitle="Application Insights: Proaktive Anomaliediagnose | Microsoft Azure" 
...
#  Proaktive Anomaliediagnose

*Application Insights befindet sich in der Vorschau.*

[Visual Studio Application Insights](app-insights-overview.md) führt eine umfassende Analyse Ihrer App-Telemetrie durch und kann Sie bei potenziellen Leistungsproblemen warnen. Sie lesen dies wahrscheinlich, da Sie eine unserer proaktiven Warnungen per E-Mail erhalten haben.
...
## Was ist die proaktive Anomalieerkennung?

Bei der proaktiven Anomalieerkennung werden ungewöhnliche Muster in Bezug auf die Leistung der App erkannt, indem die an Application Insights gesendeten Telemetriedaten analysiert werden.
...
![Klicken Sie auf den Link in der E-Mail-Benachrichtigung, um den Anomaliebericht in Azure zu öffnen.](./media/app-insights-proactive-anomaly-diagnostics/03.png)
