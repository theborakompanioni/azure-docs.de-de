...
Melden Sie sich zunächst für ein Konto bei [Microsoft Azure](https://azure.com) an. (Sie zahlen nur für die tatsächliche Verwendung, und es fallen keine Gebühren für eine Testnutzung an.)
...
### <a name="run-your-project-and-see-first-results"></a>Ausführen Ihres Projekts und Anzeigen erster Ergebnisse
...
## <a name="analytics-out-of-the-box"></a>Analysen ohne Konfigurationsaufwand
