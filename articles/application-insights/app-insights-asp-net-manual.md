...
1. Bearbeiten Sie die NuGet-Pakete Ihres Web-App-Projekts in Visual Studio.
    ...
    ![Klicken Sie mit der rechten Maustaste auf das Projekt, und wählen Sie "NuGet-Pakete verwalten".](./media/app-insights-asp-net-manual/03-nuget.png)

2. Installieren Sie das Application Insights SDK für Web-Apps.

    ![Suchen Sie nach "Application Insights".](./media/app-insights-asp-net-manual/04-ai-nuget.png)
...
![Veröffentlichen Sie die App mit Visual Studio.](./media/app-insights-asp-net-manual/15-publish.png)
...
## Hinzufügen der Nachverfolgung von Abhängigkeiten (und von IIS-Leistungsindikatoren)
...
![In der Web-App: Einstellungen, Erweiterungen, Hinzufügen, Application Insights](./media/app-insights-asp-net-manual/05-extend.png)
...
![Öffnen Sie in Ihrer Web-App „Schnellstart“, und klicken Sie auf die Option zum Abrufen des Codes für die Überwachung von Webseiten.](./media/app-insights-asp-net-manual/02-monitor-web-page.png)
...
![Erstellen eines ASP.NET-Projekts](./media/app-insights-asp-net-manual/appinsights-01-vsnewp1.png)
...
![Application Insights hinzufügen](./media/app-insights-asp-net-manual/appinsights-03-addExisting.png)
...
![Klicken Sie mit der rechten Maustaste auf Ihr Projekt, und öffnen Sie das Azure-Portal](./media/app-insights-asp-net-manual/appinsights-04-openPortal.png)
