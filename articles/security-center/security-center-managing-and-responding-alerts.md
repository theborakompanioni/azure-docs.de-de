...
- **Virtuelle Computer, die mit schädlichen IPs kommunizieren**: Hierbei wird Netzwerkdatenverkehr mit den globalen Informationen zu Bedrohungen (Threat Intelligence) von Microsoft verglichen. Es werden Computer erkannt, die kompromittiert wurden und mit Command-and-Control-Servern (C&C) kommunizieren (und umgekehrt).
...
![Warnung vor Netzwerkkommunikation mit einem schädlichen Computer](./media/security-center-managing-and-responding-alerts/security-center-managing-and-responding-alerts-fig-11.png)
