...
1. Wählen Sie auf dem Blatt **Empfehlungen** die Option **Überwachung für SQL-Server aktivieren** aus. Daraufhin wird das Blatt **Überwachung für SQL-Server aktivieren** geöffnet. ![][1]

2. Wählen Sie einen SQL-Server aus, für den die Überwachung aktiviert werden soll. Daraufhin wird das Blatt **Überwachungseinstellungen** angezeigt. ![][2]
3. Wählen Sie auf dem Blatt **Überwachungseinstellungen** unter **Überwachung** die Option **EIN** aus. ![][3]
