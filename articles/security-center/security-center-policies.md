...
Sicherheitsrichtlinien können für jedes Abonnement oder jede Ressourcengruppe konfiguriert werden. Damit Sie eine Sicherheitsrichtlinie ändern können, müssen Sie ein Besitzer oder Mitwirkender dieses Abonnements sein. Öffnen Sie das Azure-Portal, und führen Sie die nachstehenden Schritte aus, um Sicherheitsrichtlinien in Security Center zu konfigurieren:
