...
| [Überwachung von SQL-Server aktivieren](security-center-enable-auditing-on-sql-servers.md) |Empfiehlt, dass Sie die Überwachung für Azure SQL-Server aktivieren. (Nur Azure SQL-Dienst. Schließt nicht die Ausführung von SQL auf Ihren virtuellen Computern mit ein.) |
| [Überwachung der SQL-Datenbank aktivieren](security-center-enable-auditing-on-sql-databases.md) |Empfiehlt, dass Sie die Überwachung für Azure SQL-Datenbanken aktivieren. (Nur Azure SQL-Dienst. Schließt nicht die Ausführung von SQL auf Ihren virtuellen Computern mit ein.) |
