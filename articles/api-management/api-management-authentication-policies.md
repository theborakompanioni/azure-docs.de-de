...
##  <a name="a-nameauthenticationpoliciesa-authentication-policies"></a><a name="AuthenticationPolicies"></a> Authentifizierungsrichtlinien  
...
##  <a name="a-namebasica-authenticate-with-basic"></a><a name="Basic"></a> Standardauthentifizierung  
...
##  <a name="a-nameclientcertificatea-authenticate-with-client-certificate"></a><a name="ClientCertificate"></a> Authentifizieren mit Clientzertifikat  
