...
## Voraussetzungen
Um die Schritte in diesem Leitfaden ausführen zu können, müssen Sie über eine API Management-Dienstinstanz mit einer konfigurierten API und einem konfigurierten Produkt verfügen. Falls Sie noch keine API Management-Dienstinstanz erstellt haben, finden Sie weitere Informationen im Abschnitt [Erstellen einer API Management-Dienstinstanz][Erstellen einer API Management-Dienstinstanz] im Lernprogramm [Erste Schritte mit Azure API Management][Erste Schritte mit Azure API Management].
