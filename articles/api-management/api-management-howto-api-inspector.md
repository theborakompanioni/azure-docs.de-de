...
> Falls Sie noch keine API Management-Dienstinstanz erstellt haben, finden Sie im Abschnitt zum [Erstellen einer API Management-Dienstinstanz][Create an API Management service instance] im Tutorial [Erste Schritte mit Azure API Management][Get started with Azure API Management] weitere Informationen.
> 
> 
...
Klicken Sie auf **Testen**, um die Operation **Add two integers** (Zwei ganze Zahlen addieren) aufzurufen.
