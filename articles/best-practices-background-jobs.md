...
- Wenn der Auftrag auf einen zeitplangesteuerten Trigger reagieren soll, sollten Sie ihn mit der Option **Gemäß einem Zeitplan ausführen** konfigurieren. Das Skript oder Programm wird im Ordner "site/wwwroot/app\_data/jobs/triggered" gespeichert.
