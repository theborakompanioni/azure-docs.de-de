...
Zum Erstellen einer Netzwerksicherheitsgruppe und der zugehörigen Regeln müssen Sie [die Azure CLI 1.0](../cli-install-nodejs.md) im Resource Manager-Modus installieren und verwenden:
