---
title: Probleme beim Neustart oder Ändern der Größe eines virtuellen Computers | Microsoft Docs
...
---
# Behandeln von Problemen beim Neustart oder Ändern der Größe eines vorhandenen virtuellen Linux-Computers in Azure (klassisches Bereitstellungsmodell)
> [!div class="op_single_selector"]
> * [Klassisch](virtual-machines-linux-classic-restart-resize-error-troubleshooting.md)
> * [Ressourcen-Manager](virtual-machines-linux-restart-resize-error-troubleshooting.md)
> 
> 
...
## Nächste Schritte
Wenn beim Erstellen eines neuen virtuellen Linux-Computers in Azure Probleme auftreten, finden Sie Informationen unter [Behandeln von Bereitstellungsproblemen beim Erstellen eines neuen virtuellen Linux-Computers in Azure](virtual-machines-linux-troubleshoot-deployment-new-vm.md).
