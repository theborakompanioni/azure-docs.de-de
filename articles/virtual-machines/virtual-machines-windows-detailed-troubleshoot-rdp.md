...
> [!IMPORTANT]
> Um allgemeine Remotedesktopfehler als Ursache auszuschließen, lesen Sie zunächst den Artikel zur [grundlegenden Problembehandlung für Remotedesktop](virtual-machines-windows-troubleshoot-rdp-connection.md), bevor Sie mit dieser Problembehandlung fortfahren.
> 
> 
...
Den korrekten Abonnementnamen können Sie der Eigenschaft *SubscriptionName* in der Ausgabe des Befehls **Get-AzureSubscription** entnehmen. Der Name des Clouddiensts für den virtuellen Computer wird in der Spalte *ServiceName* in der Ausgabe des Befehls **Get-AzureVM** angezeigt.
