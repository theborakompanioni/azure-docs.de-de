...
In diesem Thema lernen Sie Schritt für Schritt, wie Sie eine Hybrid Cloud-Umgebung zum Testen einer in Microsoft Azure gehosteten SharePoint 2013- oder 2016-Intranetfarm erstellen. Hier sehen Sie die daraus resultierende Konfiguration.
...
3.	Konfigurieren des SharePoint-Servers (SP1) mit SharePoint 2013 oder SharePoint 2016
...
Erstellen Sie dann in der Azure PowerShell-Eingabeaufforderung auf dem lokalen Computer mit den folgenden Befehlen einen virtuellen Azure-Computer für SQL1. Füllen Sie vor dem Ausführen dieser Befehle die Variablenwerte aus, und entfernen Sie die Zeichen < und >.
...
Fahren Sie mit der entsprechenden Phase 3 zum Konfigurieren eines SharePoint 2013- oder eines SharePoint 2016-Servers fort.

## Phase 3: Konfigurieren des SharePoint 2013-Servers (SP1)
...
Konfigurieren Sie anschließend SP1 für eine neue SharePoint 2013-Farm und eine standardmäßige Teamwebsite.
...
Ihre SharePoint 2013-Intranetfarm kann jetzt in einer Hybrid Cloud-Umgebung getestet werden.


## Phase 3: Konfigurieren des SharePoint 2016-Servers (SP1)
...
Konfigurieren Sie anschließend SP1 für eine neue SharePoint 2016-Einzelserverfarm und eine standardmäßige Teamwebsite.

1. Geben Sie auf dem Startbildschirm **SharePoint** ein, und klicken Sie dann auf **Konfigurations-Assistent für SharePoint 2016-Produkte**.
2. Klicken Sie auf der Seite „Willkommen bei den SharePoint-Produkten“ auf **Weiter**.
...
5. Auf der Seite „Einstellungen für die Konfigurationsdatenbank angeben“:
	- Geben Sie unter **Datenbankserver** den Text **SQL1** ein.
	- Geben Sie unter **Benutzername** den Text **CORP\\SPFarmAdmin** ein.
	- Geben Sie unter **Kennwort** das Kennwort für das Konto „SPFarmAdmin“ ein.
6. Klicken Sie auf **Weiter**.
7. Geben Sie auf der Seite „Farmsicherheitseinstellungen angeben“ zweimal **P@ssphrase** ein, und klicken Sie dann auf **Weiter**.
8. 	Klicken Sie auf der Seite „Serverrolle angeben“ unter **Einzelserverfarm** auf **Einzelserverfarm**, und klicken Sie dann auf **Weiter**.
9. Klicken Sie auf der Seite „Webanwendung für die SharePoint-Zentraladministration konfigurieren“ auf **Weiter**.
...
11. Die Seite „SharePoint-Produkte konfigurieren“ wird angezeigt. Warten Sie, bis der Konfigurationsprozess abgeschlossen ist.
12. Klicken Sie auf der Seite „Konfiguration erfolgreich“ auf **Fertig stellen**. Die neue Verwaltungswebsite wird gestartet.
13. Klicken Sie auf der Seite „Helfen Sie uns bei der Verbesserung von SharePoint“ auf die gewünschte Option zur Teilnahme am Programm zur Verbesserung der Benutzerfreundlichkeit, und klicken Sie dann auf **OK**.
14. Klicken Sie auf der Willkommensseite auf **Assistenten starten**.
15. Klicken Sie auf der Seite der Dienstanwendungen und Dienste unter **Dienstkonto** auf **Vorhandenes verwaltetes Konto verwenden**, und klicken Sie dann auf **Weiter**. Es kann einige Minuten dauern, bis die nächste Seite angezeigt wird.
16. Geben Sie auf der Seite „Websitesammlung erstellen“ den Namen **Contoso** unter **Titel** ein, und klicken Sie dann auf **OK**.
17. Klicken Sie auf der Seite "Farmkonfigurations-Assistent" auf **Fertig stellen**. Die Webseite für die SharePoint-Zentraladministration wird angezeigt.
18. Melden Sie sich am Computer CLIENT1 mit den Anmeldeinformationen des Kontos „CORP\\User1“ an, und starten Sie Internet Explorer.
19.	Geben Sie in die Adressleiste **http://sp1/** ein, und drücken Sie dann die EINGABETASTE. Nun sollte die SharePoint-Teamwebsite angezeigt werden. Eventuell dauert das Rendern der Seite ein wenig.

Die aktuelle Konfiguration sieht folgendermaßen aus.

![](./media/virtual-machines-windows-ps-hybrid-cloud-test-env-sp/virtual-machines-windows-ps-hybrid-cloud-test-env-sp-ph3.png)
 
Ihre SharePoint 2016-Einzelserverintranetfarm kann jetzt in einer Hybrid Cloud-Umgebung getestet werden.


## Nächste Schritte

- [Konfigurieren](https://technet.microsoft.com/library/ee836142.aspx) der SharePoint 2013-Farm
