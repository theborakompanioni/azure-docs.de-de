---
title: "Beispielkonfiguration für Windows-VM-Erweiterungen | Microsoft Docs"
...
---
# <a name="azure-windows-vm-extension-configuration-samples"></a>Konfigurationsbeispiele für Windows-VM-Erweiterungen in Azure
> [!div class="op_single_selector"]
> * [PowerShell – Vorlage](extensions-configuration-samples.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)
> * [Befehlszeilenschnittstelle – Vorlage](../linux/extensions-configuration-samples.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
> 
> 
...
Weitere Informationen zu diesen Erweiterungen finden Sie unter [Übersicht über Azure-VM-Erweiterungen](extensions-features.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).

Weitere Informationen zum Erstellen von Erweiterungsvorlagen finden Sie unter [Erstellen von Erweiterungsvorlagen](extensions-authoring-templates.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).

Dieser Artikel führt die erwarteten Konfigurationswerte für einige der Windows-Erweiterungen auf.

## <a name="sample-template-snippet-for-vm-extensions-with-iaas-vms"></a>Ausschnitt einer Beispielvorlage für Erweiterungen für virtuelle Computer mit IaaS-VMs.
...
#### <a name="parameter-description"></a>Beschreibung des Parameters:
...
### <a name="microsoft-monitoring-agent-for-azure-operational-insights"></a>Microsoft Monitoring Agent für Azure Operational Insights
            {
...
### <a name="confer-advanced-threat-prevention-and-incident-response-for-azure"></a>Confer-Lösung für eine verbesserte Abwehr von Bedrohungen und Reaktion auf Incidents für Azure
          {
            "publisher": "Confer",
            "type": "ConferForAzure",
            "typeHandlerVersion": "1.0",
...
### <a name="barracuda-vpn-connectivity-agent-for-microsoft-azure"></a>Barracuda-VPN-Konnektivitäts-Agent für Microsoft Azure
          {
...
Weitere Informationen zum Konfigurieren der Diagnose finden Sie unter [Azure-Diagnoseerweiterung](extensions-diagnostics-template.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
...
Ausführliche Informationen zum Konfigurieren von Octopus Deploy Tentacle in Azure finden Sie in der [Octopus-Dokumentation](https://octopus.com/docs/installation/installing-tentacles/azure-virtual-machines).
