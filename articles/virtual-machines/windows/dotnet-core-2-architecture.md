---
title: Bereitstellen von Windows-Computeressourcen mit Azure Resource Manager-Vorlagen | Microsoft-Dokumentation
...
![Speicherkonto](./media/dotnet-core-2-architecture/storacct-win.png)
...
![Virtuelle Festplatten](./media/dotnet-core-2-architecture/vhd-win.png)
...
![Netzwerkschnittstelle](./media/dotnet-core-2-architecture/nic-win.png)
