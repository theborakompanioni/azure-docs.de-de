...
* **HPC Pack 2012 R2-Cluster auf virtuellen Azure-Computern**: Erstellen Sie einen HPC Pack 2012 R2-Cluster im klassischen Bereitstellungsmodell. Sie können beispielsweise die Bereitstellung automatisieren, indem Sie das HPC Pack 2012 R2-VM-Image in Azure Marketplace und ein Azure PowerShell-Skript verwenden. Informationen und Voraussetzungen finden Sie unter [Erstellen eines HPC-Clusters mit dem HPC Pack-IaaS-Bereitstellungsskript](hpcpack-cluster-powershell-script.md).
