...
####[Konfigurieren von Oracle Data Guard für Azure](configure-oracle-data-guard.md)

####[Konfigurieren von Oracle GoldenGate für Azure](configure-oracle-goldengate.md)

####[Verschiedene Überlegungen für Bilder](oracle-considerations.md)
