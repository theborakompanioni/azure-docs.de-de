...
![SharePoint-Farm](./media/sharepoint-farm/Non-HAFarm.png)
...
![SharePoint-Farm](./media/sharepoint-farm/HAFarm.png)
...
![SharePoint-Farm](./media/sharepoint-farm/SP2016Farm.png)

## <a name="managing-the-sharepoint-farms"></a>Verwalten der SharePoint-Farmen
Sie können die Server dieser Farmen über Remotedesktopverbindungen verwalten. Weitere Informationen finden Sie unter [Anmelden beim virtuellen Computer](quick-create-portal.md#connect-to-virtual-machine).
