...
![Verfügbarkeitsgruppe](./media/dotnet-core-4-availability-scale/ase-win.png)

Ausführliche Informationen zu Verfügbarkeitsgruppen finden Sie unter [Verwalten der Verfügbarkeit virtueller Computer](manage-availability.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json). 
...
![Lastenausgleich für das Netzwerk](./media/dotnet-core-4-availability-scale/nlb-win.png)
...
![Regel für den Netzwerklastenausgleich](./media/dotnet-core-4-availability-scale/lbrule-win.png)
...
![Netzwerklastenausgleichstest](./media/dotnet-core-4-availability-scale/lbprobe-win.png)
...
![Eingehende NAT-Regel](./media/dotnet-core-4-availability-scale/natrule-win.png)

Ausführliche Informationen zum Azure-Netzwerklastenausgleich finden Sie unter [Lastenausgleich für Azure-Infrastrukturdienste](load-balance.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
