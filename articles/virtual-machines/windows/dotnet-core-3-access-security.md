...
![Öffentliche IP-Adresse](./media/dotnet-core-3-access-security/pubip-win.png)
...
![Netzwerksicherheitsgruppen (NSG)](./media/dotnet-core-3-access-security/nsg-win.png)
