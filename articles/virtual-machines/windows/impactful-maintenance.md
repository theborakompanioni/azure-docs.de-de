---
title: "Wartung mit weitreichender Auswirkung für virtuelle Windows-Computer in Azure | Microsoft-Dokumentation"
description: "Wartung mit weitreichender Auswirkung für virtuelle Windows-Computer."
...
# <a name="impactful-maintenance-for-virtual-machines"></a>Wartung mit weitreichender Auswirkung für virtuelle Computer
...
### <a name="single-instance-vms-vs-availability-set-or-vm-scale-set"></a>Mehrfach- und Einzelinstanz-VMs und Verfügbarkeitsgruppe oder VM-Skalierungsgruppe
...
VM-Skalierungsgruppen sind eine Azure-Computerressource, mit der Sie eine Gruppe identischer virtueller Computer als Einzelressource bereitstellen und verwalten können.
Die Skalierungsgruppe bietet in Form von Updatedomänen ähnliche Zusicherungen wie eine Verfügbarkeitsgruppe. 

Weitere Informationen zum Konfigurieren Ihrer virtuellen Computer für hohe Verfügbarkeit finden Sie unter [*Verwalten der Verfügbarkeit virtueller Windows-Computer*](../linux/manage-availability.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
...
Die präemptive erneute Bereitstellung wird einmal pro virtuellen Computer aktiviert. Wenn während des Vorgangs ein Fehler auftritt, wird der Vorgang abgebrochen. Der virtuelle Computer wird nicht beeinträchtigt und vom geplanten Wartungsschritt ausgeschlossen. Sie werden zu einem späteren Zeitpunkt mit einem neuen Zeitplan kontaktiert und erhalten eine neue Gelegenheit, die Auswirkungen auf Ihre VMs zu planen.
