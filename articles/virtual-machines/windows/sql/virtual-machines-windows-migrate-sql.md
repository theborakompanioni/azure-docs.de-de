...
Anstelle einer Sicherung in eine lokale Datei können Sie eine [Sicherung über URLs](https://msdn.microsoft.com/library/dn435916.aspx) verwenden und dann eine Wiederherstellung über diese URL auf den virtuellen Computer durchführen. SQL Server 2016 unterstützt Stripesetsicherungen, die aus Leistungsgründen empfohlen werden und erforderlich sind, um die Größenbeschränkung pro Blob zu umgehen. Für sehr große Datenbanken wird die Verwendung des [Windows-Import/Export-Diensts](../../../storage/storage-import-export-service.md) empfohlen.
