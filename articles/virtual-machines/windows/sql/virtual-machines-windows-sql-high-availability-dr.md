...
* [Configure an external listener for availability groups in Azure (Konfigurieren eines externen Listeners für Verfügbarkeitsgruppen in Azure)](../classic/ps-sql-ext-listener.md).
