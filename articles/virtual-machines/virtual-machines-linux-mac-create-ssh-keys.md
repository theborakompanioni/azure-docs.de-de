---
title: "Erstellen eines öffentlich-privaten SSH-Schlüsselpaars für virtuelle Linux-Computer | Microsoft-Dokumentation"
description: "Erstellen Sie ein öffentlich-privates SSH-Schlüsselpaar für virtuelle Linux-Computer."
...
Wenn Sie nicht über das Verzeichnis `~/.ssh` verfügen, können Sie es mithilfe des Befehls `ssh-keygen` gleich mit den richtigen Berechtigungen erstellen.

```bash
ssh-keygen -t rsa -b 2048 -C "ahmet@myserver"
```

Geben Sie den Namen der Datei des privaten Schlüssels ein, die im `~/.ssh/`-Verzeichnis gespeichert wird:
...
Kopieren Sie den öffentlichen SSH-Schlüssel auf Ihren virtuellen Linux-Computer:
...
SSH ist erfolgreich konfiguriert, wenn für den virtuellen Computer weder ein privates SSH-Schlüsselkennwort noch ein Anmeldekennwort angefordert wird.
