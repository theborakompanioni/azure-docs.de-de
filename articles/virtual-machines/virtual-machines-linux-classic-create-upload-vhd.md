---
title: Erstellen und Hochladen einer Linux-VHD | Microsoft Docs
...
Sie können auch [ein benutzerdefiniertes Datenträgerimage mit dem Azure Resource Manager hochladen](virtual-machines-linux-upload-vhd.md).
...
> [!NOTE]
> Das Azure-Plattform-SLA bezieht sich nur dann auf die virtuellen Computer mit Linux-Betriebssystem, wenn eine unterstützte Distribution mit Konfigurationsdetails verwendet wird, die unter [Linux auf von Azure unterstützten Verteilungen](virtual-machines-linux-endorsed-distros.md) angegeben sind. Alle Linux-Distributionen im Azure-Image-Katalog sind unterstützte Distributionen mit der erforderlichen Konfiguration.
> 
> 
