<properties
   pageTitle="Verfügbarkeit und Skalierung in Azure Resource Manager-Vorlagen | Microsoft Azure"
...
# Verfügbarkeit und Skalierung in Azure Resource Manager-Vorlagen
...
![Verfügbarkeitsgruppe](./media/virtual-machines-linux-dotnet-core/aset.png)

Ausführliche Informationen zu Verfügbarkeitsgruppen finden Sie unter [Verwalten der Verfügbarkeit virtueller Computer](./virtual-machines-linux-manage-availability.md).
...
![Lastenausgleich für das Netzwerk](./media/virtual-machines-linux-dotnet-core/nlb.png)

## Lastenausgleichsregel
...
![Regel für den Netzwerklastenausgleich](./media/virtual-machines-linux-dotnet-core/lbrule.png)

## Lastenausgleichstest
...
![Netzwerklastenausgleichstest](./media/virtual-machines-linux-dotnet-core/lbprobe.png)
...
Ausführliche Informationen zum Azure-Netzwerklastenausgleich finden Sie unter [Lastenausgleich für Azure-Infrastrukturdienste](./virtual-machines-linux-load-balance.md).

## Bereitstellen mehrerer VMs
