...
Ja. Anweisungen dazu finden Sie unter [Hochladen eines Windows-VM-Images in Microsoft Azure ](virtual-machines-windows-upload-image.md)
...
Ja. Anweisungen hierzu finden Sie unter [Create a copy of a specialized Windows VM running in Azure](virtual-machines-windows-vhd-copy.md) (Erstellen einer Kopie eines spezialisierten virtuellen Windows-Computers in Azure).
...
## <a name="can-i-add-a-nic-to-my-vm-after-it's-created?"></a>Kann ich meinem virtuellen Computer nach der Erstellung eine NIC hinzufügen?
