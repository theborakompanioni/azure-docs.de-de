...
1. Klicken Sie auf **Weiter** on the **Weiter** .
...
>[AZURE.NOTE] [Übermitteln von Feedback und Kontaktinformationen über Microsoft SQL Server Connect](https://connect.microsoft.com/SQLServer/Feedback)
