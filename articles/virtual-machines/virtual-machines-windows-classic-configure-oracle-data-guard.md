...
>[AZURE.IMPORTANT] Bei Verwendung von Oracle Database 12c ist der neue Benutzer **SYSDG** vorhanden, mit dem Sie Oracle Data Guard verwalten können. Weitere Informationen finden Sie unter[Änderungen in der Version Oracle Database 12c](http://docs.oracle.com/database/121/UNXAR/release_changes.htm#UNXAR404).
