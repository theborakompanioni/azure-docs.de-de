---
title: "Ausführen von Cassandra mit Linux unter Azure | Microsoft Docs"
...
**Hohe Verfügbarkeit**: Die in Abbildung 1 gezeigten Cassandra-Knoten werden für zwei Verfügbarkeitsgruppen bereitgestellt, sodass die Knoten auf mehrere Fehlerdomänen verteilt sind und eine hohe Verfügbarkeit gewährleisten. Virtuelle Computer, die mit Anmerkungen zu jeder Verfügbarkeitsgruppe versehen sind, werden zwei Fehlerdomänen zugeordnet.  Microsoft Azure verwendet das Konzept der Fehlerdomäne zum Verwalten ungeplanter Ausfallzeiten (z. B. Hardware- oder Softwarefehler) und das Konzept der Upgradedomäne (z. B. Host- oder Gastbetriebssystem-Patches und -Upgrades bzw. Anwendungsupgrades) zum Verwalten geplanter Ausfallzeiten. Welche Rolle Fehler- und Upgradedomänen zum Erreichen einer hohen Verfügbarkeit spielen, lesen Sie unter [Notfallwiederherstellung und hohe Verfügbarkeit für Azure-Anwendungen](http://msdn.microsoft.com/library/dn251004.aspx).
...
#### <a name="step-4-install-jna-for-production-systems"></a>Schritt 4: Installieren von JNA für die Produktionssysteme
...
#### <a name="step-6-capture-the-vm-image"></a>Schritt 6: Erfassen des Images des virtuellen Computers
...
Verwenden Sie den Befehl "sudo waagent –deprovision+user", um Informationen zu entfernen, die für die Instanz des virtuellen Computers spezifisch sind. Weitere Details zur Image-Erfassung finden Sie unter [Gewusst wie: Erfassen eines virtuellen Linux-Computers, um ihn als Vorlage zu verwenden](virtual-machines-linux-classic-capture-image.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json) .

##### <a name="2-shutdown-the-vm"></a>2: Herunterfahren des virtuellen Computers
...
##### <a name="3-capture-the-image"></a>3: Erfassen des Image
...
### <a name="step-8-create-the-virtual-machines-in-region-2"></a>Schritt 8: Erstellen der virtuellen Maschinen in der Region Nr. 2
...
### <a name="step-9-configure-cassandra-on-each-vm"></a>Schritt 9: Konfigurieren von Cassandra auf jeder virtuellen Maschine
Melden Sie sich am virtuellen Computer an, und gehen Sie dann wie folgt vor:
...
2. Bearbeiten Sie "cassandra.yaml", um die Seedknoten zu konfigurieren: Seeds: "10.1.2.4,10.1.2.6,10.1.2.8,10.1.2.10,10.2.2.4,10.2.2.6,10.2.2.8,10.2.2.10"
...
### <a name="step-1-get-the-internal-load-balancer-ip-for-both-the-regions-using-powershell"></a>Schritt 1: Abrufen der IP-Adresse des internen Lastenausgleichsmoduls für beide Regionen mithilfe von PowerShell
* Get-AzureInternalLoadbalancer -ServiceName "hk-c-svc-west-us"
* Get-AzureInternalLoadbalancer -ServiceName "hk-c-svc-east-us"  
  
    Beachten Sie die IP-Adressen, die angezeigt werden (z. B. "west - 10.1.2.101", "east - 10.2.2.101").

### <a name="step-2-execute-the-following-in-the-west-region-after-logging-into-hk-w1-west-us"></a>Schritt 2: Ausführen der folgenden Befehle in der Region "West" nach der Anmeldung bei "hk-w1-west-us"
...
### <a name="step-3-execute-the-following-in-the-east-region-after-logging-into-hk-w1-east-us"></a>Schritt 3: Ausführen der folgenden Befehle in der Region "Ost" nach der Anmeldung bei "hk-w1-east-us"
