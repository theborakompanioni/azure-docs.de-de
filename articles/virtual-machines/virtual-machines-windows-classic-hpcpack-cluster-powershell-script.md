...
* Ein Tutorial, in dem das Skript zum Erstellen eines Clusters und Ausführen einer HPC-Workload verwendet wird, finden Sie unter [Erste Schritte mit einem HPC Pack-Cluster in Azure zum Ausführen von Excel- und SOA-Workloads](virtual-machines-windows-excel-cluster-hpcpack.md).
