---
title: Azure-VM-Fehlermeldungen
description: 
...
---
# <a name="azure-virtual-machine-error-messages"></a>Azure-VM-Fehlermeldungen
In diesem Artikel werden die allgemeinen Fehlercodes und Fehlermeldungen beschrieben, die beim Verwalten eines virtuellen Azure-Computers (Azure-VM) auftreten können.  

>[!NOTE]
>Sie können auf dieser Seite Kommentare als Feedback zu Fehlermeldungen bzw. [Azure-Feedback](https://feedback.azure.com/forums/216843-virtual-machines) unter dem Tag „#azerrormessage“ hinterlassen.
>
>
...
Eine Fehlerantwort enthält immer einen Statuscode und ein Fehlerobjekt. Jedes Fehlerobjekt enthält immer einen Fehlercode und eine Fehlermeldung. Wenn die VM-Bereitstellung mit einer Vorlage erstellt wird, enthält das Fehlerobjekt auch einen Abschnitt mit Details zur inneren Ebene mit Fehlercodes und -meldungen. Normalerweise ist die innerste Ebene von Fehlermeldungen die Grundursache. 


## <a name="common-virtual-machine-management-error"></a>Allgemeine Verwaltungsfehler für VMs

In diesem Abschnitt sind die allgemeinen Fehlermeldungen für die Verwaltung Ihrer VM aufgeführt.
