...
-----------------------------------------------|-----------------------------------------------
[Allgemein verfügbar in globalen Azure-Regionen](https://azure.microsoft.com/en-us/regions/)     | Allgemein verfügbar 
[Azure Government](https://azure.microsoft.com/en-us/overview/clouds/government/)              | In der Vorschau 
[Azure China](https://www.azure.cn/)                                                           | In der Vorschau
[Azure Deutschland](https://azure.microsoft.com/en-us/overview/clouds/germany/)                    | In der Vorschau
...
Für den Instanzmetadatendienst wird die Versionsverwaltung genutzt. Die Versionen sind obligatorisch. Die aktuelle Version lautet `2017-04-02`.
...
scheduledevents | Derzeit in der öffentlichen Vorschau, siehe [scheduledevents](virtual-machines-scheduled-events.md)
...
6. Wie beziehe ich Support für den Dienst?
   * Um Support für den Dienst zu beziehen, erstellen Sie im Azure-Portal ein Supportproblem für die VM, auf der Sie nach wiederholten Versuchen keine Metadatenantwort erhalten. 
   ...
   ![Instanzmetadatenunterstützung](./media/virtual-machines-instancemetadataservice-overview/InstanceMetadata-support.png)
    
## <a name="next-steps"></a>Nächste Schritte

- Erfahren Sie mehr über die API [scheduledevents](virtual-machines-scheduled-events.md) **in der öffentlichen Vorschau**, die vom Instanzmetadatendienst bereitgestellt wird.
