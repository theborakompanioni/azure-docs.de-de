...
Eine ausführliche Beschreibung der Ressource des virtuellen Computers finden Sie unter [Virtuelle Computer in einer Azure Resource Manager-Vorlage](virtual-machines-windows-template-description.md). Weitere Informationen zu allen Ressourcen in einer Vorlage finden Sie unter [Exemplarische Vorgehensweise zu Azure Resource Manager-Vorlagen](../resource-manager-template-walkthrough.md).
...
## <a name="step-3-create-credentials-used-to-authenticate-requests"></a>Schritt 3: Erstellen der Anmeldeinformationen zum Authentifizieren von Anforderungen
...
## <a name="step-5-create-a-parameters-file"></a>Schritt 5: Erstellen einer Parameterdatei
...
## <a name="step-6-deploy-a-template"></a>Schritt 6: Bereitstellen einer Vorlage
...
## <a name="step-7-delete-the-resources"></a>Schritt 7: Löschen der Ressourcen
...
## <a name="step-8-run-the-console-application"></a>Schritt 8: Ausführen der Konsolenanwendung
...
* Informationen zum Bereitstellen eines virtuellen Computers und dessen unterstützender Ressourcen finden Sie unter [Bereitstellen eines virtuellen Azure-Computers mit C#](virtual-machines-windows-csharp.md).
