---
title: Einrichten von Apache Tomcat auf einem virtuellen Linux-Computer | Microsoft Docs
...
---
# <a name="how-to-set-up-tomcat7-on-a-linux-virtual-machine-with-microsoft-azure"></a>Einrichten von Tomcat7 auf einem virtuellen Linux-Computer mit Microsoft Azure
...
> [!IMPORTANT] 
> Azure verfügt über zwei verschiedene Bereitstellungsmodelle für das Erstellen und Verwenden von Ressourcen: [Resource Manager- und klassische Bereitstellung](../azure-resource-manager/resource-manager-deployment-model.md). Dieser Artikel befasst sich mit der Verwendung des klassischen Bereitstellungsmodells. Microsoft empfiehlt für die meisten neuen Bereitstellungen die Verwendung des Ressourcen-Manager-Modells. Eine Resource Manager-Vorlage zum Bereitstellen einer Ubuntu-VM mit Open JDK und Tomcat finden Sie [hier](https://azure.microsoft.com/documentation/templates/openjdk-tomcat-ubuntu-vm/).
...
Klicken Sie im [Azure-Portal](https://portal.azure.com/) auf der Taskleiste auf **Neu**, und erstellen Sie ein Image. Wählen Sie dabei das Linux-Image aus, das Ihren Anforderungen gerecht wird. Dieses Beispiel verwendet das Ubuntu 14.04-Image.
![][3]
...
1. Klicken Sie im Azure-Portal auf **Durchsuchen** -> **Virtueller Computer**, und klicken Sie dann auf den virtuellen Computer, den Sie erstellt haben.  
   ![][5]
...
#### <a name="test"></a>Test:
Wenn Sie überprüfen möchten, ob Tomcat7 erfolgreich installiert wurde, navigieren Sie zum DNS-Namen Ihres Apache-Servers (Beispiel-URL in diesem Artikel: http://tomcatexample.cloudapp.net/). Wenn sinngemäß die folgende Seite angezeigt wird, haben Sie Tomcat7 ordnungsgemäß installiert.
![][16]

### <a name="install-other-tomcat-components"></a>Installieren anderer Tomcat-Komponenten
...
> [!NOTE] 
> Erstellen Sie ein sicheres Kennwort für den Admin-Benutzernamen.  
...
### <a name="permission-denied-when-upload-you-project-files-to-varlibtomcat7webapps"></a>Beim Hochladen von Projektdateien in das Verzeichnis "/var/lib/tomcat7/webapps" wird der Zugriff verweigert
* **Symptom**  
...
* **Lösung**  
   Rufen Sie Berechtigungen aus dem root-Konto ab. Sie können den Besitzer dieses Ordners aus "root" in den Benutzernamen ändern, die Sie bei der Bereitstellung des Computers verwendet haben. Das folgende Beispiel zeigt den Kontonamen "azureuser":  
