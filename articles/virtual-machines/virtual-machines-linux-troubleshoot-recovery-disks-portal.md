...
title: Verwenden einer Linux-Problembehebungs-VM im Portal | Microsoft Docs
...
![Anzeigen der Konsolenprotokolle für die VM-Startdiagnose](./media/virtual-machines-linux-troubleshoot-recovery-disks/boot-diagnostics-error.png)
...
![Auswählen von Speicherblobs](./media/virtual-machines-linux-troubleshoot-recovery-disks/storage-account-overview.png)
...
![Identifizieren der VHD im Speichercontainer](./media/virtual-machines-linux-troubleshoot-recovery-disks/storage-container.png)
...
![Kopieren vorhandener virtueller Festplatten-URLS](./media/virtual-machines-linux-troubleshoot-recovery-disks/copy-vhd-url.png)
...
![Der Screenshot der VM-Startdiagnose zeigt einen Startfehler](./media/virtual-machines-linux-troubleshoot-recovery-disks/stop-delete-vm.png)
...
1. Wählen Sie im Portal Ihre Ressourcengruppe und dann Ihre Problembehebungs-VM aus. Wählen Sie **Datenträger** aus, und klicken Sie dann auf **Vorhandener hinzufügen**:
    ...
    ![Hinzufügen des vorhandenen Datenträgers im Portal](./media/virtual-machines-linux-troubleshoot-recovery-disks/attach-existing-disk.png)

2. Klicken Sie auf **VHD-Datei**, um Ihre vorhandene virtuelle Festplatte auszuwählen:

    ![Navigieren zu einer vorhandenen VHD](./media/virtual-machines-linux-troubleshoot-recovery-disks/select-vhd-location.png)
...
3. Wählen Sie Ihr Speicherkonto und Ihren Container aus, und klicken Sie auf Ihre vorhandenen VHD. Klicken Sie auf die Schaltfläche **Auswählen**, um Ihre Auswahl zu bestätigen:
    ...
    ![Auswählen Ihrer vorhandenen VHD](./media/virtual-machines-linux-troubleshoot-recovery-disks/select-vhd.png)

4. Nachdem Sie Ihre VHD ausgewählt haben, klicken Sie auf **OK**, um die vorhandene virtuelle Festplatte hinzuzufügen:

    ![Bestätigen Sie das Hinzufügen der vorhandene virtuellen Festplatten](./media/virtual-machines-linux-troubleshoot-recovery-disks/attach-disk-confirm.png)
...
5. Nach wenigen Sekunden zeigt der Bereich **Datenträger** für Ihre VM Ihre vorhandenen virtuellen Festplatte an, die als Datenträger verbunden ist:
    ...
    ![Vorhandene virtuelle Festplatte, die als Datenträger angefügt ist](./media/virtual-machines-linux-troubleshoot-recovery-disks/attached-disk.png)
...
2. Trennen Sie die virtuelle Festplatte von der VM. Wählen Sie Ihre VM im Portal aus, und klicken Sie auf **Datenträger**. Wählen Sie Ihre vorhandene virtuelle Festplatte aus, und klicken Sie dann auf **Trennen**:
    ...
    ![Trennen einer vorhandenen virtuellen Festplatte](./media/virtual-machines-linux-troubleshoot-recovery-disks/detach-disk.png)
...
![Erstellen einer VM über eine Vorlage](./media/virtual-machines-linux-troubleshoot-recovery-disks/deploy-from-image.png)
...
![Aktualisieren der Startdiagnoseeinstellungen](./media/virtual-machines-linux-troubleshoot-recovery-disks/reenable-boot-diagnostics.png)

## <a name="next-steps"></a>Nächste Schritte
Wenn Probleme beim Herstellen einer Verbindung mit Ihrer VM auftreten, finden Sie unter [Problembehandlung von SSH-Verbindungen mit einer Azure-VM](virtual-machines-linux-troubleshoot-ssh-connection?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) Hilfestellungen. Konsultieren Sie [Beheben von Anwendungskonnektivitätsproblemen auf einer Linux-VM](virtual-machines-linux-troubleshoot-app-connection?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) bei Problemen mit dem Zugriff auf Anwendungen, die auf Ihrer VM ausgeführt werden.

Weitere Informationen zu Resource Manager finden Sie unter [Übersicht über den Azure Resource Manager](../azure-resource-manager/resource-group-overview?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
