...
Erfahren Sie, wie Sie [diese Schritte mit dem Resource Manager-Modell ausführen](https://github.com/Azure/azure-linux-extensions/tree/master/VMAccess).
...
> [!NOTE]
> Die SSH-Konfigurationsdatei befindet sich unter "/etc/ssh/sshd\_config".
> 
> 
