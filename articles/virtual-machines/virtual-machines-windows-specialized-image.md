...
1. Öffnen Sie auf dem lokalen Computer ein Befehlsfenster, und navigieren Sie zum Ordner, in dem AzCopy installiert ist. (Dies ist ein ähnlicher Ordner wie *C:\\Program Files (x86) \\Microsoft SDKs\\Azure\\AzCopy*.) Führen Sie hier den folgenden Befehl aus: </br>
...
>[AZURE.NOTE] Sie müssen die Datenträger für das Betriebssystem und die Daten getrennt kopieren. Verwenden Sie dazu AzCopy wie im vorherigen Schritt beschrieben.
