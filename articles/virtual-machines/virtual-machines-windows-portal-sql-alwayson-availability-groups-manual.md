...
1. Wählen Sie im **Server-Manager** die Option **Tools** aus, und klicken Sie dann auf **Active Directory-Verwaltungscenter**.
...
1. Geben Sie auf dem Blatt **Active Directory-Verwaltungscenter** select **corp (lokal)** aus.

1. Wählen Sie rechts im Aufgabenbereich** **die Option **Neu** aus, und klicken Sie dann auf **Benutzer**. Verwenden Sie folgende Einstellungen:
...
1. Erstellen Sie mit der gleichen Vorgehensweise zwei weitere Benutzer: **CORP\SQLSvc1** und **CORP\SQLSvc2**. Diese Konten werden von den SQL Server-Diensten verwendet. Erteilen Sie als Nächstes **CORP\Install** die erforderlichen Berechtigungen für das Konfigurieren von WSFC (Windows Service Failover Clustering).
...
1. Gehen Sie im Dialogfeld **Erweiterte Sicherheitseinstellungen für corp** wie folgt vor: Klicken Sie auf **Hinzufügen**.
...
1. Klicken Sie im Fenster **Lokaler Server** auf den Link **ARBEITSGRUPPE**.
...
1. Wählen Sie im **Server-Manager** die Option **Tools** aus, und klicken Sie dann auf **Computerverwaltung**.
...
1. Klicken Sie im linken Bereich mit der rechten Maustaste auf **Failovercluster-Manager**, und klicken Sie dann auf **Cluster erstellen**, wie unten gezeigt.
...
1. Klicken Sie mit der rechten Maustaste auf die fehlerhafte Ressource **IP-Adresse**, und klicken Sie dann auf **Eigenschaften**.
...
1. Schließlich fügen Sie die übrigen Knoten dem Cluster hinzu. Klicken Sie in der Browserstruktur mit der rechten Maustaste auf **Cluster1.corp.contoso.com**, und klicken Sie dann auf **Knoten hinzufügen**, wie unten dargestellt.
...
1. Wählen Sie auf der Seite **Serverrollen** die Option **sysadmin** aus. Klicken Sie dann auf **OK**. Nachdem die Anmeldung erstellt wurde, können Sie sie anzeigen, indem Sie die **Anmeldungen** in **Objekt-Explorer**.
...
1. Geben Sie auf der Seite **Name** im Textfeld **Name** einen Regelnamen an (Beispiel: **SQL Server (Programmregel)**), und klicken Sie anschließend auf **Fertig stellen**.
...
1. Klicken Sie mit der rechten Maustaste auf das neue Verzeichnis, zeigen Sie auf **Freigeben für**, und klicken Sie dann auf **Bestimmte Personen**, wie unten gezeigt.
...
1. Erstellen Sie als Nächstes die Datenbank. Starten Sie **SQL Server Management Studio** über das** **Startmenü, und klicken Sie dann auf **Verbinden**, um eine Verbindung mit der Standardinstanz von SQL Server herzustellen.

1. Klicken Sie im **Objekt-Explorer** mit der rechten Maustaste auf **Datenbanken**, und klicken Sie dann auf **Neue Datenbank**.

1. Geben Sie unter **Datenbankname** den Namen **MyDB1** ein, und klicken Sie dann auf **OK**.
...
1. Starten Sie **SQL Server Management Studio** über das** **Startmenü, und klicken Sie dann auf **Verbinden**, um eine Verbindung mit der Standardinstanz von SQL Server herzustellen.
