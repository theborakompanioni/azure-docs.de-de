...
[!code-azurecli[main](../../../cli_scripts/virtual-machine/create-vm-from-snapshot/create-vm-from-snapshot.sh "Erstellen eines virtuellen Computers aus einer Momentaufnahme")]
