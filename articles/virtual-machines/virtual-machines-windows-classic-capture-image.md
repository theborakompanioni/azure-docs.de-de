...
Azure speichert das Image unter **VM-Images (klassisch)**, einem **Compute**-Dienst, den Sie durch Anzeigen aller Azure-Dienste aufrufen können. Hier werden auch sämtliche Images abgelegt, die Sie hochladen. Näheres zu Images finden Sie unter [Informationen zu Images für virtuelle Computer](virtual-machines-windows-classic-about-images.md?toc=%2fazure%2fvirtual-machines%2fWindows%2fclassic%2ftoc.json).
