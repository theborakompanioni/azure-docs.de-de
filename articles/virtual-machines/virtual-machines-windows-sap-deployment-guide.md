...
* [SAP NetWeaver auf virtuellen Windows-Computern (VMs) – Bereitstellungshandbuch (dieses Dokument)][deployment-guide]
...
## <a name="b3253ee3-d63b-4d74-a49b-185e76c4088e"></a>Bereitstellungsszenarien für virtuelle Computer für SAP in Microsoft Azure
...
Falls die Bereitstellung in Azure über Azure Standort-zu-Standort oder Express Route mit dem lokalen AD/DNS verbunden ist (im [Planungs- und Implementierungshandbuch][planning-guide] auch als standortübergreifend bezeichnet), wird davon ausgegangen, dass der virtuelle Computer einer lokalen Domäne beitritt. Überlegungen zu diesem Schritt finden Sie im Kapitel [Beitreten eines virtuellen Computers zu einer lokalen Domäne (nur Windows)][deployment-guide-4.3] in diesem Dokument.
...
### <a name="d98edcd3-f2a1-49f7-b26a-07448ceb60ca"></a>Konfigurieren der erweiterten Azure-Überwachung für SAP
...
## <a name="564adb4f-5c95-4041-9616-6635e83a810b"></a>Überprüfungen und Problembehandlung für die Einrichtung der End-to-End-Überwachung für SAP in Azure
