---
title: Erweitern von lokalen AlwaysOn-Verfügbarkeitsgruppen auf Azure | Microsoft Docs
...
4. In diesem Fall müssen Sie Verbindungen mit allen vorhandenen sekundären Replikaten herstellen. Klicken Sie neben den einzelnen Replikaten auf **Verbinden…** oder alternativ unten auf dem Bildschirm auf **Alle verbinden…**. Klicken Sie nach der Authentifizierung auf **Weiter**, um zum nächsten Bildschirm zu gelangen.
5. Auf der Seite **Replikate angeben** sind entlang der Oberkante mehrere Registerkarten aufgeführt: **Replikate**, **Endpunkte**, **Sicherungseinstellungen** und **Listener**. Klicken Sie auf der Registerkarte **Replikate** auf **Azure-Replikat hinzufügen…**, um den Assistenten zum Hinzufügen von Azure-Replikaten zu starten.
