...
> ![Linux][Logo_Linux] Linux
>
> [Erfassen eines virtuellen Linux-Computers zur Verwendung als Resource Manager-Vorlage][/linux/capture-image.md#step-2-create-vm-image]
>
>
...
* Verwenden Sie *sysprep* (unter Windows) bzw. *waagent -deprovision* (unter Linux), um die VM zu generalisieren (siehe [Technische Referenz zu Sysprep](https://technet.microsoft.com/library/cc766049.aspx) für Windows bzw. [Erfassen eines virtuellen Linux-Computers zur Verwendung als Resource Manager-Vorlage][/linux/capture-image.md#step-2-create-vm-image] für Linux).
* Melden Sie sich mit *Login-AzureRmAccount*
* Legen Sie das Abonnement Ihres Kontexts mit *Set-AzureRmContext* und dem Parameter „SubscriptionId“ oder „SubscriptionName“ fest (siehe <https://msdn.microsoft.com/library/mt619263.aspx>).
* Laden Sie die VHD mit *Add-AzureRmVhd* in ein Azure Storage-Konto hoch (siehe <https://msdn.microsoft.com/library/mt603554.aspx>).
