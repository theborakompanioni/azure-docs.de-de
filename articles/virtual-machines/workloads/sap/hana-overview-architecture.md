...
| --- | --- | --- | --- | --- |
| Optimiert für OLAP: SAP BW, BW/4HANA<br /> oder SAP HANA für generische OLAP-Workload | SAP HANA in Azure S72<br /> – 2 x Intel® Xeon®-Prozessor E7-8890 v3 |  768 GB |  3 TB | Verfügbar |
| --- | SAP HANA in Azure S144<br /> – 4 x Intel® Xeon®-Prozessor E7-8890 v3 |  1,5 TB |  6 TB | Wird nicht mehr angeboten |
| --- | SAP HANA in Azure S192<br /> – 4 x Intel® Xeon® Processor E7-8890 v4 |  2,0 TB |  8 TB | Verfügbar |
| --- | SAP HANA in Azure S384<br /> – 8 x Intel® Xeon® Processor E7-8890 v4 |  4,0 TB |  16 TB | Bestellbereit |
| Optimiert für OLTP: SAP Business Suite<br /> auf SAP HANA oder S/4HANA (OLTP),<br /> generisches OLTP | SAP HANA in Azure S72m<br /> – 2 x Intel® Xeon®-Prozessor E7-8890 v3 |  1,5 TB |  6 TB | Verfügbar |
|---| SAP HANA in Azure S144m<br /> – 4 x Intel® Xeon®-Prozessor E7-8890 v3 |  3,0 TB |  12 TB | Wird nicht mehr angeboten |
|---| SAP HANA in Azure S192m<br /> – 4 x Intel® Xeon® Processor E7-8890 v4 |  4,0 TB |  16 TB | Verfügbar |
|---| SAP HANA in Azure S384m<br /> – 8 x Intel® Xeon® Processor E7-8890 v4 |  6,0 TB |  18 TB | Bestellbereit |
|---| SAP HANA in Azure S384xm<br /> – 8 x Intel® Xeon® Processor E7-8890 v4 |  8,0 TB |  22 TB |  Bestellbereit |
|---| SAP HANA in Azure S576<br /> – 12 x Intel® Xeon® Processor E7-8890 v4 |  12,0 TB |  28 TB | Bestellbereit |
|---| SAP HANA in Azure S768<br /> – 16 x Intel® Xeon® Processor E7-8890 v4 |  16, 0 TB |  36 TB | Bestellbereit |
|---| SAP HANA in Azure S960<br /> – 20 x Intel® Xeon® Processor E7-8890 v4 |  20,0 TB |  46 TB | Bestellbereit |
| --- | --- | --- | --- | --- |
...
Beachten Sie unbedingt, dass der vollständige Infrastrukturstapel des Stapels für HANA (große Instanzen) nicht ausschließlich für die Verwendung durch einen einzelnen Kunden zugeordnet wird. Dies gilt für Regale mit Compute- und Speicherressourcen, die über ein in Azure bereitgestelltes Netzwerkfabric verbunden sind. Die Infrastruktur von HANA (große Instanzen) stellt wie Azure verschiedene &quot;Kundenmandanten&quot; bereit, die durch Netzwerkisolation voneinander getrennt sind. Daher beeinträchtigen diese Bereitstellungen von HANA (große Instanzen) sich nicht gegenseitig und sind für die jeweils anderen nicht sichtbar. Ein bereitgestellter Mandant im Stapel für große Instanzen wird für die Abrechnung einem Azure-Abonnement zugewiesen. Netzwerktechnisch kann jedoch auch über Azure-VNETs aus anderen Azure-Abonnements in der gleichen Azure-Registrierung darauf zugegriffen werden. Bei Bedarf können Sie auch einen getrennten HANA-Mandanten (großen Instanz) beantragen, wenn Sie mit einem anderen Azure-Abonnement in derselben Azure-Region bereitstellen.
...
- Im Gegensatz zu Azure ist der Server für SAP HANA in Azure (große Instanzen) für einen bestimmten Kunden vorgesehen. Ein Neustart oder das Herunterfahren des Servers führt nicht dazu, dass das Betriebssystem und SAP HANA auf einem anderen Server bereitgestellt werden. (Für SKUs der Klasse Typ I ist die einzige Ausnahme, wenn auf einem Server möglicherweise Probleme auftreten und eine erneute Bereitstellung auf einem anderen Server erfolgen muss.)
...
In einem Stapel von SAP HANA (große Instanzen) werden mehrere Kunden bereitgestellt, und jeder Kunde wird durch die Bereitstellung im eigenen VLAN von den anderen abgeschirmt. Um eine Verbindung von HANA (große Instanzen) mit einem Azure Virtual Network (VNet) herzustellen, stellen die Netzwerkkomponenten isoliert eine Verbindung der Einheiten für HANA (große Instanzen) der Mandanten mit Azure-VNets des Azure-Abonnements der Mandanten her. 
