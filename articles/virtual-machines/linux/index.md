---
title: "Dokumentation für virtuelle Azure-Computer unter Linux – Tutorials, API-Referenz | Microsoft-Dokumentation"
...
---
<div class="content">
    <h1>Dokumentation zu Linux-VMs</h1>
    <p style="padding-bottom: 0px; max-width: 1050px;">Azure Linux Virtual Machines bietet eine auf Red Hat, Ubuntu oder der von Ihnen gewünschten Linux-Verteilung basierende sichere, virtuelle On-Demand-Infrastruktur mit umfangreicher Skalierung.  Erfahren Sie anhand unserer Schnellstarts, Tutorials und Beispiele, wie Sie virtuelle Linux-Computer erstellen, konfigurieren, verwalten und skalieren.</p>
<h2 style="margin-top: 36px; margin-bottom: 0px;">Schnellstarts</h2>
<p style="margin-top: 6px; margin-bottom: 6px;">Erstellen eines virtuellen Linux-Computers über:</p>
<div class="ico48Case">
    <div class="ico48Link">die 
...
<div class="columnHolder">
    <div class="column50">
        ...
        <p>Erstellen und Bereitstellen von virtuellen Linux-Computern</p>
        <ul class="spaced">
            <li><a href="/azure/virtual-machines/virtual-machines-linux-tutorial-manage-vm?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json">Erstellen und Verwalten von virtuellen Linux-Computern</a></li>
            <li><a href="/azure/virtual-machines/virtual-machines-linux-tutorial-load-balance-nodejs?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json">Lastenausgleich für hoch verfügbare virtuelle Computer</a></li>
        </ul>
        <h2>Beispiele</h2>
        <p>Stellen Sie Ihre erste Anwendung in Azure bereit.</p>
        <ul class="spaced">
            <li><a href="/azure/virtual-machines/virtual-machines-linux-cli-samples">Azure-Befehlszeilenschnittstelle</a></li>
    ...
    <div class="column50" style="max-width: 400px">
        ...
        <a href="https://www.pluralsight.com/courses/managing-infrastructure-microsoft-azure-getting-started?twoid=d6abac77-7dcc-4d33-9e03-f85e78989f02">
            ...
            <p style="margin-top: 0px">Kostenloses PluralSight-Videotraining: Verwalten der Infrastruktur</a></p>
            ...
            <p style="margin-top: 0px">Kostenloses Pluralsight-Videotraining – Erste Schritte mit Virtual Machines</a></p>
        <p style="margin-top: 36px"></p>
        <a href="https://www.pluralsight.com/courses/azure-iaas-monitoring-management-getting-started?twoid=d6abac77-7dcc-4d33-9e03-f85e78989f02">
            ...
            <p style="margin-top: 0px">Kostenloses Pluralsight-Videotraining – Erste Schritte mit IaaS-Überwachung</a></p>
    </div>
</div>
<hr />
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/compute">REST-API-Referenz</a></p>
                    </div>
                </div>
            </div>
        </div>
