...
![Ein Browserfenster, das die Seite 'Hello World' in Azure anzeigt.](./media/python-django-web-app/mac-linux-django-helloworld-browser.png)
...
1. Befolgen Sie die [hier](quick-create-portal.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) aufgeführten Anweisungen, um einen virtuellen Azure-Computer der *Ubuntu Server 14.04 LTS*-Distribution zu erstellen.  Wenn Sie dies bevorzugen, können Sie die Kennwortauthentifizierung statt eines öffentlichen SSH-Schlüssels wählen.
