...
* [Erstellen eines virtuellen Linux-Computers mit der Azure CLI 2.0](quick-create-cli.md)
  ...
  * Erstellen Sie mit [az vm create](/cli/azure/vm#create) einen virtuellen Computer namens *myVM* mit dem aktuellen *UbuntuLTS*-Image, und generieren Sie SSH-Schlüssel (sofern diese nicht bereits in *~/.ssh* vorhanden sind):
