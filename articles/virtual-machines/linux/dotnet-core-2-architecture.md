---
title: Bereitstellen von Linux-Computeressourcen mit Azure Resource Manager-Vorlagen | Microsoft-Dokumentation
...
---
# <a name="application-architecture-with-azure-resource-manager-templates-for-linux-vms"></a>Anwendungsarchitektur mit Azure Resource Manager-Vorlagen für Linux-VMs
...
![Speicherkonto](./media/dotnet-core-2-architecture/storacct.png)
...
![Virtuelle Festplatten](./media/dotnet-core-2-architecture/vhd.png)
...
![Netzwerkschnittstelle](./media/dotnet-core-2-architecture/nic.png)
