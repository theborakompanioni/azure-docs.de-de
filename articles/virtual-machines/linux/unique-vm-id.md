---
title: Abrufen einer Azure-Linux-VM-ID | Microsoft-Dokumentation
description: "Beschreibt, wie Sie eine eindeutige ID für eine Azure-Linux-VM abrufen und verwenden."
...
Weitere Informationen finden Sie unter [Erstellen eines virtuellen Computers](../windows/creation-choices.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).

## <a name="connect-to-the-vm"></a>Herstellen der Verbindung zur VM
Weitere Informationen finden Sie unter [SSH von Linux](mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
