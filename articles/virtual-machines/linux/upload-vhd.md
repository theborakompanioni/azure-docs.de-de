...
Das folgende Beispiel erstellt eine Ressourcengruppe mit dem Namen *myResourceGroup* am Standort *eastus*: [Azure Managed Disks – Übersicht](../../storage/storage-managed-disks-overview.md)
```azurecli
az group create \
