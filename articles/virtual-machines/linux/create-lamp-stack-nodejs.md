...
- [Azure CLI 2.0:](create-lamp-stack.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) Unsere CLI der nächsten Generation für das Resource Manager-Bereitstellungsmodell
...
Falls Sie beim Erstellen eines virtuellen Linux-Computers Hilfe benötigen, helfen Ihnen diese [Informationen zum Erstellen eines virtuellen Linux-Computers](quick-create-cli.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) weiter. Als Nächstes müssen Sie eine SSH-Verbindung mit dem virtuellen Linux-Computer herstellen. Falls Sie beim Erstellen eines SSH-Schlüssels Hilfe benötigen, lesen Sie diese [Informationen zum Erstellen eines SSH-Schlüssels unter Linux/Mac](mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
