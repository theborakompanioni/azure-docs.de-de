...
![Screenshot](./media/jupyter-notebook/ipy-notebook-spectral.png): Analysieren der Struktur einer Tonaufnahme mithilfe von SciPy- und Matplotlib-Paketen.

## <a name="jupyter-two-ways-azure-notebooks-or-custom-deployment"></a>Zwei Möglichkeiten der Verwendung von Jupyter: Azure-Notebooks oder benutzerdefinierte Bereitstellung
...
## <a name="create-and-configure-a-vm-on-azure"></a>Erstellen und Konfigurieren einer VM in Azure
Zunächst müssen Sie einen virtuellen Computer (VM) erstellen, der in Azure ausgeführt wird.
...
Klicken Sie in Ihrer Netzwerksicherheitsgruppe auf **Netzwerkschnittstellen**, und notieren Sie sich die **öffentliche IP-Adresse**, da diese im nächsten Schritt für die Verbindung mit dem virtuellen Computer benötigt wird.

## <a name="install-required-software-on-the-vm"></a>Installieren der erforderlichen Software auf der VM
...
### <a name="installing-jupyter-on-ubuntu"></a>Installieren von Jupyter unter Ubuntu
...
#### <a name="installing-anaconda3-230-64-bit-on-ubuntu"></a>Installieren von Anaconda3 2.3.0 64 Bit unter Ubuntu
...
### <a name="configuring-jupyter-and-using-ssl"></a>Konfigurieren von Jupyter und Verwenden von SSL
...
## <a name="a-powerful-paradigm-live-computational-documents-with-rich-media"></a>Ein mächtiges Paradigma: Live-Berechnungsdokumente mit Rich-Media-Objekten
