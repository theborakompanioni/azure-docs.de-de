...
![Systemarchitektur](./media/mariadb-mysql-cluster/Setup.png)
...
9. Optimieren Sie die Leistung des Systems. Weitere Informationen finden Sie unter [Strategie zur Optimierung der Leistung](optimize-mysql.md).
...
3. Für den nächsten Schritt müssen Sie die interne IP-Adresse aller drei virtuellen Computer abrufen:
    ...
    ![Beziehen der IP-Adresse](./media/mariadb-mysql-cluster/IP.png)
...
![Endpunkt bearbeiten](./media/mariadb-mysql-cluster/Endpoint.PNG)

Aktivieren Sie **Gruppe mit Lastenausgleich neu konfigurieren**.

![Gruppe mit Lastenausgleich neu konfigurieren](./media/mariadb-mysql-cluster/Endpoint2.PNG)

Ändern Sie dann **Testintervall** in 5 Sekunden, und speichern Sie Ihre Änderungen.

![Testintervall ändern](./media/mariadb-mysql-cluster/Endpoint3.PNG)
...
Es empfiehlt sich unter Umständen, sich über [eine weitere Möglichkeit zur Erstellung eines MySQL-Clusters unter Linux](mysql-cluster.md) sowie über Möglichkeiten zum [Optimieren und Testen der MySQL-Leistung auf virtuellen Azure-Computern mit Linux](optimize-mysql.md) zu informieren.
