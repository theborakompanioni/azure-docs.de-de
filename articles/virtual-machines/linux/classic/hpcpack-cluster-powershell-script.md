...
* Unter [Erste Schritte mit Linux-Computeknoten in einem HPC Pack-Cluster in Azure](hpcpack-cluster.md) finden Sie Informationen zu unterstützten Linux-Distributionen sowie zum Verschieben von Daten und Senden von Aufträgen an HPC Pack-Cluster mit Linux-Serverknoten.
* Tutorials, in denen das Skript zum Erstellen eines Cluster und Ausführen einer Linux HPC-Workload verwendet wird, finden Sie in folgenden Artikeln:
  ...
  * [Ausführen von OpenFOAM mit Microsoft HPC Pack auf Linux-Serverknoten in Azure](hpcpack-cluster-openfoam.md)
  * [Ausführen von STAR-CCM+ mit Microsoft HPC Pack auf einem Linux-RDMA-Cluster in Azure](hpcpack-cluster-starccm.md)
