...
### [Verwalten von VMs mit Visual Studio](manage-visual-studio.md)
### [Überwachen von VMs mit der VM-Erweiterung für die Diagnose](../diagnostic-extension.md)
...
### [Verbinden von VMs mit einem virtuellen Netzwerk oder Clouddienst](connect-vms.md)

## Bereitstellen von Images
### [Erstellen und Hochladen einer VHD](create-upload-vhd.md)
### [Erstellen und Hochladen einer FreeBSD-VHD](freebsd-create-upload-vhd.md)
### [Liste der Oracle-VM-Images](oracle-images.md)
