...
Die N-Serie von virtuellen Linux-Computern unterstützt die folgenden Verteilungen aus dem Azure Marketplace sowie die angegebenen NVIDIA-Treiber.


| VM-Serie | Unterstützte Verteilungen | Unterstützte Treiber |
| --- | --- | --- |
| **NC** (Tesla K80-Karte) | Ubuntu 16.04 LTS<br/><br/> Red Hat Enterprise Linux 7.3<br/><br/> 7.3 (CentOS-basiert) | NVIDIA CUDA 8.0, Treiberverzweigung R375<br/>[Installationsschritte](#install-cuda-drivers-for-nc-vms) |
| **NV** (Tesla M60-Karte)| Ubuntu 16.04 LTS<br/><br/>Red Hat Enterprise Linux 7.3<br/><br/>7.3 (CentOS-basiert) | NVIDIA GRID 4.2, Treiberbranch R367<br/>[Installationsschritte](#install-grid-drivers-for-nv-vms) |
...
7. Fügen Sie nach Abschluss der Installation Folgendes zu `/etc/nvidia/gridd.conf.template` hinzu:
 
  ```
  IgnoreSP=TRUE
  ```
8. Starten Sie die VM neu, und fahren Sie mit der Überprüfung der Installation fort.
