<properties
   pageTitle=".NET Core-Tutorial für virtuelle Azure-Computer 1 | Microsoft Azure"
...
# Automatisieren von Anwendungsbereitstellungen auf virtuellen Azure-Computern
...
## Bereitstellen der Music Store-Anwendung
...
|---|---|
|SSHKEYDATA | SSH-Schlüsseldaten, die zum Schützen des Zugriffs auf den virtuellen Computer verwendet werden. Weitere Informationen zum Erstellen eines SSH-Schlüsselpaars finden Sie unter [Erstellen von SSH-Schlüsseln für Linux-VMs in Azure](./ virtual-machines-linux-mac-create-ssh-keys.md). |
...
[Schritt 1: Anwendungsarchitektur mit Azure Resource Manager-Vorlagen](./virtual-machines-linux-dotnet-core-2-architecture.md)
...
[Schritt 4: Anwendungsbereitstellung mit Azure Resource Manager-Vorlagen](./virtual-machines-linux-dotnet-core-5-app-deployment.md)
