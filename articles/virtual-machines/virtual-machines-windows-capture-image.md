<properties
	pageTitle="Erstellen eines VM-Image aus einer Azure-VM | Microsoft Azure"
...
>[AZURE.NOTE] Die VM muss in demselben Speicherkonto wie die ursprüngliche VHD enthalten sein.
