---
title: "CLI-Beispiele für den Schnellstart mit Azure Monitor | Microsoft Docs"
...
---
# <a name="azure-monitor--cross-platform-cli-quick-start-samples"></a>Azure Monitor – Schnellstartbeispiele für die plattformübergreifende Befehlszeilenschnittstelle
...
### <a name="create-a-log-alert-rule"></a>Erstellen einer Warnungsregel für ein Protokoll
```console
