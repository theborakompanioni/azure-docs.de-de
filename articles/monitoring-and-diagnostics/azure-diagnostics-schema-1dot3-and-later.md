---
title: "Konfigurationsschema für Azure-Diagnose 1.3, 1.4, 1.5, 1.6, 1.7 | Microsoft Docs"
description: "Schemaversion 1.3 und höher für Azure-Diagnose wird als Komponente des Microsoft Azure SDK geliefert."
...
Dies ist die JSON-Entsprechung der vorherigen XML-Konfigurationsdatei.  
```json
{
    "WadCfg": {
        "DiagnosticMonitorConfiguration": {
