...
## <a name="scale-based-on-other-metrics"></a>Skalieren basierend auf anderen Metriken
...
1. Wählen Sie in der Dropdownliste **Skalieren nach** die Einstellung **Zeitplan- und Leistungsregeln** aus: ![Leistungsregeln](./media/insights-how-to-scale/Insights_PerformanceRules.png)
...
### <a name="scaling-with-multiple-steps"></a>Skalieren in mehreren Schritten
...
1. Hierzu wählen Sie im Profil anstelle von **Immer** die Einstellung **Wiederholung** aus und geben an, wie oft das Profil angewendet werden soll.
...
8. Wählen Sie wie beim Standardprofil die **Tage** aus, für die dieses Profil gelten soll, und geben Sie die **Startzeit** tagsüber an.
