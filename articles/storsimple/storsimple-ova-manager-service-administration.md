---
title: StorSimple Manager Virtual Array-Verwaltung | Microsoft Docs
...
---
# <a name="use-the-storsimple-manager-service-to-administer-your-storsimple-virtual-array"></a>Verwalten des StorSimple Virtual Array mithilfe des StorSimple Manager-Diensts
...
## <a name="connect-to-the-storsimple-manager-service"></a>Herstellen einer Verbindung mit dem StorSimple Manager-Dienst
...
## <a name="navigate-the-storsimple-manager-service-ui"></a>Navigieren auf der Benutzeroberfläche des StorSimple Manager-Diensts
...
## <a name="use-the-storsimple-manager-service-to-perform-management-tasks"></a>Verwenden des StorSimple Manager-Diensts zum Durchführen von Verwaltungsaufgaben
...
| --- | --- | --- |
| Dienst erstellen</br>Löschen von Diensten</br>Abrufen des Dienstregistrierungsschlüssels</br>Dienstregistrierungsschlüssel erneut generieren |StorSimple Manager-Dienst |[Bereitstellen des StorSimple Manager-Diensts](storsimple-ova-manage-service.md) |
...
| Informationen zu Speicherkonten</br>Hinzufügen von Speicherkonten</br>Bearbeiten eines Speicherkontos</br>Löschen von Speicherkonten |StorSimple Manager-Dienst → Konfigurieren |[Verwalten von Speicherkonten für das StorSimple Virtual Array](storsimple-ova-manage-storage-accounts.md) |
...
| Konfigurieren von Warnungseinstellungen</br>Warnungsbenachrichtigungen empfangen</br>Warnungen verwalten</br>Überprüfen von Warnungen |StorSimple Manager-Dienst → Warnungen |[Anzeigen und Verwalten von Warnungen für das StorSimple Virtual Array](storsimple-ova-manage-alerts.md) |
...
| Softwareupdates installieren |StorSimple Manager-Dienst → Geräte → Wartung |[Virtual Array aktualisieren](storsimple-ova-install-update-01.md) |
