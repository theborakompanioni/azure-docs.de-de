...
4. Eine Benachrichtigung wird angezeigt, wenn die Test-E-Mail gesendet wird. 
   ...
   > [!NOTE]
   > Wenn die Testbenachrichtigung nicht gesendet werden kann, zeigt der StorSimple-Geräte-Manager-Dienst eine entsprechende Fehlermeldung an. Warten Sie einige Minuten, und versuchen Sie dann, die Testnachricht erneut zu senden. 
