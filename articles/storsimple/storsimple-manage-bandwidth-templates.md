...
3. Klicken Sie unten auf der Seite auf **Speichern** , um die Änderungen zu speichern. Klicken Sie am unteren Rand der Seite auf **Ja** , wenn Sie zur Bestätigung aufgefordert werden.
