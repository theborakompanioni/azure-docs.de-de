---
title: Automatisieren von DR für Dateifreigaben auf StorSimple mithilfe von Azure Site Recovery | Microsoft Docs
...
1. Trennen Sie das iSCSI-Ziel/die iSCSI-Ziele von den lokalen VMs, die Sie durch Azure Site Recovery schützen möchten:
   ...
   > 
   > 
2. [Aktivieren des Schutzes für virtueller Computer](../site-recovery/site-recovery-hyper-v-site-to-azure.md##step-6-enable-replication) der Dateiserver-VM aus dem Azure Site Recovery-Portal.
