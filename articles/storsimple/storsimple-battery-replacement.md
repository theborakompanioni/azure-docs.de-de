---
title: "Austauschen von Akkus bei Microsoft Azure StorSimple-Geräten | Microsoft-Dokumentation"
...
> [!IMPORTANT]
> Vor dem Entfernen und Austauschen eines Notfallakkus überprüfen Sie die Sicherheitsinformationen in der [Einführung in den Austausch von StorSimple-Hardwarekomponenten](storsimple-hardware-component-replacement.md).
> 
> 
...
1. Gehen Sie im klassischen Azure-Portal zu **Geräte** > **Wartung** > **Hardwarestatus**. Überprüfen Sie den Status des Akkus unter **Gemeinsam genutzte Komponenten**.
...
Im klassischen Azure-Portal wird unter **Hardwarestatus** auf der Seite **Wartung** angezeigt, ob der Akku fehlerhaft ist, oder ob seine Lebensdauer sich dem Ende zuneigt. Der Akkustatus wird durch **Akku in PCM 0** oder **Akku in PCM 1** unter **Gemeinsam genutzte Komponenten** angezeigt. Auf dieser Seite wird der Status **HERUNTERGESTUFT** angezeigt, wenn sich die Lebensdauer dem Ende zuneigt, und **FEHLGESCHLAGEN** zum Ende der Lebensdauer. 
...
* Wenn kein Stromausfall stattgefunden hat, das PCM eingeschaltet und mit dem Stromnetz verbunden ist, muss der Akku ausgetauscht werden. [Contact Microsoft Support](storsimple-contact-microsoft-support.md) .
