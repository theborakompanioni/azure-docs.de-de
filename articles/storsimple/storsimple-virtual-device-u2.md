...
| **Speichertyp** |Verwendet Azure Storage Standard für lokale Datenträger<br></br> Erfahren Sie, wie Sie ein [Storage Standard-Konto erstellen](). |Verwendet Azure Storage Premium für lokale Datenträger<sup>2</sup> <br></br> Erfahren Sie, wie Sie ein [Storage Premium-Konto erstellen](../storage/storage-premium-storage.md#create-and-use-a-premium-storage-account-for-a-virtual-machine-data-disk). |
...
[!INCLUDE [Erstellen eines virtuellen Geräts](../../includes/storsimple-create-virtual-device-u2.md)]
...
[!INCLUDE [Konfigurieren und Registrieren eines virtuellen Geräts](../../includes/storsimple-configure-register-virtual-device.md)]
...
[!INCLUDE [Konfigurieren der Remoteverwaltung über HTTP für virtuelle Geräte](../../includes/storsimple-configure-remote-management-http-device.md)]
...
[!INCLUDE [Erstellen öffentlicher Endpunkte auf einem virtuellen Gerät](../../includes/storsimple-create-public-endpoints-virtual-device.md)]
...
[!INCLUDE [Beenden und Neustarten eines virtuellen Geräts](../../includes/storsimple-stop-restart-virtual-device.md)]
...
[!INCLUDE [Herunterfahren eines virtuellen Geräts](../../includes/storsimple-shutdown-virtual-device.md)]

[!INCLUDE [Löschen eines virtuellen Geräts](../../includes/storsimple-delete-virtual-device.md)]
