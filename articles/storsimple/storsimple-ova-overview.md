---
title: StorSimple Virtual Array – Übersicht | Microsoft Docs
...
| Vereinfachte Speicherverwaltung |StorSimple ermöglicht die zentrale Verwaltung mehrerer Geräte in der Cloud über den StorSimple Manager. |
...
| --- | --- | --- | --- | --- |
| ROBO-Zusammenarbeit |Dateifreigabe |Ja |Informationen finden Sie im Thema zu den [Obergrenzen für Dateiserver](storsimple-ova-limits.md). <br>Informationen finden Sie im Thema zu den [Systemanforderungen für unterstützte SMB-Versionen](storsimple-ova-system-requirements.md). |Alle Versionen |
...
## <a name="virtual-array-components"></a>Virtual Array-Komponenten
...
* [Lokale Webbenutzeroberfläche:](#local-web-user-interface) eine webbasierte UI, die zum Konfigurieren des Geräts verwendet wird. So kann die Verbindung mit dem lokalen Netzwerk hergestellt und das Gerät anschließend beim StorSimple Manager-Dienst registriert werden. 
* [Befehlszeilenschnittstelle:](#command-line-interface) eine Windows PowerShell-Schnittstelle, die Sie zum Starten einer Supportsitzung auf dem Virtual Array verwenden können.
...
> [!NOTE]
> Ein Virtual Array kann nicht erweitert werden. Daher ist es wichtig, ausreichend Speicherplatz bereitzustellen, wenn Sie das virtuelle Gerät erstellen. 
> 
> 
...
> [!NOTE]
> Im Virtual Array gespeicherte Daten werden nicht dedupliziert oder komprimiert. Die Deduplizierung und Komprimierung wird jeweils direkt vor dem Senden der Daten in die Cloud durchgeführt.
> 
> 
