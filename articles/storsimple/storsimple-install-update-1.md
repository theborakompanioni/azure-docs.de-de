...
4. Navigieren Sie im klassischen Azure-Portal zur Seite **Wartung**, und klicken Sie am unteren Seitenrand auf **Updates scannen**, um nach Windows-Updates zu suchen. Klicken Sie anschließend auf **Updates installieren**. Sie sind fertig, wenn alle Updates erfolgreich installiert wurden.
