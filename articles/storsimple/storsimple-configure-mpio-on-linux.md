...
2. **Ausnahmen für schwarze Liste** *(blacklist\_exceptions)*: Sie können festlegen, dass bestimmte Geräte als Multipfadgeräte behandelt werden, selbst wenn Sie in der schwarzen Liste aufgeführt sind.
