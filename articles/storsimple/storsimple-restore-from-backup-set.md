...
description: 'Erläutert, wie Sie die Seite '
;sicherungskatalog";: ''
des: ''
storsimple: ''
manager-diensts: ''
...
6. Überprüfen Sie die Informationen für die Wiederherstellung, und klicken Sie auf das Häkchensymbol ![Häkchensymbol](./media/storsimple-restore-from-backup-set/HCS_CheckIcon.png). Damit initiieren Sie einen Wiederherstellungsauftrag, den Sie auf der Seite **Jobs** anzeigen können.
