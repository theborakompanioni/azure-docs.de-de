---
title: "Installieren von Update 2 auf dem StorSimple-Gerät | Microsoft Docs"
...
---
# <a name="install-update-2-on-your-storsimple-device"></a>Installieren von Update 2 auf Ihrem StorSimple-Gerät
...
## <a name="install-update-2-via-the-azure-classic-portal"></a>Installieren von Update 2 über das klassische Azure-Portal
...
1. Stellen Sie sicher, dass auf Ihrem Gerät **Update 2 der StorSimple 8000-Serie (6.3.9600.17673)**ausgeführt wird. Das **Datum der letzten Aktualisierung** hat sich ebenfalls geändert. Sie werden auch feststellen, dass Wartungsmodus-Updates verfügbar sind. (Diese Meldung wird nach der Updateinstallation unter Umständen noch bis zu 24 Stunden lang angezeigt.)
...
## <a name="install-update-2-as-a-hotfix"></a>Installieren von Update 2 als Hotfix
...
| 3 |KB3080728 |Storport-Fehlerbehebung  </br>  Windows Server 2012 R2 |Normal |
| 4 |KB3090322 |Spaceport-Fehlerbehebung  </br>  Windows Server 2012 R2 |Normal |
