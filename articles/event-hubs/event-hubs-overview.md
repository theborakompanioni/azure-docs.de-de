---
title: "Übersicht über Azure Event Hubs | Microsoft Docs"
...
Weitere Informationen zur Verwendung von SAS finden Sie unter [SAS-Authentifizierung (Shared Access Signature) mit Service Bus](../service-bus-messaging/service-bus-shared-access-signature-authentication.md).

### <a name="common-publisher-tasks"></a>Allgemeine Herausgeberaufgaben
In diesem Abschnitt werden allgemeine Aufgaben für Ereignisherausgeber beschrieben.

#### <a name="acquire-a-sas-token"></a>Abrufen eines SAS-Tokens
...
### <a name="event-consumer"></a>Ereignisconsumer
