---
title: "Übertragen von SQL-Daten in Azure Event Hubs mithilfe von Pull | Microsoft Docs"
...
---
# <a name="pulling-data-from-sql-into-an-azure-event-hub"></a>Übertragen von Daten per Pull aus SQL in einen Azure Event Hub
...
2. Die SQL-Tabelle muss über ein Feld mit einer eindeutigen und sich erhöhenden Zahl verfügen, z. B. eine Datensatznummer. Dies kann einfach ein Feld namens „Id“ oder ein anderer Wert sein, der sich beim Hinzufügen von Datensätzen zur Datenbank erhöht, z. B. „Creation_time“ oder „Sequence_number“. Die Anwendung erkennt und speichert den Wert des Felds bei jeder Iteration. In jedem nachfolgenden Durchlauf der Schleife fragt die Anwendung im Wesentlichen die Tabelle nach allen Datensätzen ab, in denen der Wert dieses Felds den Wert übersteigt, der beim letzten Durchlaufen der Schleife erkannt wurde. Diesen letzten Wert bezeichnen wir als „Offset“.
