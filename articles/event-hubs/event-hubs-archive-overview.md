...
Nach der Konfiguration erstellt Event Hubs Archive im Azure-Speicherkonto Dateien und Container, die im konfigurierten Zeitfenster bereitgestellt werden. Sie können diese Dateien mit einem beliebigen Tool wie beispielsweise [Azure-Speicher-Explorer][Azure-Speicher-Explorer] anzeigen. Sie können die Dateien zur Bearbeitung lokal herunterladen.
