...
2. Löschen Sie die folgenden Dateien im Projekt:
    ...
    ```
3. Schließen Sie die Projektmappe, und entfernen Sie die folgenden Zeilen aus der XPROJ-Datei:
...
5. Entfernen Sie die folgenden Zeilen aus „Properties\\launchSettings.json“:
    ...
    ```
6. Entfernen Sie die folgenden Docker-bezogenen Dateien aus „project.json“ (unter „publishOptions“):
