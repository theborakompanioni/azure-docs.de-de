...
## <a name="documentdb-access-control-concepts"></a>Zugriffssteuerungskonzepte in DocumentDB
...
## <a name="working-with-documentdb-master-and-read-only-keys"></a>Arbeiten mit DocumentDB-Hauptschlüsseln und Schlüsseln mit Leseberechtigung
...
## <a name="overview-of-documentdb-resource-tokens"></a>Übersicht über DocumentDB-Ressourcentoken
...
## <a name="working-with-documentdb-users-and-permissions"></a>Arbeiten mit DocumentDB-Benutzern und -Berechtigungen
...
> [!NOTE]
> Jeder DocumentDB-Benutzer hat eine PermissionsLink-Eigenschaft, mit der die Liste der dem Benutzer zugeordneten Berechtigungen abgerufen werden kann.
> 
> 
...
> [!TIP]
> Ressourcentoken verfügen über einen gültigen Zeitspannenwert von einer Stunde.  Die Gültigkeitsdauer des Tokens kann bis maximal fünf Stunden angegeben werden.
> 
> 
