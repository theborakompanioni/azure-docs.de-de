...
| Garantie | STARK (Strong) | Begrenzte Veraltung (Bounded staleness) | SITZUNG | Letztlich (Eventual) |
| --- | --- | --- | --- | --- |
...
| **Lesen der eigenen Schreibvorgänge** |Ja |Ja (in der Region des Schreibvorgangs) | Ja |Nein |
...
> [!NOTE]
> Das Konfigurieren der Standardkonsistenzebene wird im [Azure DocumentDB-Emulator](documentdb-nosql-local-emulator.md) nicht unterstützt. 
...
| Keine |Wählen Sie STARK, BEGRENZTE VERALTUNG, SITZUNG oder LETZTLICH. |Nicht zutreffend |
