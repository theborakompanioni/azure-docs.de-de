...
Wenn Sie Daten in eine API für MongoDB-Datenbank importieren, folgen Sie den Anweisungen in [Migrieren von Daten zu DocumentDB mit Protokollunterstützung für MongoDB](documentdb-mongodb-migrate.md).
...
> [!TIP]
> Das DocumentDB-Tool zum Importieren von Daten unterstützt auch das Importieren von Daten aus dem [DocumentDB Emulator](documentdb-nosql-local-emulator.md). Legen Sie beim Importieren von Daten aus einem lokalen Emulator den Endpunkt auf „https://localhost:<port>“ fest. 
> 
> 
