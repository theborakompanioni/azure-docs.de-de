...
Kopieren Sie den folgenden Code, und fügen Sie ihn in die **GetStartedDemo**-Methode unterhalb der Datenbankerstellung ein. Dadurch wird eine Dokumentsammlung mit dem Namen *FamilyCollection* erstellt.
