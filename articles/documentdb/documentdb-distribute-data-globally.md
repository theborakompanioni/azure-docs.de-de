...
## <a name="a-idenableglobaldistributionaenabling-turn-key-global-distribution"></a><a id="EnableGlobalDistribution"></a>Aktivieren der sofort einsatzbereiten globalen Verteilung
...
### <a name="a-idregionalpresenceaubiquitous-regional-presence"></a><a id="RegionalPresence"></a>Ubiquitäre regionale Präsenz 
...
### <a name="a-idunlimitedregionsperaccountaassociating-an-unlimited-number-of-regions-with-your-documentdb-database-account"></a><a id="UnlimitedRegionsPerAccount"></a>Zuordnen einer unbegrenzten Anzahl von Regionen zu Ihrem DocumentDB-Datenbankkonto
...
### <a name="a-idpolicybasedgeofencingapolicy-based-geo-fencing"></a><a id="PolicyBasedGeoFencing"></a>Richtlinienbasiertes Geofencing
...
### <a name="a-iddynamicallyaddregionsadynamically-add-and-remove-regions"></a><a id="DynamicallyAddRegions"></a>Dynamisches Hinzufügen und Entfernen von Regionen
...
### <a name="a-idfailoverprioritiesafailover-priorities"></a><a id="FailoverPriorities"></a>Failoverprioritäten
...
### <a name="a-idofflineregionsadynamically-taking-a-region-offline"></a><a id="OfflineRegions"></a>Dynamisches Offlineschalten einer Region
...
### <a name="a-idconsistencylevelsamultiple-well-defined-consistency-models-for-globally-replicated-databases"></a><a id="ConsistencyLevels"></a>Mehrere klar definierte Konsistenzmodelle für global replizierte Datenbanken
...
### <a name="a-idtunableconsistencyatunable-consistency-for-globally-replicated-databases"></a><a id="TunableConsistency"></a>Verschiedene Konsistenzeinstellungen für global replizierte Datenbanken
...
### <a name="a-iddynamicallyconfigurablereadwriteregionsadynamically-configurable-read-and-write-regions"></a><a id="DynamicallyConfigurableReadWriteRegions"></a>Dynamisch konfigurierbare Lese- und Schreibregionen
Mit DocumentDB können Sie die (der Datenbank zugeordneten) Regionen für „Lesen“, „Schreiben“ oder „Lesen/Schreiben“ konfigurieren. 

### <a name="a-idelasticallyscalethroughputaelastically-scaling-throughput-across-azure-regions"></a><a id="ElasticallyScaleThroughput"></a>Elastisches Skalieren des Durchsatzes für Azure-Regionen
...
### <a name="a-idgeolocalreadsandwritesageo-local-reads-and-writes"></a><a id="GeoLocalReadsAndWrites"></a>Geolokale Lese- und Schreibvorgänge
...
### <a name="a-idmanualfailoveramanually-initiate-regional-failover"></a><a id="ManualFailover"></a>Manuelles Initiieren eines regionalen Failovers
...
### <a name="a-idautomaticfailoveraautomatic-failover"></a><a id="AutomaticFailover"></a>Automatisches Failover
...
### <a name="a-idgranularfailoveradesigned-for-different-failover-granularities"></a><a id="GranularFailover"></a>Konzipiert für verschiedene Failovergranularitäten
...
### <a name="a-idmultihomingapisamulti-homing-apis"></a><a id="MultiHomingAPIs"></a>Multihosting-APIs
...
### <a name="a-idtransparentschemamigrationatransparent-and-consistent-database-schema-and-index-migration"></a><a id="TransparentSchemaMigration"></a>Transparente und konsistente Migration von Datenbankschemas und Indizes 
...
### <a name="a-idcomprehensiveslasacomprehensive-slas-beyond-just-high-availability"></a><a id="ComprehensiveSLAs"></a>Umfassende, über bloße Hochverfügbarkeit hinausgehende SLAs
...
## <a name="a-idlatencyguaranteesalatency-guarantees"></a><a id="LatencyGuarantees"></a>Latenzgarantien
...
### <a name="a-idlatencyandconsistencyalatencys-relationship-with-consistency"></a><a id="LatencyAndConsistency"></a>Zusammenhang zwischen Latenz und Konsistenz 
...
### <a name="a-idlatencyandavailabilityalatencys-relationship-with-availability"></a><a id="LatencyAndAvailability"></a>Zusammenhang zwischen Latenz und Verfügbarkeit 
...
### <a name="a-idlatencyandthroughputalatencys-relationship-with-throughput"></a><a id="LatencyAndThroughput"></a>Zusammenhang zwischen Latenz und Durchsatz
...
## <a name="a-idconsistencyguaranteesaconsistency-guarantees"></a><a id="ConsistencyGuarantees"></a>Konsistenzgarantien
...
### <a name="a-idconsistencyandavailabilityaconsistencys-relationship-with-availability"></a><a id="ConsistencyAndAvailability"></a>Zusammenhang zwischen Konsistenz und Verfügbarkeit
...
### <a name="a-idconsistencyandavailabilityaconsistencys-relationship-with-latency"></a><a id="ConsistencyAndAvailability"></a>Zusammenhang zwischen Konsistenz und Latenz
...
### <a name="a-idconsistencyandthroughputaconsistencys-relationship-with-throughput"></a><a id="ConsistencyAndThroughput"></a>Zusammenhang zwischen Konsistenz und Durchsatz
...
## <a name="a-idthroughputguaranteesathroughput-guarantees"></a><a id="ThroughputGuarantees"></a>Durchsatzgarantien 
...
### <a name="a-idthroughputandconsistencyathroughputs-relationship-with-consistency"></a><a id="ThroughputAndConsistency"></a>Zusammenhang zwischen Durchsatz und Konsistenz 
Siehe [Zusammenhang zwischen Konsistenz und Durchsatz](#ConsistencyAndThroughput).

### <a name="a-idthroughputandavailabilityathroughputs-relationship-with-availability"></a><a id="ThroughputAndAvailability"></a>Zusammenhang zwischen Durchsatz und Verfügbarkeit
...
## <a name="a-idavailabilityguaranteesaavailability-guarantees"></a><a id="AvailabilityGuarantees"></a>Verfügbarkeitsgarantien
...
### <a name="a-idavailabilityandconsistencyaavailabilitys-relationship-with-consistency-latency-and-throughput"></a><a id="AvailabilityAndConsistency"></a>Zusammenhang zwischen Verfügbarkeit, Konsistenz, Latenz und Durchsatz
...
## <a name="a-idreferencesareferences"></a><a id="References"></a>Referenzen
