...
![Azure Cosmos DB ist in allen Azure-Regionen verfügbar](./media/documentdb-distribute-data-globally/azure-regions.png)
...
![Azure Cosmos DB-Datenbankkonto, das sich über 25 Azure-Regionen erstreckt](./media/documentdb-distribute-data-globally/documentdb-spanning-regions.png)
...
![Konfigurieren von Failoverprioritäten mit Azure Cosmos DB](./media/documentdb-distribute-data-globally/documentdb-failover-priorities.png)
...
Azure Cosmos DB macht [mehrere klar definierte Konsistenzebenen](documentdb-consistency-levels.md) mit SLA-Abdeckung verfügbar. In Abhängigkeit von der Workload/den Szenarien können Sie aus den verfügbaren Optionen ein bestimmtes Konsistenzmodell auswählen. 
...
Informationen zum Konfigurieren der Leseeinstellungen für die [DocumentDB](../cosmos-db/tutorial-global-distribution-documentdb.md)-, [Graph](../cosmos-db/tutorial-global-distribution-graph.md)-, [Table](../cosmos-db/tutorial-global-distribution-table.md)- und [MongoDB](../cosmos-db/tutorial-global-distribution-mongodb.md)-APIs finden Sie in den verknüpften spezifischen Artikeln.
...
![Azure Cosmos DB – elastisch bereitgestellter Durchsatz](./media/documentdb-distribute-data-globally/documentdb-elastic-throughput.png)
...
![Azure Cosmos DB – für Kunden sichtbare SLA-Metriken](./media/documentdb-distribute-data-globally/documentdb-customer-slas.png)
...
* Informationen zum Implementieren von Architekturen mit mehreren Mastern mit Azure Cosmos DB finden Sie unter [Multi-master database architectures with Azure Cosmos DB](documentdb-multi-region-writers.md) (Architekturen mit mehreren Mastern mit Azure Cosmos DB).
* Weitere Informationen zur Funktionsweise von automatischem und manuellem Failover in Azure Cosmos DB finden Sie unter [Regional Failovers in Azure Cosmos DB](documentdb-regional-failovers.md) (Regionale Failover in Azure Cosmos DB).
