...
Azure Cosmos DB bietet nun zusätzliche Unterstützung für die automatische Partitionierung durch [REST-API-Version 2015-12-16](https://msdn.microsoft.com/library/azure/dn781481.aspx). Um partitionierte Container erstellen zu können, müssen Sie die SDK-Versionen 1.6.0 oder neuer in einer der unterstützten SDK Plattformen (.NET, Node.js, Java, Python, MongoDB) herunterladen. 
...
* Nutzen Sie Cosmos DB, um Skalierungs- und Leistungstests durchzuführen. Ein Beispiel finden Sie unter [Leistungs- und Skalierungstests mit Azure Cosmos DB](documentdb-performance-testing.md).
...
* Erfahren Sie mehr über den [bereitgestellten Durchsatz in Azure Cosmos DB](documentdb-request-units.md).
