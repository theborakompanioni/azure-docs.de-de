---
title: Ressourcenmodell und Konzepte von Azure DocumentDB | Microsoft-Dokumentation
...
---
# <a name="documentdb-hierarchical-resource-model-and-core-concepts"></a>Hierarchisches Ressourcenmodell und wichtige Konzepte von DocumentDB
...
> [!NOTE]
> DocumentDB bietet ein hoch effizientes TCP-Protokoll mit einem RESTful-basierten Kommunikationsmodell, das über das [.NET Client-SDK](https://msdn.microsoft.com/library/azure/dn781482.aspx)verfügbar ist.
> 
> 
...
Im Azure-Portal unter können Sie unter [http://portal.azure.com/](documentdb-create-account.md) [DocumentDB-Datenbankkonten erstellen und verwalten](https://portal.azure.com/). Das Erstellen und Verwalten eines Datenbankkontos erfordert Administratorzugriff und kann nur unter Ihrem Azure-Abonnement ausgeführt werden. 
...
Sie können beliebige JSON-Dokumente zu einer Sammlung hinzufügen, sie dort ersetzen, löschen, lesen, aufzählen und abfragen. DocumentDB erfordert weder Schema noch sekundäre Indizes, um die dokumentübergreifende Abfrage in einer Sammlung zu unterstützen. Die maximale Größe für ein Dokument beträgt 2 MB.   
