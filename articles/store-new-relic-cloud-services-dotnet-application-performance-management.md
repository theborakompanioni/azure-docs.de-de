...
##Verwenden von New Relic mit Azure
...
* [New Relic for .NET](https://docs.newrelic.com/docs/agents/net-agent/getting-started/new-relic-net) (New Relic für .NET)
* [Instrument a .NET Worker Role on Azure Cloud service](https://docs.newrelic.com/docs/agents/net-agent/azure-installation/instrument-net-worker-role-azure-cloud-service) (Instrumentieren einer .NET-Workerrolle für den Azure-Clouddienst)
* [New Relic for the Microsoft Azure Cloud platform](https://docs.newrelic.com/docs/agents/net-agent/azure-installation/azure-cloud-services) (New Relic für die Microsoft Azure Cloud-Plattform)
* [New Relic for the Microsoft Azure App Services](https://docs.newrelic.com/docs/agents/net-agent/azure-installation/azure-portal) (New Relic für Microsoft Azure App Services)
* [New Relic/Azure troubleshooting](https://docs.newrelic.com/docs/agents/net-agent/azure-troubleshooting) (Problembehandlung für New Relic/Azure)
