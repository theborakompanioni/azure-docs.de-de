<properties
	pageTitle="Installieren des Azure Toolkit für IntelliJ | Microsoft Azure"
...
## So installieren Sie das Azure Toolkit für IntelliJ über das Dialogfeld „Einstellungen“
...
1. Geben Sie im Dialogfeld **Browse Repositories** (Repositorys durchsuchen) in das Suchfeld „Azure“ ein. Markieren Sie **Azure Toolkit for IntelliJ** (Azure Toolkit für IntelliJ), und klicken Sie dann auf **Install** (Installieren).
    ...
    ![Das Azure Toolkit für IntelliJ suchen][03]
...
## So installieren Sie das Azure Toolkit für IntelliJ über den Startbildschirm
