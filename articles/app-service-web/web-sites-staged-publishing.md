---
title: Einrichten von Stagingumgebungen für Web-Apps in Azure App Service
...
2. Klicken Sie auf **Einstellungen** und dann auf **Bereitstellungsslots**. Klicken Sie dann auf dem Blatt **Bereitstellungsslots**auf **Bereitstellungsslot hinzufügen**.
   ...
   > 
   > 
3. Weisen Sie dem Slot auf dem Blatt **Slot hinzufügen** einen Namen zu, und wählen Sie aus, ob Sie die Web-App-Konfiguration von einem anderen vorhandenen Bereitstellungsslot klonen möchten. Klicken Sie auf das Häkchen, um fortzufahren.
...
4. Klicken Sie auf dem Blatt **Bereitstellungsslots** auf den Bereitstellungsslot, um ein Blatt für den Slot mit einem Satz von Metriken und Konfiguration wie bei anderen Web-Apps zu öffnen. **Ihr Web-App-Name-Bereitstellungsslot-Name** wird oben im Blatt angezeigt, um Sie daran zu erinnern, dass der Bereitstellungsslot angezeigt wird.
...
> [!IMPORTANT]
> Bevor Sie eine Web-App aus einem Bereitstellungsslot in die Produktion überführen, stellen Sie sicher, dass alle nicht Slot-spezifischen Einstellungen im Austauschziel genau wie gewünscht konfiguriert sind.
> 
> 
...
2. Klicken Sie auf **OK**, um den Vorgang abzuschließen. Wenn der Vorgang abgeschlossen ist, wurden die Bereitstellungsslots ausgetauscht.
...
2. Klicken Sie auf **Anwendungseinstellungen**. Wählen Sie**Ein** für **Auto Swap**, wählen Sie unter **Auto Swap-Slot** den gewünschten Zielslot aus, und klicken Sie in der Befehlsleiste auf **Speichern**. Stellen Sie sicher, dass die Konfiguration für den Slot genau der für den Zielslot vorgesehenen Konfiguration entspricht.
   ...
   > [!NOTE]
   > Um Auto Swap für Ihre Web-App zu testen, können Sie zunächst unter **Auto Swap-Slot** einen Nicht-Produktionszielslot auswählen, um sich mit der Funktion vertraut zu machen.
   > 
   > 
