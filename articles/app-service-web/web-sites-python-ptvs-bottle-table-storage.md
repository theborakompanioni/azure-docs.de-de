...
2. Die Projektvorlagen aus den [Python Tools 2.2 für Visual Studio, Beispiel-VSIX] sind unter **Python** > **Beispiele** verfügbar. Wählen Sie **Polls Bottle-Webprojekt** aus, und klicken Sie auf "OK", um das Projekt zu erstellen.
