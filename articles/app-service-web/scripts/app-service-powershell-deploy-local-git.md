...
Stellen Sie vor dem Ausführen dieses Skripts sicher, dass über das Cmdlet `Login-AzureRmAccount` eine Verbindung mit Azure hergestellt wurde und dass Ihr Anwendungscode in ein lokales Git-Repository übernommen wurde.
