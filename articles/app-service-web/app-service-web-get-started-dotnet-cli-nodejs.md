---
title: "Bereitstellen Ihrer ersten ASP.NET-Web-App für Azure in fünf Minuten | Microsoft-Dokumentation"
...
---
# <a name="deploy-your-first-aspnet-web-app-to-azure-in-five-minutes"></a>Bereitstellen Ihrer ersten ASP.NET-Web-App für Azure in fünf Minuten
...
4. Wechseln Sie in ein Arbeitsverzeichnis (`CD`), und klonen Sie die ASP.NET-Beispiel-App.
...
6. Erstellen Sie die App Service-App-Ressource in Azure mit einem eindeutigen App-Namen und dem zuvor konfigurierten Bereitstellungsbenutzer. Geben Sie die Zahl der gewünschten Region ein, wenn Sie dazu aufgefordert werden.
    ...
    ![Erstellen der Azure-Ressource für Ihre erste Web-App in Azure](./media/app-service-web-get-started-languages/dotnet-site-create.png)
