...
3. Klicken Sie auf **Tool installieren**, um den Migrations-Assistenten für Web-Apps auf Ihrem Computer zu installieren.
   ...
   > 
   > 
4. Klicken Sie im Bildschirm **Anwendungsinstallation** auf **Installieren**, um die Installation auf Ihrem Computer vorzunehmen. Bei Bedarf werden auch die entsprechenden Abhängigkeiten wie Web Deploy, DacFX und IIS installiert.
