...
WebJobs-Bereitstellungsfeatures stehen in Visual Studio zur Verfügung, wenn Sie das Azure SDK für .NET installieren:

* [Azure SDK für .NET (Visual Studio)](https://azure.microsoft.com/downloads/).
