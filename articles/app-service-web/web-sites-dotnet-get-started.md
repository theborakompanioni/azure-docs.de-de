---
title: Bereitstellen einer ASP.NET-App für Azure App Service mit Visual Studio | Microsoft Docs
...
9. Vergewissern Sie sich im Dialogfeld **Neues ASP.NET-Projekt** im Abschnitt **Microsoft Azure**, dass **In der Cloud hosten** und in der Dropdownliste die Option **App Service** ausgewählt ist.
...
1. Klicken Sie im Dialogfeld **App Service erstellen** auf **Konto hinzufügen**, und melden Sie sich dann mit der ID und dem Kennwort des Kontos an, mit dem Sie Ihr Azure-Abonnement verwalten.
