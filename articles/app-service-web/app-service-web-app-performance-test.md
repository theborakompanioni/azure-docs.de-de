---
title: Testen der Leistung einer Azure-Web-App | Microsoft Docs
...
1. Melden Sie sich beim [Azure-Portal](https://portal.azure.com) an. Um ein Visual Studio Team Services-Konto zu verwenden, dessen Besitzer Sie sind, melden Sie sich als Kontobesitzer an.
...
1. Befolgen Sie die Schritte oben zum Öffnen des Blatts **Neuer Leistungstest**. Wählen Sie auf diesem Blatt die Option „CONFIGURE TEST USING“ (TEST KONFIGURIEREN MIT) aus, um das Blatt **Configure test using** (Test konfigurieren mit) zu öffnen.  
...
2. Überprüfen Sie, ob als „TESTTYP“ **Visual Studio Web Test** (Visual Studio-Webtest) festgelegt ist, und wählen Sie die HTTP-Archivdatei aus. Verwenden Sie das Ordnersymbol, um das Dialogfeld für die Dateiauswahl zu öffnen.
