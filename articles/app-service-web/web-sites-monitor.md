...
> [AZURE.NOTE] Falls der Befehl **azure** nicht installiert ist, finden Sie Informationen zur Installation und Konfiguration unter [Installieren der Azure-Befehlszeilenschnittstelle](../xplat-cli-install.md).
