---
title: Erweiterte Konfiguration und Erweiterungen von Azure App Service-Web-Apps
...
---
# <a name="azure-app-service-web-app-advanced-config-and-extensions"></a>Erweiterte Konfiguration und Erweiterungen von Azure App Service-Web-Apps
...
## <a name="a-idtransformaadvanced-configuration-through-applicationhostconfig"></a><a id="transform"></a>Erweiterte Konfiguration durch "ApplicationHost.config"
...
## <a name="a-idextenda-extend-your-web-app"></a><a id="extend"></a> Erweitern Ihrer Web-App
### <a name="a-idoverviewa-overview-of-private-web-app-extensions"></a><a id="overview"></a> Überblick über private Web-App-Erweiterungen
...
### <a name="a-idsitesamplea-web-app-extension-example-php-manager"></a><a id="SiteSample"></a> Beispiel für eine Web-App-Erweiterung: PHP Manager
...
#### <a name="a-idphpwebappa-the-php-manager-web-application"></a><a id="PHPwebapp"></a> Die PHP-Manager-Webanwendung
...
#### <a name="a-idxdta-the-applicationhostxdt-file"></a><a id="XDT"></a> Die Datei "applicationHost.xdt"
Der Code für Ihre Web-App-Erweiterung wird unter „%HOME%\SiteExtensions\[Name-der-Erweiterung]“ gespeichert. Dies wird als Erweiterungsstamm bezeichnet.  
...
### <a name="a-iddeploya-web-app-extension-deployment"></a><a id="deploy"></a> Bereitstellung von Web-App-Erweiterungen
