...
4. Beginnen Sie im linken Menü, und klicken Sie auf **App Services** > **&lt;App-Name>** > **Tools**.
    ...
    >[AZURE.TIP] Wenn Sie anstelle von **Tools** auf **Einstellungen** klicken, können Sie auf das Blatt **Anwendungseinstellungen** 
 zugreifen. Darin können Sie – wie eben durchgeführt – PHP-Versionen, App-Einstellungen und virtuelle Verzeichnisse festlegen. 
    
4. Klicken Sie auf **Composer** > **Hinzufügen** , um eine Erweiterung hinzuzufügen.

4. Wählen Sie auf dem [Blatt](../azure-portal-overview.md) **Erweiterung wählen** die Option **Composer**. (Ein *Blatt* ist eine Portalseite, die horizontal geöffnet wird.)

4. Klicken Sie auf dem Blatt **Rechtliche Bedingungen akzeptieren** auf **OK**. 

5. Klicken Sie auf dem Blatt **Erweiterung hinzufügen** auf **OK**.
...
4. Klicken Sie auf dem Blatt Ihrer Web-App auf **Einstellungen** >  > **Anwendungseinstellungen**.
