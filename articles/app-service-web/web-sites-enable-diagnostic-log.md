...
> [!NOTE]
> Wenn Sie [den Zugriffsschlüssel für Ihr Speicherkonto neu generieren](../storage/storage-create-storage-account.md#view-copy-and-regenerate-storage-access-keys), müssen Sie die jeweilige Protokollierungskonfiguration zur Verwendung der aktualisierten Tasten zurücksetzen. Gehen Sie dazu folgendermaßen vor:
> 
...
> 
> [!NOTE]
> Protokoll-Streaming zeigt auch Informationen an, die in eine Textdatei im Ordner **D:\\home\\LogFiles\** geschrieben werden.
> 
> 
