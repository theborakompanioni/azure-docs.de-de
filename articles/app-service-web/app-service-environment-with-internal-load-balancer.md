...
Nach Auswahl der internen Adresse können Sie Ihrer ASE keine weiteren IP-Adressen hinzufügen, und stattdessen müssen Sie die Unterdomäne der ASE bereitstellen. In einer ASE mit einer externen VIP-Adresse wird der Name der ASE in der Unterdomäne für Apps verwendet, die in dieser ASE erstellt werden. Wenn Ihre ASE als ***contosotest*** und Ihre App in dieser ASE als ***mytest*** bezeichnet wurde, hat die Unterdomäne das Format ***contosotest.p.azurewebsites.net***, und die URL für die App lautet ***mytest.contosotest.p.azurewebsites.net***. Wenn Sie „Intern“ für den VIP-Typ festgelegt haben, wird Ihr ASE-Name in der Unterdomäne für die ASE nicht verwendet. Sie geben die Unterdomäne explizit an. Beispiel: Wenn die Unterdomäne ***contoso.corp.net*** heißt und Sie in dieser ASE eine App mit dem Namen ***timereporting*** erstellen, dann lautet die URL für diese App ***timereporting.contoso.corp.net***.
