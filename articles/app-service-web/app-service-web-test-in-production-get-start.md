---
title: "Erste Schritte beim Testen in der Produktionsumgebung für Web-Apps"
...
---
# <a name="get-started-with-test-in-production-for-web-apps"></a>Erste Schritte beim Testen in der Produktionsumgebung für Web-Apps
...
## <a name="traffic-routing-in-app-service-web-apps"></a>Datenverkehrsrouting in App Service-Web-Apps
...
### <a name="requirements-for-using-traffic-routing-in-web-apps"></a>Anforderungen für die Verwendung des Datenverkehrsroutings in Web-Apps
...
## <a name="route-traffic-segment-to-a-deployment-slot"></a>Weiterleiten eines Datenverkehrssegments an einen Bereitstellungsslot
...
> [!NOTE]
> Bei den folgenden Schritten wird davon ausgegangen, dass Sie bereits über einen [Nicht-Produktionsbereitstellungsslot](web-sites-staged-publishing.md) verfügen und die gewünschten Web-App-Inhalte in diesem Slot [bereitgestellt](web-sites-deploy.md) wurden.
> 
> 

1. Melden Sie sich beim [Azure-Portal](https://portal.azure.com/)an.
2. Klicken Sie auf dem Blatt der Web-App auf **Einstellungen** > **Datenverkehrsrouting**.
...
## <a name="force-client-requests-to-a-specific-slot"></a>Weiterleiten von Clientanforderungen an einen bestimmten Slot
...
### <a name="opt-users-out-of-beta-app"></a>Beenden der Nutzung der Beta-App für Benutzer
...
### <a name="opt-users-in-to-beta-app"></a>Nutzen der Beta-App durch Benutzer
