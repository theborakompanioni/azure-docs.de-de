...
3. Navigieren Sie zu **http://[site name].azurewebsites.net/index.php**, um die Anwendung zu verwenden (diese Informationen werden in Ihrem Konto-Dashboard gespeichert):
