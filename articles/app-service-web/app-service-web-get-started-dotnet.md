...
---
# <a name="deploy-your-first-net-web-app-to-azure-in-five-minutes"></a>Bereitstellen Ihrer ersten .NET-Web-App für Azure in fünf Minuten
...
4. Wechseln Sie in ein Arbeitsverzeichnis (`CD`), und klonen Sie die Beispiel-App.
