...
## <a name="a-nametokensastore-the-authentication-token-on-the-client"></a><a name="tokens"></a>Speichern des Authentifizierungstokens auf dem Client
