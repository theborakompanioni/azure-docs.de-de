...
## Übersicht
In diesem Lernprogramm erfahren Sie, wie Sie mithilfe eines mobilen Azure-App-Back-Ends einen cloudbasierten Back-End-Dienst einer mobilen Xamarin.iOS-App hinzufügen können. Sie erstellen ein neues mobiles App-Back-End sowie eine einfache Xamarin.iOS-*Todo list*-App, die App-Daten in Azure speichert.
