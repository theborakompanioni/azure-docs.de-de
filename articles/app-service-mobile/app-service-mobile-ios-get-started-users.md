...
Klicken Sie in Xcode auf **Run**, um die App zu starten. Es wird eine Ausnahme ausgelöst, da die App als nicht authentifizierter Benutzer auf das Back-End zugreift, aber die *TodoItem*-Tabelle nun eine Authentifizierung verlangt.
