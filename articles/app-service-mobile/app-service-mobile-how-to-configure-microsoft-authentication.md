...
6. Geben Sie unter „Umleitungs-URIs“ den Endpunkt der Anwendung an, und klicken Sie dann auf **Speichern**.
   ...
   > [!NOTE]
   > Der Umleitungs-URI ist die URL Ihrer Anwendung mit angefügtem Pfad */.auth/login/microsoftaccount/callback*. Beispiel: `https://contoso.azurewebsites.net/.auth/login/microsoftaccount/callback`. Stellen Sie sicher, dass Sie das HTTPS-Schema verwenden.
   > 
   > 
