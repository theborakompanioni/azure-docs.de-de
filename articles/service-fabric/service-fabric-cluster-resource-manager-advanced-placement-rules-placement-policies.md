...
Es gibt viele weitere Regeln, die ggf. beachtet werden müssen, wenn sich Ihr Service Fabric-Cluster über größere Entfernungen erstreckt, z.B. über mehrere Datencenter oder Azure-Regionen, oder sich Ihre Umgebung über mehrere geopolitische Kontrollbereiche erstreckt (oder ein anderer Fall, bei dem rechtliche oder strategische Grenzen beachtet werden müssen, oder die gegebenen Entfernungen tatsächlich Einfluss auf die Leistung/Latenz haben). Die meisten dieser Fälle können mithilfe von Knoteneigenschaften und Platzierungseinschränkungen konfiguriert werden, aber einige sind komplizierter. In jedem Fall stellen wir diese Verfahren bereit. Ebenso wie Platzierungseinschränkungen können Platzierungsrichtlinien auf Dienstinstanzbasis namensbezogen konfiguriert werden.
