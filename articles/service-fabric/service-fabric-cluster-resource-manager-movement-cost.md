...
Der Service Fabric-Ressourcen-Manager stellt zwei Methoden bereit, um Kosten zu berechnen und einzudämmen: Wenn der Ressourcen-Manager ein neues Layout für den Cluster plant, berechnet er genau die zu verschiebenden Daten. Wenn Sie zwei Lösungen mit etwa dem gleichen Endergebnis zur Auswahl haben, wählen Sie diejenige mit den geringsten Kosten (Gesamtzahl der Datenverschiebungen). Das funktioniert recht gut, bis dasselbe Problem wie bei den Standard- oder statischen Lasten auftritt: In einem komplexen System sind Verschiebevorgänge nicht alle gleich; einige sind mit sehr viel höheren Kosten verbunden als andere.
...
MoveCost hilft dabei, Lösungen zu finden, die die geringsten Unterbrechungen und den besten Ausgleich versprechen. Die Kosten eines Dienstes können von Vielem abhängen, doch die gängigsten Faktoren in der Berechnung Ihrer Verschiebekosten sind:
