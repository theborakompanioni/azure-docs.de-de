...
>[AZURE.NOTE] Um erweiterte Sicherheitsoptionen zu nutzen, z.B. Benutzerauthentifizierung mit Azure Active Directory und Zertifikate für die Anwendungssicherheit, [erstellen Sie Ihren Cluster mithilfe von Azure Resource Manager][create-cluster-arm].
