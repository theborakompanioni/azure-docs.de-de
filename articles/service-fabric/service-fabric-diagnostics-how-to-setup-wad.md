...
Nachdem Sie die Datei **template.json** wie beschrieben geändert haben, veröffentlichen Sie die ARM-Vorlage erneut. Wenn die Vorlage exportiert wurde, wird sie durch Ausführung der Datei **deploy.ps1** neu veröffentlicht. Stellen Sie nach der Bereitstellung sicher, dass *ProvisioningState* den Status *Erfolgreich* hat.
