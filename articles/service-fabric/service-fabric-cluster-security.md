---
title: Sichern eines Service Fabric-Clusters | Microsoft Docs
...
### <a name="client-to-node-azure-active-directory-aad-security-on-azure"></a>AAD-Sicherheit (Azure Active Directory) in Azure (Client zu Knoten)
