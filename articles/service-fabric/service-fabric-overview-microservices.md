...
***Auf der rechten Seite ist der Microservice-Ansatz dargestellt. Dabei handelt es sich um einen Graphen verbundener Microservices, wobei der Zustand meist auf den Microservice beschränkt ist und verschiedene Technologien verwendet werden.***
