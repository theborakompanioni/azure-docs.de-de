...
***Ziel von Service Fabric ist die Bewältigung der schwierigen Herausforderungen, die mit der Erstellung und Ausführung eines Diensts einhergehen (etwa Ausfälle und Upgrades), sowie die effiziente Auslastung der Infrastrukturressourcen, damit Teams geschäftliche Probleme mit einem Microservice-Ansatz lösen können.***
...
***Service Fabric ist agnostisch, was die Erstellung Ihres Diensts betrifft, und Sie können eine beliebige Technologie verwenden. Es werden aber integrierte Programmierungs-APIs bereitgestellt, mit denen die Erstellung von Microservices stark vereinfacht wird.***
