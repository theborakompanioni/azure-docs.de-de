...
## <a name="using-console-redirection-for-local-debugging"></a>Verwenden der Konsolenumleitung für das lokale Debuggen
...
**Hinweis** : Verwenden Sie die in einer Anwendung bereitgestellte Richtlinie zur Konsolenumleitung nie in der Produktion, da sich dies auf das Anwendungsfailover auswirken kann. **NUR** für die lokale Entwicklung und das Debuggen.  
...
~~~
### <a name="using-an-active-directory-domain-group-or-user"></a>Verwenden einer Active Directory-Domänengruppe oder eines -Benutzers
...
[Bild1]: ./media/service-fabric-application-runas-security/copy-to-output.png
