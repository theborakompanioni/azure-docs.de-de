---
title: "Durchführen von Auslastungstests für Anwendungen mithilfe von Visual Studio Team Services | Microsoft Docs"
...
## <a name="create-and-run-the-web-performance-and-load-test-project"></a>Erstellen und Ausführen des Webleistungs- und Auslastungstestprojekts
### <a name="create-a-web-performance-and-load-test-project"></a>Erstellen eines Webleistungs- und Auslastungstestprojekts
...
1. Wählen Sie im Kontextmenü Ihres Webleistungs- und Auslastungstestprojekts die Optionen **Hinzufügen** > **Auslastungstest**können Sie ein kostenloses Konto erhalten. Klicken Sie im **Auslastungstest**-Assistenten auf die Schaltfläche **Weiter**, um die Testeinstellungen zu konfigurieren.
2. Wählen Sie im Abschnitt **Auslastungsmuster** aus, ob Sie mit einer konstanten Benutzerauslastung oder einer Auslastung in Einzelschritten testen möchten. Letztere beginnt mit wenigen Benutzern und erhöht die Anzahl der Benutzer im Lauf der Zeit.
...
4. Geben Sie im Abschnitt **Testlaufeinstellungen** die Dauer des Auslastungstests an.
   ...
   > [!NOTE]
   > Die Option **Testiterationen** ist nur verfügbar, wenn Sie einen Auslastungstest lokal über Visual Studio ausführen.
   >
   >
...
6. Nachdem der Auslastungstest erstellt wurde, öffnen Sie das LOADTEST-Projekt, und wählen Sie die aktuelle Testlaufeinstellung aus, beispielsweise **Testlaufeinstellungen** > **Testlaufeinstellungen1 [Active]**können Sie ein kostenloses Konto erhalten. Dadurch werden die Testlaufeinstellungen im Fenster **Eigenschaften** geöffnet.
...
### <a name="run-the-load-test-by-using-visual-studio-team-services"></a>Ausführen von Auslastungstests mit Visual Studio Team Services
...
## <a name="view-and-analyze-the-load-test-results"></a>Anzeigen und Analysieren von Auslastungstestergebnissen
...
## <a name="automate-your-load-test"></a>Automatisieren des Auslastungstests
