...
Wählen Sie zum Anzeigen des Server-Explorers in Visual Studio auf der Menüleiste nacheinander die Optionen **Ansicht** > **Server-Explorer**. Der Knoten **Storage** zeigt alle Speicherkonten an, die unter jedem Azure-Abonnement oder -Zertifikat vorhanden sind, mit dem Sie verbunden sind. Wird das Speicherkonto nicht angezeigt, befolgen Sie die Anweisungen am [Ende des Themas](#add-storage-accounts-by-using-server-explorer), um das Konto hinzuzufügen.
...
> [!NOTE]
> Da es sich bei Ordnern in Blobcontainern um virtuelle Ordner handelt, ist es nicht möglich, einen leeren Ordner zu erstellen. Zudem können Sie einen Ordner nicht zum Löschen der jeweiligen Dateiinhalte löschen. Sie müssen den gesamten Inhalt eines Ordners löschen, um den Ordner selbst zu löschen.
> 
> 
...
> [!NOTE]
> Speicherdienstwarteschlangen unterscheiden sich von Azure Service Bus-Warteschlangen. Weitere Informationen zu Service Bus-Warteschlangen finden Sie unter [Service Bus-Warteschlangen, -Themen und -Abonnements](https://docs.microsoft.com/en-us/azure/service-bus-messaging/service-bus-queues-topics-subscriptions).
> 
> 
...
2. Wählen Sie in der Symbolleiste der Tabellenansicht die Schaltfläche **Abfrage-Generator** aus.
...
Wenn Sie ein Speicherkonto mithilfe der Replikationsoption **Lesezugriff georedundant** erstellt haben, können Sie dessen sekundäre Endpunkte anzeigen:

* Öffnen Sie das Kontextmenü für den Kontonamen, und wählen Sie dann **Eigenschaften** aus.
