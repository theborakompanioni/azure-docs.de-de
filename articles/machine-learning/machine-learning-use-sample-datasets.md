...
<tr ID=bill-gates-rgb-image>
  ...
  <td valign=top>
Öffentlich verfügbare, in CSV-Daten konvertierte Imagedatei.<p> </p>Der Code zum Konvertieren des Bildes wird auf der Detailseite des Modells <strong>Farbquantifizierung mithilfe von K-Means-Clustering</strong> bereitgestellt.
  </td>
</tr>
...
<tr ID=breast-cancer-features>
  <td valign=top>Brustkrebsfunktionen <td valign=top>
