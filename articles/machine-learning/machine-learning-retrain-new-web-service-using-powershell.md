<properties
	pageTitle="Erneutes Trainieren eines neuen Webdiensts mithilfe der PowerShell-Cmdlets für die Verwaltung von Machine Learning | Microsoft Azure"
...
# Erneutes Trainieren eines neuen Webdiensts mithilfe der PowerShell-Cmdlets für die Verwaltung von Machine Learning
...
Sie benötigen ein Trainingsexperiment und ein Vorhersageexperiment (wie unter „Programmgesteuertes erneutes Trainieren von Machine Learning-Modellen“ beschrieben). Informationen zum Erstellen des Trainings- und des Vorhersageexperiments finden Sie unter [Programmgesteuertes erneutes Trainieren von Machine Learning-Modellen](Retrain Machine Learning models programmatically.md).
...
### Exportieren der Webdienstdefinition als JSON-Code
...
### Aktualisieren des Verweises auf das iLearner-Blob im JSON-Code
...
### Importieren des JSON-Codes in eine Webdienstdefinition
...
### Aktualisieren des Webdiensts mit der neuen Webdienstdefinition
