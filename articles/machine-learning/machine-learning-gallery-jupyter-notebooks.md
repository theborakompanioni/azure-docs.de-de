---
title: Jupyter-Notebooks im Cortana Intelligence-Katalog | Microsoft Docs
description: Entdecken von Jupyter-Notebooks im Cortana Intelligence-Katalog.
...
---
# <a name="discover-jupyter-notebooks-in-the-cortana-intelligence-gallery"></a>Entdecken von Jupyter-Notebooks im Cortana Intelligence-Katalog
...
## <a name="discover"></a>Entdecken
  Um Notebooks im Katalog zu suchen, öffnen Sie den [Katalog](http://gallery.cortanaintelligence.com), und klicken Sie auf **Notizbücher**
 am Anfang der Katalogstartseite.
...
3. Wählen Sie die Region und den Arbeitsbereich, die Sie verwenden möchten
    ...
    ![Öffnen Sie das Jupyter-Notebook über den Katalog](media/machine-learning-gallery-jupyter-notebooks/open-notebook-from-gallery.png)
...
3. Zeigen Sie die Maus auf ein Notebook, und wählen Sie **Notizbuch öffnen** aus
    ...
    ![Öffnen Sie das Katalognotebook in Machine Learning Studio](media/machine-learning-gallery-jupyter-notebooks/open-notebook-from-studio.png)
