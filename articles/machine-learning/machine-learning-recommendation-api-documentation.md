---
title: "Machine Learning-Empfehlungs-APIs – Dokumentation | Microsoft-Dokumentation"
...
---
# <a name="azure-machine-learning-recommendations-api-documentation"></a>Azure Machine Learning-Empfehlungs-APIs – Dokumentation
> [!NOTE]
...
### <a name="34-ids-are-case-sensitive"></a>3.4. Groß-/Kleinschreibung bei IDs
...
## <a name="4-recommendations-quality-and-cold-items"></a>4. Empfehlungsqualität und kalte Elemente
### <a name="41-recommendation-quality"></a>4.1. Qualität der Empfehlungen
...
## <a name="5-model-basic"></a>5. Einfaches Modell
...
### <a name="52-get-model"></a>5.2. Modell abrufen
...
* `feed/entry/content/properties/Id` : Die eindeutige ID des Modells
* `feed/entry/content/properties/Name` : Die Name des Modells
* `feed/entry/content/properties/Date`: Das Erstellungsdatum des Modells
* `feed/entry/content/properties/Status`: Der Status des Modells Einer der folgenden:
...
* `feed/entry/content/properties/BuildId` : Die ID des aktiven Modellbuilds
* `feed/entry/content/properties/Mpr` : Die mittlere Prozentrangwertung (MPR – weitere Informationen finden Sie unter ModelInsight) des Modells
* `feed/entry/content/properties/UserName` : Der interne Benutzername des Modells
...
* `feed/entry/content/properties/HasActiveBuild` : Hier wird angegeben, ob das Modell erfolgreich erstellt wurde.
* `feed/entry/content/properties/BuildId` : Die ID des aktiven Modellbuilds
* `feed/entry/content/properties/Mpr` : Die MPR des Modells (weitere Informationen finden Sie unter ModelInsight)
* `feed/entry/content/properties/UserName` : Der interne Benutzername des Modells
* `feed/entry/content/properties/UsageFileNames` : Eine kommagetrennte Liste von Modellnutzungsdateien
* `feed/entry/content/properties/CatalogId` : Die ID des Modellkatalogs
* `feed/entry/content/properties/Description` : Die Modellbeschreibung
* `feed/entry/content/properties/CatalogFileName` : Der Dateiname des Modellkatalogs
...
### <a name="54----update-model"></a>5.4.    Modell aktualisieren
Sie können die Modellbeschreibung oder die aktive Build-ID aktualisieren.<br>
<ins>Aktive Build-ID</ins>: Jeder Build für jedes Modell weist eine „Build-ID“ auf. Die aktive Build-ID ist der erste erfolgreich erstellte Build jedes neuen Modells. Wenn Sie über eine aktive Build-ID verfügen und für das gleiche Modell zusätzliche Builds erstellen, müssen Sie die aktive Build-ID gegebenenfalls ausdrücklich als Standard-Build-ID festlegen. Wenn Sie Empfehlungen nutzen und die zu verwendende Build-ID nicht definieren, wird automatisch der Standardbuild verwendet.<br>
...
## <a name="6-model-advanced"></a>6. Komplexes Modell
### <a name="61----model-data-insight"></a>6.1.    Modelldateneinblicke
...
### <a name="62----model-insight"></a>6.2.    Modelleinblicke
...
### <a name="63----get-model-sample"></a>6.3.    Modellprobe abrufen
...
<pre>
9fb54f180400, Family Pictures: Ein Roman Bewertung: 0.5341 8d06d01d-31cd-4678-b6b1-140a67987ce9, Songs in Ordinary Time (Oprah's Book Club (Taschenbuch)) Bewertung: 0.5334 da45c4d5-aba1-413b-a9bd-50df98b1e1d2, The Bean Trees Bewertung: 0.5319 d5358189-d70f-4e35-8add-34b83b4942b3, Pigs in Heaven d5358189, d70f, 4e35, 8add, 34b83b4942b3, Pigs in Heaven Bewertung: 0.5491 ff91a483-1ce5-4b37-a6fd-5ffcf21f8745, The Poisonwood Bible: Ein Roman Bewertung: 0.5401 c78743bf-7947-4a0c-8db7-8a3bfe69ba70, The Stone Diaries Bewertung: 0.5393 8d06d01d-31cd-4678-b6b1-140a67987ce9, Songs in Ordinary Time (Oprah's Book Club (Taschenbuch)) Bewertung: 4dd0d7dc3a19-0.5382 973f8cbd-0846-4f6b - 9d 28, Pigs in Heaven Bewertung: 0.5367

</pre>


## <a name="7-model-business-rules"></a>7. Modellgeschäftsregeln
...
### <a name="71----get-model-rules"></a>7.1.    Modellregeln abrufen
| HTTP-Methode | URI |
|:--- |:--- |
...
* `feed/entry/content/properties/Id` : Der eindeutige Bezeichner dieser Regel
* `feed/entry/content/properties/Type` : Der Typ der Regel
* `feed/entry/content/properties/Parameter` : Der Parameter der Regel
...
<ins>Stellen Sie beim Bereitstellen von Element-IDs für Geschäftsregeln immer sicher, dass Sie die externe ID des Elements verwenden (die ID aus der Katalogdatei).</ins><br>
<ins>Gehen Sie wie folgt vor, um eine BlockList-Regel hinzuzufügen:</ins><br>`<ApiFilter xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><ModelId>24024f7e-b45c-419e-bfa2-dfd947e0d253</ModelId><Type>BlockList</Type><Value>{"ItemsToExclude":["2406E770-769C-4189-89DE-1C9283F93A96","3906E110-769C-4189-89DE-1C9283F98888"]}</Value></ApiFilter>`<br><br><ins>
<ins>Gehen Sie wie folgt vor, um eine FeatureBlockList-Regel hinzuzufügen:</ins><br>
<br>
`<ApiFilter xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><ModelId>24024f7e-b45c-419e-bfa2-dfd947e0d253</ModelId><Type>FeatureBlockList</Type><Value>{"Name":"Movie_category","Values":["Adult","Drama"]}</Value></ApiFilter>`<br><br><ins>Gehen Sie wie folgt vor, um eine Upsale-Regel hinzuzufügen:</ins><br>`<ApiFilter xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><ModelId>24024f7e-b45c-419e-bfa2-dfd947e0d253</ModelId><Type>Upsale</Type><Value>{"ItemsToUpsale":["2406E770-769C-4189-89DE-1C9283F93A96"],"NumberOfItemsToUpsale":5}</Value></ApiFilter>`<br><br>
<ins>Gehen Sie wie folgt vor, um eine WhiteList-Regel hinzuzufügen:</ins><br>
`<ApiFilter xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><ModelId>24024f7e-b45c-419e-bfa2-dfd947e0d253</ModelId><Type>WhiteList</Type><Value>{"ItemsToInclude":["2406E770-769C-4189-89DE-1C9283F93A96","1116E770-769C-4189-89DE-1C9283F88888"]}</Value></ApiFilter>`<br><br><ins>
<ins>Gehen Sie wie folgt vor, um eine FeatureWhiteList-Regel hinzuzufügen:</ins><br>
<br>
`<ApiFilter xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><ModelId>24024f7e-b45c-419e-bfa2-dfd947e0d253</ModelId><Type>FeatureWhiteList</Type><Value>{"Name":"Movie_rating","Values":["PG13"]}</Value></ApiFilter>`<br><br><ins>Gehen Sie wie folgt vor, um eine PerSeedBlockList-Regel hinzuzufügen:</ins><br>`<ApiFilter xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><ModelId>24024f7e-b45c-419e-bfa2-dfd947e0d253</ModelId><Type>PerSeedBlockList</Type><Value>{"SeedItems":["9949"],"ItemsToExclude":["9862","8158","8244"]}</Value></ApiFilter>`|
...
* `feed/entry/content/properties/Id` : Der eindeutige Bezeichner dieser Regel
* `feed/entry/content/properties/Type` : Der Typ der Regel („BlockList“ oder „Upsale“)
* `feed/entry/content/properties/Parameter` : Der Parameter der Regel
...
### <a name="81----import-catalog-data"></a>8.1.    Importieren von Katalogdaten
...
|:--- |:--- |:--- |:--- |
| Element-ID |Ja |[A-z], [a-z], [0-9], [_] &#40;Unterstrich&#41;, [-] &#40;Bindestrich&#41;<br> Maximale Länge: 50 |Dies ist der eindeutige Bezeichner eines Elements. |
| Item Name |Ja |Alle alphanumerischen Zeichen<br> Maximale Länge: 255 |Dies ist der Name des Elements. |
| Item Category |Ja |Alle alphanumerischen Zeichen <br> Maximale Länge: 255 |Kategorie, zu der dieses Element gehört (z. B. Kochbücher, Drama ...). Darf leer sein. |
| Beschreibung |Nein, es sei denn, es sind Features vorhanden (darf jedoch leer sein) |Alle alphanumerischen Zeichen <br> Maximale Länge: 4000 |Dies ist die Beschreibung des Elements. |
| Features list |Nein |Alle alphanumerischen Zeichen <br> Maximale Länge: 4000; Maximale Anzahl von Funktionen: 20 |Eine durch Trennzeichen getrennte Liste mit Featurenamen und zugehörigen Featurewerten, die zur Erweiterung der Modellempfehlung verwendet werden können. Siehe Abschnitt [Erweiterte Themen](#2-advanced-topics). |
...
### <a name="82----get-catalog"></a>8.2.    Katalog abrufen
Hierdurch werden alle Katalogelemente abgerufen.
Der Katalog wird Seite für Seite abgerufen. Wenn Sie Elemente in einem bestimmten Index abrufen möchten, können Sie den Parameter „$skip odata“ verwenden. Beispiel: Wenn Sie Elemente ab Position 100 abrufen möchten, fügen Sie der Anforderung den Parameter „$skip=100“ hinzu.
...
* `feed/entry/content/properties/ExternalId` : Die externe Katalogelement-ID, die vom Kunden bereitgestellt wird
* `feed/entry/content/properties/InternalId` : Die interne Katalogelement-ID, die von den Azure Machine Learning-Empfehlungen generiert wurde
* `feed/entry/content/properties/Name` : Der Name des Katalogelements
* `feed/entry/content/properties/Category` : Die Kategorie des Katalogelements
* `feed/entry/content/properties/Description` : Die Beschreibung des Katalogelements
* `feed/entry/content/properties/Metadata` : Die Metadaten des Katalogelements
...
### <a name="83----get-catalog-items-by-token"></a>8.3.    Katalogelemente anhand von Token abrufen
| HTTP-Methode | URI |
|:--- |:--- |
...
## <a name="9-usage-data"></a>9. Nutzungsdaten
### <a name="91----import-usage-data"></a>9.1.    Importieren von Nutzungsdaten
#### <a name="911-uploading-file"></a>9.1.1. Hochladen einer Datei
...
| apiVersion |1,0 |
|  | |
| Anforderungstext |Nutzungsdaten. Format:<br>`<User Id>,<Item Id>[,<Time>,<Event>]`<br><br><table><tr><th>Name</th><th>Erforderlich</th><th>Typ</th><th>Beschreibung</th></tr><tr><td>Benutzer-ID</td><td>Ja</td><td>[A-z], [a-z], [0-9], [_] &#40;Unterstrich&#41;, [-] &#40;Bindestrich&#41;<br> Maximale Länge: 255 </td><td>Eindeutiger Bezeichner eines Benutzers</td></tr><tr><td>Element-ID</td><td>Ja</td><td>[A-z], [a-z], [0-9], [&#95;] &#40;Unterstrich&#41;, [-] &#40;Bindestrich&#41;<br> Maximale Länge: 50</td><td>Dies ist der eindeutige Bezeichner eines Elements.</td></tr><tr><td>Zeit</td><td>Nein</td><td>Datum im Format: YYYY/MM/DDTHH:MM:SS (z.B. 2013/06/20T10:00:00)</td><td>Zeitpunkt der Daten</td></tr><tr><td>Ereignis</td><td>Nein. Falls angegeben, muss auch ein Datum vorhanden sein.</td><td>Eins der folgenden Elemente:<br>• Click<br>• RecommendationClick<br>• AddShopCart<br>• RemoveShopCart<br>• Purchase</td><td></td></tr></table><br>Maximale Dateigröße: 200 MB<br><br>Beispiel:<br><pre>149452,1b3d95e2-84e4-414c-bb38-be9cf461c347<br>6360,1b3d95e2-84e4-414c-bb38-be9cf461c347<br>50321,1b3d95e2-84e4-414c-bb38-be9cf461c347<br>71285,1b3d95e2-84e4-414c-bb38-be9cf461c347<br>224450,1b3d95e2-84e4-414c-bb38-be9cf461c347<br>236645,1b3d95e2-84e4-414c-bb38-be9cf461c347<br>107951,1b3d95e2-84e4-414c-bb38-be9cf461c347</pre> |
...
#### <a name="912-using-data-acquisition"></a>9.1.2. Verwenden der Datenerfassung
...
* `feed\entry\content\properties\Id` : Die ID der Nutzungsdatei
* `feed\entry\content\properties\Length` : Die Größe der Nutzungsdatei in MB
* `feed\entry\content\properties\DateModified` : Das Erstellungsdatum der Nutzungsdatei
...
### <a name="93----get-usage-statistics"></a>9.3.    Nutzungsstatistiken abrufen
...
* `feed\entry[i]\content\properties\Value` : Die Gesamtzahl der Ereignisse
...
### <a name="94----get-usage-file-sample"></a>9.4.    Nutzungsdateiprobe abrufen
...
### <a name="95----get-model-usage-file"></a>9.5.    Modellnutzungsdatei abrufen
...
### <a name="96----delete-usage-file"></a>9.6.    Nutzungsdatei löschen
...
### <a name="97----delete-all-usage-files"></a>9.7.    Alle Nutzungsdateien löschen
...
### <a name="101-get-features-info-for-last-rank-build"></a>10.1. Featureinformationen abrufen (für den letzten Rangfolgebuild)
...
|:--- |:--- |
| modelId |Dies ist der eindeutige Bezeichner des Modells. |
| samplingSize |Dies ist die Anzahl der Werte, die für jedes Feature anhand der Daten im Katalog eingeschlossen werden sollen. <br/>Mögliche Werte:<br> -1: alle Beispiele <br>0: Keine Proben <br>N: N Proben für jeden Featurenamen zurückgeben |
| apiVersion |1,0 |
|  | |
| Anforderungstext |KEINE |
...
### <a name="102-get-features-info-for-specific-rank-build"></a>10.2. Featureinformationen abrufen (für einen bestimmten Rangfolgebuild)
...
## <a name="11-build"></a>11. Entwickeln
...
* U2I – auch bekannt als seine sonstige Elementauswahl) von hohem Interesse sind. U2I-Empfehlungen basieren auf dem Verlauf derjenigen Elemente, für die der Benutzer sich bis zu dem Zeitpunkt interessiert hat, zu dem das Modell entwickelt wurde.
...
#### <a name="111-build-parameters"></a>11.1 Buildparameter
...
##### <a name="1111-usage-condenser"></a>11.1.1. Nutzungskondensator
...
##### <a name="1112-rank-build-parameters"></a>11.1.2. Parameter für Rangfolgebuilds
...
##### <a name="1113-recommendation-build-parameters"></a>11.1.3. Parameter für Empfehlungsbuilds
...
##### <a name="1114-fbt-build-parameters"></a>11.1.4. Parameter für FBT-Builds
In der folgenden Tabelle sind die Parameter für Empfehlungsbuilds aufgeführt.
...
### <a name="112-trigger-a-recommendation-build"></a>11.2. Auslösen eines Empfehlungsbuilds
...
### <a name="113-trigger-build-recommendation-rank-or-fbt"></a>11.3. Auslösen eines Builds (Empfehlung, Rang oder FBT)
| HTTP-Methode | URI |
|:--- |:--- |
...
* Create: Das Modell wurde erstellt.
* Queued: Die Modellerstellung wurde ausgelöst und in die Warteschlange eingereiht.
* Building: Das Modell wird erstellt.
* Success: Der Build wurde erfolgreich abgeschlossen.
* Error: Der Build wurde mit einem Fehler beendet.
* Cancelled: Der Vorgang wurde abgebrochen.
* Cancelling: Der Vorgang wird abgebrochen.
...
### <a name="114-get-builds-status-of-a-model"></a>11.4. Buildstatus eines Modells abrufen
...
### <a name="115-get-builds-status"></a>11.5. Abrufen von Buildstatus
...
### <a name="116-delete-build"></a>11.6. Build löschen
Löscht einen Build.

HINWEIS:  <br>Aktive Builds können nicht gelöscht werden. Das Modell muss auf einen anderen aktiven Build aktualisiert werden, bevor Sie es löschen.<br>In Bearbeitung befindliche Builds können nicht gelöscht werden. Brechen Sie den Build zunächst durch den Aufruf <strong>Build abbrechen</strong>.
...
### <a name="117-cancel-build"></a>11.7. Build abbrechen
...
### <a name="118-get-build-parameters"></a>11.8. Buildparameter abrufen
...
## <a name="12-recommendation"></a>12. Empfehlung
### <a name="121-get-item-recommendations-for-active-build"></a>12.1. Abrufen von Elementempfehlungen (für aktiven Build)
...
| numberOfResults |Dies ist die Anzahl der erforderlichen Ergebnisse. <br> Max.: 150 |
...
### <a name="122-get-item-recommendations-of-a-specific-build"></a>12.2. Abrufen von Elementempfehlungen (eines bestimmten Builds)
...
### <a name="123-get-fbt-recommendations-for-active-build"></a>12.3. Abrufen von FBT-Empfehlungen (für aktiven Build)
...
### <a name="124-get-fbt-recommendations-of-a-specific-build"></a>12.4. Abrufen von FBT-Empfehlungen (eines bestimmten Builds)
...
### <a name="125-get-user-recommendations-for-active-build"></a>12.5. Abrufen von Benutzerempfehlungen (für aktiven Build)
...
### <a name="126-get-user-recommendations-with-item-list-for-active-build"></a>12.6. Abrufen von Benutzerempfehlungen mit Elementliste (für aktiven Build)
...
### <a name="127-get-user-recommendations--of-a-specific-build"></a>12.7. Abrufen von Benutzerempfehlungen (eines bestimmten Builds)
...
### <a name="128-get-user-recommendations-with-item-list-of-a-specific-build"></a>12.8. Abrufen von Benutzerempfehlungen mit Elementliste (für einen bestimmten Build)
...
## <a name="13-user-usage-history"></a>13. Nutzungsverlauf eines Benutzers
...
### <a name="131-retrieve-user-history"></a>13.1 Abrufen des Nutzungsverlaufs
...
### <a name="141-get-notifications"></a>14.1. Benachrichtigungen abrufen
...
### <a name="142-delete-model-notifications"></a>14.2. Modellbenachrichtigungen löschen
...
### <a name="143-delete-user-notifications"></a>14.3. Benutzerbenachrichtigungen löschen
