...
3. Klicken Sie auf **DATA SERVICES**, dann **COMPUTERLERNEN**, dann **SCHNELLERFASSUNG**.
   
    ![Schnellerfassung eines neuen Arbeitsbereichs][3]
4. Geben Sie einen **ARBEITSBEREICHSNAMEN** für den Arbeitsbereich ein.
5. Geben Sie den Azure-**SPEICHERORT** ein und geben Sie dann ein vorhandenes Azure-**SPEICHERKONTO** an, oder wählen Sie **Neues Speicherkonto erstellen** aus, um ein neues zu erstellen.
