...
### [Übersicht](data-science-process-overview.md)
### [Lebenszyklus](data-science-process-lifecycle.md)
### [Exemplarische Vorgehensweisen](data-science-process-walkthroughs.md)
####[Spark mit PySpark und Scala](data-science-process-walkthroughs-spark.md)
...
####[Hive mit HDInsight Hadoop](data-science-process-walkthroughs-hdinsight-hadoop.md)
####[U-SQL mit Azure Data Lake](data-science-process-walkthroughs-azure-data-lake.md)
####[R, Python und T-SQL mit SQL Server](data-science-process-walkthroughs-sql-server.md)
####[T-SQL und Python mit SQL DW](data-science-process-walkthroughs-sql-data-warehouse.md)
### [Mit Azure ML](http://aka.ms/datascienceprocess)
...
### [3: Stellen Sie die richtige Frage](machine-learning-data-science-for-beginners-ask-a-question-you-can-answer-with-data.md)
...
### [Identifizieren des Szenarios](machine-learning-data-science-plan-sample-scenarios.md)
...
#### Beispieldaten
##### [Übersicht](machine-learning-data-science-sample-data.md)
...
##### [Auswählen von Algorithmen](machine-learning-algorithm-choice.md)
...
### Nutzen von Modellen
#### [Übersicht](machine-learning-consume-web-services.md)
...
#### [Verwenden eines Batch-Pools](machine-learning-dedicated-capacity-for-bes-jobs.md)
...
## [Codebeispiele](https://azure.microsoft.com/en-us/resources/samples/?service=machine-learning)
## [PowerShell-Modul (Neu)](/powershell/module/azurerm.machinelearning)
## [PowerShell-Modul (Klassisch)](machine-learning-powershell-module.md)
## [Algorithmen und Module – Referenz](https://msdn.microsoft.com/library/azure/dn905974.aspx)
## [REST-API-Referenz](/rest/api/machinelearning)
## [Webdienst-Fehlercodes](machine-learning-web-service-error-codes.md)
...
## Cortana Intelligence-Partnerlösungen
### [Veröffentlichungsleitfaden für Cortana Intelligence](cortana-intelligence-appsource-publishing-guide.md)
### [Lösungsauswertungstool für Cortana Intelligence](cortana-intelligence-appsource-evaluation-tool.md)
