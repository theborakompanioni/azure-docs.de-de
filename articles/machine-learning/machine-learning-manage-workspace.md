...
>[AZURE.NOTE] Die Verfahren in diesem Artikel sind für klassische Azure Machine Learning-Webdienste relevant. Informationen zum Verwalten von Webdiensten im Machine Learning Web Services-Portal finden Sie unter [Verwalten eines Webdiensts im Azure Machine Learning Web Services-Portal](machine-learning-manage-new-webservice.md).
...
> [AZURE.TIP] In Azure Machine Learning Studio können Sie auf der Registerkarte **WEB SERVICES** Machine Learning-Webdienste hinzufügen, aktualisieren oder löschen.
