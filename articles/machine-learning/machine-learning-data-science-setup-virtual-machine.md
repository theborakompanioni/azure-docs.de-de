---
title: Einrichten eines virtuellen Computers als IPython Notebook-Server | Microsoft Docs
...
4. Wählen Sie **REGION/AFFINITÄTSGRUPPE/VIRTUAL NETWORK** für das **SPEICHERKONTO** aus, das Sie für diesen virtuellen Computer verwenden möchten, und wählen Sie dann dieses Speicherkonto aus. Fügen Sie im unteren Bereich im Feld **ENDPUNKTE** einen Endpunkt hinzu, indem Sie den Namen des Endpunkts eingeben (in diesem Fall „IPython“). Sie können eine beliebige Zeichenfolge als **NAME** für den Endpunkt auswählen sowie eine beliebige ganze Zahl von 0 bis 65536, sofern diese als **ÖFFENTLICHER PORT** noch **verfügbar** ist. Der **PRIVATE PORT** muss **9999** lauten. **Vermeiden** Sie die Verwendung öffentlicher Ports, denen bereits Internetdienste zugewiesen wurden. <a href="http://www.chebucto.ns.ca/~rakerman/port-table.html" target="_blank">Ports for Internet Services</a> (in englischer Sprache) enthält eine Liste der Ports, die zugewiesen wurden und daher vermieden werden sollten.
...
## <a name="your-azure-vm-is-ready-to-use-whats-next"></a>Ihre Azure-VM ist damit einsatzbereit. Wie lauten die nächsten Schritte?
