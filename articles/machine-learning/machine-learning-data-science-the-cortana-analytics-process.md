---
title: Was ist der Team Data Science-Prozess (TDSP)?  | Microsoft Docs
...
---
# <a name="what-is-the-team-data-science-process-tdsp"></a>Was ist der Team Data Science-Prozess (TDSP)?
...
## <a name="preparation-steps"></a>Vorbereitungsschritte
## <a name="p1-plan-the-analytics-project"></a>P1. Planen des Analyseprojekts
...
## <a name="p2-setup-analytics-environment"></a>P2. Einrichten der Analyse-Umgebung
...
## <a name="analytics-steps"></a>Analyseschritte:
## <a name="1-ingest-data-into-the-analytical-environment"></a>1. Erfassen von Daten in der Analyse-Umgebung
...
## <a name="5-deploy-and-consume-models"></a>5. Bereitstellen und Nutzen von Modellen
...
Der [Team Data Science-Prozess](https://azure.microsoft.com/documentation/learning-paths/cortana-analytics-process/) wird als eine Folge von zu durchlaufenden Schritten modelliert. Diese bieten einen **Leitfaden** für die Aufgaben, die zur Entwicklung intelligenter Anwendungen mit komplexen Analysen ausgeführt werden müssen. Jeder Schritt enthält Details zur Verwendung verschiedener Microsoft-Technologien zum Erledigen der beschriebenen Aufgaben. 
