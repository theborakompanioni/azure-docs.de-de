...
> [!NOTE]
> Probieren Sie die **IT Anomaly Insights-Lösung**, die von [dieser API](https://datamarket.azure.com/dataset/aml_labs/anomalydetection) unterstützt wird.
> 
