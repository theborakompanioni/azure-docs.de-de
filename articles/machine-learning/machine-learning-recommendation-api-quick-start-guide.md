...
* Rank: Rangfolgebuild. (Ausführliche Informationen zu Rangfolgebuilds finden Sie in der Dokumentation zu Machine Learning-Empfehlungs-APIs.)
* Recommendation: Empfehlungsbuild .
* FBT-Build (häufig zusammen gekaufte Elemente).
