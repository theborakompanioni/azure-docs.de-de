...
> [!NOTE]
> Um das Cheat Sheet herunterzuladen und parallel zu diesem Artikel als Referenz verwenden zu können, wechseln Sie zu [Machine Learning – Cheat Sheet für Algorithmen für Microsoft Azure Machine Learning Studio](machine-learning-algorithm-cheat-sheet.md).
> 
> 
...
Hier finden Sie ein [Tutorial zur linearen Regression](machine-learning-linear-regression-in-azure.md).
