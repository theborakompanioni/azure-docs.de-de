<properties 
    pageTitle="Exemplarische Vorgehensweisen für den Team Data Science-Prozess | Microsoft Azure" 
...
Die hier aufgeführten umfassenden exemplarischen Vorgehensweisen veranschaulichen jeweils die Schritte im Team Data Science-Prozess für **bestimmte Szenarien**. Sie zeigen, wie Cloud- und lokale Tools und Dienste in einem Workflow oder einer Pipeline zum Erstellen einer intelligenten Anwendung kombiniert werden.
...
## <a name="use-azure-data-lake-storage-and-analytics"></a>Azure Data Lake-Speicher und Analytics
