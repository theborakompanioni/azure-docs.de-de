---
title: Data Science auf der Linux Data Science Virtual Machine | Microsoft Docs
...
---
# <a name="data-science-on-the-linux-data-science-virtual-machine"></a>Data Science auf der Linux Data Science Virtual Machine
...
* [X2Go](http://wiki.x2go.org/doku.php) auf dem Computer mit geöffneter XFCE-Sitzung. Informationen zur Installation und Konfiguration eines **X2Go-Clients** finden Sie unter [Installieren und Konfigurieren des X2Go-Clients](machine-learning-data-science-linux-dsvm-intro.md#installing-and-configuring-x2go-client). 
...
Wählen Sie oben im Menü die Option **Authorization Tokens**, und notieren Sie sich Ihr **Primary Authorization Token**.![3](./media/machine-learning-data-science-linux-dsvm-walkthrough/workspace-token.png)
...
> [!NOTE]
> Die Anaconda-Distribution enthält so genannte [Condas](http://conda.pydata.org/docs/index.html). Diese können zum Erstellen von benutzerdefinierten Umgebungen für Python verwendet werden, für die verschiedene Versionen bzw. Pakete installiert sind.
>
>
