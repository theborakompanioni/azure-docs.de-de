...
Informationen zu Twilio-Preisen finden Sie unter [Twilio-Preise][twilio_pricing]. Azure-Kunden erhalten ein [Sonderangebot][special_offer]: ein Gratisguthaben von 1000 SMS oder 1000 Minuten Spracheingang. Besuchen Sie [http://ahoy.twilio.com/azure][special_offer], um sich für dieses Angebot zu registrieren und weitere Informationen zu erhalten.  
...
Wenn Sie ein Twilio-Konto erstellen möchten, registrieren Sie sich unter [Twilio testen][try_twilio]. Sie können mit einem kostenlosen Konto beginnen und später ein Upgrade vornehmen.

Wenn Sie sich für ein Twilio-Konto anmelden, erhalten Sie eine Konto-ID und ein Authentifizierungstoken. Beide Angaben benötigen Sie zum Tätigen von Twilio-API-Anrufen. Bewahren Sie Ihr Authentifizierungstoken sicher auf, um unbefugten Zugriff auf Ihr Konto zu verhindern. Ihre Konto-ID und Ihr Authentifizierungstoken werden auf der [Twilio-Kontoseite][twilio_account] in den Feldern **ACCOUNT SID** beziehungsweise **AUTH TOKEN** angezeigt.

## <a name="a-idcreateappacreate-a-java-application"></a><a id="create_app"></a>Erstellen einer Java-Anwendung
...
## <a name="a-idhowtoprovidetwimlresponsesahow-to-provide-twiml-responses-from-your-own-website"></a><a id="howto_provide_twiml_responses"></a>Bereitstellen von TwiML-Antworten von der eigenen Website
...
## <a name="a-idadditionalservicesahow-to-use-additional-twilio-services"></a><a id="AdditionalServices"></a>Verwenden zusätzlicher Twilio-Dienste
