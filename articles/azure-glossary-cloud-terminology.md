...
### <a name="availabilityset"></a>Verfügbarkeitsgruppe  
...
### <a name="classicmodel"></a>Klassisches Azure-Bereitstellungsmodell  
...
### <a name="armmodel"></a>Azure Resource Manager-Bereitstellungsmodell  
...
### <a name="georeplication"></a>Georeplikation  
...
### <a name="rmtemplate"></a>Resource Manager-Vorlage  
...
### <a name="resourceprovider"></a>Ressourcenanbieter  
...
### <a name="storageaccount"></a>Speicherkonto  
...
### <a name="updatedomain"></a>Updatedomäne  
...
### <a name="vmextension"></a>VM-Erweiterung  
