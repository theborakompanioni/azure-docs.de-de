...
* Nachdem ein Failover abgeschlossen wurde, befindet sich der Schlüsseltresor im Modus ***Schreibgeschützt***. Folgende Anforderungen werden in diesem Modus unterstützt:
  ...
  * Signieren
  * Sichern
* Sobald auf ein Failover ein Failback erfolgt ist, stehen alle Anforderungstypen (d.h. Lese- ***und*** Schreibanforderungen) wieder zur Verfügung.
