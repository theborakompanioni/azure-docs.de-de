...
# Wenn Sie sich nicht bei Azure anmelden können
...
## Wieso erhalte ich, wenn ich mich anmelde, während der Kontoprüfung keine Textnachrichten oder Anrufe?
...
>[AZURE.NOTE] Sie können Ihre bevorzugte Telefonnummer später durch [Aktualisierung Ihrer Profilinformationen](billing-how-to-change-azure-account-profile.md) ändern.
...
Wenn Sie keinen OSA-Schlüssel haben, wenden Sie sich an einen der auf [Microsoft Pinpoint](http://pinpoint.microsoft.com/) aufgeführten Microsoft-Partner.

## Ich kann eine kostenlose Azure-Testversion nicht aktivieren

Haben Sie in der Vergangenheit bereits ein Azure-Abonnement verwendet? Die Vereinbarung in den Azure-Nutzungsbedingungen sieht vor, dass eine kostenlose Testversion von Benutzern, die Azure noch nie zuvor genutzt haben, nur einmal aktiviert werden darf. Wenn Sie bereits einen anderen Typ von Azure-Abonnement hatten, können Sie keine kostenlose Testversion aktivieren.
