...
5. Geben Sie einen **Namen** für die Vereinbarung ein. Wählen Sie dann auf dem geöffneten Blatt „Vereinbarungen“ den **Hostpartner**, die **Hostidentität**, den **Gastpartner** und die **Gastidentität** aus.  
...
1. Wählen Sie **Empfangseinstellungen** aus, um zu konfigurieren, wie Nachrichten, die über diese Vereinbarung empfangen werden, behandelt werden.  
   ...
   * Sie können auch die Komprimierung von Nachrichten anfordern. Aktivieren Sie hierzu das Kontrollkästchen **Nachricht muss komprimiert sein** .  
