...
Ähnliche Szenarios können über den visuellen Designer konfiguriert werden, ohne eine einzige Codezeile schreiben zu müssen. Erste Schritte zum [sofortigen Erstellen Ihrer Logik-App][erstellen].  Nachdem sie geschrieben wurde, kann eine Logik-App über mehrere Umgebungen und Regionen hinweg [schnell bereitgestellt und neu konfiguriert werden](app-service-logic-create-deploy-template.md) .
...
* Befolgen Sie zum Einstieg in Logik-Apps das Tutorial [Erstellen einer Logik-App][erstellen].  
...
[Vorlagen]: app-service-logic-use-logic-app-templates.md
