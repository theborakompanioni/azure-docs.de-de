---
title: Erstellen von Logik-Apps in Visual Studio | Microsoft-Dokumentation
...
1. Klicken Sie auf das Menü **Datei**, und wählen Sie **Neu** >  **Projekt** (oder wählen Sie **Hinzufügen** und dann **Neues Projekt**, um es einer vorhandenen Projektmappe hinzuzufügen):  ![Dateimenü](./media/app-service-logic-deploy-from-vs/filemenu.png)
...
2. Wählen Sie das Abonnement, die Ressourcengruppe und den Speicherort für die Bereitstellungsvorlage aus.
   * Beachten Sie unbedingt, dass beim Entwerfen einer Logik-App Ressourcen vom Typ **API-Verbindung** erstellt werden, um während des Entwurfsvorgangs Eigenschaften abfragen zu können.  Die ausgewählte Ressourcengruppe ist die Ressourcengruppe, die zum Erstellen dieser Verbindungen zur Entwurfszeit verwendet wird.  Sie können alle API-Verbindungen anzeigen oder ändern, indem Sie auf das Azure-Portal zugreifen und nach **API-Verbindungen**suchen.
     ![Abonnementauswahl](./media/app-service-logic-deploy-from-vs/designer_picker.png)
