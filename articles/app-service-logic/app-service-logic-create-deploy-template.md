...
## <a name="create-a-logic-app-deployment-template"></a>Erstellen einer Bereitstellungsvorlage für Logik-Apps
Eine gültige Bereitstellungsvorlage für Logik-Apps wird am einfachsten mit den [Visual Studio-Tools für Logic Apps](app-service-logic-deploy-from-vs.md) erstellt.  Die Visual Studio-Tools generieren eine gültige Bereitstellungsvorlage, die in allen Abonnements und an allen Standorten eingesetzt werden können.
