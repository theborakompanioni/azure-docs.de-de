---
title: Verwendung des Office 365-Connectors in Logik-Apps | Microsoft Docs
...
5. Zum Herstellen einer Verbindung mit Office 365 müssen Sie die Logik-App für den Zugriff auf Ihr Konto autorisieren. Klicken Sie auf "Autorisieren", um Office 365-Anmeldeinformationen bereitzustellen: ![][5]
6. Sie werden zur Office 365-Anmeldeseite umgeleitet und können sich mit den Anmeldeinformationen für Ihr Office 365-Konto authentifizieren: ![][6] ![][7]
7. Sobald die Autorisierung abgeschlossen ist, werden die Office 365-Trigger angezeigt: ![][8]
8. Wählen Sie den Trigger "Neue E-Mail", und die Eingabeparameter werden angezeigt.
9. Ändern Sie die Häufigkeit des Triggers in "Minuten", und klicken Sie auf ✓: ![][9]
10. Der Office 365-Trigger "Neue E-Mail" wird konfiguriert, und die Ausgabeparameter werden angezeigt: ![][10]
11. Wählen Sie im Katalog im Abschnitt "Zuletzt verwendet" den Eintrag "Office 365-Connector". Eine neue "Office 365"-Aktion wird hinzugefügt.
12. Wählen Sie "Ereignis senden" aus der Liste der Aktionen, und die Eingabeparameter der Aktion "Ereignis senden" werden angezeigt: ![][11]
13. Geben Sie die Ereignisdetails an, und klicken Sie auf ✓: ![][12]
14. Wählen Sie im Katalog im Abschnitt "Zuletzt verwendet" den Eintrag "Office 365-Connector". Eine neue "Office 365"-Aktion wird hinzugefügt.
15. Wählen Sie "Kontakt hinzufügen" aus der Liste der Aktionen, und die Eingabeparameter der Aktion "Kontakt hinzufügen" werden angezeigt: ![][13]
16. Klicken Sie neben dem Feld "E-Mail-Adresse" auf "+", und wählen Sie den Wert des Ausgabefelds "Von" aus dem Trigger aus: ![][14]
17. Klicken Sie auf ✓, und die Aktionskonfiguration ist abgeschlossen: ![][15]
18. Wählen Sie im Katalog im Abschnitt "Zuletzt verwendet" den Eintrag "Office 365-Connector". Eine neue "Office 365"-Aktion wird hinzugefügt.
19. Wählen Sie "E-Mail senden" aus der Liste der Aktionen, und die Eingabeparameter der Aktion "E-Mail senden" werden angezeigt: ![][19]
20. Geben Sie die Details an, die zum Senden der E-Mail erforderlich sind. Sie können eine Meldung erstellen, indem Sie zum Beispiel Folgendes eingeben. Sobald die-Aktion "E-Mail senden" konfiguriert ist, klicken Sie auf ✓:
    
     Body - @concat('You got a new sales enquiry from',triggers().output.body.From)
    
    ![][20]
21. Wählen Sie im Katalog im Abschnitt "Zuletzt verwendet" den Eintrag "Office 365-Connector". Eine neue "Office 365"-Aktion wird hinzugefügt.
22. Wählen Sie "Antworten an" aus der Liste der Aktionen, und die Eingabeparameter der Aktion "Antworten an" werden angezeigt: ![][16]
23. Klicken Sie neben dem Feld "Von" auf "+", wählen Sie den Wert aus der Ausgabenachricht-ID des Triggers, und klicken Sie auf ✓: ![][17]
24. Klicken Sie im Bildschirm des Logik-App-Editors auf "OK", und klicken Sie dann auf "Erstellen". Es dauert ungefähr 30 Sekunden, bis die Erstellung abgeschlossen ist.
25. Senden Sie eine E-Mail an das Konto, mit dem Sie den Trigger konfiguriert haben. Sie sollten eine E-Mail in Ihrem persönlichen E-Mail-Konto vorfinden sowie ein Ereignis und einen Kontakt in Ihrem Büro-E-Mail-Konto. Darüber hinaus sollten Sie eine Antwort zur Bestätigung erhalten, dass die Vertriebsanfrage in Kürze beantwortet wird.
