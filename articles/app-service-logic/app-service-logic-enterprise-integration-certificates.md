...
<properties
	pageTitle="Verwenden von Zertifikaten mit dem Enterprise Integration Pack | Microsoft Azure"
...
Um ein *öffentliches Zertifikat* in Ihren Logik-Apps mit B2B-Funktionen zu verwenden, müssen Sie das Zertifikat zuerst in Ihr Integrationskonto hochladen. Wenn Sie hingegen ein *selbstsigniertes Zertifikat* verwenden, müssen Sie es zuerst in [Azure Key Vault](../key-vault/key-vault-get-started.md "Informationen zu Key Vault") hochladen.
...
1. Wählen Sie **Durchsuchen** aus. ![„Durchsuchen“ auswählen](./media/app-service-logic-enterprise-integration-overview/overview-1.png)

2. Geben Sie den Begriff **Integration** in das Filtersuchfeld ein, und wählen Sie in der Ergebnisliste die Option **Integrationskonten** aus. ![„Integrationskonten“ auswählen](./media/app-service-logic-enterprise-integration-overview/overview-2.png)

3. Wählen Sie das Integrationskonto aus, dem Sie das Zertifikat hinzufügen möchten. ![Integrationskonto auswählen, dem Sie das Zertifikat hinzufügen möchten](./media/app-service-logic-enterprise-integration-overview/overview-3.png)

4.  Wählen Sie die Kachel **Zertifikate** aus. ![Kachel „Zertifikate“ auswählen](./media/app-service-logic-enterprise-integration-certificates/certificate-1.png)

5. Wählen Sie auf dem Blatt **Zertifikate** die Schaltfläche **Hinzufügen** aus. ![Schaltfläche „Hinzufügen“ auswählen](./media/app-service-logic-enterprise-integration-certificates/certificate-2.png)

6. Geben Sie einen **Namen** für Ihr Zertifikat ein, und wählen Sie dann den Zertifikattyp aus. (In diesem Beispiel wurde der Zertifikattyp „öffentlich“ verwendet.) Wählen Sie das Ordnersymbol rechts neben dem Textfeld **Zertifikat** aus.
...
8. Wählen Sie nach Rückkehr zum Blatt **Zertifikat hinzufügen** die Schaltfläche **OK** aus. ![Schaltfläche „OK“ auswählen](./media/app-service-logic-enterprise-integration-certificates/certificate-3.png)

9. Sie erhalten nach etwa einer Minute die Benachrichtigung, dass das Hochladen des Zertifikats abgeschlossen ist.

10. Wählen Sie die Kachel **Zertifikate** aus. Das neu hinzugefügte Zertifikat wird angezeigt. ![Neues Zertifikat anzeigen](./media/app-service-logic-enterprise-integration-certificates/certificate-4.png)
...
1. Wählen Sie **Durchsuchen** aus. ![Das private Zertifikat in Ihr Integrationskonto hochladen](./media/app-service-logic-enterprise-integration-overview/overview-1.png)
...
9. Wählen Sie nach Rückkehr zum Blatt **Zertifikat hinzufügen** die Schaltfläche **OK** aus. ![Zertifikat hinzufügen](./media/app-service-logic-enterprise-integration-certificates/privatecertificate-1.png)

10. Sie erhalten nach etwa einer Minute die Benachrichtigung, dass das Hochladen des Zertifikats abgeschlossen ist.

11. Wählen Sie die Kachel **Zertifikate** aus. Das neu hinzugefügte Zertifikat wird angezeigt. ![Neues Zertifikat anzeigen](./media/app-service-logic-enterprise-integration-certificates/privatecertificate-2.png)
