---
title: Liste der verfügbaren Connectors und API-Apps | Microsoft Docs
...
> [!NOTE]
> Diese Version des Artikels gilt für die Logik-Apps-Schemaversion 2014-12-01-preview. Informationen zur allgemein verfügbaren Version von Logik-Apps finden Sie unter [Neue Connectorliste](../connectors/apis-list.md).
> 
> 
...
> [!NOTE]
> Wenn Sie Logik-Apps ausprobieren möchten, ehe Sie sich für ein Azure-Konto anmelden, besuchen Sie [Logik-App testen](https://tryappservice.azure.com/?appservice=logic). Sie können sofort eine kurzlebige Starter-Logik-App in App Service erstellen. Keine Kreditkarte erforderlich, keine Verpflichtungen.
> 
> 
