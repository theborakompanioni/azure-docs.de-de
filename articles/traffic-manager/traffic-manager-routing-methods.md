---
title: Traffic Manager – Methoden für das Datenverkehrsrouting | Microsoft Docs
...
> [!NOTE]
> Die ARM-API (Azure Resource Manager) für Traffic Manager verwendet eine andere Terminologie als die ASM-API (Azure Service Manager). Diese Änderung wurde aufgrund von Kundenfeedback eingeführt, um die Klarheit zu verbessern und Missverständnisse zu reduzieren. In diesem Artikel wird die ARM-Terminologie verwendet. Folgende Unterschiede bestehen:
> 
