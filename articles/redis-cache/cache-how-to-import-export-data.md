...
2. Klicken Sie auf **Speichercontainer auswählen**, und wählen Sie das gewünschte Speicherkonto aus. Das Speicherkonto muss sich in demselben Abonnement und derselben Region wie der Cache befinden.
   ...
   > [!IMPORTANT]
   > Import/Export funktioniert auch in Verbindung mit Seitenblobs. Diese werden von klassischen Speicherkonten und ARM-Speicherkonten unterstützt, aber derzeit noch nicht von [Blob-Speicherkonten](../storage/storage-blob-storage-tiers.md#blob-storage-accounts).
   > 
   > 
