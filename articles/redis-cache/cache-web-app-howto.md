...
## <a name="create-the-asp.net-mvc-application"></a>Erstellen der ASP.NET MVC-Anwendung
...
8. Ersetzen Sie `controller = "Home"` im folgenden Code der `RegisterRoutes`-Methode durch `controller = "Teams"`, wie im folgenden Beispiel gezeigt:
...
### <a name="configure-the-application-to-use-stackexchange.redis"></a>Konfigurieren der Anwendung für die Verwendung von „StackExchange.Redis“
...
1. Wählen Sie auf dem Blatt **Benutzerdefinierte Bereitstellung** das gewünschte Azure-Abonnement und dann eine vorhandene Ressourcengruppe aus, oder erstellen Sie eine neue, und geben Sie den Speicherort der Ressourcengruppe an.
...
3. Die anderen Einstellungen können bei Bedarf geändert werden, aber Sie können auch die Standardwerte beibehalten. Klicken Sie anschließend auf **OK**.
...
3. Wählen Sie das Abonnement aus, das beim Erstellen der Azure-Ressourcen verwendet wurde, erweitern Sie die Ressourcengruppe mit den Ressourcen, wählen Sie die gewünschte Web-App aus, und klicken Sie auf **OK**. Bei Verwendung der Schaltfläche zum Bereitstellen für Azure**** beginnt der Name Ihrer Web-App mit **webSite**, gefolgt von einigen zusätzlichen Zeichen.
