...
> [!IMPORTANT]
> Wenn Sie das Clusteringfeature aus dem Premium-Tarif verwenden, müssen Sie [RedisSessionStateProvider](https://www.nuget.org/packages/Microsoft.Web.RedisSessionStateProvider) 2.0.1 oder höher verwenden. Andernfalls wird eine Ausnahme ausgelöst. Dies ist eine Änderung, die zu Fehlern führt. Weitere Informationen finden Sie unter [v2.0.0 Breaking Change Details (in englischer Sprache)](https://github.com/Azure/aspnet-redis-providers/wiki/v2.0.0-Breaking-Change-Details).
> 
> 
