...
* Informieren Sie sich über das [Konfigurieren einer Spring Boot Initializer-App für die Verwendung von Redis Cache](cache-java-spring-boot-initializer-with-redis-cache.md).
