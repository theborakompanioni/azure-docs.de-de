...
|:--- |:--- |
| ***startTime*** |*startTime* ist eine Datums-/Uhrzeitangabe. Bei einfachen Zeitpläne ist *startTime* das erste Vorkommen. Bei komplexen Zeitplänen beginnt der Auftrag nicht vor *startTime*. |
...
## Ausführliche Betrachtung: *startTime*
...
## Ausführliche Betrachtung: *schedule*
