...
2. Klicken Sie im Blatt **Dokument-Explorer** auf **Dokument erstellen**.
	...
	![screenshot des dokument explorers](./media/documentdb-view-json-document-explorer/createdocument.png)
...
2. Um ein vorhandenes Dokument zu bearbeiten, wählen Sie es im Blatt **Dokument-Explorer** aus, bearbeiten das Dokument im Blatt **Dokument** und klicken dann auf **Speichern**.
    ...
    ![screenshot des dokument explorers](./media/documentdb-view-json-document-explorer/editdocument.png)
...
2. Wählen Sie das Dokument im **Dokument-Explorer** aus, und klicken Sie auf **Löschen**. Bestätigen Sie anschließend den Löschvorgang. Nach der Bestätigung wird das Dokument sofort aus der Liste im Dokument-Explorer entfernt.
	...
	![screenshot des dokument explorers](./media/documentdb-view-json-document-explorer/deletedocument.png)
...
![screenshot des dokument explorers hervorhebung](./media/documentdb-view-json-document-explorer/invalidjson1.png)

Dokument-Explorer verhindert auch das Speichern eines Dokuments mit ungültigem JSON.

![screenshot des dokument](./media/documentdb-view-json-document-explorer/invalidjson2.png)
...
![screenshot des dokument explorers](./media/documentdb-view-json-document-explorer/documentproperties.png)
...
3.  Die Filtereinstellungen werden unterhalb der Befehlsleiste angezeigt. Geben Sie in den Filtereinstellungen eine WHERE-Klausel bzw. eine ORDER BY-Klausel ein, und klicken Sie dann auf **Filter**.
	...
	![screenshot des dokument explorers](./media/documentdb-view-json-document-explorer/documentexplorerfiltersettings2.png)
	...
	![screenshot der dokument explorers](./media/documentdb-view-json-document-explorer/documentexplorerfilter.png)

	Die Ergebnisse in der Dokument-Explorer-Liste werden nun nach den angegebenen Kriterien gefiltert.

	![screenshot der dokument explorers](./media/documentdb-view-json-document-explorer/documentexplorerfilterresults.png)
...
4. Zum Aktualisieren der von Dokument-Explorer geladenen Dokumentenliste klicken Sie im oberen Bereich des Blatts auf **Aktualisieren**.
	...
	![screenshot des dokument explorers befehl](./media/documentdb-view-json-document-explorer/documentexplorerrefresh.png)
