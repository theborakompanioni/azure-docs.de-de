...
2. Klicken Sie oben im Blatt **DocumentDB-Konto** auf **Dokument-Explorer**.
	...
	![screenshot1](articles/documentdb/media/documentdb-view-json-document-explorer/documentexplorercommand.png)
	...
	![screenshot2](articles/documentdb/media/documentdb-view-json-document-explorer/documentexplorerinitial.png)
...
2. Klicken Sie im Blatt **Dokument-Explorer** auf **Dokument erstellen**.
	...
	![screenshot4](articles/documentdb/media/documentdb-view-json-document-explorer/createdocument.png)
...
2. Geben bzw. fügen Sie im Blatt **Dokument** den Inhalt des JSON-Dokuments ein, das Sie erstellen möchten. Klicken Sie anschließend auf **Speichern**, um Ihr Dokument für die Datenbank und die Sammlung festzulegen, die im Blatt **Dokument-Explorer** angegeben sind.
	...
	![screenshot5](articles/documentdb/media/documentdb-view-json-document-explorer/savedocument1.png)
...
2. Um ein vorhandenes Dokument zu bearbeiten, wählen Sie es im Blatt **Dokument-Explorer** aus, bearbeiten das Dokument im Blatt **Dokument** und klicken dann auf **Speichern**.
    ...
    ![screenshot6](articles/documentdb/media/documentdb-view-json-document-explorer/editdocument.png)
    ...
    ![screenshot7](articles/documentdb/media/documentdb-view-json-document-explorer/discardedit.png)
...
2. Wählen Sie das Dokument im **Dokument-Explorer** aus, und klicken Sie auf **Löschen**. Bestätigen Sie anschließend den Löschvorgang. Nach der Bestätigung wird das Dokument sofort aus der Liste im Dokument-Explorer entfernt.
	...
	![screenshot8](articles/documentdb/media/documentdb-view-json-document-explorer/deletedocument.png)
...
![screenshot9](articles/documentdb/media/documentdb-view-json-document-explorer/invalidjson1.png)

Dokument-Explorer verhindert auch das Speichern eines Dokuments mit ungültigem JSON.

![screenshot10](articles/documentdb/media/documentdb-view-json-document-explorer/invalidjson2.png)
...
![screenshot11](articles/documentdb/media/documentdb-view-json-document-explorer/documentproperties.png)
...
2. Klicken Sie am oberen Rand des Blatts **Dokument-Explorer** auf **Filter**.
    ...
    ![screenshot12](articles/documentdb/media/documentdb-view-json-document-explorer/documentexplorerfiltersettings.png)
...
3.  Die Filtereinstellungen werden unterhalb der Befehlsleiste angezeigt. Geben Sie in den Filtereinstellungen eine WHERE-Klausel bzw. eine ORDER BY-Klausel ein, und klicken Sie dann auf **Filter**.
	...
	![screenshot13](articles/documentdb/media/documentdb-view-json-document-explorer/documentexplorerfiltersettings2.png)
	...
	![screenshot14](articles/documentdb/media/documentdb-view-json-document-explorer/documentexplorerfilter.png)

	Die Ergebnisse in der Dokument-Explorer-Liste werden nun nach den angegebenen Kriterien gefiltert.

	![screenshot15](articles/documentdb/media/documentdb-view-json-document-explorer/documentexplorerfilterresults.png)
...
4. Zum Aktualisieren der von Dokument-Explorer geladenen Dokumentenliste klicken Sie im oberen Bereich des Blatts auf **Aktualisieren**.
	...
	![screenshot16](articles/documentdb/media/documentdb-view-json-document-explorer/documentexplorerrefresh.png)
