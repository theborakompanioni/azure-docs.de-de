<properties
	pageTitle="Erweiterte Konfiguration mit dem Mobile Engagement SDK für Android"
	description="Erweiterte Konfigurationsoptionen für Android unter Verwendung des Azure Mobile Engagement-SDK"
...
# Erweiterte Konfiguration mit dem Mobile Engagement SDK für Android

> [AZURE.SELECTOR]
- [Android](mobile-engagement-android-logging.md)

Hier wird erläutert, wie verschiedene erweiterte Konfigurationsoptionen für Engagement Android-Apps konfiguriert werden.
...
| ---------- | --------- |
| INTERNET | Grundlegende Berichterstellung |
| ACCESS\_NETWORK\_STATE | Grundlegende Berichterstellung |
| WRITE\_EXTERNAL\_STORAGE | Grundlegende Berichterstellung |
| RECEIVE\_BOOT\_COMPLETED | Grundlegende Berichterstellung |
| VIBRATE | Grundlegende Berichterstellung |
| DOWNLOAD\_WITHOUT\_NOTIFICATION | Überblick-Benachrichtigung |
| WAKE\_LOCK | Erfassen von Statistiken bei WLAN-Verwendung oder ausgeschaltetem Bildschirm |
| RECEIVE\_BOOT\_COMPLETED | Aktivieren der Berichterstellung im Hintergrund |
| ACCESS\_COARSE\_LOCATION | Echtzeit-Berichterstellung für Speicherorte |
| ACCESS\_FINE\_LOCATION | GPS-basierte Berichterstellung |
...
## Konfigurationsoptionen für Manifestdateien
