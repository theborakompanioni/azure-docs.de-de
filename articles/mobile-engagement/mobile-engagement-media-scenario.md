---
title: "Azure Mobile Engagement-Implementierung für Medien-App"
...
---
# <a name="implement-mobile-engagement-with-media-app"></a>Implementieren von Mobile Engagement per Medien-App
...
1. **Betriebssysteme** : Da alle Betriebssysteme eigene Regeln zum Verwalten von Pushbenachrichtigungen haben, entscheidet sich Peter dafür, alle Fälle aufzulisten und zu überprüfen, ob sie von den APIs verarbeitet werden können.
   Beispiel: Beim Android-Pushsystem sind große Bilder zulässig, was für iOS nicht der Fall ist.
