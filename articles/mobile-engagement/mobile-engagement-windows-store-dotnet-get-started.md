...
6. Navigieren Sie zu den **Einstellungen** Ihres Mobile Engagement-Portals, und klicken Sie auf den Abschnitt **Native Push** auf der linken Seite. Klicken Sie dann auf die Schaltfläche **Bearbeiten**, um Ihre **Paket-Sicherheits-ID (SID)** und Ihren **geheimen Schlüssel** einzugeben. Dies ist hier dargestellt:
