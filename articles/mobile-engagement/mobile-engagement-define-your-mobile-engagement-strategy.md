...
## <a name="mobile-engagement-serves-your-objectives"></a>Mobile Engagement dient Ihren Zielen
...
## <a name="why-do-you-need-analytics-to-engage"></a>Warum benötigen Sie Analysen für die Erfassung?
...
> [!NOTE]
> Denken Sie an Folgendes: Zu viele Daten sind der Daten Tod!
> 
> 
...
### <a name="how-to-create-a-great-tag-plan"></a>Vorgehensweise zum Erstellen eines geeigneten Markierungsplans?
...
*App-Informationen* sind Daten, mit denen Sie in Echtzeit den Status der Anwendung oder des Benutzers bestätigen können. Diese sind auch für die Kategorisierung einer Zielgruppenbasis und die schnelle Ausrichtung auf diese Basis nützlich. So kann beispielsweise mithilfe von „true“ oder „false“ angegeben werden, ob sich der Benutzer anmeldet, oder es kann das Ablaufdatum seines Abonnements angegeben werden.

#### <a name="example-of-tags"></a>Beispiele für Kennzeichen
