...
Beispiele und eine Anleitung finden Sie im Arbeitsblatt **KPI Builder** in [Media Playbook Template](Media Playbook link.md) \(in englischer Sprache).
...
Beispiele und eine Anleitung finden Sie im Arbeitsblatt **Engagement Program** in [Media Playbook Template](Media Playbook link.md) \(in englischer Sprache).
