...
13. Kopieren Sie sofort den Wert, der für den Schlüssel angezeigt wird. Er wird nur jetzt angezeigt, und er wird nicht gespeichert, daher ist er später nicht mehr abrufbar. Wenn er verloren geht, müssen Sie einen neuen Schlüssel generieren. Dies ist das **CLIENT\_SECRET** für Ihre API-Aufrufe.
...
15. Kopieren Sie im Dialogfeld „Anwendungsendpunkte“ den **OAUTH 2.0-TOKEN-ENDPUNKT**.
    ...
    ![][14]
16. Dieser Endpunkt liegt im folgenden Format vor, wobei die GUID in der URL Ihre **TENANT\_ID** darstellt, die Sie ebenfalls notieren sollten:
