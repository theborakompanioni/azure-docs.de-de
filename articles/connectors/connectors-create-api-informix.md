...
3. Geben Sie einen Wert für **Informix-Datenbankname** ein. Geben Sie beispielsweise `nwind`.
4. Geben Sie einen Wert für **Benutzername** ein. Geben Sie beispielsweise `informix`.
5. Geben Sie einen Wert für **Kennwort** ein. Geben Sie beispielsweise `Password1`.
