...
> [!TIP]
> Die [vollständige Liste von A bis Z](#az) (in diesem Thema) enthält alle verfügbaren Connectors, die Sie in Ihren Logik-Apps verwenden können.
...
* **Standardconnectors:** Automatisch verfügbar und enthalten, wenn Sie Logik-Apps verwenden. Beispiele wären etwa Service Bus, DropBox, GoogleDrive, Power BI, Oracle Database, OneDrive und viele mehr.
...
* **Enterprise-Connectors:** Unter anderem für MQ und SAP. Hierbei fallen auch zusätzliche Kosten an. 
...
| **Join** | Verknüpfen Sie ein Array unter Verwendung eines Trennzeichens.  Der Vorgang zur Erkennung von Schlüsselausdrücken gibt beispielsweise ein Array mit Schlüsselausdrücken zurück.  Diese können etwa durch ein `,` verknüpft werden. Anstelle von `[“Some”, “Phrase”]` erhalten Sie dann `“Some, Phrase”`. |
