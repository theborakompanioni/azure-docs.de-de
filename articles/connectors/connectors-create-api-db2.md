...
3. Geben Sie einen Wert für **DB2-Datenbankname** ein. Geben Sie beispielsweise `nwind`.
4. Geben Sie einen Wert für **Benutzername** ein. Geben Sie beispielsweise `db2admin`.
