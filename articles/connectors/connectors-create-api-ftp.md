---
title: 'So wird''s gemacht: Verwenden des FTP-Connectors in Logik-Apps | Microsoft Docs'
...
### Herstellen einer FTP-Verbindung
> [!INCLUDE [Schritte zum Erstellen einer FTP-Verbindung](../../includes/connectors-create-api-ftp.md)]
> 
> 
...
3. Wählen Sie den Pfeil nach rechts (**>**) aus, und navigieren Sie zu dem Ordner, den Sie auf neue oder geänderte Dateien überwachen möchten. Wählen Sie den Ordner aus. Der Ordner wird nun im Steuerelement **Ordner** angezeigt.  
...
5. Wählen Sie das Steuerelement **Datei** (leerer Bereich unterhalb von **DATEI***) aus. Hier können Sie die unterschiedlichen Eigenschaften der neuen oder geänderten Datei verwenden, die auf dem FTP-Server gefunden wurde.
6. Wählen Sie die Option **Dateiinhalt** aus.  
