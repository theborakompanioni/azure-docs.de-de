---
title: Dynamische Paketerstellung – Übersicht | Microsoft Docs
...
1. [Überprüfen Sie die vorcodierten Dateien](media-services-static-packaging.md#validating-adaptive-bitrate-mp4s-encoded-with-external-encoders).
2. [Streamen Sie Ihre Inhalte](media-services-deliver-content-overview.md).
