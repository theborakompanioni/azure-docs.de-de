...
In diesem Thema werden einige Elemente und Typen des XML-Schemas beschrieben, auf dem [Media Encoder Standard-Voreinstellungen](https://msdn.microsoft.com/library/azure/mt269960.aspx) basieren. Das Thema enthält eine Beschreibung der Elemente und der dazugehörigen gültigen Werte. Das vollständige Schema wird zu einem späteren Zeitpunkt veröffentlicht.  
...
Beispiele für XML-Voreinstellungen, die basierend auf diesem Schema erstellt werden, finden Sie unter [Task Presets for MES (Media Encoder Standard)](https://msdn.microsoft.com/library/azure/mt269960.aspx) (Aufgabenvoreinstellungen für MES (Media Encoder Standard)).
