...
2. Klicken Sie auf **Schnellerfassung**, um einen Pass-Through-Kanal mit dem RTMP-Erfassungsprotokoll zu erstellen.
   
    Das Fenster **EINEN NEUEN KANAL ERSTELLEN** wird angezeigt.
3. Geben Sie dem neuen Kanal einen Namen, und klicken Sie auf **Erstellen**.
