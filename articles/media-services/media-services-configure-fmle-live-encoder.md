---
title: Konfigurieren des FMLE zum Senden eines Single-Bitrate-Livedatenstroms | Microsoft Docs
...
1. Klicken Sie auf **Kanal erstellen**. ![FMLE](./media/media-services-fmle-live-encoder/media-services-fmle2.png)
...
> [!IMPORTANT]
> Bevor Sie auf **Verbinden** klicken, **müssen** Sie sicherstellen, dass der Kanal bereit ist. Stellen Sie außerdem sicher, dass der Kanal nicht länger als 15 Minuten ohne Eingabe-/Beitragsfeed in einem betriebsbereiten Zustand verbleibt.
> 
> 
