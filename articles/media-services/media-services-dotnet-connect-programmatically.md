...
> [!NOTE]
> Die **CloudMediaContext** -Klasse ist nicht threadsicher. Sie sollten für jeden Thread oder für jeden Satz von Vorgängen einen neuen CloudMediaContext erstellen.
> 
> 
...
## <a name="reusing-access-control-service-tokens"></a>Wiederverwenden von Token des Zugriffssteuerungsdiensts
...
## <a name="connecting-to-a-media-services-account-located-in-the-north-china-region"></a>Herstellen einer Verbindung mit einem Media Services-Konto, das sich in der Region Nordchina befindet
...
## <a name="storing-connection-values-in-configuration"></a>Speichern von Verbindungswerten in der Konfiguration
