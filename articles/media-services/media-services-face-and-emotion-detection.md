...
- **Gesichtserkennung**
	...
	>[AZURE.NOTE]Diese Dienste führen keine Gesichtserkennung durch. Eine Person, die zu lange nicht im Frame ist oder verdeckt wird, erhält bei ihrer Rückkehr eine neue ID.
...
Dieses Thema enthält Details zu **Azure Media Face Detector** und zeigt die Verwendung mit Media Services SDK für .NET.

##Face Detector-Eingabedateien

Videodateien. Derzeit werden folgende Formate unterstützt: MP4, MOV und WMV.

##Face Detector-Ausgabedateien
...
##Eingabe- und Ausgabebeispiel für Gesichtserkennung
...
##Eingabe- und Ausgabebeispiel für Emotionenerkennung
