---
title: Konfigurieren des NewTek TriCaster-Encoders zum Senden eines Single-Bitrate-Livedatenstroms | Microsoft Docs
...
1. Klicken Sie auf **Kanal erstellen**. ![Tricaster](./media/media-services-tricaster-live-encoder/media-services-tricaster2.png)
...
9. Fügen Sie diese Informationen im Tricaster-Projekt in das Feld **Speicherort** unter **Flash Server** ein. Weisen Sie außerdem im Feld **Datenstrom-ID** einen Datenstromnamen zu.
