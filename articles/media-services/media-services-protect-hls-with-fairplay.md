...
- Einschränkungen (offen oder Token) und Informationen zum Typ der Schlüsselbereitstellung, der definiert, wie der Schlüssel an den Client übermittelt wird. 
...
1. Erstellen Sie einen OnDemand-Locator, um eine Streaming-URL zu erhalten.
