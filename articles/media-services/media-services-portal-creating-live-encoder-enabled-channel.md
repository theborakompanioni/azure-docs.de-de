...
6. Veröffentlichen Sie das Ereignis (dadurch wird ein OnDemand-Locator für das zugehörige Asset erstellt).
...
3. Abrufen der Erfassungs-URL, um sie dem Liveencoder bereitzustellen Diese URL wird vom Liveencoder verwendet, um den Datenstrom in den Kanal zu leiten.
