...
* Installieren Sie die aktuelle Version der Azure PowerShell-Module. Weitere Informationen finden Sie unter [Installieren und Konfigurieren von Azure PowerShell](/powershell/azureps-cmdlets-docs).
