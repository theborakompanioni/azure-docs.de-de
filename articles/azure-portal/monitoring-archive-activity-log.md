<properties
	pageTitle="Archivieren des Azure-Aktivitätsprotokolls | Microsoft Azure"
...
# Archivieren des Azure-Aktivitätsprotokolls
...
## Archivieren des Aktivitätsprotokolls mithilfe von PowerShell
```
...
| category | Kategorie der Aktion (beispielsweise „Write“, „Read“ oder „Action“). |
| resultType | Art des Ergebnisses (beispielsweise „Success“, „Failure“ oder „Start“). |
