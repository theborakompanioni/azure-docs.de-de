<properties
	pageTitle="Verwenden von PowerShell zum Erstellen von Warnungen für Azure-Dienste | Microsoft Azure"
...
# Verwenden von PowerShell zum Erstellen von Warnungen für Azure-Dienste 
...
## Erstellen von Warnregeln in PowerShell
...
7. Zum Erstellen einer Warnung, die bei einer bestimmten Bedingung im Aktivitätsprotokoll ausgelöst wird, wählen Sie Befehle im folgenden Format:
...
8. Überprüfen Sie, ob Warnungen ordnungsgemäß erstellt wurden, indem Sie sich die einzelnen Regeln ansehen.
...
9. Löschen Sie Ihre Warnungen. Mit diesen Befehlen werden die zuvor in diesem Artikel erstellten Regeln gelöscht.
