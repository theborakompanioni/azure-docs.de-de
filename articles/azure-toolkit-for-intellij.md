---
title: "Azure Toolkit für IntelliJ | Microsoft-Dokumentation"
...
Das Azure Toolkit für IntelliJ stellt Vorlagen und Funktionen bereit, die Ihnen das einfache Erstellen, Entwickeln, Testen und Bereitstellen von Azure-Anwendungen mithilfe der IntelliJ-Entwicklungsumgebung ermöglichen. Es handelt sich um ein Open-Source-Projekt, dessen Quellcode unter der MIT-Lizenz auf der Website des Projekts verfügbar ist:
...
## <a name="getting-started-with-the-azure-toolkit-for-intellij"></a>Erste Schritte mit dem Azure Toolkit für IntelliJ
...
## <a name="using-the-azure-toolkit-for-intellij"></a>Verwenden des Azure-Toolkits für IntelliJ
...
* Weitere Informationen finden Sie unter [Verwenden der HDInsight-Tools im Azure-Toolkit für IntelliJ zum Erstellen von Spark-Anwendungen für HDInsight Spark-Cluster unter Linux][Verwenden des HDInsight-Tools-Plug-Ins für IntelliJ IDEA zum Erstellen von Spark-Anwendungen für HDInsight Spark-Cluster unter Linux].
