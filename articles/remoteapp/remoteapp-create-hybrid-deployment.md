...
2. Richten Sie Ihr virtuelles Netzwerk ein. Weitere Informationen finden Sie im [Artikel zur VNET-Planung](remoteapp-planvnet.md) und [Größenbestimmung](remoteapp-vnetsizing.md).
...
* Installieren Sie das [Azure PowerShell](/powershell/azure/overview) -Modul.
...
## <a name="step-1-set-up-your-virtual-network"></a>Schritt 1: Einrichten des virtuellen Netzwerks
...
### <a name="create-an-azure-vnet-and-join-it-to-your-active-directory-deployment"></a>Erstellen eines Azure-VNET und Verknüpfen mit der Active Directory-Bereitstellung
...
### <a name="make-sure-your-virtual-network-is-ready-for-azure-remoteapp"></a>Sicherstellen, dass das virtuelle Netzwerk für Azure RemoteApp bereit ist
...
## <a name="step-2-create-an-azure-remoteapp-collection"></a>Schritt 2: Erstellen einer Azure RemoteApp-Sammlung
...
## <a name="step-3-link-your-collection-to-the-local-domain"></a>Schritt 3: Verknüpfen der Sammlung mit der lokalen Domäne
...
## <a name="step-4-link-to-an-azure-remoteapp-image"></a>Schritt 4: Verbinden mit einem Azure RemoteApp-Image
...
## <a name="step-5-configure-active-directory-directory-synchronization"></a>Schritt 5: Konfigurieren der Active Directory-Verzeichnissynchronisierung
...
2. Geben Sie das Geschäftskonto (aus Active Directory) oder das Microsoft-Konto ein, dem Sie Zugriff gewähren möchten.
   ...
   **Hinweise:**
   ...
   Stellen Sie sicher, dass Sie das Format *user@domain.com* verwenden.
