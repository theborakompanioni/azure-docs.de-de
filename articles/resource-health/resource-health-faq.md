...
* [Was ist Azure Resource Health?](#what-is-azure-resource-health)
* [Wofür ist Resource Health vorgesehen?](#what-is-the-resource-health-intended-for)
* [Welche Integritätsprüfungen werden von Resource Health ausgeführt?](#what-health-checks-are-performed-by-resource-health)
* [Was bedeuten die einzelnen Integritätsstatus?](#what-does-each-of-the-health-status-mean)
* [Was bedeutet der unbekannte Status? Stimmt mit meiner Ressource etwas nicht?](#what-does-the-unknown-status-mean-is-something-wrong-with-my-resource)
* [Wie kann ich Hilfe für eine Ressource erhalten, die nicht verfügbar ist?](#how-can-i-get-help-for-a-resource-that-is-unavailable)
* [Differenziert Resource Health, ob Nichtverfügbarkeit auf Plattformprobleme zurückzuführen ist, oder auf Aktionen, die ich durchgeführt habe?](#does-resource-health-differentiate-between-unavailability-cased-by-platform-problems-versus-something-i-did)
* [Kann ich Resource Health in meine Überwachungstools integrieren?](#can-i-integrate-resource-health-with-my-monitoring-tools)
* [Wo finde ich Resource Health?](#where-do-i-find-resource-health)
* [Steht Resource Health für alle Ressourcentypen zur Verfügung?](#is-resource-health-available-for-all-resource-types)
* [Was kann ich tun, wenn meine Ressource als verfügbar angezeigt wird, aber ich davon ausgehe, dass dies nicht der Fall ist?](#what-should-i-do-if-my-resource-is-showing-available-but-i-believe-it-is-not)
* [Steht Resource Health für alle Azure-Regionen zur Verfügung?](#is-resource-health-available-for-all-azure-regions)
* [Wie unterscheidet sich Resource Health vom Service Health Dashboard oder den Dienstbenachrichtigungen des Azure-Portals?](#how-is-resource-health-different-from-the-service-health-dashboard-or-the-azure-portal-service-notifications)
* [Muss ich Resource Health für jede Ressource aktivieren?](#do-i-need-to-activate-resource-health-for-each-resource)
* [Müssen wir Resource Health für meine Organisation aktivieren?](#do-we-need-to-enable-resource-health-for-my-organization)
* [Ist Resource Health kostenlos verfügbar?](#is-resource-health-available-free-of-charge)
* [Welche Empfehlungen gibt Resource Health?](#what-are-the-recommendations-that-resource-health-provides)
...
1. Ungeplante Ereignisse, z.B. einen unerwarteten Hostneustart
2. Geplante Ereignisse wie geplante Host-BS-Updates
3. Durch Benutzeraktionen ausgelöste Ereignisse, z.B. Neustart eines virtuellen Computers durch einen Benutzer
...
1.    Benutzerinitiierte Aktion
2.    Geplantes Ereignis 
3.    Ungeplantes Ereignis
...
1. Wechseln Sie zu Ihrer Ressource. Klicken Sie im linken Navigationsbereich auf **Resource Health**.
2. Gehen Sie zum Blatt „Azure Monitor“.  Klicken Sie im linken Navigationsbereich auf **Resource Health**.
3. Öffnen Sie das Blatt **Hilfe und Support**, indem Sie oben rechts im Portal auf das Fragezeichen klicken und dann die Option **Hilfe und Support** wählen. Nachdem das Blatt geöffnet ist, klicken Sie auf **Resource Health**.
...
## <a name="how-is-resource-health-different-from-the-service-health-dashboard-or-the-azure-portal-service-notifications"></a>Wie unterscheidet sich Resource Health vom Service Health Dashboard oder den Dienstbenachrichtigungen des Azure-Portals?
Die von Resource Health bereitgestellten Informationen sind präziser als die vom Azure Service Health Dashboard bereitgestellten Informationen.

Während [Azure-Status](https://status.azure.com) und die Portaldienstbenachrichtigungen Sie über Dienstprobleme informieren, die einen großen Kundenkreis (z.B. eine Azure-Region) betreffen, deckt Resource Health spezifischere Ereignisse auf, die nur für die jeweilige Ressource relevant sind. Wenn z.B. ein Host unerwartet neu startet, warnt Resource Health nur die Kunden, deren virtuelle Computer auf diesem Host ausgeführt wurden.

Bitte beachten Sie: Um Ihnen einen vollständigen Überblick über Ereignisse zu bieten, die Auswirkungen auf Ihre Ressourcen haben, deckt Resource Health auch Ereignisse auf, die in Dienstbenachrichtigungen und dem Service Health Dashboard veröffentlicht werden.
