...
1. Klicken Sie auf **Geschützte Elemente** > **Schutzgruppen** > **Computer** > „Computer hinzufügen“.
...
3. Sie können folgende Eigenschaften ändern:
	...
	- **Azure-IP-Adresse/-Subnetz**: Wählen Für jede Netzwerkkarte das Subnetz aus, mit dem der virtuelle Azure-Computer verbunden werden soll. Beachten Sie Folgendes:
