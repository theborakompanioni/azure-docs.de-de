...
**Lokale VMware-Server** | Mindestens einen VMware vSphere-Server mit 6.5, 6.0, 5.5, 5.1 mit den neuesten Updates. Die Server sollten sich in demselben Netzwerk wie der Konfigurationsserver (oder der separate Prozessserver) befinden.<br/><br/> Wir empfehlen Ihnen die Verwendung eines vCenter-Servers zum Verwalten von Hosts, auf dem Version 6.5, 6.0 oder 5.5 mit den neuesten Updates ausgeführt wird.
...
**VMware** | Site Recovery unterstützt neue Features von vCenter und vSphere 6.5 und 6.0 nicht. Hierzu zählen etwa Cross vCenter vMotion, Virtual Volumes und Storage DRS.
