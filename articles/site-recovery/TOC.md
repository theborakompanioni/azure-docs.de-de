...
# Erste Schritte
## [Replikation von Azure-VMs (Vorschau)](azure-to-azure-walkthrough-overview.md)
### [Schritt 1: Überprüfen der Architektur](azure-to-azure-walkthrough-architecture.md)
### [Schritt 2: Vorbereitung](azure-to-azure-walkthrough-prerequisites.md)
### [Schritt 3: Planen des Netzwerks](azure-to-azure-walkthrough-network.md)
### [Schritt 4: Erstellen eines Tresors](azure-to-azure-walkthrough-vault.md)
### [Schritt 5: Aktivieren der Replikation](azure-to-azure-walkthrough-enable-replication.md)
### [Schritt 6: Ausführen eines Testfailovers](azure-to-azure-walkthrough-test-failover.md)
...
## [Replizieren von Hyper-V-VMs an einem sekundären Standort (mit VMM)](vmm-to-vmm-walkthrough-overview.md)
### [Schritt 1: Überprüfen der Architektur](vmm-to-vmm-walkthrough-architecture.md)
### [Schritt 2: Überprüfen der Voraussetzungen und Einschränkungen](vmm-to-vmm-walkthrough-prerequisites.md)
### [Schritt 3: Planen des Netzwerks](vmm-to-vmm-walkthrough-network.md)
### [Schritt 4: Vorbereiten von VMM und Hyper-V](vmm-to-vmm-walkthrough-vmm-hyper-v.md)
### [Schritt 5: Erstellen eines Tresors](vmm-to-vmm-walkthrough-create-vault.md)
### [Schritt 6: Einrichten von Quelle und Ziel](vmm-to-vmm-walkthrough-source-target.md)
### [Schritt 7: Konfigurieren der Netzwerkzuordnung](vmm-to-vmm-walkthrough-network-mapping.md)
### [Schritt 8: Erstellen einer Replikationsrichtlinie](vmm-to-vmm-walkthrough-replication.md)
### [Schritt 9: Aktivieren der Replikation](vmm-to-vmm-walkthrough-enable-replication.md)
### [Schritt 10: Ausführen eines Testfailovers](vmm-to-vmm-walkthrough-test-failover.md)
