...
|Microsoft-ASR\_UA\*RHEL6-64*release.tar.gz| RHEL 6.4, 6.5, 6.6 (nur 64 Bit) </br> CentOS 6.4, 6.5, 6.6 (nur 64 Bit) |
...
|Microsoft-ASR_UA\*Ubuntu-14.04-64\*release.tar.gz | Ubuntu 14.04 (nur 64 Bit)|
