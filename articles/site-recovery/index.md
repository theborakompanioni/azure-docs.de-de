...
Erfahren Sie mehr darüber, wie Site Recovery Ihre Strategie für Geschäftskontinuität und Notfallwiederherstellung unterstützen kann, um die Verfügbarkeit von Apps und Workloads in Ausfallzeiten zu erhalten. In Tutorials und anderen Artikeln finden Sie Informationen zum Planen, Bereitstellen und Verwalten von Replikation, Failover und Wiederherstellung von lokalen Computern und virtuellen Azure-Computern.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Informationen zu Azure Site Recovery</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Site Recovery – Videobibliothek</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erste Schritte mit Azure Site Recovery</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erste Schritte mit der Replikation von virtuellen Hyper-V-Computern auf Azure (ohne VMM)</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erste Schritte mit der Replikation von virtuellen Hyper-V-Computern in VMM-Clouds auf Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="https://msdn.microsoft.com/en-us/library/mt750497">REST-API-Referenz</a></p>
                    </div>
                </div>
            </div>
        </div>
