...
|:---------|:--------------------------:|:------------------:|
| [Cloud Services](https://azure.microsoft.com/services/cloud-services/ "Azure Cloud Services") | [link](../cloud-services/cloud-services-disaster-recovery-guidance.md "Azure Cloud Services – Leitfaden zur Notfallwiederherstellung") | In Kürze verfügbar |
| [Schlüsseltresor](https://azure.microsoft.com/services/key-vault/ "Azure-Schlüsseltresor") | [link](../key-vault/key-vault-disaster-recovery-guidance.md "Azure Key Vault – Leitfaden zur Notfallwiederherstellung") | In Kürze verfügbar |
| [Speicher](https://azure.microsoft.com/services/storage/ "Azure Storage") | [link](../storage/storage-disaster-recovery-guidance.md "Azure Storage – Leitfaden zur Notfallwiederherstellung") | In Kürze verfügbar |
...
| [Virtuelle Computer](https://azure.microsoft.com/services/virtual-machines/ "Azure Virtual Machines") | [link](../virtual-machines/virtual-machines-disaster-recovery-guidance.md "Azure Virtual Machines – Leitfaden zur Notfallwiederherstellung") | In Kürze verfügbar |
