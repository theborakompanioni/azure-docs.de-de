...
---
# <a name="get-started-with-azure-data-lake-store-using-rest-apis"></a>Erste Schritte mit Azure Data Lake-Speicher mithilfe von REST-APIs
...
## <a name="list-folders-in-a-data-lake-store-account"></a>Auflisten von Ordnern in einem Data Lake-Speicherkonto
...
## <a name="upload-data-into-a-data-lake-store-account"></a>Hochladen von Daten in das Data Lake-Speicherkonto
...
In der obigen Syntax gibt der **-T**-Parameter den Speicherort der hochgeladenen Datei an.
...
## <a name="read-data-from-a-data-lake-store-account"></a>Lesen von Daten aus einem Data Lake-Speicherkonto
...
## <a name="rename-a-file-in-a-data-lake-store-account"></a>Umbenennen einer Datei in einem Data Lake-Speicherkonto
...
## <a name="delete-a-file-from-a-data-lake-store-account"></a>Löschen einer Datei aus einem Data Lake-Speicherkonto
