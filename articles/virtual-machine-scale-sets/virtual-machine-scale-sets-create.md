...
### <a name="using-a-custom-virtual-machine-image"></a>Verwenden eines benutzerdefinierten VM-Images
Wenn Sie eine Skalierungsgruppe aus Ihrem eigenen benutzerdefinierten Image erstellen, statt auf ein VM-Image aus dem Katalog zu verweisen, sieht der Befehl _Set-AzureRmVmssStorageProfile_ folgendermaßen aus:
```PowerShell
