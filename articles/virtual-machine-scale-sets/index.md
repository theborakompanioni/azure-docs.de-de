        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Informationen zu VM-Skalierungsgruppen</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Videobibliothek zu virtuellen Computern</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erste Schritte mit VM-Skalierungsgruppen unter Windows</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erste Schritte mit VM-Skalierungsgruppen unter Linux</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>PowerShell</h3>
                        <p>VM-Skalierungsgruppen unter Verwendung von PowerShell</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p>VM-Skalierungsgruppen unter Verwendung der Azure-Befehlszeilenschnittstelle</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p>VM-Skalierungsgruppen – REST-API-Referenz</p>
                    </div>
                </div>
            </div>
        </div>
