...
>[AZURE.NOTE]Sie können die Ressourcen auch über das Portal bereitstellen. Verwenden Sie den folgenden Link: https://portal.azure.com/#create/Microsoft.Template/uri/<link to VM Scale Set JSON template>
