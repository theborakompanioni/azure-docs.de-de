<properties
	pageTitle="Erstellen von Skalierungsgruppen über das Portal | Microsoft Azure"
...
# Erstellen einer Skalierungsgruppe über das Azure-Portal
...
## Auswählen des VM-Images aus dem Marketplace

Über das Portal können Sie komfortabel eine Skalierungsgruppe mit CentOS-, CoreOS-, Debian-, Open Suse-, Red Hat Enterprise Linux-, SUSE Linux Enterprise Server- oder Ubuntu Server-Images bereitstellen.
