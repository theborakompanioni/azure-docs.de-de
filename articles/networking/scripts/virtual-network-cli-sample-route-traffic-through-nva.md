...
[!code-azurecli-interactive[main](../../../cli_scripts/virtual-network/route-traffic-through-nva/route-traffic-through-nva.sh "Weiterleiten von Datenverkehr über ein virtuelles Netzwerkgerät")]
