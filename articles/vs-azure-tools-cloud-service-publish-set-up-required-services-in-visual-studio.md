...
3. Klicken Sie auf die Schaltfläche **Weiter**, um zur Seite **Einstellungen** zu gelangen.
...
5. Geben Sie einen Namen für Ihren Clouddienst an. Die vollständige URL wird neben dem Namen angezeigt.
...
3. Wenn Sie fertig sind, wählen Sie **Erstellen** aus. Das neue Speicherkonto wird im **Server-Explorer** in der Liste **Speicher** angezeigt.
...
4. Wählen Sie im angezeigten Menü erst **Speicher** und dann **Schnellerfassung** aus.
...
9. Geben Sie in das Feld **Kontoname** den Namen Ihres Azure-Speicherkontos ein.
   ...
   > 
   > 
10. Geben Sie im Feld **Kontoschlüssel** den Primärschlüssel ein, oder kopieren Sie ihn aus dem [klassischen Azure-Portal](http://go.microsoft.com/fwlink/?LinkID=213885), und fügen Sie ihn dann ein. So kopieren Sie den Schlüssel
