...
# <a name="service-bus-relay-rest-tutorial"></a>REST-Tutorial zu Service Bus Relay
...
4. Erstellen Sie nach dem `<services>`-Element ein `<behaviors>`-Element mit dem folgenden Inhalt, das „SAS_KEY“ durch den *Shared Access Signature*-Schlüssel (SAS) ersetzt, den Sie zuvor 1 aus dem [Azure-Portal][] abgerufen haben.
