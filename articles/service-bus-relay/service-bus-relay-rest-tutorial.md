...
# REST-Tutorial zu Service Bus Relay
...
4. Erstellen Sie nach dem `<services>`-Element ein `<behaviors>`-Element mit dem folgenden Inhalt, der „SAS\_KEY“ durch den *Shared Access Signature*-Schlüssel (SAS) ersetzt, den Sie zuvor 1 aus dem [Azure-Portal][] abgerufen haben.
...
- [Übersicht über die Architektur von Azure Service Bus](../service-bus/service-bus-fundamentals-hybrid-solutions.md#relays)
