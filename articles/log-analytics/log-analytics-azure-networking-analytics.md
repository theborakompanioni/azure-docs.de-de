<properties
    pageTitle="Azure Networking Analytics-Lösung in Log Analytics | Microsoft Azure"
...
>[AZURE.NOTE] Dies ist eine [Vorschaulösung](log-analytics-add-solutions.md#log-analytics-preview-solutions-and-features).
...
2.  Konfigurieren Sie Log Analytics für das Lesen der Protokolle aus Blob Storage. Gehen Sie dabei vor wie unter [JSON-Dateien in Blob Storage](../log-analytics/log-analytics-azure-storage-json.md) beschrieben.
