...
>[AZURE.NOTE] Für virtuelle Computer in Azure können Sie die Installation vereinfachen, indem Sie die [VM-Erweiterung](log-analytics-azure-vm-extension.md) verwenden.
