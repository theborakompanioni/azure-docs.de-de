<properties
    pageTitle="Überwachen von Surface Hubs mit Log Analytics | Microsoft Azure"
...
# <a name="monitor-surface-hubs-with-log-analytics"></a>Überwachen von Surface Hubs mit Log Analytics
...
6. Geben Sie im Dialogfeld mit den OMS-Einstellungen die **Arbeitsbereichs-ID** und den **Arbeitsbereichsschlüssel** ein.  
