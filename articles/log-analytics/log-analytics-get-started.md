...
## <a name="sign-up-in-3-steps-using-the-operations-management-suite"></a>Anmelden in drei Schritten über die Operations Management Suite
1. Wechseln Sie zum [Operations Management Suite](http://microsoft.com/oms) -Website erstellen und auf **Kostenlos testen**klicken. Melden Sie sich zur Verwendung mit Office 365 oder anderen Microsoft-Diensten mit Ihrem Microsoft-Konto, z. B. Outlook.com, oder mit einem vom Unternehmen oder der Bildungseinrichtung bereitgestellten Organisationskonto an.
...
1. Wechseln Sie zum [Azure-Portal](https://portal.azure.com) , und melden Sie sich an, durchsuchen Sie die Liste von Diensten, und wählen Sie dann **Log Analytics (OMS)**.  
...
3. Klicken Sie auf **Erstellen**. Die Arbeitsbereichsdetails werden im Azure-Portal angezeigt.       
