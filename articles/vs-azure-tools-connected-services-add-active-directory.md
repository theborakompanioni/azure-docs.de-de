...
description: 'Fügen Sie Azure Active Directory mithilfe des Dialogfelds '
;verbundene: ''
dienste: ''
hinzufügen";: ''
in: ''
...
4. Aktivieren Sie auf der ersten Seite von **Azure-Authentifizierung konfigurieren** das Kontrollkästchen **Einmaliges Anmelden mit Azure AD konfigurieren**.
