...
Twilio ist ein Pay-as-you-go-Dienst, also vertragsungebunden. Es fallen keine Einrichtungsgebühren an, und Sie können Ihr Konto jederzeit schließen. Weitere Informationen finden Sie unter [Twilio-Preiset][twilio_pricing].
...
## <a name="a-idcreateappacreate-a-php-application"></a><a id="create_app"></a>Erstellen einer PHP-Anwendung
