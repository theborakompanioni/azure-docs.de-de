---
title: Öffentliche und private IP-Adressen (klassisch) in Azure | Microsoft Docs
...
Erfahren Sie, wie Sie [diese Schritte mit dem Resource Manager-Bereitstellungsmodell ausführen](virtual-network-ip-addresses-overview-arm.md).
