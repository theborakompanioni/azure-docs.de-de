...
---
# <a name="accelerated-networking-for-a-virtual-machine-using-powershell"></a>Beschleunigter Netzwerkbetrieb für einen virtuellen Computer – PowerShell
...
Accelerated Networking ermöglicht die E/A-Virtualisierung mit Einzelstamm (Single Root I/O Virtualization, SR-IOV) in einem virtuellen Computer (VM) und somit eine erhebliche Steigerung der Netzwerkleistung. Über diesen Hochleistungspfad wird der Host des Datenpfads umgangen, um Latenzen, Jitter und CPU-Auslastung zu verringern. So können auf unterstützten VM-Typen die anspruchsvollsten Netzwerkworkloads genutzt werden. Dieser Artikel erläutert die Verwendung von Azure PowerShell für das Konfigurieren von Accelerated Networking im Azure Resource Manager-Bereitstellungsmodell. Sie können im Azure-Portal auch einen virtuellen Computer mit Accelerated Networking erstellen. Informationen zur Vorgehensweise erhalten Sie, indem Sie am Anfang dieses Artikels auf das Feld „Azure-Portal“ klicken.
