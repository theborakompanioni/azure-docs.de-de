...
1. Erstellen Sie über eine PowerShell-Konsole ein lokales Netzwerk, indem Sie den nachstehenden Befehl ausführen. Das lokale Netzwerk muss CIDR-Block des klassischen VNet verwenden, mit dem Sie eine Verbindung herstellen möchten, sowie die öffentliche IP-Adresse des Gateways, die Sie in Schritt 1 oben erstellt haben.
...
4. Richten Sie über eine PowerShell-Konsole einen gemeinsam verwendeten Schlüssel ein, indem Sie den nachstehenden Befehl ausführen. Stellen Sie sicher, dass Sie die Namen der VNets in die Namen Ihrer eigenen VNets ändern.
