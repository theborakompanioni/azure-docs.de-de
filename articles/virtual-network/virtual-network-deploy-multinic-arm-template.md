---
title: Bereitstellen von Multi-NIC-VMs mithilfe einer Vorlage in Ressourcen-Manager | Microsoft Docs
...
1. Führen Sie das Cmdlet **`New-AzureRmResourceGroup`** aus, um mit der Vorlage eine Ressourcengruppe zu erstellen.
