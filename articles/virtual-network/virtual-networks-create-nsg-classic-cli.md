...
Dieser Artikel gilt für das klassische Bereitstellungsmodell. Sie können [NSGs auch im Ressourcen-Manager-Bereitstellungsmodell erstellen](virtual-networks-create-nsg-arm-cli.md).
...
2. Führen Sie den Befehl **`azure network nsg rule create`** aus, um eine Regel zu erstellen, die den Zugriff auf Port 1433 (SQL) über das Front-End-Subnetz zulässt.
    ...
    Erwartete Ausgabe:
        ...
        data:    Priority                        : 100
        info:    network nsg rule create command OK
3. Führen Sie den Befehl **`azure network nsg rule create`** aus, um eine Regel zu erstellen, die den Zugriff auf das Internet verweigert.
    ...
    Erwartete Ausgabe:
        ...
        data:    Priority                        : 200
        info:    network nsg rule create command OK
4. Führen Sie den Befehl **`azure network nsg subnet add`** aus, um die NSG mit dem Back-End-Subnetz zu verbinden.
