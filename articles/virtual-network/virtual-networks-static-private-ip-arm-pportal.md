...
> [!NOTE]
> Wenn Sie nach dem Klicken auf **Speichern** feststellen, dass die Zuweisung immer noch den Wert **dynamisch** anzeigt, bedeutet dies, dass die eingegebene IP-Adresse bereits verwendet wird. Versuchen Sie, eine andere IP-Adresse zu verwenden.
> 
> 
