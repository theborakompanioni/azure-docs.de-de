...
7. Fügen Sie die NIC beim Erstellen eines virtuellen Computers an. Führen Sie dazu die entsprechenden Schritte aus dem Artikel [Erstellen einer Windows-VM mit dem Resource Manager und PowerShell](../virtual-machines/virtual-machines-windows-ps-create.md) aus. Obwohl in dem Artikel ein virtueller Computer unter Windows Server erstellt wird, sind die Schritte für einen virtuellen Linux-Computer identisch, mit der einzigen Ausnahme, dass ein anderes Betriebssystem ausgewählt wird. Führen Sie die Schritte 1 bis 3 des Artikels aus. Überspringen Sie die Schritte 4 und 5, und führen Sie dann Schritt 6 aus.
