---
title: Bereitstellen von Multi-NIC-VMs mithilfe von PowerShell im klassischen Bereitstellungsmodell | Microsoft Docs
...
Erfahren Sie, wie Sie [diese Schritte mit dem Resource Manager-Modell ausführen](virtual-network-deploy-multinic-arm-ps.md).
