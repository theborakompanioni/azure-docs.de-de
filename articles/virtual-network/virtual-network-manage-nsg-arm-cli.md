---
title: Verwalten der NSGs mithilfe der Azure-Befehlszeilenschnittstelle in Resource Manager | Microsoft Docs
...
> [!NOTE]
> Der Parameter **--quiet** stellt sicher, dass Sie die Löschung nicht bestätigen müssen.
> 
> 
...
> [!NOTE]
> Beachten Sie, den "" (leer) Wert für den Parameter **network-security-group-id**. So entfernen Sie die Zuordnung zu einer NSG. Die selbe Aktion können Sie nicht mit dem Parameter **Netzwerksicherheitsgruppen-Name** durchführen.
> 
> 
