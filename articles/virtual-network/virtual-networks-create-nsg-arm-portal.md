---
title: 'Gewusst wie: Erstellen von NSGs im ARM-Modus über das Azure-Portal | Microsoft Docs'
...
6. Wiederholen Sie die Schritte bis Schritt 6 zum Erstellen einer eingehenden Regel namens *RDP-Regel* mit einer Priorität von *250*, und erlauben Sie damit den Zugriff auf einen beliebigen virtuellen Computer per *TCP* über Port *3389* von einer beliebigen Quelle aus.
