---
title: "Verwalten von Netzwerksicherheitsgruppen – Azure CLI 1.0 | Microsoft-Dokumentation"
description: Hier erfahren Sie, wie Sie Netzwerksicherheitsgruppen mithilfe der Azure-Befehlszeilenschnittstelle (Azure CLI 1.0) verwalten.
...
---
# <a name="manage-network-security-groups-using-the-azure-cli-10"></a>Verwalten von Netzwerksicherheitsgruppen mit der Azure CLI 1.0

## <a name="cli-versions-to-complete-the-task"></a>CLI-Versionen zum Durchführen dieser Aufgabe 

Führen Sie die Aufgabe mit einer der folgenden CLI-Versionen durch: 

- [Azure CLI 1.0:](#View-existing-NSGs) Unsere CLI für das klassische Bereitstellungsmodell und das Resource Manager-Bereitstellungsmodell 
- [Azure CLI 2.0](virtual-network-manage-nsg-arm-cli.md): Unsere CLI der nächsten Generation für das Resource Manager-Bereitstellungsmodell (dieser Artikel)
