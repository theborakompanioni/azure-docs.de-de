---
title: 'Gewusst wie: Verwenden von Blitline zur Bildverarbeitung - Leitfaden zu Azure-Features'
...
---
# <a name="how-to-use-blitline-with-azure-and-azure-storage"></a>Verwenden von Blitline mit Azure und Azure Storage
...
## <a name="create-a-blitline-account"></a>Erstellen eines Blitline-Kontos
[!INCLUDE [blitline-signup](../includes/blitline-signup.md)]

## <a name="how-to-create-a-blitline-job"></a>Erstellen eines Blitline-Jobs
...
## <a name="how-to-save-an-image-to-your-azure-storage-account"></a>Speichern eines Bilds im Azure-Speicherkonto
