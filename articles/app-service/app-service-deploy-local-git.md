...
Viele der in diesem Artikel beschriebenen Git-Befehle werden automatisch ausgeführt, wenn Sie eine App Service-App mit der [Azure-Befehlszeilenschnittstelle] erstellen, wie [hier](app-service-web-get-started-dotnet.md) beschrieben.
