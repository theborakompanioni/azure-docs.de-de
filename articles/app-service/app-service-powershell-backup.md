...
Eine Anleitung zum Installieren und Verwenden von Azure PowerShell finden Sie unter [Verwenden von Azure PowerShell mit dem Azure Resource Manager](/powershell/azureps-cmdlets-docs) .
