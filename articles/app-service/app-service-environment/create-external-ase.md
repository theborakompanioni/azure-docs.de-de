...
Die Azure App Service-Umgebung ist eine Bereitstellung von Azure App Service in einem Subnetz in einem virtuellen Azure-Netzwerk (VNET). Es gibt zwei Möglichkeiten, eine App Service-Umgebung (ASE) bereitzustellen:
