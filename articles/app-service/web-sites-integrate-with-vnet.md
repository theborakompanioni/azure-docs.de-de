...
Wählen Sie zum Erstellen eines Resource Manager-VNET über die Benutzeroberfläche der VNET-Integration einfach die Option **Neues virtuelles Netzwerk erstellen** aus, und geben Sie Folgendes an:
