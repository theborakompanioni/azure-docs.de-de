...
- Wenn die Erstellung einer Swagger-Datei neu für Sie ist bzw. wenn Sie noch nie eine Swagger-Datei erstellt haben, ist die Seite [Get started with Swagger][6] (Erste Schritte mit Swagger) hilfreich. 
...
- Informationen zum Anpassen Ihres Swagger-Dokuments für die Verwendung mit PowerApps und logischen Abläufen finden Sie unter [Anpassen der Swagger-Definition](powerapps-how-to-swagger.md).
...
In diesem Schritt erstellen wir eine sehr einfache PowerApp, die verdeutlicht, wie Sie Ihre benutzerdefinierte API hinzufügen. Ausführlichere Informationen finden Sie unter [Create an app from a set of data][11] (Erstellen einer App aus einer Gruppe von Daten).
...
Benutzer können benutzerdefinierte APIs auch untereinander freigeben. Nachdem Sie eine benutzerdefinierte API hinzugefügt haben, wählen Sie die Registerkarte **Verbindungen** und dann **Benutzerdefinierte APIs**. Wählen Sie anschließend das Freigabesymbol aus:
