---
title: Erste Schritte mit Azure Mobile Services und Sencha
...
3. Klicken Sie auf **TodoItems-Tabelle erstellen**, um eine Tabelle zum Speichern der App-Daten zu erstellen.
   ...
   > [!NOTE]
   > Laden Sie NICHT die HTML-App aus dem klassischen Azure-Portal herunter. Wir werden stattdessen im Abschnitt unten manuell eine Sencha Touch-Anwendung erstellen.
   > 
   > 
4. Notieren Sie sich **appKey** und **appUrl** im klassischen Azure-Portal. Sie werden diese in anderen Abschnitten dieses Lernprogramms benötigen.
...
> [!NOTE]
> Sie können diese Methode nur verwenden, wenn Sie die Anwendung mithilfe des Befehls <code>sencha generate app</code> erstellt haben.
> 
> 
