---
title: Speichern des Projektcodes vom JavaScript-Back-End in der Quellcodeverwaltung | Microsoft Docs
...
1. Wechseln Sie zum Ordner `.\service` Ihres lokalen Git-Repositorys, und öffnen Sie die Datei "package.json" in einem Text-Editor. Fügen Sie dem Objekt **dependencies** das folgende Feld hinzu:
   
        "node-uuid": "~1.4.3"
   
   > [!NOTE]
   > Durch diese Änderung in der Datei "package.json" wird nach dem Commit-Push ein Neustart in Ihrem mobilen Dienst ausgelöst.
   > 
   > 
2. Öffnen Sie nun das Unterverzeichnis .\\service\\table, öffnen Sie die Datei todoitem.insert.js und ändern Sie den Code wie folgt:
...
3. Geben Sie wie bereits im vorigen Abschnitt die folgenden Befehle in der Git-Eingabeaufforderung ein:
