---
title: Dienstseitige Autorisierung von Benutzern in einem mobilen JavaScript-Back-End-Dienst | Microsoft Docs
...
2. Klicken Sie auf **Skript**, wählen Sie den Vorgang **Einfügen**, ersetzen Sie das vorhandene Skript durch die folgende Funktion, und klicken Sie dann auf **Save**.
   ...
   > [!NOTE]
   > Stellen Sie sicher, dass das [dynamische Schema](https://msdn.microsoft.com/library/azure/jj193175.aspx) aktiviert ist. Andernfalls wird die Spalte *userID* nicht automatisch hinzugefügt. Diese Einstellung ist für einen neuen mobilen Dienst standardmäßig aktiviert.
   > 
   > 
