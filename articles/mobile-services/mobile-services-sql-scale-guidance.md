---
title: Skalieren von durch Azure SQL-Datenbank gesicherten mobilen Diensten | Microsoft Docs
...
Weitere Informationen zu Indizes finden Sie unter [Index Annotations in Entity Framework][Index Annotations in Entity Framework]. Weitere Hinweise zum Optimieren von Indizes finden Sie unter [Erweiterte Indizierung](#AdvancedIndexing) am Ende dieses Dokuments.
...
Weitere Informationen finden Sie unter [Überwachung von SQL Database mit dynamischen Verwaltungssichten][Überwachung von SQL Database mit dynamischen Verwaltungssichten]. Zusätzlich zur Ausführung der Abfrage finden Sie im **Verwaltungsportal für SQL-Datenbank** eine praktische Möglichkeit, diese Daten anzuzeigen. Wählen Sie **Zusammenfassung** für Ihre Datenbank, und klicken Sie dann auf **Abfrageleistung**:
...
* [Richtlinien für das Design von gruppierten Indizes][Richtlinien für das Design von gruppierten Indizes]
* [Primär- und Fremdschlüsselbeschränkungen][Primär- und Fremdschlüsselbeschränkungen]
