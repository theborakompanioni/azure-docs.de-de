---
title: Registrieren für die Authentifizierung in Azure Active Directory | Microsoft Docs
...
6. Nachdem die Anwendung hinzugefügt wurde, klicken Sie auf die Registerkarte **Konfigurieren** und kopieren Sie die **Client-ID** für die App.
   ...
   > [!NOTE]
   > Für einen mobilen .NET-Backend-Dienst müssen Sie auch den Wert **Antwort-URL** unter **Einmaliges Anmelden** bearbeiten, und legen diese URL gefolgt vom Pfad *signin-aad* fest. Beispiel: `https://todolist.azure-mobile.net/signin-aad`
   > 
   > 
