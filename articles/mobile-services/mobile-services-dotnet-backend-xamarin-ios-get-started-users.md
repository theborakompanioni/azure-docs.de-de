---
title: Erste Schritte bei der Authentifizierung in Mobile Services für Xamarin iOS-Apps | Microsoft Docs
...
2. Fügen Sie eine neue Methode **Authenticate** zu **QSTodoService** hinzu mit der folgenden Definition:
   ...
   > [!NOTE]
   > Wenn Sie einen anderen Identitätsanbieter als Facebook verwenden, ändern Sie den an **LoginAsync** übergebenen Wert auf einen der folgenden Werte: *MicrosoftAccount*, *Twitter*, *Google* oder *WindowsAzureActiveDirectory*.
   > 
   > 
