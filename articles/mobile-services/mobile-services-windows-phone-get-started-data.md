---
title: Hinzufügen von Mobile Services zu einer vorhandenen App (WP8) | Microsoft Docs
...
7. Fügen Sie in der Datei "MainPage.cs" die folgenden `using`-Anweisungen hinzu, oder heben Sie deren Auskommentierung auf:
   
           using Microsoft.WindowsAzure.MobileServices;
        using Newtonsoft.Json;
8. Ersetzen Sie im DataModel-Ordner die **TodoItem**-Klassendefinition durch den folgenden Code:
