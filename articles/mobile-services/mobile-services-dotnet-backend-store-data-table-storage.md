---
title: Erstellen eines mobilen .NET-Back-End-Diensts, der den Tabellenspeicher verwendet | Microsoft Docs
...
1. Ändern Sie den **TodoItem**-Datentyp wie folgt, sodass er von **StorageData** anstelle von **EntityData** abgeleitet wird.
   ...
   > [!NOTE]
   > Der Typ **StorageData** verfügt über eine Id-Eigenschaft, die einen zusammengesetzten Schlüssel erfordert. Dieser ist eine Zeichenfolge im Format *partitionId*,*rowValue*.
   > 
   > 
...
4. Ersetzen Sie die vorhandene **GetAllTodoItems**-Methode durch folgenden Code.
...
2. Führen Sie die Schnellstart-Client-App aus, die mit dem mobilen Dienst verbunden ist.
...
3. Fügen Sie neue Elemente hinzu, um Datenbankänderungen zu generieren.
