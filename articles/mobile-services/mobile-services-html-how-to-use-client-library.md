---
title: Verwenden eines HTML-Clients mit Azure Mobile Services | Microsoft Docs
...
> [!NOTE]
> Wenn Sie für die `read`-Funktion eine unformatierte Optionszeichenfolge für OData-Abfragen angeben, können Sie in derselben Abfrage nicht gleichzeitig Methoden des Abfrage-Generators verwenden. In diesem Fall müssen Sie die gesamte Abfrage als OData-Abfragezeichenfolge erstellen. Weitere Informationen zu OData-Systemabfrageoptionen finden Sie in der [Referenz zu OData-Systemabfrageoptionen].
> 
> 
...
> [!NOTE]
> Wenn Sie Authentifizierung in einer PhoneGap- oder Cordova-App verwenden, müssen Sie dem Projekt auch die folgenden Plug-Ins hinzufügen:
> 
