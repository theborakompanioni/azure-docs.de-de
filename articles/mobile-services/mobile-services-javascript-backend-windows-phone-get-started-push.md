---
title: Hinzufügen von Pushbenachrichtigungen zur Mobile Services-App (Windows Phone) | Microsoft Docs
...
> [!NOTE]
> Zum Senden von Pushbenachrichtigungen an eine Windows Phone 8.1 Store-App führen Sie die Lernprogrammversion für [Windows Store-Apps](mobile-services-javascript-backend-windows-universal-dotnet-get-started-push.md) aus.
> 
> 
...
5. Erweitern Sie im Projektmappen-Explorer **Eigenschaften**, öffnen Sie die Datei "WMAppManifest.xml", klicken Sie auf die Registerkarte **Funktionen**, und aktivieren Sie die Funktion **IID\_\_\_CAP\_\_\_PUSH\_NOTIFICATION**.
