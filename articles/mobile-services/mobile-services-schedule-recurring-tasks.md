---
title: Planen von Back-End-Aufgaben in einen mobilen JavaScript-Back-End-Dienst | Microsoft Docs
...
1. Klicken Sie im [klassischen Azure-Portal] auf die Registerkarte **Daten** für Ihren mobilen Dienst und anschließend auf **+Create**.
...
3. Klicken Sie auf den gerade erstellten neuen Auftrag und danach auf die Registerkarte **Skript**, und ersetzen Sie die Platzhalterfunktion **getUpdates** durch den folgenden Code:
...
1. Klicken Sie auf **Einmal ausführen**, um das Skript zu testen.
   
       Dadurch wird der Auftrag gespeichert und ausgeführt, während er im Scheduler deaktiviert bleibt.
2. Klicken Sie auf die Zurück-Schaltfläche und dann auf **Daten**. Klicken Sie danach auf die Tabelle **Updates** und anschließend auf **Durchsuchen**. Überprüfen Sie im Anschluss, ob Twitter-Daten in die Tabelle eingefügt wurden.
3. Klicken Sie auf die Zurück-Schaltfläche und danach auf **Scheduler**. Wählen Sie **getUpdates** aus, und klicken Sie dann auf **Enable**.
