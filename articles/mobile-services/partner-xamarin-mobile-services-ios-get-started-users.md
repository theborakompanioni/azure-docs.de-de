---
title: Erste Schritte mit der Authentifizierung (Xamarin.iOS) - Mobile Services
...
1. Öffnen Sie in Xcode das Projekt, das Sie im Lernprogramm [Erste Schritte mit Mobile Services] erstellt haben.
...
2. Fügen Sie in **TodoService** dann eine neue **Authenticate**-Methode hinzu, die folgendermaßen definiert ist:
   ...
   > [!NOTE]
   > Falls Sie einen anderen Identitätsanbieter als ein Microsoft-Konto verwenden, ändern Sie den an **LoginAsync** übergebenen Wert auf einen der folgenden Werte: *Facebook*, *Twitter*, *Google* oder *WindowsAzureActiveDirectory*.
   > 
   > 
...
1. Entfernen Sie den ursprünglichen Aufruf von **RefreshAsync** aus **TodoListViewController.ViewDidLoad**.
