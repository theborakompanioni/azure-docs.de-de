---
title: Registrieren für die Microsoft-Authentifizierung | Microsoft Docs
...
> [!NOTE]
> Windows Phone 8, Windows Phone 8.1 Silverlight und nicht auf Windows basierte Anwendungen können diesen Abschnitt überspringen.
> 
> 
...
2. Öffnen Sie Ihr Windows-App-Projekt in Visual Studio. Klicken Sie im Projektmappen-Explorer mit der rechten Maustaste auf das Windows Store-App-Projekt, und klicken Sie anschließend auf **Store** > **App mit Store verknüpfen...**.
   
      ![](./media/mobile-services-how-to-register-microsoft-authentication/mobile-services-store-association.png)
3. Klicken Sie im Assistenten auf **Anmelden**, melden Sie sich mit Ihrem Microsoft-Konto an, wählen Sie den reservierten App-Namen aus, und klicken Sie auf **Weiter** > **Zuordnen**.
4. Optional: Wiederholen Sie bei einer universellen Windows 8.1-App die Schritte 4 und 5 für das Windows Phone Store-Projekt.
5. Klicken Sie auf der Windows Dev Center-Seite für Ihre neue App auf **Dienste** > **Pushbenachrichtigungen**.
6. Klicken Sie auf der Seite **Pushbenachrichtigungen** unter **Windows-Pushbenachrichtigungsdienste (WNS) und Microsoft Azure Mobile Services** auf **Live Services-Website**.
   
    Die Seite mit den App-Einstellungen des Microsoft-Kontos für Ihre App wird nun angezeigt.
7. Notieren Sie sich den Wert der **Paket-SID**. Sie können diese SID im Azure-Portal speichern, um das einmalige Anmelden sowie Pushbenachrichtigungen für die Windows-App zu aktivieren.
...
2. Klicken Sie auf der Microsoft-Kontoseite für Ihre App auf **API-Einstellungen**, aktivieren Sie das Kontrollkästchen **Mobile oder Desktop-Client-App**, legen Sie die mobile Dienst-URL als Zieldomäne fest, geben Sie unter **Umleitungs-URL** eines der folgenden URL-Formate ein, und klicken Sie anschließend auf **Speichern**:
   ...
   * **JavaScript-Back-End**: `https://<mobile_service>.azure-mobile.net/login/microsoftaccount`
     ...
     > [!NOTE]
     > Stellen Sie sicher, dass Sie das richtige Umleitungs-URL-Pfadformat für Ihren Typ von Mobile Services-Back-End verwenden. Andernfalls ist die Authentifizierung nicht erfolgreich. Die **Stammdomäne** wird automatisch ausgefüllt. &nbsp;
     > 
     > 
...
3. Klicken Sie auf **App-Einstellungen** und notieren Sie sich die Werte unter **Client-ID**, **Geheimer Clientschlüssel** und **Paket-SID**.
...
1. Klicken Sie im [klassischen Azure-Portal] auf die Registerkarte **Identität** für den mobilen Dienst, geben Sie die Client-ID, den geheimen Clientschlüssel und die Paket-SID von Ihrem Identitätsanbieter ein, und klicken Sie anschließend auf **Speichern**.
   
   > [!NOTE]
   > Für Windows Phone 8, Windows Phone Store 8.1 Silverlight und nicht auf Windows basierte Anwendungen ist kein Paket-SID-Wert erforderlich.
   > 
   > 
