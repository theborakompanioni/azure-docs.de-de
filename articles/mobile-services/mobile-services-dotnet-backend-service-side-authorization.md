---
title: Dienstseitige Autorisierung von Benutzern in einem mobilen .NET-Back-End-Dienst | Microsoft Docs
...
1. Öffnen Sie in Visual Studio Ihr Projekt für mobile Geräte, erweitern Sie den Ordner „DataObjects“, und öffnen Sie **TodoItem.cs**. Die **TodoItem**-Klasse definiert das Datenobjekt, und Sie müssen eine **UserId**-Eigenschaft für Filterzwecke hinzufügen. Fügen Sie die folgende neue UserId-Eigenschaft zur **TodoItem**-Klasse hinzu:
   ...
   > [!NOTE]
   > Um eine Datenmodelländerung durchzuführen und bestehende Daten in der Datenbank beizubehalten, müssen Sie [Code First-Migrationen](mobile-services-dotnet-backend-how-to-use-code-first-migrations.md) verwenden.
   > 
   > 
...
4. Suchen Sie die **GetAllTodoItems**-Methode und ersetzen Sie die vorhandene **return**-Anweisung durch die folgende Codezeile:
...
5. das Projekt für den mobilen Service erneut auf Azure veröffentlichen.
