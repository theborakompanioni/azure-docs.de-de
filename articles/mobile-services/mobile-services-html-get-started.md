---
title: Erste Schritte mit Azure Mobile Services für HTML-/JavaScript-Apps | Microsoft Docs
...
3. Geben Sie in der App in *Neue Aufgabe eingeben* eine Beschreibung ein, wie zum Beispiel **Lernprogramm ausführen**, und klicken Sie dann auf **Hinzufügen**.
   ...
   > [!NOTE]
   > Sie können den Code, der zum Abfragen und Einfügen von Daten auf Ihren mobilen Dienst zugreift, in der Datei „page.js“ finden und prüfen.
   > 
   > 
