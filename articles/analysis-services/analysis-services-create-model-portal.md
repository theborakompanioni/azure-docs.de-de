...
Die Funktion des Azure Analysis Services-Web-Designers (Vorschau) im Azure-Portal bietet eine schnelle und einfache Möglichkeit zum Erstellen und Bearbeiten von Tabellenmodellen und Abfragen von Modelldaten direkt in Ihrem Browser. 

Beachten Sie, dass der Web-Designer eine **Vorschau** ist. Während immer neue Funktionen hinzugefügt werden, ist in der Vorschau die Funktionalität begrenzt. Bei komplexeren Modellentwicklungen und -tests ist es sinnvoll, Visual Studio (SSDT) und SQL Server Management Studio (SSMS) zu verwenden.
