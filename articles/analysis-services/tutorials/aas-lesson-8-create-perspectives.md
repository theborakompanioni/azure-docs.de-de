...
4.  Wählen Sie alle Tabellen *außer* **DimCustomer**.  
    ...
    In einer späteren Lektion werden Sie diese Perspektive mit Analyze in Excel testen. Die Feldliste Excel PivotTable enthält alle Tabellen außer DimCustomer.  
