...
Wenn Sie ein Abonnement für eine kostenlose Testversion, [Visual Studio](https://azure.microsoft.com/pricing/member-offers/msdn-benefits-details/), Azure in Open (AIO) oder BizSpark haben, wird Ihr Abonnement automatisch deaktiviert, wenn Ihr gesamtes Guthaben verbraucht ist. Erfahren Sie mehr über [Ausgabenlimits](#spending-limit), um zu vermeiden, dass Ihr Abonnement unerwartet deaktiviert wird. 
...
5. Darüber hinaus können Sie auf eine Ressource klicken, um den Ausgabenverlauf und die täglichen Kosten der Ressource anzuzeigen.
