...
## <a name="a-idservicedebugawcf--do-not-include-servicedebug-node-in-configuration-file"></a><a id="servicedebug"></a>WCF – serviceDebug-Knoten nicht in die Konfigurationsdatei aufnehmen
...
## <a name="a-idservicemetadataawcf--do-not-include-servicemetadata-node-in-configuration-file"></a><a id="servicemetadata"></a>WCF – serviceMetadata-Knoten nicht in die Konfigurationsdatei aufnehmen
...
## <a name="a-idexceptionaensure-that-proper-exception-handling-is-done-in-aspnet-web-api"></a><a id="exception"></a>Sicherstellen, dass eine ordnungsgemäße Ausnahmebehandlung in der ASP.NET-Web-API erfolgt

| Titel                   | Details      |
| ----------------------- | ------------ |
| Komponente               | Web-API | 
| SDL-Phase               | Entwickeln |  
| Technologien | MVC 5, MVC 6 |
| Attribute              | –  |
...
# <a name="by-action"></a>Nach Aktion
# <a name="by-controller"></a>Nach Controller
...
## <a name="a-idmessagesado-not-expose-security-details-in-error-messages"></a><a id="messages"></a>Keine Sicherheitsdetails in Fehlermeldungen verfügbar machen
...
## <a name="a-iddefaultaimplement-default-error-handling-page"></a><a id="default"></a>Implementieren der Standardseite für die Fehlerbehandlung
...
## <a name="a-iddeploymentaset-deployment-method-to-retail-in-iis"></a><a id="deployment"></a>Festlegen der Bereitstellungsmethode auf „Retail“ in IIS
...
## <a name="a-idfailaexceptions-should-fail-safely"></a><a id="fail"></a>Sicherer Ausfall bei Ausnahmen
