...
- Bereitstellen von [Sicherheitsempfehlungen](../security-center/security-center-recommendations.md) für virtuelle Computer, z.B. Anwenden von Systemupdates, Konfigurieren von ACL-Endpunkten, Aktivieren von Antimalware, Aktivieren von Netzwerk-Sicherheitsgruppen und Anwenden der Datenträgerverschlüsselung.
