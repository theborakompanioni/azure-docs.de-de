---
title: 'Hadoop-Tutorial: Erste Schritte mit Hadoop und Hive in HDInsight | Microsoft-Dokumentation'
description: "Führen Sie dieses Tutorial aus, um sich mit Hadoop in HDInsight vertraut zu machen. Erfahren Sie, wie Sie Linux-Cluster erstellen und Daten mit Hive abfragen."
services: hdinsight
documentationcenter: 
author: mumian
manager: jhubbard
...
2. Geben Sie folgende Werte ein bzw. wählen diese aus:
    ...
    * **Anzahl von Workerknoten**: 2
     ...
     Jeder Cluster verfügt über eine Abhängigkeit von einem Azure Storage-Konto. Es wird in der Regel als Standardspeicherkonto bezeichnet. Der HDInsight-Cluster und das dazugehörige Speicherkonto müssen sich in derselben Azure-Region befinden. Beim Löschen von Clustern wird das Speicherkonto nicht gelöscht. 
