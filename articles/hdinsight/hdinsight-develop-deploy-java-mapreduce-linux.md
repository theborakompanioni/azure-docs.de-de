...
# Entwickeln von Java MapReduce-Programmen für Hadoop in HDInsight (Linux)
...
2. Verwenden Sie in der SSH-Sitzung den folgenden Befehl, um die MapReduce-Anwendung auszuführen:
	...
	Dadurch wird die WordCount MapReduce-Anwendung verwendet, um die Wörter in der Datei "davinci.txt" zu zählen und die Ergebnisse in \_\_wasbs:///example/data/wordcountout__ zu speichern. Die Eingabedatei und die Ausgabe werden im Standardspeicher für den Cluster gespeichert.
