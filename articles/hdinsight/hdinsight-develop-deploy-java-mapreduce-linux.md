...
3. Verwenden Sie den Befehl __mvn__ , der mit Maven installiert wird, um das Gerüst für das Projekt zu erstellen.
    ...
    * __src__ – Das Verzeichnis, das das Verzeichnis __main/java/org/apache/hadoop/examples__ enthält, in dem Sie die Anwendung erstellen.
...
1. Wechseln Sie in das Verzeichnis __wordcountjava\src\main\java\org\apache\hadoop\examples__, und benennen Sie die Datei __pp.java__ in __WordCount.java__ um.
...
2. Verwenden Sie in der SSH-Sitzung den folgenden Befehl, um die MapReduce-Anwendung auszuführen:
    ...
    Dadurch wird die WordCount MapReduce-Anwendung verwendet, um die Wörter in der Datei „davinci.txt“ zu zählen und die Ergebnisse in __wasbs:///example/data/wordcountout__ zu speichern. Die Eingabedatei und die Ausgabe werden im Standardspeicher für den Cluster gespeichert.
