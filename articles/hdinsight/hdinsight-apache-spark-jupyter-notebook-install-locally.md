---
title: Installieren von Jupyter Notebook auf Ihrem Computer und Herstellen einer Verbindung zu einem HDInsight-Spark-Cluster (Vorschau) | Microsoft Docs
...
## <a name="<a-name="seealso"></a>see-also"></a><a name="seealso"></a>Weitere Informationen
