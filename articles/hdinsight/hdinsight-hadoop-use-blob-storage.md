...
> [!NOTE]
> In HDInsight-Versionen vor 3.0 wurde `asv://` anstelle von `wasb://` verwendet. `asv://` sollte nicht für HDInsight-Cluster der Version 3.0 oder höher verwendet werden, da dies zu einem Fehler führt.
> 
> 
