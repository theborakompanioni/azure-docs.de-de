...
1. Erstellen Sie die JAR-Ausgabedatei. Führen Sie die folgenden Schritte aus.
   ...
   2. Klicken Sie im Dialogfeld **Create JAR from Modules** auf die Auslassungspunkte (![Auslassungspunkte](./media/hdinsight-apache-spark-eventhub-streaming/ellipsis.png)) für die **Hauptklasse**.
