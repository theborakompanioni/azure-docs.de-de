...
3. Nachdem die Regeln erstellt wurden, gehen Sie wie folgt vor, um die neue Netzwerksicherheitsgruppe einem Subnetz zuzuordnen. Ersetzen Sie **RESOURCEGROUPNAME** durch den Namen der Ressourcengruppe, die das virtuelle Azure-Netzwerk enthält. Ersetzen Sie **VNETNAME** und **SUBNETNAME** durch den Namen der Azure Virtual Network-Instanz und des Subnetzes, die Sie bei der Installation von HDInsight verwenden.
