...
6. Nach Abschluss des Auftrags werden die Ergebnisse im Verzeichnis **wasb:///example/out/shortestpaths** gespeichert. Die erstellten Dateien beginnen mit **part-m-** und enden mit einer Zahl, die die erste, zweite, dritte Datei usw. anzeigt. Verwenden Sie den folgenden Befehl, um die Ausgabe anzuzeigen:
