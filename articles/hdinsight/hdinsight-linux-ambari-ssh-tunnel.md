...
Verwenden Sie den folgenden Befehl zum Erstellen eines SSH-Tunnels mithilfe des Befehls `ssh` . Ersetzen Sie __USERNAME__ durch einen SSH-Benutzer für Ihren HDInsight-Cluster und __CLUSTERNAME__ durch den Namen des HDInsight-Clusters.
