...
Der Sicherungsspeicher von HDInsight kann Azure Storage oder Azure Data Lake Store sein. Die Daten aus diesen Speichern können, je nach verwendetem Speicher, auf verschiedene Weisen abgerufen werden. Weitere Informationen zur Verwendung von Azure Storage und Azure Data Lake Store finden Sie im Dokument „HDInsight unter Linux“ im Abschnitt [HDFS, Blob-Speicher und Data Lake Store](hdinsight-hadoop-linux-information.md#hdfs-azure-storage-and-data-lake-store).
