---
title: "Erste Schritte mit einem HBase-Beispiel in HDInsight – Azure | Microsoft-Dokumentation"
...
In HBase (eine Implementierung von BigTable) sehen die gleichen Daten wie folgt aus:
...
Eine Datei mit Beispieldaten finden Sie in einem öffentlichen Blobcontainer: *wasbs://hbasecontacts@hditutorialdata.blob.core.windows.net/contacts.txt*.  Diese Datendatei hat folgenden Inhalt:
...
1. Melden Sie sich an der Ambari-Webbenutzeroberfläche unter „https://&lt;Clustername>.azurehdinsight.net“ an.
