...
---
# <a name="release-notes-archive-for-hadoop-components-on-azure-hdinsight"></a>Versionshinweise (Archiv) zu Hadoop-Komponenten in Azure HDInsight

Dieser Artikel enthält Informationen zu den **älteren** Versionsupdates für Azure HDInsight. Informationen zu neueren Versionen finden Sie unter [Versionshinweise zu HDInsight](hdinsight-release-notes.md).
...
## <a name="notes-for-08302016-release-of-hdinsight"></a>Hinweise zur HDInsight-Version vom 30.8.2016
...
## <a name="08172016---release-of-r-server-on-hdinsight"></a>17.08.2016: Release von R Server in HDInsight
...
* Option zur Verwendung des CRAN-Repositorys beim Hinzufügen von R-Paketen zu Datenknoten. Weitere Informationen finden Sie unter [Get started using R Server on HDInsight (Erste Schritte mit R Server in HDInsight)](hdinsight-hadoop-r-server-get-started.md).
...
## <a name="notes-for-07072016-release-of-hdinsight"></a>Hinweise zur HDInsight-Version vom 07.07.2016
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte Linux-basierte HDInsight-Cluster lauten:
...
| [HDInsight-Tools für Eclipse](hdinsight-apache-spark-eclipse-tool-plugin.md) |Das Azure-Toolkit für Eclipse unterstützt nun HDInsight Spark-Cluster. Dies ermöglicht die folgenden Features: <ul><li>Müheloses Erstellen und Schreiben einer Spark-Anwendung in Scala und Java mit erstklassiger Erstellungsunterstützung für IntelliSense, automatische Formatierung, Fehlerüberprüfung usw.</li><li>Lokales Testen der Spark-Anwendung.</li><li>Übermitteln von Aufträgen an HDInsight Spark-Cluster und Abrufen der Ergebnisse.</li><li>Anmelden bei Azure und Zugreifen auf alle Spark-Cluster, die Ihren Azure-Abonnements zugeordnet sind.</li><li>Wechseln zu allen zugeordneten Speicherressourcen Ihres HDInsight Spark-Clusters.</li></ul> |Tools |Spark |N/V |

Ab dieser Version wurde die Patchingrichtlinie für Gastbetriebssysteme für Linux-basierte HDInsight-Cluster geändert. Ziel der neuen Richtlinie ist es, die aufgrund von Patching erforderlichen Neustarts erheblich zu reduzieren. Im Rahmen der neuen Richtlinie werden Patches für virtuelle Computer in Linux-Clustern jeden Montag oder Donnerstag ab 0:00 Uhr UTC schrittweise auf allen Knoten in jedem Cluster aufgespielt. Die einzelnen virtuellen Computer werden aufgrund von Patchingvorgängen für das Gastbetriebssystem aber nur noch maximal alle 30 Tage neu gestartet. Auch der erste Neustart eines neu erstellten Clusters erfolgt nicht früher als 30 Tage nach Erstellungsdatum des Clusters.

> [!NOTE]
> Diese Änderungen gelten nur für neu erstellte Cluster mit dieser oder einer höheren Version.
>
>

## <a name="notes-for-06062016-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 06.06.2016
...
| Titel | Beschreibung | Betroffener Bereich (z. B. Dienst, Komponente oder SDK) | Clustertyp (z.B. Spark, Hadoop, HBase oder Storm) | JIRA (falls zutreffend) |
| --- | --- | --- | --- | --- |
| Spark unter HDInsight ist jetzt allgemein verfügbar |Diese Version bringt Verbesserungen hinsichtlich Verfügbarkeit, Skalierbarkeit und Produktivität für Open Source-Apache Spark unter HDInsight. <ul><li>Branchenführende Verfügbarkeits-SLA von 99,9 %, wodurch die Version für anspruchsvolle Workloads von Unternehmen geeignet ist.</li><li>Skalierbare Speicherebene mithilfe von Azure Data Lake Store.</li><li>Produktivitätstools für jede Phase der Datenuntersuchung und -entwicklung. Jupyter-Notebooks mit benutzerdefiniertem Spark-Kernel ermöglichen interaktives Durchsuchen von Daten. Die Integration in BI-Dashboards wie Power BI, Tableau und Qlik ist ideal für schnelle Datenfreigabe und kontinuierliche Berichterstellung. Das IntelliJ-Plug-In ist die zuverlässige Option für die langfristige Entwicklung und das Debuggen von Codeartefakten.</li></ul> |Dienst |Spark |N/V |
| HDInsight-Tools für IntelliJ |Dies ist ein IntelliJ IDEA-Plug-In für HDInsight Spark-Cluster. Dies ermöglicht die folgenden Features:<ul><li>Müheloses Erstellen und Schreiben einer Spark-Anwendung in Scala und Java mit erstklassiger Erstellungsunterstützung für IntelliSense, automatische Formatierung, Fehlerüberprüfung usw.</li><li>Lokales Testen der Spark-Anwendung.</li><li>Übermitteln von Aufträgen an HDInsight Spark-Cluster und Abrufen der Ergebnisse.</li><li>Anmelden bei Azure und Zugreifen auf alle Spark-Cluster, die Ihren Azure-Abonnements zugeordnet sind.</li><li>Wechseln zu allen zugeordneten Speicherressourcen Ihres HDInsight Spark-Clusters.</li><li>Wechseln zum gesamten Auftragsverlauf und zu allen Auftragsinformationen für Ihren HDInsight Spark-Cluster.</li><li>Debuggen von Spark-Aufträgen remote über Ihren Desktopcomputer.</li></ul> |Tools |Spark |N/V |

## <a name="notes-for-05132016-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 13.05.2016
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
| Titel | Beschreibung | Betroffener Bereich (z. B. Dienst, Komponente oder SDK) | Clustertyp (z.B. Spark, Hadoop, HBase oder Storm) | JIRA (falls zutreffend) |
| --- | --- | --- | --- | --- |
| Spark-Versionsupdate und andere Fehlerbehebungen |Mit dieser Version wird die Spark-Version im HDInsight-Cluster auf 1.6.1 aktualisiert, und andere Fehler werden behoben. |Dienst |Spark |N/V |

## <a name="notes-for-04112016-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 11.04.2016
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
| Einstellung des Supports für ältere Versionen von Spark |Die ältere Version Spark 1.3.1 wird am 31.5. aus dem Dienst entfernt. |Dienst |Spark-Cluster unter Windows |N/V |
...
| Titel | Beschreibung | Betroffener Bereich (z. B. Dienst, Komponente oder SDK) | Clustertyp (z. B. Hadoop, HBase oder Storm) | JIRA (falls zutreffend) |
| --- | --- | --- | --- | --- |
| HDInsight-Version 3.4 hinzugefügt und HDP-Versionen aller HDInsight-Cluster aktualisiert. |In dieser Version haben wir die HDInsight-Version 3.4 (auf Grundlage von HDP 2.4) hinzugefügt und auch andere HDP-Versionen aktualisiert. Anmerkungen zur HDP-Version 2.4 finden Sie [hier](http://docs.hortonworks.com/HDPDocuments/HDP2/HDP-2.4.0/bk_HDP_RelNotes/content/ch_relnotes_v240.html). Weitere Informationen zu HDInsight-Versionen finden Sie [hier](hdinsight-component-versioning.md). |Dienst |Alle Linux-Cluster |N/V |
| HDInsight Premium |HDInsight ist jetzt in zwei Kategorien verfügbar: Standard und Premium. HDInsight Premium befindet sich derzeit in der Vorschauphase und ist nur für Hadoop- und Spark-Cluster unter Linux verfügbar. Weitere Informationen finden Sie [hier](hdinsight-component-versioning.md#hdinsight-standard-and-hdinsight-premium). |Dienst |Hadoop und Spark unter Linux |N/V |
| Microsoft R Server |HDInsight Premium bietet Microsoft R Server, das mit Hadoop- und Spark-Clustern unter Linux verwendet werden kann. Weitere Informationen finden Sie unter [Übersicht über R Server in HDInsight](hdinsight-hadoop-r-server-overview.md). |Dienst |Hadoop und Spark unter Linux |N/V |
| Spark 1.6.0 |HDInsight 3.4-Cluster enthalten jetzt Spark 1.6.0 |Dienst |Spark-Cluster unter Linux |N/V |
...
## <a name="notes-for-03222016-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 22.03.2016
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
## <a name="notes-for-03102016-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 10.03.2016
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
## <a name="notes-for-01272016-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 27.01.2016
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
## <a name="notes-for-12022015-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 02.12.2015
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
| Titel | Beschreibung | Betroffener Bereich (z. B. Dienst, Komponente oder SDK) | Clustertyp (z. B. Hadoop, HBase oder Storm) | JIRA (falls zutreffend) |
| --- | --- | --- | --- | --- |
| Aktualisierte Versionen von HDInsight für alle HDInsight-Cluster und HDP-Versionen für HDInsight 3.2-Cluster (Windows und Linux) |In dieser Version wurden HDInsight- und HDP-Versionen aktualisiert |Dienst |Alle |N/V |

## <a name="notes-for-10272015-release-of-hdinsight"></a>Hinweise für die HDInsight-Version 3.1 vom 27.10.2015
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
| Titel | Beschreibung | Betroffener Bereich (z. B. Dienst, Komponente oder SDK) | Clustertyp (z. B. Hadoop, HBase oder Storm) | JIRA (falls zutreffend) |
| --- | --- | --- | --- | --- |
| HDInsight-Versionen aller HDInsight-Cluster (Windows und Linux) aktualisiert |In dieser Version wurden HDInsight- und HDP-Versionen aktualisiert |Dienst |Alle |N/V |
| Jupyter for Windows Spark-Cluster mit Clustern in Großbuchstaben korrigiert |Cluster, deren DNS-Namen in Großbuchstaben angegeben waren, hatten aufgrund einer angeforderten Prüfung des Ursprungs Probleme mit Jupyter-Notebooks. Die Korrektur bestand darin, den DNS-Namen in der Jupyter-Konfiguration klein zu schreiben. |Dienst |HDInsight Spark (Windows) |N/V |

## <a name="notes-for-10202015-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 20.10.2015
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
## <a name="notes-for-07312015-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 31.07.2015
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
| Titel | Beschreibung | Betroffener Bereich (z. B. Dienst, Komponente oder SDK) | Clustertyp (z. B. Hadoop, HBase oder Storm) | JIRA (falls zutreffend) |
| --- | --- | --- | --- | --- |
| Korrektur des Reimaging-Workflow des Spark-Clusterknotens |Ein Fehler wurde behoben, der verhinderte, dass Spark-Clusterknoten nach dem Reimaging nicht wiederhergestellt wurden. |Dienst |Spark |N/V |
...
## <a name="notes-for-07072015-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 07.07.2015
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
## <a name="notes-for-06262015-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 06.26.2015
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
## <a name="notes-for-06182015-release-of-hdinsight"></a>Hinweise zur HDInsight-Version vom 18.06.2015
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
<td>Anmerkungen zur Hortonworks-Version für diese Version sind <a href="http://docs.hortonworks.com/HDPDocuments/HDP2/HDP-2.1.15-Win/bk_releasenotes_HDP-Win/content/ch_relnotes-HDP-2.1.15.html" target="_blank">hier</a> verfügbar.</td>
<td>HDP</td>
<td>Alle</td>
<td>N/V</td>
</tr>
...
## <a name="notes-for-06042015-release-of-hdinsight"></a>Hinweise zur HDInsight-Version vom 04.06.2015
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
## <a name="notes-for-06012015-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 01.06.2015
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
## <a name="notes-for-05272015-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 27.05.2015
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
<td>Diese Version von HDInsight 3.2 enthält HDP 2.2.6 und einige wichtige Fehlerbehebungen für HDInsight. Die vollständigen Anmerkungen zur Version finden Sie in den <a href="http://dev.hortonworks.com.s3.amazonaws.com/HDPDocuments/HDP2/HDP-2.2.6/HDP_RelNotes_v226/index.html">Anmerkungen zur Version HDP 2.2.6</a>.</td>
<td>HDP</td>
<td>Alle Clustertypen</td>
<td>N/V</td>
</tr>
...
## <a name="notes-for-05202015-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 20.05.2015
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
## <a name="notes-for-04272015-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 27.04.2015
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
## <a name="notes-for-04142015-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 14.04.2015
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
<td>Updates für Apache TEZ 2214 und TEZ 1923 sind in dieser Version von HDI 3.2 enthalten. Diese werden für bestimmte Hive-Abfragen in Tez benötigt, für die eine beträchtliche Datenmenge gemischt werden muss.
</td>
<td>HDP</td>
<td>Hadoop</td>
...
## <a name="notes-for-04062015-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 06.04.2015
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
## <a name="notes-for-04012015-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 01.04.2015
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
<td>Dieses Update für HDInsight Version 3.2 enthält verschiedene Fehlerbehebungen, und einige interne Jars, die einen Teil des HDP-Pakets bilden, wurden aktualisiert. Diese JAR-Dateien sind im HDP-Paket enthalten und nicht für die direkte Verwendung durch Kundenanwendungen vorgesehen. Anwendungen sollten ihre eigene Version der JAR-Dateien in einem Paket zusammenstellen, damit Kundenanwendungen durch ein Upgrade auf die internen HDP-JARs nicht beschädigt werden.</td>
<td>HDP</td>
<td>Alle</td>
<td>N/V</td>
</tr>
...
## <a name="notes-for-03032015-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 03.03.2015
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
## <a name="notes-for-02182015-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 18.02.2015
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
<td>Cluster können unter Ubuntu Linux bereitgestellt werden. Weitere Informationen finden Sie unter „Erste Schritte mit HDInsight unter Linux“.</td>
<td>Dienst</td>
<td>Hadoop</td>
<td>N/V</td>
</tr>
...
<td>Apache-Storm-Cluster sind allgemein verfügbar. Weitere Informationen finden Sie unter „Erste Schritte mit Storm in HDInsight“.</td>
<td>Dienst</td>
<td>Storm</td>
<td>N/V</td>
</tr>
...
## <a name="notes-for-02062015-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 06.02.2015
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
<td>HDInsight 3.1 wird aktualisiert, um HDP 2.1.10.0 bereitstellen. Weitere Informationen finden Sie in den <a href ="http://docs.hortonworks.com/HDPDocuments/HDP2/HDP-2.1.10/bk_releasenotes_hdp_2.1/content/ch_relnotes-HDP-2.1.10.html" target="_blank">Anmerkungen zur Version HDP-2.1.10</a>. </td>
<td>Open-Source-Software</td>
<td>Alle</td>
<td>N/V</td>
</tr>
...
<td>Es gibt einige JAR-Dateien in HBase, für die Dateinamen aktualisiert wurden. Da diese JAR-Dateien werden intern von HBase verwendet werden, wird nicht erwartet, dass bei Kunden eine Abhängigkeit von den Namen dieser JAR-Dateien vorhanden ist. Diese umfassen:
<ul>
...
## <a name="notes-for-1292015-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 29.1.2015
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
## <a name="notes-for-152015-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 5.1.2015
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster:
...
## <a name="notes-for-12232014-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 23.12.2014
...
## <a name="notes-for-12182014-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 18.12.2014
...
## <a name="notes-for-12052014-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 05.12.2014
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster sind:
...
<td>Für die HDI-Clusterversion 3.0 gelten für von HDP installierte interne JAR-Dateien verschiedene Änderungen. „jetty-6.1.26.jar“ wurde durch „jetty-6.1.26.hwx.jar“ ersetzt. „jetty-util-6.1.26.jar“ wurde durch „jetty-util-6.1.26.hwx.jar“ ersetzt. Diese Änderungen gelten für Hadoop-, Mahout-, WebHCat- und Oozie-Projekte.</td>
...
## <a name="notes-for-11212014-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 21.11.2014
Die vollständigen Versionsnummern für mit dieser Version bereitgestellte HDInsight-Cluster sind:
...
<table border="1">
<tr><th>Titel</th><th>Beschreibung</th><th>Component</th><th>Clustertyp</th><th>JIRA (falls zutreffend)</th></tr>
<tr>
...
## <a name="notes-for-11142014-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 11.14.2014
...
> [!NOTE]
> Zur Veranschaulichung der neuen, durch die Clusteranpassung verfügbaren Möglichkeiten wurden die Verfahren mit Skriptaktionen zum Installieren von Spark- und R-Modulen für einen Cluster dokumentiert. Weitere Informationen finden Sie unter:
...
## <a name="notes-for-11072014-release-of-hdinsight"></a>Hinweise für die HDInsight-Version vom 07.11.2014
...
<tr>
<td>HDP 2.1.7</td>
<td>Diese Version basiert auf Hortonworks Data Platform (HDP) 2.1.7. Weitere Informationen finden Sie in den <a href="http://docs.hortonworks.com/HDPDocuments/HDP2/HDP-2.1.7-Win/bk_releasenotes_HDP-Win/content/ch_relnotes-HDP-2.1.7.html" target="_blank">Anmerkungen zur Version HDP 2.1.7</a>.</td>
<td>HDP</td>
<td>Alle</td>
<td>N/V</td>
</tr>
...
Ausführlichere Informationen finden Sie unter <a href="http://hadoop.apache.org/docs/r2.4.0/hadoop-yarn/hadoop-yarn-site/TimelineServer.html" target="_blank">YARN Timeline Server</a>.</td>
<td>Dienst, YARN</td>
<td>Hadoop, HBase</td>
<td>N/V</td>
</tr>
...
> [!NOTE]
> Der Fehler, der das Anzeigen der vollständigen Versionsnummer im Portal oder deren Rückgabe durch das SDK oder durch Windows PowerShell verhindert hat, wurde in dieser Version behoben.

## <a name="notes-for-10152014-release"></a>Hinweise für die Version vom 15.10.2014
...
## <a name="notes-for-1072014-release"></a>Hinweise für die Version vom 07.10.2014

* Beim Verwenden des Ambari-Endpunkts „https://{clusterDns}.azurehdinsight.net/ambari/api/v1/clusters/{clusterDns}.azurehdinsight.net/services/{servicename}/components/{componentname}“ gibt das Feld *host_name* nun den vollqualifizierten Domänennamen (FQDN) des Knotens anstelle des Hostnamens zurück. Anstelle von **headnode0** erhalten Sie beispielsweise nun den FQDN **headnode0.{ClusterDNS}.azurehdinsight.net**. Diese Änderung war erforderlich, um Szenarien, in denen mehrere Clustertypen (z. B. HBase und Hadoop) in einem einzigen virtuellen Netzwerk (VNET) bereitgestellt werden, zu erleichtern. Dies ist z. B. der Fall, wenn HBase als Back-End-Plattform für Hadoop verwendet wird.

* Wir haben neue Speichereinstellungen für die Standardbereitstellung des HDInsight-Clusters bereitgestellt. Bei den vorherigen Speichereinstellungen wurden die Empfehlungen für die Anzahl der bereitgestellten CPU-Kerne nicht ausreichend berücksichtigt. Diese neuen Arbeitsspeichereinstellungen sollten (gemäß den Empfehlungen von Hortonworks) bessere Standardeinstellungen bieten. Um diese Einstellungen zu ändern, konsultieren Sie die Referenzdokumentation des SDK bezüglich des Änderns der Clusterkonfiguration. Die folgende Tabelle enthält die neuen Arbeitsspeichereinstellungen für ein Standard-HDInsight-Cluster mit 4 CPU-Kernen (8 Containern). (Die Werte, die in vorherigen Versionen verwendet wurden, sind in Klammern angegeben).
...
## <a name="notes-for-8212014-release"></a>Hinweise für die Version vom 21.08.2014
...
## <a name="notes-for-7282014-release"></a>Hinweise für die Version vom 28.07.2014
* **Verfügbarkeit von HDInsight in drei neuen Regionen**: Die geografische Präsenz von HDInsight wurde auf drei neue Regionen ausgeweitet. HDInsight-Kunden können in den folgenden Regionen Cluster erstellen:
  * Ostasien
  * USA (Mitte/Norden)
  * USA (Mitte/Süden)
* HDInsight Version 1.6 (HDP 1.1 und Hadoop 1.0.3) und HDInsight Version 2.1 (HDP1.3 und Hadoop 1.2) werden aus dem Azure-Portal entfernt. Sie können weiterhin Hadoop-Cluster für diese Versionen mithilfe des Azure PowerShell-Cmdlets ([New-AzureRmHDInsightCluster](http://msdn.microsoft.com/library/dn593744.aspx)) oder des [HDInsight SDK](http://msdn.microsoft.com/library/azure/dn469975.aspx) erstellen. Weitere Informationen finden Sie unter [HDInsight-Komponentenversionen](hdinsight-component-versioning.md).
...
## <a name="notes-for-6242014-release"></a>Hinweise für die Version vom 24.06.2014
...
### <a name="hive-queries-can-use-tez-in-hdinsight-31"></a>Hive-Abfragen können Tez in HDInsight 3.1 verwenden
Hive 0.13 ist in HDInsight 3.1 verfügbar und kann Abfragen mit Tez ausführen. Dies kann für erhebliche Leistungsverbesserungen genutzt werden.
Tez ist nicht standardmäßig für Hive-Abfragen aktiviert. Um es zu verwenden, müssen Sie die entsprechende Option aktivieren. Sie können Tez aktivieren, indem Sie das folgende Code-Snippet ausführen:
...
Weitere Informationen finden Sie im Artikel zur [Hive in Tez](https://cwiki.apache.org/confluence/display/Hive/Hive+on+Tez).
...
### <a name="dos--donts-between-cluster-versions"></a>Empfehlungen und Warnungen für unterschiedliche Clusterversionen
...
**Präfixsyntax**: In HDInsight 3.1- und 3.0-Clustern wird nur die Syntax „wasb://“ unterstützt. Die ältere "asv://"-Syntax wird in HDInsight 2.1- und 1.6-Clustern unterstützt, nicht aber in HDInsight 3.1 oder 3.0-Clustern. Dies bedeutet, dass alle an einen HDInsight-Cluster der Version 3.1 oder 3.0 übermittelten Aufträge, die explizit die asv://-Syntax verwenden, misslingen. Stattdessen sollte die Syntax „wasb://“ verwendet werden. An HDInsight-Cluster der Version 3.1 oder 3.0 übermittelte Aufträge, die mithilfe eines vorhandenen Metastores erstellt wurden, der explizite Verweise auf Ressourcen mit der "asv://"-Syntax enthält, schlagen ebenfalls fehl. Diese Metastores müssen mit der „wasb://“-Syntax zur Adressierung von Ressourcen neu erstellt werden.
...
### <a name="version-changes"></a>Versionsänderungen
...
* Die HDInsight-Version 3.1 verwendet eine Hadoop-Distribution, die auf [Hortonworks Data Platform 2.1.7][hdp-2-1-7] basiert. Dies ist der Hadoop-Standardcluster, der bei Verwendung des Azure-Portals nach dem 7.11.2014 erstellt wird. Vor dem 7.11.2014 erstellte HDInsight 3.1-Cluster basierten auf [Hortonworks Data Platform 2.1.1][hdp-2-1-1].
* Die HDInsight-Version 3.0 verwendet eine Hadoop-Distribution, die auf [Hortonworks Data Platform 2.0][hdp-2-0-8] basiert.
* Die HDInsight-Version 2.1 verwendet eine Hadoop-Distribution, die auf [Hortonworks Data Platform 1.3][hdp-1-3-0] basiert.
* Die HDInsight-Version 1.6 verwendet eine Hadoop-Distribution, die auf [Hortonworks Data Platform 1.1][hdp-1-1-0] basiert.
