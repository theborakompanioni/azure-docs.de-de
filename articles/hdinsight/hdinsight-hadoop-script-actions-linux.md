...
Parameter, die an das Skript übergeben werden, werden als *Positionsparameter* bezeichnet und werden für den ersten Parameter `$1` zugewiesen, für den zweiten Parameter `$2` usw. `$0` enthält den Namen des Skripts.
