...
Verwenden Sie den folgenden Befehl zum Erstellen eines SSH-Tunnels mithilfe des Befehls `ssh`. Ersetzen Sie **USERNAME** mit einem SSH-Benutzer für Ihren HDInsight-Cluster und **CLUSTERNAME** mit dem Namen des HDInsight-Clusters.
