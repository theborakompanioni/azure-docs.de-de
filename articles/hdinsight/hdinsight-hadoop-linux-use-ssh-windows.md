...
---
# <a name="use-ssh-with-linuxbased-hadoop-on-hdinsight-from-windows"></a>Verwenden von SSH mit Linux-basiertem Hadoop in HDInsight unter Windows
...
> [!NOTE]
> Für die Schritte in diesem Artikel wird davon ausgegangen, dass Sie einen Windows-Client verwenden. Wenn Sie einen Linux-, Unix- oder OS X-Client verwenden, finden Sie entsprechende Informationen unter [Verwenden von SSH mit Linux-basiertem Hadoop in HDInsight unter Linux, Unix oder OS X](hdinsight-hadoop-linux-use-ssh-unix.md).
> 
