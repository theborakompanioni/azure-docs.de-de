...
In diesem Artikel erfahren Sie, wie einen Apache Spark-Cluster in Azure HDInsight erstellen.
...
In diesem Artikel haben Sie gelernt, wie Sie einen HDInsight Spark-Cluster erstellen und eine einfache Spark SQL-Abfrage ausführen. Erfahren Sie als Nächstes, wie Sie [Daten in HDInsight Spark laden und eine interaktive Abfrage ausführen](hdinsight-apache-spark-load-data-run-query.md).

Falls Sie die nächsten Schritte erst zu einem späteren Zeitpunkt ausführen möchten, löschen Sie den HDInsight-Cluster wieder. 
