---
title: Verwenden von Hadoop Pig mit SSH in einem HDInsight-Cluster | Microsoft Docs
...
## <a name="<a-id="pig"></a>use-the-pig-command"></a><a id="pig"></a>Verwenden des Pig-Befehls
