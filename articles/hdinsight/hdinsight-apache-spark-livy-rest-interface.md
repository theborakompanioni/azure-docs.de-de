---
title: Remoteübermittlung von Spark-Aufträgen mithilfe von Livy | Microsoft Docs
...
---
# Remoteübermittlung von Spark-Aufträgen an einen Apache Spark-Cluster unter HDInsight (Linux) mithilfe von Livy
