...
# Verwenden von BI-Tools mit Apache Spark in HDInsight unter Linux (Vorschau)
...
> [AZURE.NOTE] Dieses Tutorial gilt nur für Spark 1.5.2-Cluster, die in Azure HDInsight erstellt wurden.
