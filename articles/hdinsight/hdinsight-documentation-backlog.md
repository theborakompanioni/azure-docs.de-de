...
------------- | ------------- | -------------- | -------------- | --------------- | --------------
Administration | Verwalten von HDInsight-Clustern mit .NET SDK | 1 | Schreiben| [@mumian](https://github.com/mumian) | - |
...
Entwicklung | Curl and Rest-API-Beispiel zur Verwendung von Sqoop | 2 | Ausstehend | [@mumian](https://github.com/mumian) | Jon Kennerly |
Entwicklung| [Nicht interaktive Authentifizierung mit HDInsight .NET-Anwendung](hdinsight-create-non-interactive-authentication-dotnet-applications) |2| [Abgeschlossen](hdinsight-create-non-interactive-authentication-dotnet-applications.md) | [@mumian](https://github.com/mumian) | [@matt1883](https://github.com/matt1883)
