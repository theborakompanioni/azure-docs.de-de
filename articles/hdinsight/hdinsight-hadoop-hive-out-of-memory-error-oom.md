---
title: "Fehlermeldung „Nicht genügend Arbeitsspeicher“ (Out Of Memory, OOM) – Hive-Einstellungen | Microsoft-Dokumentation"
...
---
# <a name="fix-an-out-of-memory-oom-error-with-hive-memory-settings-in-hadoop-in-azure-hdinsight"></a>Beheben eines „Nicht genügend Arbeitsspeicher“-Fehlers (Out of Memory, OOM) mit Hive-Arbeitsspeichereinstellungen in Hadoop in Azure HDInsight
...
## <a name="scenario-hive-query-across-large-tables"></a>Szenario: große Tabellen übergreifende Hive-Abfrage
...
## <a name="debug-the-out-of-memory-oom-error"></a>Debuggen des OOM-Fehlers 
...
Wir haben bestätigt, dass **hive.auto.convert.join.noconditionaltask** in der Datei „hive-site.xml“ tatsächlich auf **true** gesetzt war:
...
![Diagramm des Tez-Containerspeichers: Fehler – nicht genügend Hive-Speicher (Out of Memory, OOM)](./media/hdinsight-hadoop-hive-out-of-memory-error-oom/hive-out-of-memory-error-oom-tez-container-memory.png)
