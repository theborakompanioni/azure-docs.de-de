...
---
# <a name="what-is-hbase-in-hdinsight-a-nosql-database-that-provides-bigtablelike-capabilities-for-hadoop"></a>Überblick über HBase in HDInsight: Eine NoSQL-Datenbank, die BigTable-ähnliche Funktionen für Hadoop bereitstellt
...
## <a name="a-namenextstepsanext-steps"></a><a name="next-steps"></a>Nächste Schritte
...
## <a name="a-nameseealsoasee-also"></a><a name="see-also"></a>Weitere Informationen
