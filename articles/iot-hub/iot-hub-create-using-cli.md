---
title: Erstellen eines IoT Hubs über die Befehlszeilenschnittstelle | Microsoft Docs
...
> [!NOTE]
> Azure verfügt über zwei verschiedene Bereitstellungsmodelle für das Erstellen und Verwenden von Ressourcen: [Resource Manager-Bereitstellung und klassische Bereitstellung](../resource-manager-deployment-model.md). Die Azure-Befehlszeilenschnittstelle muss im Azure Resource Manager-Modus ausgeführt werden:
> 
> ```
...
1. Sie können die Ressourcengruppe **exampleResourceGroup** erstellen, wenn Sie über keine verfügen. 
   ```
...
> [!NOTE]
> Mit diesem CLI-Befehl wird ein für Sie kostenpflichtiger S1-Standard-IoT Hub hinzugefügt. Sie können den IoT Hub **exampleIoTHubName** mit dem folgenden Befehl löschen: 
> 
> ```
