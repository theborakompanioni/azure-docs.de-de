...
- [Erste Schritte mit Ihrem Raspberry Pi 3](iot-hub-raspberry-pi-kit-c-get-started.md)
- [Create your Azure IoT hub](iot-hub-raspberry-pi-kit-c-get-started.md) (Erstellen Ihres Azure IoT-Hubs)
...
* Die Datei `main.c` im Unterordner `app` ist die Hauptquelldatei. Diese Quelldatei enthält den Code, mit dem eine Nachricht 20-mal an die IoT Hub-Instanz gesendet wird. Dabei blinkt die LED bei jeder gesendeten Nachricht.
...
![Azure Resource Manager-Vorlagenparameter](media/iot-hub-raspberry-pi-lessons/lesson3/arm_para_c.png)

* Ersetzen Sie **[your IoT Hub name]** (Ihr IoT Hub-Name) durch **{mein Hub-Name}**, den Sie beim [Erstellen des IoT-Hubs und Registrieren von Raspberry Pi 3](iot-hub-raspberry-pi-kit-c-lesson2-prepare-azure-iot-hub.md) angegeben haben.
...
[Ausführen einer Beispielanwendung zum Senden von D2C-Nachrichten](iot-hub-raspberry-pi-kit-c-lesson3-run-azure-blink.md)
