...
Laden Sie die Entwicklungstools und die Software für die erste Beispielanwendung für Ihren Raspberry Pi 3 herunter. Problemlösungen finden Sie auf der [Seite zur Problembehandlung](iot-hub-raspberry-pi-kit-node-troubleshooting.md).
...
Wenn bei der Installation von Node.js und diesen zusätzlichen Entwicklungstools unter macOS Probleme auftreten, finden Sie in der [Anleitung zur Problembehandlung](iot-hub-raspberry-pi-kit-node-troubleshooting.md) Lösungen für häufiger auftretende Probleme.
