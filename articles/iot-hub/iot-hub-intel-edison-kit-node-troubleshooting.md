---
title: "Verbinden von Intel Edison (Node) mit Azure IoT – Lektion 4: Problembehandlung | Microsoft-Dokumentation"
description: "Problembehandlungsseite für die Node.js-Umgebung des Intel Edison"
services: iot-hub
documentationcenter: 
author: shizn
manager: timtl
...
Wenn das Debugmodul bereit ist, sollte in der Konsolenausgabe ```Debugger listening on port 5858``` angezeigt werden.

### <a name="configure-vs-code-to-connect-to-the-remote-device"></a>Konfigurieren von VS Code zum Verbinden mit dem Remotegerät

Öffnen Sie links den Bereich **Debuggen**.

Klicken Sie auf die grüne Schaltfläche (F5) **Debuggen starten**. VS Code öffnet eine Datei vom Typ **launch.json**, die Sie aktualisieren müssen.

Aktualisieren Sie die Datei **launch.json** mit folgendem Inhalt, und ersetzen Sie dabei `[device hostname or IP address]` durch die tatsächliche Geräte-IP-Adresse oder den Hostnamen.  
...
![Remotedebuggen – Konfiguration](media/iot-hub-intel-edison-lessons/troubleshooting/remote_debugging_configuration.png)

### <a name="attach-to-the-remote-application"></a>Anfügen an die Remoteanwendung

Klicken Sie auf die grüne Schaltfläche **Debuggen starten** (F5), um das Debuggen zu starten.

Weitere Informationen zum Debugger finden Sie unter [JavaScript in VS Code](https://code.visualstudio.com/docs/languages/javascript#_debugging).

![Interaktiv remotedebuggen](media/iot-hub-intel-edison-lessons/troubleshooting/remote_debugging_interactive.png)
...
Zurück zu [Erste Schritte mit Intel Edison (Node.js)](iot-hub-intel-edison-kit-node-get-started.md)
