...
* Einen abfragbaren Speicher mit Zustandsinformationen und Metdadaten auf Gerätebasis
...
* Unter [Senden und Empfangen von Nachrichten mit IoT Hub][devguide-messaging] werden die Messagingfunktionen (D2C und C2D) beschrieben, die mit IoT Hub zur Verfügung stehen. Der Artikel bietet auch Informationen zu Themen wie Nachrichtenformaten und unterstützten Kommunikationsprotokollen sowie den Portnummern, die diese verwenden.
