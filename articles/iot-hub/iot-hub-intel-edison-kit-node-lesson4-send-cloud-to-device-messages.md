...
1. Stellen Sie sicher, dass Sie sich im Repositoryordner `iot-hub-node-edison-getting-started` befinden. Öffnen Sie die Beispielanwendung in Visual Studio Code, indem Sie die folgenden Befehle ausführen:
