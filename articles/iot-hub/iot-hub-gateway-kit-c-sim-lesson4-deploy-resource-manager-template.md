...
- [Lektion 1: Einrichten von Intel NUC als IoT Gateway](iot-hub-gateway-kit-c-sim-lesson1-set-up-nuc.md)
- [Lektion 2: Vorbereiten des Hostcomputers und von Azure IoT Hub](iot-hub-gateway-kit-c-sim-lesson2-get-the-tools-win32.md)
- [Lektion 3: Empfangen von Nachrichten vom simulierten Gerät und Lesen von Nachrichten vom IoT Hub](iot-hub-gateway-kit-c-sim-lesson3-configure-simulated-device-app.md)
...
[Lesen von persistent gespeicherten Nachrichten in Azure Storage](iot-hub-gateway-kit-c-sim-lesson4-read-table-storage.md)
