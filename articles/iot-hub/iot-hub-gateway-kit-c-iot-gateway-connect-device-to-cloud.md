...
Die Beispielanwendung „Bluetooth Low Energy (BLE)“ wird vom Azure IoT Gateway SDK bereitgestellt. Die Beispielanwendung erfasst Daten zur BLE-Verbindung und sendet Daten zu Ihrem IoT Hub. Zum Ausführen der Beispielanwendung müssen Sie wie folgt vorgehen:
...
[Verwenden des IoT-Gateways für die Transformation von Sensordaten mit dem Azure IoT Gateway SDK](iot-hub-gateway-kit-c-use-iot-gateway-for-data-conversion.md)
