...
Führen Sie die erste Konfiguration von Pi durch, und installieren Sie das Raspbian-Betriebssystem. Raspbian ist ein kostenloses Betriebssystem, das für die Raspberry Pi-Hardware optimiert ist. Wenn Sie Probleme haben, helfen Ihnen die Lösungen auf der [Seite zur Problembehandlung](iot-hub-raspberry-pi-kit-node-troubleshooting.md) weiter.
