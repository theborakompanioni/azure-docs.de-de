---
title: "Verbinden von Intel Edison (Node) mit Azure IoT – Erste Schritte | Microsoft-Dokumentation"
...
---
# <a name="connect-your-intel-edison-device-to-your-iot-hub-using-nodejs"></a>Herstellen einer Verbindung Ihres Intel Edison-Geräts mit Ihrem IoT Hub mit Node.js
...
Wechseln Sie zu [Erstellen der IoT Hub-Instanz und Registrieren von Intel Edison](iot-hub-intel-edison-kit-node-lesson2-prepare-azure-iot-hub.md).
