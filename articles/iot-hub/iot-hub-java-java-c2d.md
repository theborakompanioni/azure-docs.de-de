...
---
# <a name="tutorial-how-to-send-cloud-to-device-messages-with-iot-hub-and-java"></a>Tutorial: Senden von Cloud-zu-Gerät-Nachrichten mithilfe von IoT Hub und Java
