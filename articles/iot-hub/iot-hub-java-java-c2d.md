...
* Eine vollständig funktionierende Version des Tutorials [Erste Schritte mit IoT Hub](iot-hub-java-java-getstarted.md) oder [Verarbeiten von D2C-Nachrichten mit IoT Hub](iot-hub-java-java-process-d2c.md)
