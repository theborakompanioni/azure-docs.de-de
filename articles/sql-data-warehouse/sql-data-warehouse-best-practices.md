...
Weitere Informationen finden Sie unter [Anhalten von Computeressourcen][Anhalten von Computeressourcen], [Fortsetzen von Computeressourcen][Fortsetzen von Computeressourcen] und [Skalieren von Computeressourcen][Skalieren von Computeressourcen].
...
Siehe auch [Grundlagen von Transaktionen][Grundlagen von Transaktionen], [Optimieren von Transaktionen][Optimieren von Transaktionen].
...
Siehe auch [Verwalten von Tabellenstatistiken][Verwalten von Tabellenstatistiken], [CREATE STATISTICS][CREATE STATISTICS], [UPDATE STATISTICS][UPDATE STATISTICS].
...
Siehe auch [Laden von Daten][Laden von Daten], [Anleitung für die Verwendung von PolyBase][Anleitung für die Verwendung von PolyBase], [Azure SQL Data Warehouse loading patterns and strategies][Azure SQL Data Warehouse loading patterns and strategies] \(Azure SQL Data Warehouse – Lademuster und -strategien), [Laden von Daten mit Azure Data Factory][Laden von Daten mit Azure Data Factory], [Verschieben von Daten mit Azure Data Factory][Verschieben von Daten mit Azure Data Factory], [CREATE EXTERNAL FILE FORMAT][CREATE EXTERNAL FILE FORMAT], [Create Table As Select (CTAS)][Create Table As Select (CTAS)].
...
Siehe auch [Anleitung für die Verwendung von PolyBase in SQL Data Warehouse][Anleitung für die Verwendung von PolyBase in SQL Data Warehouse].
...
Siehe auch [Übersicht über Tabellen][Übersicht über Tabellen], [Tabellenverteilung][Tabellenverteilung], [Selecting table distribution][Selecting table distribution] \(Auswählen der Tabellenverteilung), [CREATE TABLE][CREATE TABLE], [CREATE TABLE AS SELECT][CREATE TABLE AS SELECT].
...
Siehe auch [Tabellenpartitionierung][Tabellenpartitionierung].
...
Siehe auch [Grundlagen von Transaktionen][Grundlagen von Transaktionen], [Optimieren von Transaktionen][Optimieren von Transaktionen], [Tabellenpartitionierung][Tabellenpartitionierung], [TRUNCATE TABLE][TRUNCATE TABLE], [ALTER TABLE][ALTER TABLE], [Create Table As Select (CTAS)][Create Table As Select (CTAS)].
...
Siehe auch [Übersicht über Tabellen][Übersicht über Tabellen], [Tabellendatentypen][Tabellendatentypen], [CREATE TABLE][CREATE TABLE].
...
Siehe auch [Tabellenindizes][Tabellenindizes], [Beschreibung von Columnstore-Indizes][Beschreibung von Columnstore-Indizes] und [Neuerstellen von Columnstore-Indizes][Neuerstellen von Columnstore-Indizes].
...
Siehe auch [Parallelitäts- und Workloadverwaltung][Parallelitäts- und Workloadverwaltung].
...
Siehe auch [Parallelitäts- und Workloadverwaltung][Parallelitäts- und Workloadverwaltung] und [sys.dm\_pdw\_waits][sys.dm\_pdw\_waits].
...
Siehe auch [Überwachen Ihrer Workload mit dynamischen Verwaltungssichten][Überwachen Ihrer Workload mit dynamischen Verwaltungssichten], [LABEL][LABEL], [OPTION][OPTION], [sys.dm\_exec\_sessions][sys.dm\_exec\_sessions], [sys.dm\_pdw\_exec\_requests][sys.dm\_pdw\_exec\_requests], [sys.dm\_pdw\_request\_steps][sys.dm\_pdw\_request\_steps], [sys.dm\_pdw\_sql\_requests][sys.dm\_pdw\_sql\_requests], [sys.dm\_pdw\_dms\_workers], [DBCC PDW\_SHOWEXECUTIONPLAN][DBCC PDW\_SHOWEXECUTIONPLAN] und [sys.dm\_pdw\_waits][sys.dm\_pdw\_waits].
