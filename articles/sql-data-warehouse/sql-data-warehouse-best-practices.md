...
Weitere Informationen finden Sie unter [Anhalten von Computeressourcen][Anhalten von Computeressourcen], [Fortsetzen von Computeressourcen][Fortsetzen von Computeressourcen], [Skalieren von Computeressourcen][Skalieren von Computeressourcen].
...
Weitere Informationen finden Sie unter [Grundlegendes zu Transaktionen][Grundlegendes zu Transaktionen], [Optimieren von Transaktionen][Optimieren von Transaktionen].
...
Weitere Informationen finden Sie unter [Verwalten von Tabellenstatistiken][Verwalten von Tabellenstatistiken], [CREATE STATISTICS][CREATE STATISTICS], [UPDATE STATISTICS][UPDATE STATISTICS].
...
Weitere Informationen finden Sie unter [Laden von Daten][Laden von Daten], [Anleitung für die Verwendung von PolyBase][Anleitung für die Verwendung von PolyBase], [Azure SQL Data Warehouse – Lademuster und -strategien][Azure SQL Data Warehouse – Lademuster und -strategien], [Laden von Daten mit Azure Data Factory][Laden von Daten mit Azure Data Factory], [Verschieben von Daten mit Azure Data Factory][Verschieben von Daten mit Azure Data Factory], [CREATE EXTERNAL FILE FORMAT][CREATE EXTERNAL FILE FORMAT], [Create table as select (CTAS)][Create table as select (CTAS)].
...
Weitere Informationen finden Sie unter [Anleitung für die Verwendung von PolyBase][Anleitung für die Verwendung von PolyBase].
...
Weitere Informationen finden Sie unter [Tabellenübersicht][Tabellenübersicht], [Tabellenverteilung][Tabellenverteilung], [Auswählen von Tabellenverteilungen][Auswählen von Tabellenverteilungen], [CREATE TABLE][CREATE TABLE], [CREATE TABLE AS SELECT][CREATE TABLE AS SELECT].

## <a name="do-not-overpartition"></a>Vermeiden von übermäßiger Partitionierung
...
Weitere Informationen finden Sie unter [Tabellenpartitionierung][Tabellenpartitionierung].
...
Weitere Informationen finden Sie unter [Grundlegendes zu Transaktionen][Grundlegendes zu Transaktionen], [Optimieren von Transaktionen][Optimieren von Transaktionen], [Tabellenpartitionierung][Tabellenpartitionierung], [TRUNCATE TABLE][TRUNCATE TABLE], [ALTER TABLE][ALTER TABLE], [Create table as select (CTAS)][Create table as select (CTAS)].
...
Weitere Informationen finden Sie unter [Tabellenübersicht][Tabellenübersicht], [Tabellendatentypen][Tabellendatentypen], [CREATE TABLE][CREATE TABLE].
...
Weitere Informationen finden Sie unter [Tabellenindizes][Tabellenindizes], [Beschreibung von Columnstore-Indizes][Beschreibung von Columnstore-Indizes], [Neuerstellen von Columnstore-Indizes][Neuerstellen von Columnstore-Indizes].
...
Weitere Informationen finden Sie unter [Parallelitäts- und Workloadverwaltung][Parallelitäts- und Workloadverwaltung].
...
Weitere Informationen finden Sie unter [Parallelitäts- und Workloadverwaltung][Parallelitäts- und Workloadverwaltung], [sys.dm_pdw_waits][sys.dm_pdw_waits].
...
Weitere Informationen finden Sie unter [Überwachen Ihrer Workload mit dynamischen Verwaltungssichten][Überwachen Ihrer Workload mit dynamischen Verwaltungssichten], [LABEL][LABEL], [OPTION][OPTION], [sys.dm_exec_sessions][sys.dm_exec_sessions], [sys.dm_pdw_exec_requests][sys.dm_pdw_exec_requests], [sys.dm_pdw_request_steps][sys.dm_pdw_request_steps], [sys.dm_pdw_sql_requests][sys.dm_pdw_sql_requests], [sys.dm_pdw_dms_workers], [DBCC PDW_SHOWEXECUTIONPLAN][DBCC PDW_SHOWEXECUTIONPLAN], [sys.dm_pdw_waits][sys.dm_pdw_waits].

## <a name="other-resources"></a>Weitere Ressourcen
Informationen zu häufigen Problemen und den entsprechenden Lösungen finden Sie im Artikel [Problembehandlung][Problembehandlung].

Wenn Sie die gewünschten Informationen in diesem Artikel nicht gefunden haben, können Sie links auf dieser Seite die Option zum Suchen nach Dokumenten (Search for docs) verwenden, um alle Dokumente zu Azure SQL Data Warehouse zu durchsuchen.  Das [MSDN-Forum für Azure SQL Data Warehouse][MSDN-Forum für Azure SQL Data Warehouse] ist ein Ort, an dem Sie anderen Benutzern und dem SQL Data Warehouse-Produktteam Fragen stellen können.  Wir überwachen dieses Forum aktiv, um sicherzustellen, dass Ihre Frage entweder von einem anderen Benutzer oder einem Mitarbeiter beantwortet wird.  Falls Sie Ihre Fragen lieber über Stack Overflow stellen möchten, können Sie auch das [Stack Overflow-Forum für Azure SQL Data Warehouse][Stack Overflow-Forum für Azure SQL Data Warehouse] verwenden.
...
[Auswählen von Tabellenverteilungen]: https://blogs.msdn.microsoft.com/sqlcat/2015/08/11/choosing-hash-distributed-table-vs-round-robin-distributed-table-in-azure-sql-dw-service/
...
[Azure SQL Data Warehouse – Lademuster und -strategien]: https://blogs.msdn.microsoft.com/sqlcat/2016/02/06/azure-sql-data-warehouse-loading-patterns-and-strategies
