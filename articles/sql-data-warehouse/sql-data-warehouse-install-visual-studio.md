...
1. [Laden Sie Visual Studio 2015 herunter][Laden Sie Visual Studio 2015 herunter].
2. Führen Sie die Schritte der auf MSDN bereitgestellten Anleitung [Installieren von Visual Studio][Installieren von Visual Studio] aus, und wählen Sie die Standardkonfigurationen aus.
...
## Nächste Schritte
Da Sie jetzt die neueste Version von SSDT verwenden, sind Sie bereit, eine [Verbindung][Verbindung] mit SQL Data Warehouse herzustellen.
