...
| [Tempdb][] | Maximale Größe von „tempdb“ | 399 GB pro DW100. Daher ist „tempdb“ in DWU1000 3,99 TB groß. |
...
| Tabelle | Bytes pro Zeile, definierte Größe | 8060 Bytes<br/><br/>Die Anzahl von Bytes pro Zeile wird auf die gleiche Weise wie bei SQL Server mit aktivierter Seitenkomprimierung berechnet. Wie SQL Server auch, unterstützt SQL Data Warehouse die Speicherung von Zeilenüberlaufsdaten, sodass Spalten variabler Länge aus der Zeile verschoben werden können. Im Hauptdatensatz für Spalten variabler Länge, die aus einer Zeile verschoben wurden, wird nur ein 24-Byte-Stamm gespeichert. Weitere Informationen finden Sie unter [Zeilenüberlauf bei Daten über 8 KB][] in der SQL Server-Onlinedokumentation.<br/><br/>Eine Liste der SQL Data Warehouse-Datentypgrößen finden Sie unter [CREATE TABLE (Azure SQL Data Warehouse)][]. |
| Table | Partitionen pro Tabelle | 15\.000<br/><br/>Für eine hohe Leistung empfehlen wir, die Anzahl der benötigten Partitionen zu minimieren, ohne die Unterstützung Ihrer Geschäftsfunktionen zu beeinträchtigen. Mit einer steigenden Anzahl von Partitionen wächst der Verarbeitungsaufwand für Datendefinitionssprache (DDL)- und Datenbearbeitungssprache (DML)-Vorgänge, was zu Leistungseinbußen führt.|
...
| Index | Zeilen in einer Rowgroup eines Columnstore-Indexes | 1024<br/><br/>Jeder Columnstore-Index wird in Form von mehreren Columnstore-Indizes implementiert. Beachten Sie, dass beim Einfügen von 1.024 Zeilen in einen SQL Data Warehouse-Columnstore-Index die Zeilen nicht alle in dieselbe Rowgroup übertragen werden.|
