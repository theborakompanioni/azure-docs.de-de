...
| ![Informatica][4] |**Informatica Cloud**<br>Das Cloudintegrationsportfolio von Informatica ermöglicht es Ihnen, Datenquellen in der Cloud, lokale Datenquellen, mobile Datenquellen und Datenquellen aus sozialen Netzwerken miteinander zu verknüpfen. Sie können Informatica Cloud verwenden, um relevante und vertrauenswürdige Geschäftsdaten effizient gemeinsam zu nutzen. Unser Angebot für die Cloudintegration gehört zu den umfassendsten auf dem Markt. Es eignet sich für Batchprozesse genauso wie für die Echtzeitverarbeitung oder für die Verwaltung von Testdaten in der Cloud. Anwendungen zur Datenqualitätssicherung oder zur Stammdatenverwaltung in der Cloud werden ebenfalls abgedeckt. |[Marketplace][informatica_Cloud_Services_marketplace]<br>[Kostenlose Testversion][informatica_cloud_free_trial]<br>[Konfigurationsleitfaden][informatica_cloud_services_config]<br>[Website][informatica_Cloud_Services_website]<br>[Datenblatt][informatica_cloud_datasheet]<br>[Twitter][informatica_cloud_twitter]<br>[YouTube][informatica_cloud_youtube] | |
