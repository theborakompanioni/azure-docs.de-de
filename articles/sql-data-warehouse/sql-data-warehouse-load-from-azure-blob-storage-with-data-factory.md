...
* **Azure Data Factory**: Azure Data Factory schließt die tatsächliche Last ab und ist daher zum Erstellen der Datenverschiebungspipeline erforderlich. Das Erstellen (sofern erforderlich) ist in Schritt 1 von [Erste Schritte mit Azure Data Factory (Data Factory Edition)][Get started with Azure Data Factory (Data Factory Editor)] beschrieben.
