...
Ohne entsprechende Angabe wird die Standardsortierung „COLLATE SQL\_Latin1\_General\_CP1\_CI\_AS“ verwendet. `MAXSIZE` kann zwischen 250 GB und 240 TB liegen. `SERVICE_OBJECTIVE` kann einen [DWU][DWU]-Wert zwischen DW100 und DW2000 aufweisen. Eine Liste aller gültigen Werte finden Sie in der MSDN-Dokumentation zu [CREATE DATABASE][CREATE DATABASE]. Sowohl „MAXSIZE“ als auch „SERVICE\_OBJECTIVE“ kann mit einem T-SQL-Befehl vom Typ [ALTER DATABASE][ALTER DATABASE] geändert werden. Die Sortierung einer Datenbank kann nach der Erstellung nicht mehr geändert werden. Gehen Sie beim Ändern von „SERVICE\_OBJECTIVE“ mit Bedacht vor, da eine DWU-Änderung einen Neustart des Diensts und somit den Abbruch sämtlicher aktueller Abfragen zur Folge hat. Da MAXSIZE nur ein einfacher Metadatenvorgang ist, werden durch die Änderung dieses Werts keine Dienste neu gestartet.
