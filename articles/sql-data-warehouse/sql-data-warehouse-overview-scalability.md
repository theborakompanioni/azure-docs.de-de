<properties
   pageTitle="Leistungsskalierbarkeit für Azure SQL Data Warehouse | Microsoft Azure"
   description="Grundlagen zu den Funktionen zur horizontalen Leistungsskalierung in Azure SQL Data Warehouse. Führen Sie eine horizontale Skalierung durch, indem Sie DWUs anpassen oder Computeressourcen anhalten und fortsetzen, um Kosten zu sparen."
...
- Skalieren der Leistung durch Anpassen von Data Warehouse-Einheiten (DWUs)
...
- [Skalieren der Leistung mit dem Azure-Portal][]
- [Skalieren der Leistung mit PowerShell][]
- [Skalieren der Leistung mit REST-APIs][]
- [Skalieren der Leistung mit TSQL][]
...
[Skalieren der Leistung mit dem Azure-Portal]: ./sql-data-warehouse-manage-scale-out-tasks.md#task-1-scale-performance
[Skalieren der Leistung mit PowerShell]: ./sql-data-warehouse-manage-scale-out-tasks-powershell.md#task-1-scale-performance
[Skalieren der Leistung mit REST-APIs]: ./sql-data-warehouse-manage-scale-out-tasks-rest-api.md#task-1-scale-performance
[Skalieren der Leistung mit TSQL]: ./sql-data-warehouse-manage-scale-out-tasks-tsql.md
