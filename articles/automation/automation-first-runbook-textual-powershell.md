...
1.	Fügen Sie Parameter für *VMName* und *VMServiceName* zum Runbook hinzu, und verwenden Sie diese Variablen mit dem Cmdlet **Start-AzureVM**, wie in der folgenden Abbildung gezeigt. ![Parameter hinzufügen](media/automation-first-runbook-textual-powershell/automation-add-parameter.png)  
