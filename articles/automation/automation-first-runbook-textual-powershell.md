...
1.	Klicken Sie auf **Veröffentlichen**, um das Runbook zu veröffentlichen, und bestätigen Sie den Vorgang mit **Ja**, wenn Sie dazu aufgefordert werden. ![Schaltfläche "Veröffentlichen"](media/automation-first-runbook-textual-powershell/automation-publish-button.png)  
...
4.	Wir möchten das Runbook hier nur starten. Klicken Sie daher auf **Start** und dann auf dem Blatt „Runbook starten“ auf **OK**. ![Schaltfläche „Start“](media/automation-first-runbook-textual-powershell/automation-start-button.png)  
...
5.	Klicken Sie auf **Starten**, um den Test zu starten. Sobald der Vorgang abgeschlossen ist, sollten Sie eine Ausgabe mit der Umgebung und der Abonnement-ID Ihres Kontos erhalten. Auf diese Weise wird bestätigt, dass die Anmeldeinformationen gültig sind.
...
1.	Fügen Sie Parameter für *VMName* und *ResourceGroupName* zum Runbook hinzu, und verwenden Sie diese Variablen mit dem Cmdlet **Start-AzureRmVM**, wie in der folgenden Abbildung gezeigt.  
...
6.	Klicken Sie auf **Starten**, um das Runbook zu starten. Geben Sie **VMName** und **ResourceGroupName** für den virtuellen Computer ein, der gestartet wird. ![Parameter übergeben](media/automation-first-runbook-textual-powershell/automation-pass-params.png)  
