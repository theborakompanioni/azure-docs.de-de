...
## <a name="physicalvirtual-linux-machines-on-premises-in-azure-or-in-a-cloud-other-than-azure"></a>Physische/virtuelle Linux-Computer, lokal, in Azure oder in einer anderen Cloud als Azure
