...
4. Schließen Sie den Assistenten ab, und aktivieren Sie das Kontrollkästchen, um die neue Variable zu speichern.

### So erstellen Sie eine neue Variable über das Azure-Portal
1. Klicken Sie in Ihrem Automation-Konto auf **Objekte**, um das Blatt **Objekte** zu öffnen.
2. Klicken Sie auf **Variablen**, um das Blatt **Variablen** zu öffnen.
3. Klicken Sie oben im Blatt auf **Variable hinzufügen**.
4. Geben Sie die erforderlichen Daten ein, und klicken Sie auf **Erstellen**, um die neue Variable zu speichern.
