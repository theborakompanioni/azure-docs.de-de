...
---|---|---|---|---
Barracuda Networks, Inc.|Barracuda NextGen Firewall F-Serie 6.2.1-057|Hinweis: Diese Appliance wird über eine Clientanwendung verwaltet, und TCP/807 muss dazu weitergeleitet werden. Weitere Informationen finden Sie in der INFODATEI https://techlib.barracuda.com/NG61/DeployAzure...|Linux|80 zur Bereitstellung. GB
Barracuda Networks, Inc.|Barracuda Web Application Firewall 8.0.1.008-20160405|Hinweis: Diese Appliance wird über eine Clientanwendung verwaltet, und TCP/8000 muss dazu weitergeleitet werden. Einzelheiten finden Sie in der INFODAEI https://techlib.barracuda.com/WAF/Azure zur Bereitstellung. Das Barracuda Web...|Linux|50 GB
...
credativ|Debian 7 Wheezy|Debian 7 Wheezy (20160405.0) für Microsoft Azure. Debian GNU/Linux ist eine der am häufigsten verwendeten Linux-Distributionen. |Linux|30 GB
credativ|Debian 8 Jessie|Debian 8 Jessie (20160405.0) für Microsoft Azure. Debian GNU/Linux ist eine der am häufigsten verwendeten Linux-Distributionen. |Linux|30 GB
...
Microsoft Windows Server-Gruppe|Windows Server 2016-Core mit Containern Technische Vorschau 4|Windows Server bringt die Bandbreite und den Umfang der Erfahrung von Microsoft in Bezug auf globale Clouddienste in die Infrastruktur Ihres Datencenters ein. Windows Server 2016-Core mit Containern Technische Vorschau 4|Windows|127 GB
Microsoft Windows Server-Gruppe|Windows Server 2016 Technical Preview 4|Als Kernstück der Vision von Microsoft-Cloud-OS überträgt Windows Server die Bandbreite und den Umfang der Erfahrung von Microsoft in Bezug auf globale Cloud-Dienste in die Infrastruktur Ihres Rechenzentrums. Windows ...|Windows|128 GB
...
- [Bereitstellen eines virtuellen Linux-Rechners](./virtual-machines/virtual-machines-linux-create-cli-complete.md)

- [Virtuelle Computer – häufig gestellte Fragen](./virtual-machines/virtual-machines-linux-classic-faq.md)

- [Erstellen und Hochladen Ihrer eigenen VHD](./virtual-machines/virtual-machines-linux-about-disks-vhds.md/)
