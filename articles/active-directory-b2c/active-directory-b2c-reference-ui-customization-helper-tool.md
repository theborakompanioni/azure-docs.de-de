...
6. Wiederholen Sie den gleichen Schritt für die **Social account sign-up page** (Registrierungsseite für Konten sozialer Netzwerke). Klicken Sie zweimal auf **OK**, um die Blätter für die UI-Anpassung zu schließen.
...
14. Geben Sie einen **Namen** für den Container an (z. B. „b2c“), und wählen Sie **Blob** als **Zugriffstyp** aus. Klicken Sie auf **OK**.
15. Öffnen Sie den Container **properties**, und notieren Sie sich die URL des Containers. Sie sieht beispielsweise wie folgt aus: `https://contoso.blob.core.windows.net/b2c`. Schließen Sie das Blatt „Container“.
