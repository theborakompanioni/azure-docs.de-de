...
1. [Führen Sie diese Schritte aus, um im Azure-Portal zum Blatt „B2C-Funktionen“ zu navigieren](https://docs.microsoft.com/azure/active-directory-b2c/active-directory-b2c-app-registration#navigate-to-b2c-settings).
...
3. Das Blatt **Unterstützte Sprachen** wird geöffnet.  Auf dem Blatt können Sie die Option **Sprache hinzufügen** wählen.
...
Von rechts nach links geschriebene Sprachen werden nicht unterstützt. Wenn Sie diese Funktion benötigen, stimmen Sie auf [Azure-Feedback](https://feedback.azure.com/forums/169401-azure-active-directory/suggestions/19393000-provide-language-support-for-right-to-left-languag) dafür.
