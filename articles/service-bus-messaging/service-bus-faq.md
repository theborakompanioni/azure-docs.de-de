...
Ein [Namespace](../service-bus/service-bus-create-namespace-portal.md) ist ein Bereichscontainer für die Adressierung von Service Bus-Ressourcen innerhalb Ihrer Anwendung. Die Namespace-Erstellung ist für die Verwendung von Service Bus erforderlich und ist einer der ersten Schritte.
...
### <a name="what-is-the-azure-service-bus-relay-service?"></a>Was ist der Azure Service Bus Relay-Dienst?
...
* [Bewährte Methoden zum Schützen von Anwendungen vor Service Bus-Ausfällen und Notfällen][Bewährte Methoden zum Schützen von Anwendungen vor Service Bus-Ausfällen und Notfällen]: In diesem Artikel wird beschrieben, wie Sie Relayendpunkte, Warteschlangen und Themen und die aktive und passive Replikation zwischen Ausfällen von Datencentern am besten schützen.
...
### <a name="how-is-the-relay-hours-meter-calculated?"></a>Wie wird die Verbrauchseinheit "Relaystunden" berechnet?
...
### <a name="how-is-the-messages-meter-calculated-for-relays?"></a>Wie wird die Verbrauchseinheit "Nachrichten" für Relays berechnet?
...
#### <a name="queue/topic-size"></a>Warteschlangen-/Themengröße
...
#### <a name="number-of-concurrent-listeners-on-a-relay"></a>Anzahl der gleichzeitigen Listener für ein Relay
...
#### <a name="number-of-concurrent-relay-listeners-per-namespace"></a>Anzahl von gleichzeitigen Relaylistenern pro Namespace
...
#### <a name="number-of-topics/queues-per-service-namespace"></a>Anzahl von Themen/Warteschlangen pro Dienstnamespace
...
#### <a name="queue/topic/subscription"></a>Warteschlange/Thema/Abonnement
