...
- Sie möchten das auf Standards basierende AMQP 1.0-Messagingprotokoll verwenden. Weitere Informationen zu AMQP finden Sie unter [Service Bus AMQP – Übersicht](./service-bus-amqp-overview.md).
...
- [The Developer's Guide to Service Bus (Entwicklerhandbuch für Service Bus, in englischer Sprache)](http://www.cloudcasts.net/devguide/Default.aspx?id=11030)
