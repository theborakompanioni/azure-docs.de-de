...
> [AZURE.NOTE]
> Sie können diesen Wert auch ermitteln, indem Sie sich beim [Azure-Portal][] anmelden und zu den Verbindungsinformationen für Ihren Namespace navigieren.
...
Themen und Abonnements sind persistent und müssen über das [Azure-Portal][] oder programmgesteuert explizit gelöscht werden. Das folgende Beispiel zeigt, wie Sie das Thema namens "test-topic" löschen.
