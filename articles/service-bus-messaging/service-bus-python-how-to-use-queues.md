...
> [AZURE.NOTE] Informationen zur Installation von Python bzw. des [Python Azure Service Bus-Pakets][] finden Sie unter [Installieren von Python und SDK](../python-how-to-install.md).
