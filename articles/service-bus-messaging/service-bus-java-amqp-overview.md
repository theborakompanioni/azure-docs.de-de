---
title: Übersicht über Service Bus AMQP mit Java | Microsoft Docs
...
---
# <a name="amqp-1.0-support-in-service-bus"></a>Unterstützung für AMQP 1.0 in Service Bus
...
## <a name="introduction:-what-is-amqp-1.0-and-why-is-it-important?"></a>Einführung: Was ist AMQP 1.0 und warum ist es wichtig?
...
## <a name="amqp-1.0-technical-features"></a>Technische Merkmale von AMQP 1.0
...
## <a name="amqp-1.0-is-a-standard-(with-a-capital-'s')"></a>AMQP 1.0 ist ein Standard (im wahrsten Sinne des Wortes)
...
## <a name="amqp-1.0-and-service-bus"></a>AMQP 1.0 und Service Bus
...
Weitere Informationen zur Beschaffung dieser Bibliotheken und ihrer Verwendung mit Service Bus entnehmen Sie dem [Entwicklerhandbuch für Service Bus AMQP][Entwicklerhandbuch für Service Bus AMQP]. Links zu weiteren Informationen finden Sie im Abschnitt [Nächste Schritte](service-bus-java-amqp-overview.md#next-steps).
...
* [Entwicklerhandbuch für Service Bus AMQP][Entwicklerhandbuch für Service Bus AMQP]
