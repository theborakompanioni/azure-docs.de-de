---
title: Verschieben von Ressourcen in eine neue Ressourcengruppe | Microsoft Docs
...
1. Der Dienst muss die Möglichkeit bieten, Ressourcen zu verschieben. In diesem Thema wird erläutert, welche Dienste das Verschieben von Ressourcen ermöglichen und welche nicht.
2. Quell- und Zielabonnement müssen im selben [Active Directory-Mandanten](../active-directory/active-directory-howto-tenant.md) vorhanden sein. Zum Verschieben in einen neuen Mandanten wenden Sie sich an den Support.
...
5. Wenn Sie Ressourcen verschieben, die mit Recovery Services verknüpft sind, müssen Sie die [Einschränkungen von Recovery Services](#recovery-services-limitations) kennen.
6. Wenn Sie Ressourcen verschieben, die Sie mithilfe des klassischen Bereitstellungsmodells bereitgestellt haben, müssen Sie [Einschränkungen bei der klassischen Bereitstellung](#classic-deployment-limitations)kennen.
...
* Traffic Manager
* Virtueller Computer – Das Verschieben in ein neues Abonnement wird jedoch nicht unterstützt, wenn dessen Zertifikate in einem Schlüsseltresor gespeichert sind.
...
Verwenden Sie zum Verschieben vorhandener Ressourcen in eine andere Ressourcengruppe oder ein anderes Abonnement den Befehl **azure resource move** . Geben Sie die Ressourcen-IDs der zu verschiebenden Ressourcen an. Die Ressourcen-IDs können Sie mit dem folgenden Befehl abrufen:
