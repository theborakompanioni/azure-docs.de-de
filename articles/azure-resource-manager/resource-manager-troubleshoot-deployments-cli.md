...
---
# <a name="view-deployment-operations-with-azure-cli"></a>Anzeigen von Bereitstellungsvorgängen mit der Azure-Befehlszeilenschnittstelle
...
2. Mit dem Befehl **azure group log show** werden zahlreiche Informationen abgerufen. Bei der Problembehandlung konzentrieren Sie sich in der Regel auf fehlgeschlagene Vorgänge. Im folgenden Skript werden die Option **--json** und das JSON-Hilfsprogramm [jq](https://stedolan.github.io/jq/) verwendet, um das Protokoll nach Bereitstellungsfehlern zu durchsuchen.
    ...
    **properties** enthält Informationen in JSON zum fehlgeschlagenen Vorgang.
    ...
    Mit den Optionen **--verbose** und **-vv** können Sie weitere Informationen aus den Protokollen anzeigen.  Mit der Option **--verbose** können Sie die einzelnen Schritte der Vorgänge in `stdout` anzeigen. Den vollständigen Anforderungsverlauf zeigen Sie mit der Option **-vv** an. Die Mitteilungen liefern häufig wertvolle Hinweise zur Ursache von Fehlern.
