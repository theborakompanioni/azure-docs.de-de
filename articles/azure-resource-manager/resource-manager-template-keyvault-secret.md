---
title: "Resource Manager-Vorlage für ein Geheimnis in einem Schlüsseltresor | Microsoft Docs"
...
---
# <a name="key-vault-secret-template-schema"></a>Vorlagenschema für einen geheimen Schlüssel in einem Schlüsseltresor
...
| Name | Wert |
| --- | --- |
| type |Enum<br />Erforderlich<br />**Geheimnisse** (wenn als untergeordnete Ressource des Schlüsseltresors bereitgestellt) oder<br /> **Microsoft.KeyVault/vaults/secrets** (wenn als Ressource auf oberster Ebene bereitgestellt)<br /><br />Der zu erstellende Ressourcentyp. |
...
| Name |String<br />Erforderlich<br />Ein einzelnes Wort, wenn als untergeordnete Ressource eines Schlüsseltresors bereitgestellt, oder im Format **{key-vault-name}/{secret**, wenn als Ressource der obersten Ebene zum Hinzufügen zu einem vorhandenen Schlüsseltresor bereitgestellt.<br /><br />Der Name des zu erstellenden geheimen Schlüssels. |
| Eigenschaften |Objekt<br />Erforderlich<br />[properties-Objekt](#properties)<br /><br />Ein Objekt, das den Wert des zu erstellenden geheimen Schlüssels angibt. |
| dependsOn |Array<br />Optional<br />Eine durch Komma getrennte Liste von Ressourcennamen oder eindeutigen Ressourcenbezeichnern.<br /><br />Die Auflistung von Ressourcen, von denen diese Verknüpfung abhängt. Wenn der Schlüsseltresor für den geheimen Schlüssel in der gleichen Vorlage bereitgestellt wird, fügen Sie den Namen des Schlüsseltresors in diesem Element ein, um sicherzustellen, dass der Tresor zuerst bereitgestellt wird. |
...
| Name | Wert |
| --- | --- |
| Wert |String<br />Erforderlich<br /><br />Der im Schlüsseltresor zu speichernde Wert des geheimen Schlüssels. Wenn Sie einen Wert für diese Eigenschaft übergeben, verwenden Sie einen Parameter des Typs **securestring**. |
