---
title: "Überwachen von Vorgängen mit dem Resource Manager | Microsoft Docs"
...
---
# <a name="audit-operations-with-resource-manager"></a>Überwachen von Vorgängen mit dem Ressourcen-Manager
...
## <a name="portal-to-view-activity-logs"></a>Verwenden des Portals zum Anzeigen von Aktivitätsprotokollen
...
## <a name="powershell-to-view-activity-logs"></a>Verwenden von PowerShell zum Anzeigen von Aktivitätsprotokollen
...
## <a name="azure-cli-to-view-activity-logs"></a>Verwenden der Azure-Befehlszeilenschnittstelle zum Anzeigen von Aktivitätsprotokollen
...
## <a name="rest-api-to-view-audit-logs"></a>REST-API zum Anzeigen von Überwachungsprotokollen
