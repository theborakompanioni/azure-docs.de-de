...
---
# <a name="use-azure-resource-explorer-to-view-and-modify-resources"></a>Verwenden des Azure-Ressourcen-Explorer zum Anzeigen und Ändern von Ressourcen
...
## <a name="view-resources"></a>Anzeigen von Ressourcen
...
Sobald die Anforderung gesendet wurde, initiiert der Ressourcen-Explorer die GET-Anforderung erneut, um den Status zu aktualisieren. In diesem Fall sehen wir, dass `requestedServiceObjectiveId` aktualisiert wurde und sich von `currentServiceObjectiveId` unterscheidet, was bedeutet, dass ein Skalierungsvorgang ausgeführt wird. Sie können auf die GET-Schaltfläche klicken, um den Status manuell zu aktualisieren.
