...
## [Unterstützte Dienste, Regionen und API-Versionen](resource-manager-supported-services.md)
## [Grundlegendes zu Resource Manager-Bereitstellungen und klassischen Bereitstellungen](resource-manager-deployment-model.md)
## [Präskriptive Abonnementgovernance](resource-manager-subscription-governance.md)
## [Governancebeispiele für Unternehmen](resource-manager-subscription-examples.md)
