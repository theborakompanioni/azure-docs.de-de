...
Ein Steuerelement, mit dem Benutzer hochzuladende Dateien angeben können. Dieses Element verwenden Sie beim [Erstellen einer verwalteten Azure-Anwendung](managed-application-publishing.md).
