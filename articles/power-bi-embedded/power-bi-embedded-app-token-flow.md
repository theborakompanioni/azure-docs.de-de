<properties
   pageTitle="Authentifizieren und Autorisieren mit Power BI Embedded"
...
**Schlüssel**: Schlüssel können für alle Power BI Embedded-REST-API-Aufrufe verwendet werden. Die Schlüssel finden Sie im **Azure-Portal** unter **Alle Einstellungen** > **Zugriffsschlüssel**. Behandeln Sie Ihren Schlüssel immer wie ein Kennwort. Die Schlüssel verfügen über Berechtigungen, die es ihnen ermöglichen, beliebige REST-API-Aufrufe für eine bestimmte Arbeitsbereichssammlung durchzuführen.
...
|--------------|------------|
| **ver** | Die Version des App-Tokens. Die aktuelle Version ist .1.0.0. |
...
1. Kopieren der API-Schlüssel zu Ihrer Anwendung Die Schlüssel erhalten Sie über das **Azure-Portal**.
