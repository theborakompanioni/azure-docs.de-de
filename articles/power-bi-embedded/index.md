        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Erste Schritte beim Erstellen von Power BI-Berichten mit dem Beispielkatalog</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>PowerShell</h3>
                        <p>PowerShell-Cmdlets für Power BI Embedded</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>.NET</h3>
                        <p>Verwaltete Referenz zu Power BI Embedded</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p>Power BI Embedded – REST-API-Referenz</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="downloadHolder">
    <a href="https://opbuildstorageprod.blob.core.windows.net/output-pdf-files/en-us/Azure.azure-documents/live/power-bi-embedded.pdf">
        <div class="img"></div>
        <div class="text">
Herunterladen der Dokumentation zu Power BI Embedded </div>
    </a>
</div>
