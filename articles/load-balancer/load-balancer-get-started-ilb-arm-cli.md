<properties
   pageTitle="Erstellen eines internen Load Balancers mit der Azure-Befehlszeilenschnittstelle in Resource Manager | Microsoft Azure"
...
1. Wenn Sie die Azure-Befehlszeilenschnittstelle noch nicht verwendet haben, lesen Sie [Installieren und Konfigurieren der Azure-Befehlszeilenschnittstelle](../../articles/xplat-cli-install.md). Folgen Sie den Anweisungen, bis Sie Ihr Azure-Konto und Ihr Abonnement auswählen müssen.
...
1. Erstellen eines internen Load Balancers
    ...
    >[AZURE.NOTE] Alle Ressourcen für einen internen Load Balancer, wie z.B. virtuelle Netzwerke und Subnetze virtueller Netzwerke, müssen sich in derselben Ressourcengruppe und in derselben Region befinden.
