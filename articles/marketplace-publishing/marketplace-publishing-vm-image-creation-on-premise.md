...
Verwenden Sie folgenden Befehl im [Linux-Befehlszeilentool](../virtual-machines-command-line-tools.md): azure vm image create <image name> --location <Location of the data center> --OS Linux <LocationOfLocalVHD>
