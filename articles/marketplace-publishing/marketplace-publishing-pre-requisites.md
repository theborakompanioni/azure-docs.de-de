...
>[AZURE.NOTE] Für neue Benutzer: Bevor Sie einen Co-Admin im Veröffentlichungsportal hinzufügen, stellen Sie sicher, dass Sie mindestens eine Anwendung im Veröffentlichungsportal erstellt haben. Dies ist erforderlich, da die Registerkarte **HERAUSGEBER** nur nach der Erstellung mindestens einer Anwendung im Veröffentlichungsportal angezeigt wird.
