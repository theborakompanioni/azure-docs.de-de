...
1. Erstellen Sie eine Verteilerliste (Distribution List, DL) oder Sicherheitsgruppe (Security Group, SG) in der Domäne Ihres Unternehmens. Durch Verwendung einer DL können mehrere Personen E-Mail-Benachrichtigungen mit wichtigen Zahlungsinformationen empfangen. Gleichzeitig ist sichergestellt, dass das Eigentum am Microsoft-Konto übertragen werden kann und nicht an eine Einzelperson geknüpft ist.
...
## <a name="2-create-your-microsoft-developer-center-account"></a>2. Erstellen des Microsoft Developer Center-Kontos
...
## <a name="3-register-your-account-in-the-publishing-portal"></a>3. Registrieren Ihres Kontos im Veröffentlichungsportal
...
## <a name="4-steps-to-add-a-co-admin-in-the-publishing-portal"></a>4. Schritte zum Hinzufügen eines Co-Admins im Veröffentlichungsportal
...
## <a name="5-steps-to-delete-a-co-admin-in-the-publishing-portal"></a>5. Schritte zum Löschen eines Co-Admins im Veröffentlichungsportal
