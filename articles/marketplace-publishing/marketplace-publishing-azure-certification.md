...
1. Der erste Schritt auf dem Weg zur Zertifizierung Ihrer Lösung und zur Integration in den Azure Marketplace besteht im Ausfüllen des Bewerbungsformulars auf der Webseite [Microsoft Azure Certified](https://createopportunity.azurewebsites.net).
2. Wenn Sie die Teilnahmekriterien erfüllen und Ihre Bewerbung angenommen wird, arbeiten wir gemeinsam mit Ihnen an der Aufnahme Ihrer Lösung in den Azure Marketplace.
