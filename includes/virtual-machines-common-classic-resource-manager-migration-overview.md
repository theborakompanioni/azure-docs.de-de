...
| Netzwerk |ExpressRoute mit Autorisierungslinks  | Entfernen Sie vor Beginn der Migration die ExpressRoute-Verbindung mit der Verbindung mit einem virtuellen Netzwerk, und erstellen Sie die Verbindung nach Abschluss der Migration neu. Weitere Informationen zur [ExpressRoute-Migration](../articles/expressroute/expressroute-migration-classic-resource-manager.md). |
