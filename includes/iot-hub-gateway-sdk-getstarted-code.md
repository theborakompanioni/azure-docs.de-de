...
Der folgende Code zeigt den JSON-Code, der verwendet wurde, um alle Module für das Hello World-Beispiel unter Linux zu deklarieren. Ob ein Modul ein Argument erfordert, hängt vom Modulentwurf ab. In diesem Beispiel akzeptiert das Protokollierungsmodul ein Argument (den Pfad zur Ausgabedatei), und das hello\_world-Modul verfügt über keine Argumente.
...
Das hello\_world-Modul verarbeitet keine Nachrichten, die andere Module für den Broker veröffentlichen. Daher ist die Implementierung des Nachrichtenrückrufs im hello\_world-Modul eine no-op-Funktion.
...
Weitere Informationen zur Verwendung des IoT Gateway SDKs finden Sie in den folgenden Artikeln:
