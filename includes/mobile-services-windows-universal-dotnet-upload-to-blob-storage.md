...
4. Ersetzen Sie das **StackPanel**-Element in der **Datenvorlage** durch den folgenden Code:
...
5. Öffnen Sie im Windows Phone-App-Projekt die Datei "MainPage.xaml", und ersetzen Sie das **ButtonSave**-Element durch den folgenden Code:
...
6. Ersetzen Sie das **StackPanel**-Element in der **Datenvorlage** durch den folgenden Code:
...
7. Öffnen Sie im freigegebenen Ordner "DataModel" die Projektdatei "TodoItem.cs", und fügen Sie der TodoItem-Klasse die folgenden Eigenschaften hinzu:
...
8. Öffnen Sie die freigegebene Projektdatei "MainPage.cs", und fügen Sie die folgenden **using**-Anweisungen hinzu:
...
9. Fügen Sie der MainPage-Klasse den folgenden Code hinzu:
...
10. Ersetzen Sie die vorhandene `InsertTodoItem`-Methode durch den folgenden Code:
...
7. Tippen Sie auf die Vorschau, um ein Bild aufzunehmen, und klicken Sie dann auf **Hochladen**, um das neue Element einzufügen und das Bild hochzuladen.
