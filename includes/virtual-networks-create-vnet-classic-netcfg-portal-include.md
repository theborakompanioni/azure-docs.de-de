## <a name="how-to-create-a-vnet-using-a-network-config-file-in-the-azure-portal"></a>Erstellen eines VNet mithilfe einer Netzwerkkonfigurationsdatei im Azure-Portal
...
9. Klicken Sie im Azure-Portal in der unteren linken Ecke der Seite auf **NEU**, klicken Sie dann auf **NETZWEKDIENSTE**, auf **VIRTUELLES NETZWERK** und auf **KONFIGURATION IMPORTIEREN**, wie in der folgenden Abbildung dargestellt.
