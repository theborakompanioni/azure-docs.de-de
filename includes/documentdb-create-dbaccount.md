...
2. Klicken Sie im linken Menü auf **Neu**, dann auf **Datenbanken** und anschließend auf **Azure Cosmos DB**.
   ...
   ![Screenshot des Azure-Portals mit Hervorhebung von „Weitere Dienste“ und „Azure Cosmos DB“](./media/documentdb-create-dbaccount/create-nosql-db-databases-json-tutorial-1.png)
...
3. Legen Sie auf dem Blatt **Neues Konto** die gewünschte Konfiguration für das Azure Cosmos DB-Konto fest. 
    ...
    Füllen Sie das Blatt „Neues Konto“ mithilfe der Informationen auf dem Screenshot aus. Beim Einrichten Ihres Kontos wählen Sie Ihre eigenen Werte aus, sprich, die Werte sollen nicht mit den Werten auf dem Screenshot übereinstimmen. 
 
    ![Screenshot des Blatts „Neue Azure Cosmos DB“](./media/documentdb-create-dbaccount/create-nosql-db-databases-json-tutorial-2.png)
...
5. Klicken Sie in der Symbolleiste oben auf **Benachrichtigungen**, um den Bereitstellungsprozess zu überwachen.
    ...
    ![Benachrichtigung „Bereitstellung gestartet“](./media/documentdb-create-dbaccount/azure-documentdb-nosql-notification.png)

6.  Wenn die Bereitstellung abgeschlossen wurde, öffnen Sie das neue Konto über die Kachel „Alle Ressourcen“. 

    ![DocumentDB-Konto auf der Kachel „Alle Ressourcen“](./media/documentdb-create-dbaccount/azure-documentdb-all-resources.png)