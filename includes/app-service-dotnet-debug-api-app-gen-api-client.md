## <a name="generate-an-api-app-client"></a>Generieren eines API-App-Clients
...
1. Öffnen Sie in Visual Studio die Projektmappe mit der API-App aus dem Thema [Erstellen einer API-App](../articles/app-service-api/app-service-dotnet-create-api-app.md). 
...
## <a name="test-the-api-app-client"></a>Testen des API-App-Clients
