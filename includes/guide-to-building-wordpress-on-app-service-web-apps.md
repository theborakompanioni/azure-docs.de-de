...
- [Bereitstellen einer durch einen MySQL-Replikationscluster unterstützten WordPress-Web-App](https://azure.microsoft.com/documentation/templates/wordpress-mysql-replication/)
- [Erstellen eines eigenen Master-Master-MySQL-Clusters mit Percona Cluster](https://azure.microsoft.com/documentation/templates/mysql-ha-pxc/) und [Weitere Informationen zum Verwalten des Clusters](https://github.com/fanjeffrey/axiom.articles/tree/master/pxc)
- [Bereitstellen einer durch einen MySQL-Replikationscluster unterstützten WordPress-App mit Master-Slave-Konfiguration](https://azure.microsoft.com/documentation/templates/mysql-replication/)
- [Bereitstellen einer WordPress-App, die durch eine von ProjectNami verwaltete SQL Azure-DB unterstützt wird](https://azure.microsoft.com/marketplace/partners/projectnami/projectnami/)
- [Gewusst wie: Erstellen einer WordPress-Web-App mit mehreren Websites](../articles/app-service-web/web-sites-php-convert-wordpress-multisite.md)


###Portieren einer Anwendung in App Service 
- [How to Plan your migration to Azure App Service](https://azure.microsoft.com/blog/how-to-plan-your-migration-to-azure-websites/) (Gewusst wie: Planen der Migration zu Azure App Service)
- [How to migrate your existing WordPress site to Azure web apps](https://sunithamk.wordpress.com/2013/11/06/migrate-your-existing-wordpress-site-to-windows-azure/) (Gewusst wie: Migrieren Ihrer vorhandenen WordPress-Website zu Azure Web-Apps)
- [How to migrate your Web App from Linux to Azure web apps](https://www.movemetothecloud.net/LinuxMigration) (Gewusst wie: Migrieren Ihrer Web-App von Linux zu Azure Web-Apps)
- [Checkliste für die Veröffentlichung in Azure Web-Apps](https://sunithamk.wordpress.com/2015/10/27/azure-web-apps-basic-operations-checklist/)
- [Gewusst wie: Konfigurieren von PHP](../articles/app-service-web/web-sites-php-configure.md)
- [Setup multiple development environments for your WordPress app](../articles/app-service-web/app-service-web-staged-publishing-realworld-scenarios.md) (Einrichten mehrerer Entwicklungsumgebungen für Ihre WordPress-App)
