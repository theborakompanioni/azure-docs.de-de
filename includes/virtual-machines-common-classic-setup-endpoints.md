...
6. Geben Sie auf der Seite **Die Details des Endpunkts angeben** unter **Name** einen Namen für den Endpunkt an. Sie können auch den Namen eines Netzwerkprotokolls aus der Liste auswählen, wodurch Anfangswerte für **Protokoll**, **Öffentlicher Port** und **Privater Port** eingetragen werden.
