+ Fügen Sie Ihrer mobilen App eine Authentifizierung hinzu: [Android][android-get-started-users], [Cordova][cordova-get-started-users], [iOS][ios-get-started-users], [Windows Universal][windows-get-started-users], [Xamarin.Android][xamarin-android-get-started-users], [Xamarin.iOS][xamarin-ios-get-started-users] – erfahren Sie, wie Sie Ihrer mobilen App eine App Service-Authentifizierung hinzufügen können.

+ Authentifizierung in API-Apps: [Benutzerprinzip](../articles/app-service-api/app-service-api-dotnet-user-principal-auth.md), [Serviceprinzip](../articles/app-service-api/app-service-api-dotnet-service-principal-auth.md) – erfahren Sie, wie Sie Ihre API-App mit App Service-Authentifizierung sichern können.
