...
* [Hinzufügen von Authentifizierung zu einer Web-App](../articles/app-service-web/app-service-web-get-started-2.md#authenticate-your-users)
* Hinzufügen von Authentifizierung zu Ihrer Mobile Services-App: [iOS][ios-get-started-users], [Android][android-get-started-users], [Windows Universal][windows-get-started-users], [Xamarin.Android][xamarin-android-get-started-users], [Xamarin.iOS][xamarin-ios-get-started-users], [Xamarin.Forms][xamarin-forms-get-started-users], [Cordova][cordova-get-started-users]  
  – Erfahren Sie, wie Sie Ihrer mobilen App eine App Service-Authentifizierung hinzufügen können.
* Authentifizierung in API-Apps: [Benutzerprinzipal](../articles/app-service-api/app-service-api-dotnet-user-principal-auth.md), [Dienstprinzipal](../articles/app-service-api/app-service-api-dotnet-service-principal-auth.md)  
  – Erfahren Sie, wie Sie Ihre API-App mit App Service-Authentifizierung sichern können.
