...
2. Navigieren Sie zur Swagger-Webseite, indem Sie `/swagger` an das Ende der Basis-URL anfügen.
   
   ![](./media/app-service-api-define-api-app/swaggerhome.png)
3. Klicken Sie auf **Contacts > Abrufen > Jetzt testen**. Sie sehen, dass die API funktioniert und das erwartete Ergebnis zurückgibt.
   
    ![](./media/app-service-api-define-api-app/swaggertry.png)
4. Klicken Sie in Visual Studio auf **Debuggen > Debuggen beenden**.
