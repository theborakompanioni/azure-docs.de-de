...
-->
## <a name="connect-to-the-azure-portal-with-a-subscription"></a>Herstellen einer Verbindung mit dem Azure-Portal mit einem Abonnement
Zum Herstellen einer Verbindung mit dem Azure-Portal benötigen Sie ein Abonnement.

### <a name="get-a-new-account"></a>Einrichten eines neuen Kontos
