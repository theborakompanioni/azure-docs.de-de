...
Wenn Sie einen SRV-Eintrag im Zonenstamm erstellen, geben Sie im Eintragsnamen einfach *_service* und *_protocol* an. Es ist nicht erforderlich, include"@" im Eintragsnamen anzugeben.
