1. Klicken Sie im **Projektmappen-Explorer** mit der rechten Maustaste auf das API-App-Projekt, und wählen Sie **Veröffentlichen** aus, um das Dialogfeld für die Veröffentlichung zu öffnen. Das Veröffentlichungsprofil, das Sie zuvor erstellt haben, sollte vorausgewählt sein. 
2. Klicken Sie auf **Veröffentlichen**, um den Bereitstellungsprozess zu beginnen.
...
3. Wechseln Sie in Ihrem Browser zum [Azure-Vorschauportal](https://portal.azure.com).
4. Navigieren Sie zum Blatt **API-App** für die API-App, die Sie bereitgestellt haben.
...
5. Klicken Sie auf den Link **Gateway**.
6. Klicken Sie im Blatt **Gateway** auf **Neu starten**.
