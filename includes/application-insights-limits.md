...
Die Beschränkungen hängen von der von Ihnen ausgewählten [Preisübersicht](https://azure.microsoft.com/pricing/details/application-insights/) ab.
...
| [Ablaufverfolgung und Protokolle](../articles/application-insights/app-insights-search-diagnostic-logs.md)  |200 DP/s |500 DP/s |
| [Ausnahmen](../articles/application-insights/app-insights-asp-net-exceptions.md)  |50 DP/s |50 DP/s |
...
| [Eigenschaften](../articles/application-insights/app-insights-api-custom-events-metrics.md#properties)  |100 | |
...
| [Metriken](../articles/application-insights/app-insights-api-custom-events-metrics.md#properties)  |100 | |
