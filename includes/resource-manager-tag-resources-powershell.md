...
In der neuesten Version wurde der Name des Parameters **Tags** in **Tag** geändert und der Typ von **Hashtable[]** in **Hashtable**. Sie müssen nicht mehr für jeden Eintrag **Name** und **Wert** angeben. Stattdessen geben Sie Schlüssel/Wert-Paare im Format **Schlüssel = „Wert“**an.
