...
Klicken Sie auf **Erstellen**, um in Azure eine Funktions-App mit diesen Einstellungen zu erstellen. Notieren Sie sich nach Abschluss der Bereitstellung den Wert der **Website-URL**, da es sich dabei um die Adresse Ihrer Funktions-App in Azure handelt. 
