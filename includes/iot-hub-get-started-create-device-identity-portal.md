...
1. Klicken Sie bei geöffneter IoT Hub-Ressource auf das Tool **Device Explorer** und dann oben auf **Hinzufügen**. Geben Sie den Namen für Ihr neues Gerät ein, und klicken Sie auf **Speichern**. 
