...
1. Um eine Verbindung mit box herzustellen, wählen Sie im Logik-App-Designer in der Dropdownliste **Von Microsoft verwaltete APIs anzeigen** aus, und geben Sie dann *box* in das Suchfeld ein. Wählen Sie den zu verwendenden Trigger oder die gewünschte Aktion aus:   
   ![Schritt zur Erstellung der box-Verbindung](./media/connectors-create-api-box/box-1.png)  
2. Wenn Sie noch keine Verbindungen mit box hergestellt haben, werden Sie aufgefordert, Ihre box-Anmeldeinformationen anzugeben. Mit diesen Anmeldeinformationen wird Ihre Logik-App autorisiert, eine Verbindung mit dem box-Konto herzustellen und auf dessen Daten zuzugreifen:  
