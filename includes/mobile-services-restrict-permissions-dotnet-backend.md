...
2. Übernehmen Sie das folgende *AuthorizeLevel*-Attribut für die Klasse **TodoItemController**:
   
        [AuthorizeLevel(AuthorizationLevel.User)]
   
    So wird sichergestellt, dass für alle Vorgänge für die Tabelle *TodoItem* eine Benutzerauthentifizierung erforderlich ist. Sie können auch das *AuthorizeLevel*-Attribut auf Methodenebene anwenden.
...
5. Veröffentlichen Sie das Projekt erneut.
