...
#### <a name="to-add-a-volume-container"></a>Hinzufügen eines Volumecontainers
...
3. Wenn Sie **Bandbreitenvorlage auswählen**angegeben haben, wählen Sie aus der Dropdownliste der vorhandenen Bandbreitenvorlagen eine Vorlage aus. Überprüfen Sie die Zeitplaneinstellungen, und klicken Sie auf das Häkchensymbol ![Häkchensymbol](./media/storsimple-configure-new-storage-account/HCS_CheckIcon-include.png)können Sie einen Zeitplan für die Bandbreitenzuweisung anwenden.
