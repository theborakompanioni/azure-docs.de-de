...
Die Runtime im folgenden Befehl ist auf `NODE|8.1` festgelegt. Führen Sie zum Anzeigen aller unterstützten Laufzeiten den Befehl [az webapp list-runtimes](/cli/azure/webapp#list-runtimes) aus. 
