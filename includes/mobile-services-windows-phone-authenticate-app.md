1. Öffnen Sie die Projektdatei mainpage.xaml.cs, und fügen Sie den folgenden Codeausschnitt zur MainPage-Klasse hinzu:
   ...
   > [!NOTE]
   > Falls Sie einen anderen Identitätsanbieter als Twitter verwenden, ändern Sie den Wert für <strong>MobileServiceAuthenticationProvider</strong> oben entsprechend Ihrem Anbieter.</p> </div>
   > 
   > 
