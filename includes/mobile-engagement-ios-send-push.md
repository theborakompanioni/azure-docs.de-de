### <a name="grant-access-to-your-push-certificate-to-mobile-engagement"></a>Erteilen Sie Ihrem Pushzertifikat den Zugriff auf Mobile Engagement.
...
4. Navigieren Sie nach unten, und wählen Sie im Inhaltsbereich die Option **Nur Benachrichtigung**
