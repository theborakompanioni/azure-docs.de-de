...
-->
## <a name="create-a-new-azure-sql-database"></a>Erstellen einer neuen Azure SQL-Datenbank
...
5. Geben Sie Werte für die folgenden Servereigenschaften ein:
   ...
   * Sortierung: Diese Option ist nur relevant, wenn eine leere Datenbank ausgewählt wurde.
        ...
        ![Neue Datenbank](./media/sql-database-create-new-database-portal/sql-database-create-new-database-portal-4.png)
