...
* Melden Sie sich bei Ihrem Azure-Konto an, indem Sie Ihre Anmeldeinformationen eingeben.
  ...
  Klicken Sie in **Server-Explorer** auf die Schaltfläche **Mit Azure verbinden**. Alternativ können Sie auch mit der rechten Maustaste auf den Knoten **Azure** klicken und im Kontextmenü die Option **Mit Azure verbinden** wählen.
