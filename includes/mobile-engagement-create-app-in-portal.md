...
3. Geben Sie in das Popupfenster, das angezeigt wird, die folgenden Informationen ein:
   ...
   * **Sammlungsname**: Stellt die Anwendungsgruppe dar. Hierdurch wird außerdem sichergestellt, dass sich alle Ihre Apps in einer Gruppe befinden, wodurch aggregierte Berechnungen von Metriken möglich sind. Sie sollten hier ggf. Ihren Firmenname oder Ihre Abteilung verwenden.
