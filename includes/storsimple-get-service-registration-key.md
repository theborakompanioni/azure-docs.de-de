...
5. Klicken Sie auf das Häkchensymbol ![StorSimple, Häkchensymbol](./media/storsimple-get-service-registration-key/HCS_CheckIcon-include.png) , um das Dialogfeld zu schließen und zur Seite **Schnellstart** .
