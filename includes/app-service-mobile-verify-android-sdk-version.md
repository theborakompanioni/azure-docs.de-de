...
2. Öffnen Sie auf der Registerkarte „Projektexplorer“ unter **Gradle Scripts** (Gradle-Skripts) die Datei **build.gradle (modeule: app)**. Stellen Sie sicher, dass für **compileSdkVersion** und **buildToolsVersion** die aktuelle installierte SDK-Version festgelegt ist. Die Tags könnten folgendermaßen aussehen:
