## <a name="tcp-settings-for-azure-vms"></a>TCP-Einstellungen für virtuelle Azure-Computer
...
Für [Linux][linux] müssen Sie die folgenden Kernelvariablen ändern:
net.ipv4.tcp_keepalive_time = 120 net.ipv4.tcp_keepalive_intvl = 30 net.ipv4.tcp_keepalive_probes = 8

Für [Windows][windows] müssen Sie die folgenden Registrierungswerte ändern:
