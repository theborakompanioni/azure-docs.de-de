...
Mit der aktuellen Verfügbarkeit von [Microsoft Visual C++ Compiler für Python 2.7][Microsoft Visual C++ Compiler für Python 2.7] ist das Erstellen von Paketen, die systemeigenen Code für Python 2.7 enthalten, jetzt einfacher.
