...
* **Indien, Mitte**, **Indien, Süden** und **Indien, Westen**
  * Diese Regionen sind zurzeit für Kunden mit Volumenlizenzierung und Partner mit lokaler Registrierung in Indien verfügbar. Im Laufe des Jahres 2016 werden direkte Onlineabonnements zugänglich gemacht.
