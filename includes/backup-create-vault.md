...
### <a name="azure-backup---storage-redundancy-options"></a>Azure Backup – Speicherredundanzoptionen
> [!IMPORTANT]
...
#### <a name="geo-redundant-storage-grs"></a>Georedundanter Speicher (GRS)
...
#### <a name="locally-redundant-storage-lrs"></a>Lokal redundanter Speicher (LRS)
