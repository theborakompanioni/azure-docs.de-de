...
## <a name="a-namedbinvmarunning-a-dbms-in-a-virtual-machine"></a><a name="dbinvm"></a>Ausführen eines DBMS auf einem virtuellen Computer
...
### <a name="a-namedatasyncasql-data-sync"></a><a name="datasync"></a>SQL-Datensynchronisierung
...
### <a name="a-namedatarptasql-data-reporting-using-virtual-machines"></a><a name="datarpt"></a>SQL-Datenberichte mithilfe virtueller Computer
...
Um eine bestimmte Entität in einer Tabelle zu identifizieren, stellt eine Anwendung den Schlüssel der betreffenden Entität bereit. Der Schlüssel besteht aus zwei Teilen: einem *Partitionsschlüssel*, der eine bestimmte Partition kennzeichnet, und einem *Zeilenschlüssel*, der eine Entität innerhalb dieser Partition kennzeichnet. In [Abbildung 6](#Fig6) fordert der Client beispielsweise die Entität mit Partitionsschlüssel A und Zeilenschlüssel 3 an, und Table Storage gibt diese Entität zusammen mit allen darin enthaltenen Eigenschaften zurück.
