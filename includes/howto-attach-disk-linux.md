...
2.  Geben Sie wie nachstehend gezeigt den Befehl `azure vm disk attach-new` ein, um einen neuen Datenträger zu erstellen und anzufügen. Ersetzen Sie dabei _TestVM_ durch den Namen Ihres virtuellen Linux-Computers, und geben Sie die Größe des Datenträgers in GB ein, in diesem Fall 100 GB.
...
4.  Nun fügen Sie die gewünschte VHD an Ihren virtuellen Computer an:
	...
	Denken Sie daran, _TestVM_ durch den Namen Ihres virtuellen Computers und _myTestVhd_ durch die gewünschte VHD zu ersetzen.
