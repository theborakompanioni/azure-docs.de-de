...
4. Wählen Sie nach dem Lesen der Beschreibung der WordPress-App **Erstellen**aus.
5. Klicken Sie auf **Web-App**, und geben Sie die erforderlichen Werte für die Konfiguration Ihrer Web-App ein.
   
    ![App konfigurieren][8]
6. Klicken Sie auf **Datenbank**, und geben Sie die erforderlichen Werte für die Konfiguration Ihrer MySQL-Datenbank ein. 
   
    ![Datenbank konfigurieren][database]
7. Geben Sie einen Namen für die neue Ressourcengruppe an.
   
    ![Ressourcengruppe festlegen][groupname]
8. Klicken Sie bei Bedarf auf **ABONNEMENT**, und geben Sie das zu verwendende Abonnement an. 
9. Klicken Sie nach der Definition der Web-App auf **Erstellen**, und warten Sie, bis die neue Web-App erstellt ist.
...
2. Klicken Sie auf der Seite **Zusammenfassung** auf **Durchsuchen** oder auf den Link unter **URL**, um die Willkommensseite der Web-App zu öffnen.
