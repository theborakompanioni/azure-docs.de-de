...
4. Im Dialogfeld **Mobilen Dienst erstellen** wählen Sie Ihr **Abonnement**, das **JavaScript**-Back End in **Runtime** und eine **Region** für den mobilen Dienst aus. Geben Sie dann einen **Namen** für Ihren mobilen Dienst ein.
   
   > [!NOTE]
   > Namen für mobile Dienste müssen eindeutig sein. Neben **Name** wird ein rotes X angezeigt, wenn der angegebene Name nicht verfügbar ist.
   > 
   > 
...
1. Wählen Sie den neu erstellten mobilen Dienst in der Liste im Dienst-Manager aus, nachdem er erstellt wurde, und klicken Sie auf **OK**.
