...
5. Gehen Sie im Dialogfeld **Zeitplan verwalten** unter **Hinzufügen oder Ändern eines Zeitplans** folgendermaßen vor:
   ...
   3. Wählen Sie als Typ der Sicherung die lokale Momentaufnahme oder die Cloudmomentaufnahme aus.
      
       ![Ändern von Zeitplänen 1](./media/storsimple-add-modify-backup-schedule-u2/AddModify2.png) 
   4. Geben Sie die Sicherungshäufigkeit, Aufbewahrung und Startzeit des Zeitplans an.
   5. Aktivieren Sie das Kontrollkästchen, um den Zeitplan zu aktivieren.
...
6. Wählen Sie unter **Volumes** die Volumes aus, auf die diese Richtlinie angewendet werden soll.
7. Klicken Sie unten auf der Seite auf **Speichern** , um die Änderungen an der Richtlinie zu speichern.
8. Sie werden aufgefordert, diesen Schritt zu bestätigen. Klicken Sie zum Speichern der Richtlinie auf **Ja** .
