...
> [!NOTE]
> Die Verfahren in dieser Aufgabe gelten für Azure Cloud Services. Informationen zu Speicherkonten finden Sie unter [Konfigurieren eines benutzerdefinierten Domänennamens für ein Azure-Speicherkonto](../articles/storage/storage-custom-domain-name.md). Für Websites siehe [Konfigurieren eines benutzerdefinierten Domänennamens für eine Azure-Websites](../articles/app-service-web/web-sites-custom-domain-name.md).
> 
> 
...
2. Melden Sie sich bei der Website Ihrer DNS-Registrierungsstelle an, und öffnen Sie die Seite für die DNS-Verwaltung. Suchen Sie nach Links oder Bereichen auf der Website mit der Bezeichnung **Domänenname**, **DNS** oder **Namenserververwaltung**.
...
4. Sie müssen auch den Domänen- oder Unterdomänenalias für den CNAME angeben, z. B. **www**, wenn Sie einen Alias für **www.customdomain.com** erstellen möchten. Wenn Sie einen Alias für die Stammdomäne erstellen möchten, kann sie als '**@**'-Symbol in den DNS-Tools Ihrer Registrierungsstelle aufgeführt sein.
5. Anschließend müssen Sie einen kanonischen Hostnamen angeben, der in diesem Fall die Domäne **cloudapp.net** Ihrer Anwendung ist.
...
4. Wählen Sie die Domäne oder Unterdomäne aus, die diesen A-Datensatz verwenden wird, oder geben Sie diese ein. Wählen Sie z. B. **www** aus, wenn Sie einen Alias für **www.customdomain.com** erstellen möchten. Wenn Sie einen Platzhaltereintrag für alle Unterdomänen erstellen möchten, geben Sie "*****" ein. Dieser Eintrag deckt alle Unterdomänen ab wie **mail.customdomain.com**, **login.customdomain.com** und **www.customdomain.com**.
...
5. Geben Sie die IP-Adresse Ihres Cloud-Diensts in das angegebene Feld ein. So wird der im A-Datensatz verwendete Domäneneintrag der IP-Adresse Ihrer Clouddienstbereitstellung zugewiesen.
...
## Nächste Schritte
* [Verwalten von Cloud-Diensten](../articles/cloud-services/cloud-services-how-to-manage.md)
* [Zuordnen von CDN-Inhalt (Content Delivery Network) zu einer benutzerdefinierten Domäne][Zuordnen von CDN-Inhalt (Content Delivery Network) zu einer benutzerdefinierten Domäne]
