...
## <a name="enable-azure-preview-features"></a>Aktivieren der Azure-Vorschaufeatures
1. Navigieren Sie zu <https://account.windowsazure.com/>, und melden Sie sich mit Ihrem Azure-Konto an.
2. Klicken Sie auf **Vorschaufeatures**, um die verfügbaren Vorschauversionen anzuzeigen.<br />
   ![Öffnen der Registerkarte „Vorschaufeatures“][1]
...
4. Wählen Sie Ihr Abonnement, und klicken Sie auf das Häkchen.<br />
