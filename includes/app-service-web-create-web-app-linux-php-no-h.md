...
Die Runtime im folgenden Befehl ist auf `PHP|7.0` festgelegt. Führen Sie zum Anzeigen aller unterstützten Laufzeiten den Befehl [az webapp list-runtimes](/cli/azure/webapp#list-runtimes) aus. 
