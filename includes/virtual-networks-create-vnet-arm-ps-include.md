## <a name="how-to-create-a-vnet-using-powershell"></a>Erstellen von VNets mithilfe von PowerShell
...
4. Speichern Sie das virtuelle Netzwerkobjekt in einer Variablen, wie unten dargestellt.
   ...
   > [!TIP]
   > Sie können die Schritte 3 und 4 durch Ausführen von **$vnet = New-AzureRmVirtualNetwork -ResourceGroupName TestRG -Name TestVNet -AddressPrefix 192.168.0.0/16 -Location centralus**zusammenfassen.
   > 
   > 
