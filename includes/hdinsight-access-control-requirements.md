...
* Ihre Azure-Anmeldung muss für die Azure-Ressourcengruppe, die Sie beim Erstellen von HDInsight (und anderen Azure-Ressourcen) verwenden, mindestens über Zugriff vom Typ **Mitwirkender** verfügen.
