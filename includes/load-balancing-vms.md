---
title: Lastenausgleich für Azure-Infrastrukturdienste
description: Beschreibt die Funktionen zum Ausführen des Lastenausgleichs mit Traffic Manager und dem Lastenausgleich.
metakeywords: ''
...
Weitere Informationen finden Sie unter [Azure-Lastenausgleichsmodul](../articles/load-balancer/load-balancer-overview.md). Die Schritte zum Erstellen einer Gruppe mit Lastenausgleich finden Sie unter [Konfigurieren einer Gruppe mit Lastenausgleich](../articles/load-balancer/load-balancer-overview.md).
...
Weitere Informationen finden Sie unter [Interner Lastenausgleich](../articles/load-balancer/load-balancer-internal-overview.md). Die Schritte zum Erstellen einer Gruppe mit Lastenausgleich finden Sie unter [Konfigurieren einer internen Gruppe mit Lastenausgleich](../load-balancer/load-balancer-internal-getstarted.md).
