...
* AMQP: SASL PLAIN- und AMQP Claims-basierte Sicherheit ({policyName}@sas.root.{iothubName} bei Token auf Ebene des IoT-Hubs. {Geräte-ID} bei auf Geräte bezogenen Token).
