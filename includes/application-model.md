...
* **Lokaler Speicher**. Mit diesem Element wird ein Unterverzeichnis der Rolleninstanz zugeordnet, das Ihre Anwendung verwenden kann. Es wird ausführlicher im Artikel [Data Storage Offerings in Azure][Data Storage Offerings in Azure] \(Datenspeicherangebote in Azure, in englischer Sprache\) beschrieben.
...
Weitere Informationen zum Bereitstellen, Aktualisieren und erneuten Konfigurieren Ihrer Rollen finden Sie im Artikel [Bereitstellen und Aktualisieren von Azure-Anwendungen][Bereitstellen und Aktualisieren von Azure-Anwendungen].<a id="Ref" name="Ref"></a>
...
* [Konfigurieren einer Azure-Anwendung][Konfigurieren einer Azure-Anwendung]
