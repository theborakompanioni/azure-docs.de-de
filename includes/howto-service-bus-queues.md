...
5. Wählen Sie nach der Bestätigung, dass der Name für den Namespace verfügbar ist, das Land oder die Region, wo dieser Namespace gehostet werden soll. (Stellen Sie sicher, dass dies dasselbe Land/dieselbe Region ist, in dem/der sie Ihre Rechnerressourcen einsetzen.)
   ...
   > [!IMPORTANT]
   > Wählen Sie **dieselbe Region** , in der Sie auch Ihre Anwendung einsetzen möchten. Dies sorgt für die beste Leistung.
   > 
   > 
...
## <a name="obtain-the-default-management-credentials-for-the-namespace"></a>Abrufen der Standard-Anmeldeinformationen für den Namespace
Wenn Sie Verwaltungsvorgänge ausführen möchten, z. B. die Erstellung einer Warteschlange im neuen Namespace, müssen Sie die Anmeldeinformationen für den Namespace abrufen. Diese Anmeldeinformation erhalten Sie im [klassischen Azure-Portal][klassischen Azure-Portal].

### <a name="to-obtain-management-credentials-from-the-portal"></a>So rufen Sie die Anmeldeinformationen im Verwaltungsportal ab
