---
title: "Ausführen des Assistenten zum Aktivieren einer Datenbank für Stretch | Microsoft Docs"
...
---
# <a name="get-started-by-running-the-enable-database-for-stretch-wizard"></a>Ausführen des Assistenten zum Aktivieren einer Datenbank für Stretch
...
## <a name="a-nametablesaselect-tables"></a><a name="Tables"></a>Auswählen von Tabellen
...
## <a name="a-namefilteraoptionally-provide-a-row-filter"></a><a name="Filter"></a>Optionales Bereitstellen eines Zeilenfilters
...
5. Klicken Sie zum Prüfen der Funktion auf **Überprüfen** . Wenn die Funktion Ergebnisse aus der Tabelle zurückgibt (also zu migrierende Zeilen vorhanden sind, auf die die Bedingung zutrifft), wird **Erfolgreich**zurückgegeben.
   ...
   > [!NOTE]
   > Das Textfeld, in dem die Filterabfrage angezeigt wird, ist schreibgeschützt. Es ist nicht möglich, die Abfrage im Textfeld zu bearbeiten.
   > 
   > 
...
## <a name="a-nameconfigureaconfigure-azure-deployment"></a><a name="Configure"></a>Konfigurieren der Azure-Bereitstellung
...
## <a name="a-namecredentialsasecure-credentials"></a><a name="Credentials"></a>Sichere Anmeldeinformationen
...
## <a name="a-nameknownissuesatroubleshooting-the-wizard"></a><a name="KnownIssues"></a>Problembehandlung für den Assistenten
**Der Assistent für Stretch-Datenbank ist fehlgeschlagen.**
